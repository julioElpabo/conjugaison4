...
import { aA as conjugationRequiresSubjectPronoun } from '../nitro/nitro.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const correctionPages = computed(() => paginateByHeight(
      ...
      220,
      (question) => isTableLayout.value ? tableQuestionHeight(question, true) : isTenseIdentification.value ? correctionItemHeight("", printableCorrectionText(question)) * (inclusivePrint.value ? 1.35 : 1) : correctionItemHeight(printableCorrectionLabel(question, props.exerciseKind), printableCorrectionText(question)) * (inclusivePrint.value ? 1.35 : 1)
    ));
...
//# sourceMappingURL=PrintPreview-B9nPTqX6.mjs.map
