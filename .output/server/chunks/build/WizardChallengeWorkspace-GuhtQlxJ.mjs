...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    function loadClassicExercise() {
      classicExercisePromise ??= import('./ClassicExercise-yvBa-rM3.mjs').then((module) => module.default).catch((error) => {
    ...
    function loadChatExercise() {
      chatExercisePromise ??= import('./ChatExercise-B6aR9v6t.mjs').then((module) => module.default).catch((error) => {
    ...
    watch(isPrintOpen, async (open) => {
      ...
      printPreviewComponent.value = markRaw((await import('./PrintPreview-BjS6iHzt.mjs')).default);
    });
...
//# sourceMappingURL=WizardChallengeWorkspace-GuhtQlxJ.mjs.map
