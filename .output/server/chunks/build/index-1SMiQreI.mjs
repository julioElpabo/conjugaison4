...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$1;
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "mode-landing" }, _attrs))} data-v-fda96f2f><div class="mode-landing__navigation" data-v-fda96f2f>`);
      ...
      _push(`</div><header class="mode-landing__hero" data-v-fda96f2f><p data-v-fda96f2f>${ssrInterpolate(unref(page).eyebrow)}</p><h1 data-v-fda96f2f>${ssrInterpolate(unref(page).title)}</h1>`);
      ...
      _push(`</header><div class="mode-landing__content" data-v-fda96f2f><section class="mode-purpose" data-v-fda96f2f><span data-v-fda96f2f>01</span><div data-v-fda96f2f><h2 data-v-fda96f2f>${ssrInterpolate(unref(page).purposeTitle)}</h2><p data-v-fda96f2f>${ssrInterpolate(unref(page).purpose)}</p></div></section><section class="mode-panel" data-v-fda96f2f><h2 data-v-fda96f2f>${ssrInterpolate(unref(page).examplesTitle)}</h2><ul data-v-fda96f2f><!--[-->`);
      ssrRenderList(unref(page).examples, (example) => {
        _push(`<li data-v-fda96f2f>${ssrInterpolate(example)}</li>`);
      });
      _push(`<!--]--></ul></section><section class="mode-panel mode-panel--watch" data-v-fda96f2f><h2 data-v-fda96f2f>${ssrInterpolate(unref(page).watchTitle)}</h2><ul data-v-fda96f2f><!--[-->`);
      ssrRenderList(unref(page).watchItems, (item) => {
        _push(`<li data-v-fda96f2f>${ssrInterpolate(item)}</li>`);
      });
      _push(`<!--]--></ul></section><section class="mode-tenses"${ssrRenderAttr("aria-labelledby", `${unref(slug)}-tenses-title`)} data-v-fda96f2f><div data-v-fda96f2f><p data-v-fda96f2f>02</p><div data-v-fda96f2f><h2${ssrRenderAttr("id", `${unref(slug)}-tenses-title`)} data-v-fda96f2f>${ssrInterpolate(unref(page).tensesTitle)}</h2><span data-v-fda96f2f>Choisis un temps pour comprendre son rôle précis, sa formation et les raisons de son emploi dans plusieurs contextes.</span></div></div>`);
      _push(ssrRenderComponent(_component_LearningSubnav, {
        label: unref(page).modeName,
        items: unref(tenseItems),
        "active-key": ""
      }, null, _parent));
      _push(`</section><section class="mode-cta" data-v-fda96f2f><div data-v-fda96f2f><p data-v-fda96f2f>${ssrInterpolate(unref(page).eyebrow)}</p><h2 data-v-fda96f2f>${ssrInterpolate(unref(page).ctaTitle)}</h2><span data-v-fda96f2f>${ssrInterpolate(unref(page).ctaText)}</span></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: unref(exerciseUrl) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(page).ctaLabel)} <span aria-hidden="true" data-v-fda96f2f${_scopeId}>→</span>`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(page).ctaLabel) + " ", 1),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fda96f2f"]]);

export { index as default };
//# sourceMappingURL=index-1SMiQreI.mjs.map
