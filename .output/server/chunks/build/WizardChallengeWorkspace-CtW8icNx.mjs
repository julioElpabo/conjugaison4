...
import { c as createLearnerTrackingContext } from './main-Cz2bxy_H.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    function loadClassicExercise() {
      classicExercisePromise ??= import('./ClassicExercise-BJ2ARQe4.mjs').then((module) => module.default).catch((error) => {
    ...
    function loadChatExercise() {
      chatExercisePromise ??= import('./ChatExercise-CGU2U4zJ.mjs').then((module) => module.default).catch((error) => {
...
//# sourceMappingURL=WizardChallengeWorkspace-CtW8icNx.mjs.map
