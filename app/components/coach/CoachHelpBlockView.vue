...
const renderedContent = computed(() => sanitizeCoachHtml(renderCoachHelpContent(props.block.content, props.values)))
</script>

<template>
  <section class="coach-help-block" :class="`coach-help-block--${block.type}`">
    <h3 v-if="block.title">{{ block.title }}</h3>
    <div v-if="renderedContent" class="coach-help-block__content" v-html="renderedContent" />
