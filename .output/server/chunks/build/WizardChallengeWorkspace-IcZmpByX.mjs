...
import { c as createLearnerTrackingContext } from './main-CFD2ahR5.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    function loadClassicExercise() {
      classicExercisePromise ??= import('./ClassicExercise-KNK29UER.mjs').then((module) => module.default).catch((error) => {
    ...
    function loadChatExercise() {
      chatExercisePromise ??= import('./ChatExercise-Dz83YYpw.mjs').then((module) => module.default).catch((error) => {
    ...
    watch(isPrintOpen, async (open) => {
      ...
      printPreviewComponent.value = markRaw((await import('./PrintPreview-C6KwuKOW.mjs')).default);
    });
...
//# sourceMappingURL=WizardChallengeWorkspace-IcZmpByX.mjs.map
