...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-4472aa63><section class="contact-dialog__card" data-v-4472aa63><button class="contact-dialog__close" type="button"${ssrRenderAttr("aria-label", unref(copy).close)}${ssrRenderAttr("title", unref(copy).close)}${ssrIncludeBooleanAttr(unref(submitting)) ? " disabled" : ""} data-v-4472aa63><span aria-hidden="true" data-v-4472aa63>×</span></button>`);
      if (unref(sent)) {
        _push(`<div class="contact-dialog__success" role="status" data-v-4472aa63><span class="contact-dialog__success-icon" aria-hidden="true" data-v-4472aa63>✓</span><h2 id="contact-success-title" data-v-4472aa63>${ssrInterpolate(unref(copy).successTitle)}</h2><p data-v-4472aa63>${ssrInterpolate(unref(copy).success)}</p><button class="contact-dialog__primary" type="button" data-v-4472aa63>${ssrInterpolate(unref(copy).close)}</button></div>`);
      } else {
        _push(`<!--[--><header class="contact-dialog__header" data-v-4472aa63><span class="contact-dialog__eyebrow" data-v-4472aa63>CONTACT</span><h2 id="contact-title" data-v-4472aa63>${ssrInterpolate(unref(copy).title)}</h2><p data-v-4472aa63>${ssrInterpolate(unref(copy).intro)}</p></header><form class="contact-dialog__form" data-v-4472aa63><label data-v-4472aa63><span data-v-4472aa63>${ssrInterpolate(unref(copy).email)}</span><input${ssrRenderAttr("value", unref(email))} type="email" maxlength="254" autocomplete="email"${ssrRenderAttr("placeholder", unref(copy).emailPlaceholder)} required data-v-4472aa63></label><label data-v-4472aa63><span data-v-4472aa63>${ssrInterpolate(unref(copy).subject)}</span><input${ssrRenderAttr("value", unref(subject))} type="text"${ssrRenderAttr("minlength", unref(constraints).subjectMinLength)}${ssrRenderAttr("maxlength", unref(constraints).subjectMaxLength)}${ssrRenderAttr("placeholder", unref(copy).subjectPlaceholder)} required data-v-4472aa63></label><label data-v-4472aa63><span data-v-4472aa63>${ssrInterpolate(unref(copy).message)}</span><textarea${ssrRenderAttr("minlength", unref(constraints).messageMinLength)}${ssrRenderAttr("maxlength", unref(constraints).messageMaxLength)} rows="6"${ssrRenderAttr("placeholder", unref(copy).messagePlaceholder)} required data-v-4472aa63>${ssrInterpolate(unref(message))}</textarea><small data-v-4472aa63>${ssrInterpolate(unref(copy).characters.replace("{count}", String(unref(constraints).messageMinLength)))}</small></label><label class="contact-dialog__honeypot" aria-hidden="true" data-v-4472aa63> Site internet <input${ssrRenderAttr("value", unref(website))} name="website" type="text" tabindex="-1" autocomplete="off" data-v-4472aa63></label>`);
        if (unref(turnstileSiteKey)) {
          _push(`<div class="cf-turnstile" data-v-4472aa63></div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(errorMessage)) {
          _push(`<p class="contact-dialog__error" role="alert" data-v-4472aa63>${ssrInterpolate(unref(errorMessage))}</p>`);
        } else if (!unref(constraints).enabled) {
          _push(`<p class="contact-dialog__error" role="status" data-v-4472aa63>${ssrInterpolate(unref(copy).unavailable)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<p class="contact-dialog__privacy" data-v-4472aa63>${ssrInterpolate(unref(copy).privacy)}</p><div class="contact-dialog__actions" data-v-4472aa63><button type="button"${ssrIncludeBooleanAttr(unref(submitting)) ? " disabled" : ""} data-v-4472aa63>${ssrInterpolate(unref(copy).cancel)}</button><button class="contact-dialog__primary" type="submit"${ssrIncludeBooleanAttr(unref(submitting) || !unref(constraints).enabled) ? " disabled" : ""} data-v-4472aa63>${ssrInterpolate(unref(submitting) ? unref(copy).sending : unref(copy).send)}</button></div></form><!--]-->`);
      }
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-4472aa63"]]), { __name: "ContactDialog" });
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(visible)) {
          _push2(`<div class="analytics-consent-backdrop" data-v-82ce7b75><section class="analytics-consent-dialog" role="dialog" aria-modal="true" aria-labelledby="analytics-consent-title" aria-describedby="analytics-consent-description" data-v-82ce7b75><div class="analytics-consent-languages" role="group" aria-label="Language · Langue" data-v-82ce7b75><!--[-->`);
          ssrRenderList(languages, (language) => {
            _push2(`<button type="button" class="${ssrRenderClass({ "is-active": unref(interfaceLocale) === language.locale })}"${ssrRenderAttr("aria-label", language.label)}${ssrRenderAttr("aria-pressed", unref(interfaceLocale) === language.locale)}${ssrRenderAttr("title", language.label)} data-v-82ce7b75><span aria-hidden="true" data-v-82ce7b75>${ssrInterpolate(language.flag)}</span></button>`);
          });
          _push2(`<!--]--></div><h2 id="analytics-consent-title" data-v-82ce7b75>${ssrInterpolate(unref(text).title)}</h2><p id="analytics-consent-description" data-v-82ce7b75>${ssrInterpolate(unref(text).body)}</p><div class="analytics-consent-actions" data-v-82ce7b75><button type="button" class="analytics-consent-decline" data-v-82ce7b75>${ssrInterpolate(unref(text).decline)}</button><button type="button" class="analytics-consent-accept" data-v-82ce7b75>${ssrInterpolate(unref(text).accept)}</button></div></section></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-82ce7b75"]]), { __name: "AnalyticsConsentDialog" });
...
//# sourceMappingURL=default-CdA-T7cW.mjs.map
