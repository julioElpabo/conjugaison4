...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        _push2(`<div class="chat-overlay" data-tour="chat-exercise" style="${ssrRenderStyle(unref(tourDemoReady) ? null : { display: "none" })}" data-v-66a612ed><div class="${ssrRenderClass([{ "chat-dialogs--with-help": unref(helpOpen), "chat-dialogs--confirming": unref(closeConfirmationOpen) }, "chat-dialogs"])}" style="${ssrRenderStyle(unref(coachChatStyle))}" role="dialog" aria-modal="true" aria-labelledby="chat-title" tabindex="-1" data-v-66a612ed><section class="chat-dialog" data-tour="chat-dialog" role="region" aria-labelledby="chat-title" data-v-66a612ed><header class="chat-header" data-v-66a612ed><img class="coach-avatar"${ssrRenderAttr("src", __props.coach.avatarPath)} alt="" data-v-66a612ed><div class="chat-header__identity" data-v-66a612ed><h2 id="chat-title" data-v-66a612ed>${ssrInterpolate(__props.coach.firstName)}</h2>`);
        if (__props.coach.likes) {
          _push2(`<p class="chat-header__likes" data-v-66a612ed><strong data-v-66a612ed>${ssrInterpolate(unref(ui)("Aime :"))}</strong> ${ssrInterpolate(__props.coach.likes)}</p>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</div><div class="chat-header__actions" data-v-66a612ed><button type="button" class="chat-close"${ssrRenderAttr("aria-label", unref(ui)("Quitter le chat"))} data-v-66a612ed>×</button></div></header><div class="chat-progress"${ssrRenderAttr("aria-label", unref(ui)("Progression"))} data-v-66a612ed><span style="${ssrRenderStyle({ width: `${unref(finished) ? 100 : (unref(questionNumberOffset) + unref(currentIndex)) / unref(displayedQuestionCount) * 100}%` })}" data-v-66a612ed></span></div>`);
        if (!unref(finished) && unref(currentQuestion)) {
          _push2(`<div class="chat-instruction" data-v-66a612ed><span data-v-66a612ed>${ssrInterpolate(unref(ui)("Question {current} sur {total}", { current: unref(displayedQuestionNumber), total: unref(displayedQuestionCount) }))}</span></div>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<div class="chat-thread" aria-live="polite" data-v-66a612ed><!--[-->`);
        ssrRenderList(unref(visibleMessages), (message) => {
          ...
          if (message.errorDetails?.length) {
            ...
            _push2(`<div class="chat-literary-question" data-v-66a612ed><blockquote class="chat-literary-citation" data-v-66a612ed><p data-v-66a612ed><span data-v-66a612ed>${ssrInterpolate(message.literaryCitation.before)}</span><mark data-v-66a612ed>${ssrInterpolate(message.literaryCitation.target)}</mark><span data-v-66a612ed>${ssrInterpolate(message.literaryCitation.after)}</span></p><footer data-v-66a612ed>${ssrInterpolate(message.literaryCitation.author)}, <cite data-v-66a612ed>${ssrInterpolate(message.literaryCitation.work)}</cite></footer></blockquote></div>`);
          } else if (message.identificationForm) {
            _push2(`<p class="chat-identification-form" data-v-66a612ed><span data-v-66a612ed>${ssrInterpolate(message.identificationForm.before)}</span><mark data-v-66a612ed>${ssrInterpolate(message.identificationForm.target)}</mark><span data-v-66a612ed>${ssrInterpolate(message.identificationForm.after)}</span></p>`);
          } else if (message.answerComparison) {
            _push2(`<div class="answer-comparison" data-v-66a612ed><strong data-v-66a612ed>${ssrInterpolate(message.answerComparison.mode === "focused" ? unref(ui)("Regarde où ça change :") : unref(ui)("Repars de la correction complète :"))}</strong><div class="answer-comparison__line answer-comparison__line--learner" data-v-66a612ed><small data-v-66a612ed>${ssrInterpolate(unref(ui)("Ta réponse"))}</small><p data-v-66a612ed><!--[-->`);
            ssrRenderList(message.answerComparison.learnerParts, (part, partIndex) => {
              _push2(`<span class="${ssrRenderClass(`answer-comparison__part--${part.kind}`)}" data-v-66a612ed>${ssrInterpolate(part.text)}</span>`);
            });
            _push2(`<!--]--></p></div><div class="answer-comparison__line answer-comparison__line--expected" data-v-66a612ed><small data-v-66a612ed>${ssrInterpolate(unref(ui)("Correction"))}</small><p data-v-66a612ed><!--[-->`);
            ssrRenderList(message.answerComparison.expectedParts, (part, partIndex) => {
              _push2(`<span class="${ssrRenderClass(`answer-comparison__part--${part.kind}`)}" data-v-66a612ed>${ssrInterpolate(part.text)}</span>`);
            });
            _push2(`<!--]--></p></div>`);
            if (message.answerComparison.mode === "full") {
              _push2(`<small class="answer-comparison__guidance" data-v-66a612ed>${ssrInterpolate(unref(ui)("Les deux réponses sont très différentes : observe d’abord la construction complète."))}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
          } else if (message.text && message.author === "coach" && message.answerLine) {
            _push2(`<span class="chat-message__text chat-message__text--emphasis" data-v-66a612ed><!--[-->`);
            ssrRenderList(answerLineParts(message.text), (part, partIndex) => {
              _push2(`<span class="${ssrRenderClass({ "chat-answer-line": part.isLine })}" data-v-66a612ed>${ssrInterpolate(part.text)}</span>`);
            });
            _push2(`<!--]--></span>`);
          } else if (message.text && message.author === "coach") {
            _push2(`<span class="${ssrRenderClass([{ "chat-message__text--emphasis": message.emphasis }, "chat-message__text"])}" data-v-66a612ed>${unref(sanitizeCoachHtml)(message.text) ?? ""}</span>`);
          } else if (message.text && message.emphasis) {
            _push2(`<strong data-v-66a612ed>${ssrInterpolate(message.text)}</strong>`);
          } else if (message.text) {
            _push2(`<span data-v-66a612ed>${ssrInterpolate(message.text)}</span>`);
          } else {
            _push2(`<!---->`);
          }
          if (message.consultVerbId) {
            _push2(`<button type="button" class="chat-consult-verb-link" data-v-66a612ed>${ssrInterpolate(unref(ui)("Consulter le verbe"))}</button>`);
          } else {
            _push2(`<!---->`);
          }
          if (message.media?.mediaType === "video") {
            _push2(`<video${ssrRenderAttr("src", message.media.filePath)}${ssrRenderAttr("aria-label", message.media.altText)} muted playsinline controls data-v-66a612ed></video>`);
          } else if (message.media) {
            _push2(`<img class="${ssrRenderClass({ "chat-media--emoji": message.media.mediaType === "emoji" })}"${ssrRenderAttr("src", message.media.filePath)}${ssrRenderAttr("alt", message.media.altText)} data-v-66a612ed>`);
          } else {
            _push2(`<!---->`);
          }
          if (message.identificationPrompt && message.questionIndex === unref(currentIndex)) {
            _push2(`<div class="chat-identification-choices" data-v-66a612ed>`);
            if (unref(activeExerciseKind) === "tense-identification" && unref(selectedIdentificationMode)) {
              _push2(`<div class="chat-tense-choice-step" data-v-66a612ed><div class="chat-tense-choice-step__header" data-v-66a612ed><button type="button" data-v-66a612ed>← ${ssrInterpolate(unref(ui)("Modes"))}</button><strong data-v-66a612ed>${ssrInterpolate(unref(ui)("Choisis le temps"))}</strong></div><div class="chat-tense-choices" role="group"${ssrRenderAttr("aria-label", unref(ui)("Choisis le temps"))} data-v-66a612ed><!--[-->`);
              ssrRenderList(unref(selectedModeTenseRows), (row) => {
                _push2(`<div class="chat-tense-choice-row" data-v-66a612ed>`);
                if (row.simple) {
                  _push2(`<button type="button"${ssrIncludeBooleanAttr(unref(waitingForNext) || unref(posingQuestion) || unref(deliveringFeedback)) ? " disabled" : ""} data-v-66a612ed>${ssrInterpolate(unref(uiLabel)(row.simple.name))}</button>`);
                } else {
                  _push2(`<span aria-hidden="true" data-v-66a612ed></span>`);
                }
                if (row.compound) {
                  _push2(`<button type="button"${ssrIncludeBooleanAttr(unref(waitingForNext) || unref(posingQuestion) || unref(deliveringFeedback)) ? " disabled" : ""} data-v-66a612ed>${ssrInterpolate(unref(uiLabel)(row.compound.name))}</button>`);
                } else {
                  _push2(`<span aria-hidden="true" data-v-66a612ed></span>`);
                }
                _push2(`</div>`);
              ...
              _push2(`<div class="chat-mode-choices" role="group"${ssrRenderAttr("aria-label", unref(ui)("Choisis le mode"))} data-v-66a612ed><!--[-->`);
              ssrRenderList(unref(displayedIdentificationModeChoices), (choice) => {
                _push2(`<button type="button"${ssrIncludeBooleanAttr(unref(waitingForNext) || unref(posingQuestion) || unref(deliveringFeedback)) ? " disabled" : ""} data-v-66a612ed>${ssrInterpolate(choice.label)}</button>`);
              });
              _push2(`<!--]--></div>`);
            }
            _push2(`</div>`);
        ...
        if (unref(finalSummaryPreparing)) {
          _push2(`<div class="chat-summary-loading" role="status" aria-live="polite" data-v-66a612ed><span aria-hidden="true" data-v-66a612ed></span><strong data-v-66a612ed>${ssrInterpolate(unref(ui)("Création du bilan"))}</strong></div>`);
        } else {
          _push2(`<!---->`);
        }
        if (unref(finalSummaryVisible)) {
          _push2(`<section class="chat-summary-tool" aria-labelledby="chat-summary-title" data-v-66a612ed><header data-v-66a612ed><div data-v-66a612ed><h3 id="chat-summary-title" data-v-66a612ed>${ssrInterpolate(unref(ui)("Bilan du défi"))}</h3></div><strong data-v-66a612ed>${ssrInterpolate(unref(score))} %</strong></header><ol class="chat-summary-list" data-v-66a612ed><!--[-->`);
          ssrRenderList(unref(attemptSummaries), (item) => {
            _push2(`<li class="${ssrRenderClass([`is-${item.status}`, { "is-help-selected": unref(helpOpen) && item.questionIndex === unref(helpQuestionIndex) }])}" style="${ssrRenderStyle({ "--summary-item-index": `${item.index - 1}` })}" role="button" tabindex="0"${ssrRenderAttr("aria-label", unref(ui)("Voir l’aide de la question {number} : {question}", { number: item.index, question: item.questionLabel }))} data-v-66a612ed><span class="chat-summary-list__status" aria-hidden="true" data-v-66a612ed>${ssrInterpolate(item.status === "correct" ? "✓" : "×")}</span><div data-v-66a612ed><strong class="chat-summary-list__question" data-v-66a612ed><span data-v-66a612ed>${ssrInterpolate(unref(ui)("Question"))} ${ssrInterpolate(item.index)}</span><span data-v-66a612ed>${ssrInterpolate(item.questionLabel)}</span></strong>`);
            if (item.identificationForm) {
              _push2(`<blockquote class="chat-summary-list__citation" data-v-66a612ed><p data-v-66a612ed><span data-v-66a612ed>${ssrInterpolate(item.identificationForm.before)}</span><mark data-v-66a612ed>${ssrInterpolate(item.identificationForm.target)}</mark><span data-v-66a612ed>${ssrInterpolate(item.identificationForm.after)}</span></p>`);
              if (item.literaryCitation) {
                _push2(`<footer data-v-66a612ed>${ssrInterpolate(item.literaryCitation.author)}, <cite data-v-66a612ed>${ssrInterpolate(item.literaryCitation.work)}</cite></footer>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</blockquote>`);
            ...
            _push2(`<dl data-v-66a612ed><div data-v-66a612ed><dt data-v-66a612ed>${ssrInterpolate(unref(ui)("Réponse donnée"))}</dt><dd data-v-66a612ed>${ssrInterpolate(item.learnerAnswer)}</dd></div><div data-v-66a612ed><dt data-v-66a612ed>${ssrInterpolate(unref(ui)("Bonne réponse"))}</dt><dd data-v-66a612ed>${ssrInterpolate(item.expectedAnswer)}</dd></div></dl>`);
            if (item.verbId) {
              _push2(`<button type="button" class="chat-summary-consult-link" data-v-66a612ed>${ssrInterpolate(unref(ui)("Consulter le verbe"))}</button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></li>`);
          });
          _push2(`<!--]--></ol><footer data-v-66a612ed><strong data-v-66a612ed>${ssrInterpolate(unref(correctCount))} / ${ssrInterpolate(unref(attempts).length)}</strong><span data-v-66a612ed>${ssrInterpolate(unref(correctCount) === 1 ? unref(ui)("réponse juste") : unref(ui)("réponses justes"))}</span></footer></section>`);
        } else {
          _push2(`<!---->`);
        }
        if (unref(finalSummaryVisible)) {
          _push2(`<div class="chat-message chat-message--coach chat-restart-prompt" data-v-66a612ed><span data-v-66a612ed>${ssrInterpolate(unref(ui)("Tu veux refaire ce défi ?"))}</span><div class="chat-restart-prompt__actions" data-v-66a612ed><button type="button" class="chat-restart-prompt__same"${ssrIncludeBooleanAttr(unref(regeneratingQuestions)) ? " disabled" : ""} data-v-66a612ed><span aria-hidden="true" data-v-66a612ed>↻</span>${ssrInterpolate(unref(ui)("Avec les mêmes questions"))}</button><button type="button" class="chat-restart-prompt__new"${ssrIncludeBooleanAttr(unref(regeneratingQuestions)) ? " disabled" : ""} data-v-66a612ed><span aria-hidden="true" data-v-66a612ed>↻</span>${ssrInterpolate(unref(regeneratingQuestions) ? unref(ui)("Préparation…") : unref(ui)("Avec d’autres questions"))}</button><button type="button" class="chat-restart-prompt__share"${ssrIncludeBooleanAttr(unref(regeneratingQuestions)) ? " disabled" : ""} data-v-66a612ed><span aria-hidden="true" data-v-66a612ed>`);
          _push2(ssrRenderComponent(unref(FontAwesomeIcon), { icon: unref(faArrowUpFromBracket) }, null, _parent));
          _push2(`</span>${ssrInterpolate(unref(ui)("Partager mon bilan"))}</button><button type="button" class="chat-restart-prompt__print"${ssrIncludeBooleanAttr(unref(regeneratingQuestions)) ? " disabled" : ""} data-v-66a612ed><span aria-hidden="true" data-v-66a612ed>`);
          _push2(ssrRenderComponent(unref(FontAwesomeIcon), { icon: unref(faPrint) }, null, _parent));
          _push2(`</span>${ssrInterpolate(unref(ui)("Imprimer mon bilan"))}</button><button type="button" class="chat-restart-prompt__quit"${ssrIncludeBooleanAttr(unref(regeneratingQuestions)) ? " disabled" : ""} data-v-66a612ed>${ssrInterpolate(unref(ui)("Quitter le chat"))}</button></div>`);
          if (unref(restartError)) {
            _push2(`<small class="chat-restart-prompt__error" role="alert" data-v-66a612ed>${ssrInterpolate(unref(restartError))}</small>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div>`);
...
const ChatExercise = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-66a612ed"]]), { __name: "ExerciseChatExercise" });
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
          ...
          if (unref(feedback) !== "idle") {
            ...
            if (unref(falcMode)) {
              ...
              if (unref(feedback) === "correct") {
                ...
                _push2(`<!--[--><strong>${ssrInterpolate(unref(ui)("Faux."))}</strong><p>${ssrInterpolate(unref(ui)("Bonne réponse :"))} <strong>${ssrInterpolate(unref(correction))}</strong></p><!--]-->`);
              }
              _push2(`<!--]-->`);
            } else {
        ...
        if (unref(closeConfirmationOpen)) {
          _push2(`<div class="exercise-close-confirmation"><section role="alertdialog" aria-modal="true" class="${ssrRenderClass({ "exercise-close-confirmation__dialog--falc": unref(falcMode) })}"${ssrRenderAttr("aria-label", unref(falcMode) ? unref(ui)("Quitter l’exercice") : void 0)}${ssrRenderAttr("aria-labelledby", unref(falcMode) ? void 0 : "close-confirmation-title")}${ssrRenderAttr("aria-describedby", unref(falcMode) ? void 0 : "close-confirmation-description")}>`);
          if (!unref(falcMode)) {
            _push2(`<span class="exercise-close-confirmation__icon" aria-hidden="true">?</span>`);
          } else {
            _push2(`<!---->`);
          }
          if (!unref(falcMode)) {
            _push2(`<h3 id="close-confirmation-title">${ssrInterpolate(unref(ui)("Quitter l’exercice ?"))}</h3>`);
          } else {
            _push2(`<!---->`);
          }
          if (!unref(falcMode)) {
            _push2(`<p id="close-confirmation-description">${ssrInterpolate(unref(ui)("Ta progression actuelle sera perdue."))}</p>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<div class="exercise-close-confirmation__actions"><button class="secondary-button" type="button">${ssrInterpolate(unref(falcMode) ? unref(ui)("Continuer") : unref(ui)("Continuer l’exercice"))}</button><button class="primary-button exercise-close-confirmation__leave" type="button">${ssrInterpolate(unref(ui)("Quitter"))}</button></div></section></div>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</section>`);
...
//# sourceMappingURL=main-DBan3zzZ.mjs.map
