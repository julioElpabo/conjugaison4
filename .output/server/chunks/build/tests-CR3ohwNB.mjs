          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_AdminShell, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="admin-tests" data-v-66d59fe4${_scopeId2}><header class="admin-section-heading" data-v-66d59fe4${_scopeId2}><div data-v-66d59fe4${_scopeId2}><p class="admin-eyebrow" data-v-66d59fe4${_scopeId2}>Qualité</p><h1 data-v-66d59fe4${_scopeId2}>Tests automatisés</h1><p class="admin-muted" data-v-66d59fe4${_scopeId2}>Lancez les tests métier et les scénarios importés de Postman sans quitter l’administration.</p></div><button class="admin-button admin-button--primary"${ssrIncludeBooleanAttr(unref(running) || unref(selected).length === 0) ? " disabled" : ""} data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(running) ? "Tests en cours…" : `Lancer ${unref(selected).length} fichier${unref(selected).length > 1 ? "s" : ""}`)}</button></header>`);
                  if (unref(result) && !unref(running)) {
                    _push3(`<nav class="admin-tests__summary" aria-label="Résumé de la dernière exécution" data-v-66d59fe4${_scopeId2}>`);
                    if (unref(passedResultSuites).length) {
                      _push3(`<section class="is-passed" data-v-66d59fe4${_scopeId2}><strong data-v-66d59fe4${_scopeId2}><span aria-hidden="true" data-v-66d59fe4${_scopeId2}>✓</span> Suites réussies</strong><div data-v-66d59fe4${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(passedResultSuites), (suite) => {
                        _push3(`<a${ssrRenderAttr("href", `#${suite.id}`)} data-v-66d59fe4${_scopeId2}>${ssrInterpolate(suite.title)}</a>`);
                      });
                      _push3(`<!--]--></div></section>`);
                    } else {
                      _push3(`<!---->`);
                    ...
                    if (unref(failedResultSuites).length) {
                      _push3(`<section class="is-failed" data-v-66d59fe4${_scopeId2}><strong data-v-66d59fe4${_scopeId2}><span aria-hidden="true" data-v-66d59fe4${_scopeId2}>×</span> Suites échouées</strong><div data-v-66d59fe4${_scopeId2}><!--[-->`);
                  ...
                  if (unref(error)) {
                    _push3(`<p class="admin-notice admin-notice--error" role="alert" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(error))}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<section class="admin-tests__selection admin-card" aria-labelledby="test-selection-title" data-v-66d59fe4${_scopeId2}><div class="admin-tests__selection-heading" data-v-66d59fe4${_scopeId2}><div data-v-66d59fe4${_scopeId2}><h2 id="test-selection-title" data-v-66d59fe4${_scopeId2}>Suites disponibles</h2><p class="admin-muted" data-v-66d59fe4${_scopeId2}>Les fichiers sont exécutés côté serveur avec le moteur de test Node.</p></div><button class="admin-button admin-button--small" type="button"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(allSelected) ? "Tout désélectionner" : "Tout sélectionner")}</button></div>`);
                  if (unref(loading)) {
                    _push3(`<div class="admin-tests__loading" data-v-66d59fe4${_scopeId2}><span class="admin-spinner" aria-hidden="true" data-v-66d59fe4${_scopeId2}></span> Chargement…</div>`);
                  } else {
                    _push3(`<div class="admin-tests__catalog" data-v-66d59fe4${_scopeId2}><!--[-->`);
                    ssrRenderList(unref(testGroups), (group) => {
                      _push3(`<section data-v-66d59fe4${_scopeId2}><h3 data-v-66d59fe4${_scopeId2}>${ssrInterpolate(group.title)}</h3><div class="admin-tests__list" data-v-66d59fe4${_scopeId2}><!--[-->`);
                      ssrRenderList(group.items, (test) => {
                        _push3(`<label data-v-66d59fe4${_scopeId2}><input${ssrIncludeBooleanAttr(Array.isArray(unref(selected)) ? ssrLooseContain(unref(selected), test.id) : unref(selected)) ? " checked" : ""} type="checkbox"${ssrRenderAttr("value", test.id)} data-v-66d59fe4${_scopeId2}><span data-v-66d59fe4${_scopeId2}><strong data-v-66d59fe4${_scopeId2}>${ssrInterpolate(test.title)}</strong><small data-v-66d59fe4${_scopeId2}>${ssrInterpolate(test.description)}</small></span></label>`);
                      });
                      _push3(`<!--]--></div></section>`);
                    });
                    _push3(`<!--]--></div>`);
                  ...
                  _push3(`</section>`);
                  if (unref(result)) {
                    _push3(`<section class="${ssrRenderClass(["admin-tests__result", "admin-card", { "is-success": unref(result).success, "is-failure": !unref(result).success }])}" aria-live="polite" data-v-66d59fe4${_scopeId2}><header data-v-66d59fe4${_scopeId2}><div data-v-66d59fe4${_scopeId2}><p class="admin-eyebrow" data-v-66d59fe4${_scopeId2}>Dernière exécution</p><h2 data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(result).success ? "Tous les tests passent" : "Des tests ont échoué")}</h2></div><strong data-v-66d59fe4${_scopeId2}>${ssrInterpolate((unref(result).durationMs / 1e3).toFixed(2))} s</strong></header><dl data-v-66d59fe4${_scopeId2}><div data-v-66d59fe4${_scopeId2}><dt data-v-66d59fe4${_scopeId2}>Tests</dt><dd data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(result).summary.tests)}</dd></div><div data-v-66d59fe4${_scopeId2}><dt data-v-66d59fe4${_scopeId2}>Réussis</dt><dd data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(result).summary.passed)}</dd></div><div data-v-66d59fe4${_scopeId2}><dt data-v-66d59fe4${_scopeId2}>Échoués</dt><dd data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(result).summary.failed)}</dd></div><div data-v-66d59fe4${_scopeId2}><dt data-v-66d59fe4${_scopeId2}>Ignorés</dt><dd data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(result).summary.skipped)}</dd></div></dl>`);
                    if (unref(result).repairPrompt) {
                      _push3(`<section class="repair-prompt" aria-labelledby="repair-prompt-title" data-v-66d59fe4${_scopeId2}><header data-v-66d59fe4${_scopeId2}><div data-v-66d59fe4${_scopeId2}><p class="admin-eyebrow" data-v-66d59fe4${_scopeId2}>Aide à la réparation</p><h3 id="repair-prompt-title" data-v-66d59fe4${_scopeId2}>Prompt généré à partir des échecs</h3><p data-v-66d59fe4${_scopeId2}>Copiez ce texte et envoyez-le-moi : il contient les tests concernés, les résultats attendus et le journal utile.</p></div><button class="admin-button admin-button--primary" type="button" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(promptCopied) ? "Prompt copié ✓" : "Copier le prompt")}</button></header><textarea readonly aria-label="Prompt de réparation généré" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(result).repairPrompt)}</textarea></section>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (unref(generalResultGroups).length) {
                      _push3(`<div class="test-groups" data-v-66d59fe4${_scopeId2}><header data-v-66d59fe4${_scopeId2}><p class="admin-eyebrow" data-v-66d59fe4${_scopeId2}>Détail des tests</p><h3 data-v-66d59fe4${_scopeId2}>Ce qui a été vérifié</h3></header><!--[-->`);
                      ssrRenderList(unref(resultSuites), (suite) => {
                        _push3(`<section${ssrRenderAttr("id", suite.id)} class="test-groups__suite" data-v-66d59fe4${_scopeId2}><h4 data-v-66d59fe4${_scopeId2}>${ssrInterpolate(suite.title)}</h4><!--[-->`);
                        ssrRenderList(suite.groups, (group) => {
                          _push3(`<details${ssrIncludeBooleanAttr(!group.passed) ? " open" : ""} data-v-66d59fe4${_scopeId2}><summary data-v-66d59fe4${_scopeId2}><span class="${ssrRenderClass(["postman-status", group.passed ? "is-passed" : "is-failed"])}" aria-hidden="true" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(group.passed ? "✓" : "×")}</span><span data-v-66d59fe4${_scopeId2}><strong data-v-66d59fe4${_scopeId2}>${ssrInterpolate(group.title)}</strong><small data-v-66d59fe4${_scopeId2}>${ssrInterpolate(group.description)}</small></span><b data-v-66d59fe4${_scopeId2}>${ssrInterpolate(group.cases.filter((testCase) => testCase.passed).length)}/${ssrInterpolate(group.cases.length)}</b></summary><ul data-v-66d59fe4${_scopeId2}><!--[-->`);
                          ssrRenderList(group.cases, (testCase) => {
                            _push3(`<li data-v-66d59fe4${_scopeId2}><span class="${ssrRenderClass(["postman-status", testCase.passed ? "is-passed" : "is-failed"])}" aria-hidden="true" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(testCase.passed ? "✓" : "×")}</span><span data-v-66d59fe4${_scopeId2}>${ssrInterpolate(testCase.title)}</span>`);
                            if (testCase.skipped) {
                              _push3(`<small data-v-66d59fe4${_scopeId2}>Ignoré</small>`);
                            } else {
                              _push3(`<!---->`);
                            }
                            _push3(`</li>`);
                    ...
                    if (unref(result).coachCredibility.length) {
                      _push3(`<section class="credibility-report" aria-labelledby="credibility-title" data-v-66d59fe4${_scopeId2}><header data-v-66d59fe4${_scopeId2}><div data-v-66d59fe4${_scopeId2}><p class="admin-eyebrow" data-v-66d59fe4${_scopeId2}>Conversation simulée</p><h3 id="credibility-title" data-v-66d59fe4${_scopeId2}>Crédibilité des coaches</h3></div><strong data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(result).coachCredibility.filter((report) => report.passed).length)}/${ssrInterpolate(unref(result).coachCredibility.length)} crédibles</strong></header><div class="credibility-grid" data-v-66d59fe4${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(result).coachCredibility, (report) => {
                        _push3(`<details${ssrIncludeBooleanAttr(!report.passed) ? " open" : ""} data-v-66d59fe4${_scopeId2}><summary data-v-66d59fe4${_scopeId2}><span class="${ssrRenderClass(["credibility-score", report.passed ? "is-passed" : "is-failed"])}" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(report.score)} %</span><span data-v-66d59fe4${_scopeId2}><strong data-v-66d59fe4${_scopeId2}>${ssrInterpolate(report.coachName)}</strong><small data-v-66d59fe4${_scopeId2}>${ssrInterpolate(report.caractereName)}</small></span><b data-v-66d59fe4${_scopeId2}>${ssrInterpolate(report.passed ? "Crédible" : "À améliorer")}</b></summary><ul data-v-66d59fe4${_scopeId2}><!--[-->`);
                        ssrRenderList(report.checks, (check) => {
                          _push3(`<li class="${ssrRenderClass({ "is-failed": !check.passed })}" data-v-66d59fe4${_scopeId2}><span class="${ssrRenderClass(["postman-status", check.passed ? "is-passed" : "is-failed"])}" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(check.passed ? "✓" : "×")}</span><span data-v-66d59fe4${_scopeId2}><strong data-v-66d59fe4${_scopeId2}>${ssrInterpolate(check.label)}</strong><small data-v-66d59fe4${_scopeId2}>${ssrInterpolate(check.passed ? check.actual : `Attendu : ${check.expected} · Obtenu : ${check.actual}`)}</small></span></li>`);
                        });
                        _push3(`<!--]--></ul></details>`);
                      });
                      _push3(`<!--]--></div></section>`);
                    ...
                    if (unref(result).conjugationScenarios.length) {
                      _push3(`<div id="test-results-conjugation" class="postman-report" data-v-66d59fe4${_scopeId2}><header class="postman-report__header" data-v-66d59fe4${_scopeId2}><div data-v-66d59fe4${_scopeId2}><p class="admin-eyebrow" data-v-66d59fe4${_scopeId2}>Collection Postman</p><h3 data-v-66d59fe4${_scopeId2}>Résultats par forme verbale</h3></div><div class="postman-report__filters" aria-label="Filtrer les scénarios" data-v-66d59fe4${_scopeId2}><!--[-->`);
                      ssrRenderList([["all", "Tous"], ["passed", "Réussis"], ["failed", "Échoués"]], (filter) => {
                        _push3(`<button type="button" class="${ssrRenderClass({ "is-active": unref(scenarioFilter) === filter[0] })}" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(filter[1])} <span data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(scenarioCounts)[filter[0]])}</span></button>`);
                      });
                      _push3(`<!--]--></div></header><div class="postman-report__rule-filters" aria-label="Filtrer par règle de conjugaison" data-v-66d59fe4${_scopeId2}><strong data-v-66d59fe4${_scopeId2}>Règle testée</strong><button type="button" class="${ssrRenderClass({ "is-active": unref(ruleFilter) === "all" })}" data-v-66d59fe4${_scopeId2}> Toutes <span data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(scenarioCounts).all)}</span></button><!--[-->`);
                      ssrRenderList(unref(availableRules), (rule) => {
                        _push3(`<button type="button" class="${ssrRenderClass({ "is-active": unref(ruleFilter) === rule.id })}" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(rule.label)} <span data-v-66d59fe4${_scopeId2}>${ssrInterpolate(rule.count)}</span></button>`);
                      });
                      _push3(`<!--]--></div><div class="postman-report__workspace" data-v-66d59fe4${_scopeId2}><nav class="postman-report__scenarios" aria-label="Scénarios de conjugaison" data-v-66d59fe4${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(scenariosByMode), (group) => {
                        _push3(`<section data-v-66d59fe4${_scopeId2}><h4 data-v-66d59fe4${_scopeId2}>${ssrInterpolate(group.mode)} <span data-v-66d59fe4${_scopeId2}>${ssrInterpolate(group.scenarios.length)}</span></h4><!--[-->`);
                        ssrRenderList(group.scenarios, (scenario) => {
                          _push3(`<button type="button" class="${ssrRenderClass({ "is-selected": unref(selectedScenario)?.id === scenario.id })}" data-v-66d59fe4${_scopeId2}><span class="${ssrRenderClass(["postman-status", scenario.passed ? "is-passed" : "is-failed"])}" aria-hidden="true" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(scenario.passed ? "✓" : "×")}</span><span data-v-66d59fe4${_scopeId2}><strong data-v-66d59fe4${_scopeId2}>${ssrInterpolate(scenario.name)}</strong><small data-v-66d59fe4${_scopeId2}>${ssrInterpolate(scenario.tense)}</small></span></button>`);
                        });
                        _push3(`<!--]--></section>`);
                      });
                      _push3(`<!--]-->`);
                      if (unref(visibleScenarios).length === 0) {
                        _push3(`<p class="admin-muted" data-v-66d59fe4${_scopeId2}>Aucun scénario dans ce filtre.</p>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</nav>`);
                      if (unref(selectedScenario)) {
                        _push3(`<article class="postman-report__detail" data-v-66d59fe4${_scopeId2}><header data-v-66d59fe4${_scopeId2}><div data-v-66d59fe4${_scopeId2}><span class="${ssrRenderClass(["postman-result-badge", unref(selectedScenario).passed ? "is-passed" : "is-failed"])}" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(selectedScenario).passed ? "Réussi" : "Échoué")}</span><h3 data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(selectedScenario).title)}</h3><p class="postman-report__purpose" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(selectedScenario).purpose)}</p></div></header><div class="postman-report__tags" data-v-66d59fe4${_scopeId2}><!--[-->`);
                        ssrRenderList(unref(selectedScenario).rules, (rule) => {
                          _push3(`<span data-v-66d59fe4${_scopeId2}>${ssrInterpolate(rule.label)}</span>`);
                        });
                        _push3(`<!--]--></div><div class="postman-report__source" data-v-66d59fe4${_scopeId2}><span data-v-66d59fe4${_scopeId2}>Forme${ssrInterpolate(unref(selectedScenario).sourceForms.length > 1 ? "s" : "")} en entrée</span><!--[-->`);
                        ssrRenderList(unref(selectedScenario).sourceForms, (form) => {
                          _push3(`<code data-v-66d59fe4${_scopeId2}>${ssrInterpolate(form)}</code>`);
                        });
                        _push3(`<!--]--></div><div class="postman-report__assertions" data-v-66d59fe4${_scopeId2}><!--[-->`);
                        ssrRenderList(unref(selectedScenario).assertions, (assertion) => {
                          _push3(`<section class="${ssrRenderClass({ "is-failed": !assertion.passed })}" data-v-66d59fe4${_scopeId2}><header data-v-66d59fe4${_scopeId2}><span class="${ssrRenderClass(["postman-status", assertion.passed ? "is-passed" : "is-failed"])}" aria-hidden="true" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(assertion.passed ? "✓" : "×")}</span><span data-v-66d59fe4${_scopeId2}><strong data-v-66d59fe4${_scopeId2}>${ssrInterpolate(assertionLabels[assertion.property])}</strong><small data-v-66d59fe4${_scopeId2}>${ssrInterpolate(assertionExplanations[assertion.property])}</small></span></header><dl data-v-66d59fe4${_scopeId2}><div data-v-66d59fe4${_scopeId2}><dt data-v-66d59fe4${_scopeId2}>Attendu</dt><dd data-v-66d59fe4${_scopeId2}><code data-v-66d59fe4${_scopeId2}>${ssrInterpolate(assertion.expected)}</code></dd></div><div data-v-66d59fe4${_scopeId2}><dt data-v-66d59fe4${_scopeId2}>Obtenu</dt>`);
                          if (Array.isArray(assertion.actual)) {
                            _push3(`<dd class="postman-values" data-v-66d59fe4${_scopeId2}><!--[-->`);
                            ssrRenderList(assertion.actual, (value) => {
                              _push3(`<code class="${ssrRenderClass({ "is-match": value === assertion.expected })}" data-v-66d59fe4${_scopeId2}>${ssrInterpolate(value)}</code>`);
                            });
                            _push3(`<!--]--></dd>`);
                          } else {
                            _push3(`<dd data-v-66d59fe4${_scopeId2}><code data-v-66d59fe4${_scopeId2}>${ssrInterpolate(assertion.actual)}</code></dd>`);
                          }
                    ...
                    _push3(`<details data-v-66d59fe4${_scopeId2}><summary data-v-66d59fe4${_scopeId2}>Afficher le journal technique</summary><pre data-v-66d59fe4${_scopeId2}>${ssrInterpolate(unref(result).output)}</pre></details></section>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
...
const tests = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-66d59fe4"]]);

export { tests as default };
//# sourceMappingURL=tests-CR3ohwNB.mjs.map
