...
const coachUiTexts: Record<string, CoachTranslations> = {
  ...
  'Une aide pas à pas, avec les réponses, pensée pour les personnes qui apprennent le français et le parlent depuis peu.': { de: 'Eine schrittweise Hilfe mit Antworten für Menschen, die Französisch lernen und es erst seit Kurzem sprechen.', en: 'Step-by-step help with answers for people who are learning French and have only recently begun speaking it.', it: 'Un aiuto passo dopo passo, con le risposte, pensato per chi sta imparando il francese e lo parla da poco.', es: 'Una ayuda paso a paso, con respuestas, pensada para quienes están aprendiendo francés y lo hablan desde hace poco.' },
