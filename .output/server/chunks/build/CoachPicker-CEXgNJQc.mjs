...
function coachPairForPicker(coaches) {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const coachGroups = computed(() => coachPickerGroups(coaches.value).map((group) => ({
      ...
      coaches: coachPairForPicker(group.coaches).map((coach) => localizeCoachProfile(interfaceLocale.value, coach))
    })).filter((group) => group.coaches.length === 2));
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        _push2(`<div class="coach-picker-overlay" data-tour="coach-picker" data-v-70ccc07d><section class="coach-picker" role="dialog" aria-modal="true" aria-labelledby="coach-picker-title"${ssrRenderAttr("aria-busy", __props.selectionPending)} data-v-70ccc07d><header data-v-70ccc07d><div data-v-70ccc07d><h2 id="coach-picker-title" data-v-70ccc07d>${ssrInterpolate(unref(ui)("Choisis ton coach"))}</h2></div><button type="button"${ssrRenderAttr("aria-label", unref(ui)("Fermer"))}${ssrIncludeBooleanAttr(__props.selectionPending) ? " disabled" : ""} data-v-70ccc07d>×</button></header><div class="coach-safety" data-v-70ccc07d><strong data-v-70ccc07d>${ssrInterpolate(unref(ui)("Ces coaches sont des personnages virtuels automatisés."))}</strong><p data-v-70ccc07d>${ssrInterpolate(unref(ui)("Un avatar, un prénom ou un âge ne prouvent jamais l’identité d’une personne sur Internet."))}</p></div>`);
        if (__props.selectionPending) {
          _push2(`<p class="coach-picker__state coach-picker__state--pending" role="status" data-v-70ccc07d>${ssrInterpolate(unref(ui)("Préparation de la séance…"))}</p>`);
        } else if (__props.selectionError) {
          _push2(`<p class="coach-picker__state coach-picker__state--error" role="alert" data-v-70ccc07d>${ssrInterpolate(__props.selectionError)}</p>`);
        } else {
          _push2(`<!---->`);
        }
        if (unref(loading)) {
          _push2(`<p class="coach-picker__state" data-v-70ccc07d>${ssrInterpolate(unref(ui)("Chargement des coaches…"))}</p>`);
        } else if (unref(error)) {
          _push2(`<p class="coach-picker__state coach-picker__state--error" data-v-70ccc07d>${ssrInterpolate(unref(error))}</p>`);
        } else {
          _push2(`<div class="coach-picker__groups" data-v-70ccc07d><!--[-->`);
          ssrRenderList(unref(coachGroups), (group) => {
            _push2(`<section class="coach-caractere-group"${ssrRenderAttr("data-tour", group.approach === "complete" ? "coach-complete-group" : void 0)} data-v-70ccc07d><header class="coach-caractere-group__header" data-v-70ccc07d><div data-v-70ccc07d><h3 data-v-70ccc07d>${ssrInterpolate(group.label)}</h3><p data-v-70ccc07d>${ssrInterpolate(group.description)}</p></div></header><div class="coach-picker__grid" data-v-70ccc07d><!--[-->`);
            ssrRenderList(group.coaches, (coach) => {
              _push2(`<button type="button" class="coach-card" style="${ssrRenderStyle({ "--coach-color": coach.themeColor })}"${ssrIncludeBooleanAttr(__props.selectionPending) ? " disabled" : ""} data-v-70ccc07d><img${ssrRenderAttr("src", coach.avatarPath)}${ssrRenderAttr("alt", unref(ui)("Avatar de {name}", { name: coach.firstName }))} data-v-70ccc07d><span data-v-70ccc07d><strong data-v-70ccc07d>${ssrInterpolate(coach.firstName)}</strong><small class="coach-card__caractere-description" data-v-70ccc07d>${ssrInterpolate(coach.pedagogicalStyle)}</small></span>`);
              if (coach.description) {
                _push2(`<blockquote data-v-70ccc07d>« ${ssrInterpolate(coach.description)} »</blockquote>`);
              } else {
                _push2(`<!---->`);
              }
              if (coach.likes) {
                _push2(`<p class="coach-card__likes" data-v-70ccc07d><b data-v-70ccc07d>${ssrInterpolate(unref(ui)("Aime :"))}</b> ${ssrInterpolate(coach.likes)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</button>`);
...
const CoachPicker = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-70ccc07d"]]), { __name: "ExerciseCoachPicker" });
...
//# sourceMappingURL=CoachPicker-CEXgNJQc.mjs.map
