    ...
    <AdminShell>
      <div class="challenge-admin">
        <header class="admin-section-heading challenge-admin__heading">
          ...
          <div class="challenge-admin__tools">
            <button type="button" class="challenge-cleanup-button" @click="cleanupOpen = true">Faire de la place dans la BDD</button>
        ...
        <AdminDefisCleanupDialog v-if="cleanupOpen" @close="cleanupOpen = false" />
...
<style scoped>
.challenge-admin__tools{display:flex;align-items:flex-end;flex-direction:column;gap:12px}.challenge-cleanup-button{padding:12px 17px;border:1px solid #ac4b06;border-radius:11px;color:#fff;background:#bd580b;box-shadow:0 5px 14px rgb(189 88 11 / 16%);font:inherit;font-size:.83rem;font-weight:850;cursor:pointer}.challenge-cleanup-button:hover{background:#a64908}.challenge-cleanup-button:focus-visible{outline:3px solid #237891;outline-offset:3px}
