...
const copies: Record<AppLocale, GuidedTourCopy> = withDutchVariants({
  fr: {
  ...
  es: {
    ...
    createTitle: "4 · Gebruik de uitdaging",
    ...
    classicTitle: "1 · In de klassieke modus",
    ...
    printTitle: "3 · Als afdrukbaar werkblad",
