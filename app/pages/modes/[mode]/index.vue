...
.mode-landing__hero > p:nth-of-type(2) { max-width: 720px; margin: 22px auto 28px; color: var(--muted); font-size: 1.12rem; line-height: 1.7; }
...
@media (max-width: 720px) {
  ...
  .mode-purpose, .mode-cta { grid-column: auto; }
