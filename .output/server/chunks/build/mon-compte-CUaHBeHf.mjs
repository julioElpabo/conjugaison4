          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_AdminShell, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (unref(user)) {
                    _push3(`<div class="account-page" data-v-bdcfa54a${_scopeId2}><header class="admin-section-heading" data-v-bdcfa54a${_scopeId2}><div data-v-bdcfa54a${_scopeId2}><p class="admin-eyebrow" data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Profil"))}</p><h1 data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Mon compte"))}</h1><p class="admin-muted" data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Informations associées à votre session administrateur."))}</p></div></header><section class="account-card admin-card" aria-labelledby="account-identity-title" data-v-bdcfa54a${_scopeId2}><div class="account-card__avatar" aria-hidden="true" data-v-bdcfa54a${_scopeId2}>${ssrInterpolate((unref(user).prenom?.[0] || unref(user).username?.[0] || "A").toLocaleUpperCase("fr"))}</div><div class="account-card__heading" data-v-bdcfa54a${_scopeId2}><h2 id="account-identity-title" data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(displayName) || unref(user).username)}</h2><p data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Administrateur"))}</p></div><dl data-v-bdcfa54a${_scopeId2}><div data-v-bdcfa54a${_scopeId2}><dt data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Prénom"))}</dt><dd data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(user).prenom || "—")}</dd></div><div data-v-bdcfa54a${_scopeId2}><dt data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Nom"))}</dt><dd data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(user).nom || "—")}</dd></div><div data-v-bdcfa54a${_scopeId2}><dt data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Nom d’utilisateur"))}</dt><dd data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(user).username || "—")}</dd></div><div data-v-bdcfa54a${_scopeId2}><dt data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Adresse e-mail"))}</dt><dd data-v-bdcfa54a${_scopeId2}><a${ssrRenderAttr("href", `mailto:${unref(user).email}`)} data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(user).email)}</a></dd></div><div data-v-bdcfa54a${_scopeId2}><dt data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Identifiant"))}</dt><dd data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(user).id)}</dd></div><div data-v-bdcfa54a${_scopeId2}><dt data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Niveau d’accès"))}</dt><dd data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Administration"))}</dd></div></dl></section><section class="push-card admin-card" aria-labelledby="push-notifications-title" data-v-bdcfa54a${_scopeId2}><div data-v-bdcfa54a${_scopeId2}><p class="admin-eyebrow" data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Alertes privées"))}</p><h2 id="push-notifications-title" data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Notifications Tatitotu"))}</h2><p class="admin-muted" data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Recevez les paliers de comptes créés et de sessions quotidiennes, même lorsque le site n’est pas ouvert."))}</p></div>`);
                    if (unref(pushSupported)) {
                      _push3(`<div class="push-card__actions" data-v-bdcfa54a${_scopeId2}>`);
                      if (!unref(pushEnabled)) {
                        _push3(`<button class="admin-button" type="button"${ssrIncludeBooleanAttr(unref(pushBusy)) ? " disabled" : ""} data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(pushBusy) ? unref(ui)("Activation…") : unref(ui)("Activer sur cet appareil"))}</button>`);
                      } else {
                        _push3(`<!--[--><span class="push-card__status" data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Activées sur cet appareil"))}</span><button class="admin-button" type="button"${ssrIncludeBooleanAttr(unref(pushBusy)) ? " disabled" : ""} data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Envoyer un test"))}</button><button class="admin-button admin-button--secondary" type="button"${ssrIncludeBooleanAttr(unref(pushBusy)) ? " disabled" : ""} data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Désactiver"))}</button><!--]-->`);
                      }
                      _push3(`</div>`);
                    } else if (unref(pushCapabilityChecked)) {
                      _push3(`<p class="admin-notice admin-notice--error" role="status" data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(windowSecureContext) ? unref(ui)("Ce navigateur ne prend pas en charge les notifications Web Push.") : unref(ui)("Les notifications nécessitent une connexion HTTPS sécurisée."))}</p>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (unref(pushMessage)) {
                      _push3(`<p class="admin-notice admin-notice--success" role="status" data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(pushMessage))}</p>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (unref(pushError)) {
                      _push3(`<p class="admin-notice admin-notice--error" role="alert" data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(pushError))}</p>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<fieldset class="push-preferences"${ssrIncludeBooleanAttr(!unref(pushEnabled) || unref(pushBusy)) ? " disabled" : ""} data-v-bdcfa54a${_scopeId2}><legend data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Messages à recevoir sur cet appareil"))}</legend><!--[-->`);
                    ssrRenderList(pushPreferenceOptions, (option) => {
                      _push3(`<label data-v-bdcfa54a${_scopeId2}><input type="checkbox"${ssrIncludeBooleanAttr(unref(pushPreferences)[option.key]) ? " checked" : ""} data-v-bdcfa54a${_scopeId2}><span data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)(option.label))}</span></label>`);
                    });
                    _push3(`<!--]--></fieldset></section><aside class="account-note" data-v-bdcfa54a${_scopeId2}><strong data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Modification du profil"))}</strong><p data-v-bdcfa54a${_scopeId2}>${ssrInterpolate(unref(ui)("Cette version permet de consulter le compte. Aucune API de modification du profil ou du mot de passe n’est disponible."))}</p></aside></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
...
const monCompte = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bdcfa54a"]]);

export { monCompte as default };
//# sourceMappingURL=mon-compte-CUaHBeHf.mjs.map
