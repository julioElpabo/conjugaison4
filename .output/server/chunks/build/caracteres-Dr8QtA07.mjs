          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_AdminShell, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="caractere-admin" data-v-7e16a380${_scopeId2}><header class="admin-section-heading" data-v-7e16a380${_scopeId2}><div data-v-7e16a380${_scopeId2}><p class="admin-eyebrow" data-v-7e16a380${_scopeId2}>Contenu mutualisé</p><h1 data-v-7e16a380${_scopeId2}>Caractères</h1><p class="admin-muted" data-v-7e16a380${_scopeId2}>Une modification s’applique immédiatement à tous les coaches qui partagent ce caractère.</p></div><button class="admin-button admin-button--primary" data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(tab) === "caracteres" ? "Nouveau caractère" : "Nouveau média")}</button></header><div class="caractere-tabs" data-v-7e16a380${_scopeId2}><button class="${ssrRenderClass({ active: unref(tab) === "caracteres" })}" data-v-7e16a380${_scopeId2}>Caractères</button><button class="${ssrRenderClass({ active: unref(tab) === "media" })}" data-v-7e16a380${_scopeId2}>Médiathèque <span data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(media).length)}</span></button></div>`);
                  if (unref(error)) {
                    _push3(`<p class="admin-notice admin-notice--error" data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(error))}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (unref(success)) {
                    _push3(`<p class="admin-notice admin-notice--success" data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(success))}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (unref(tab) === "caracteres") {
                    _push3(`<div class="caractere-workspace" data-v-7e16a380${_scopeId2}><aside class="caractere-list admin-card" data-v-7e16a380${_scopeId2}><!--[-->`);
                    ssrRenderList(unref(sortedCaracteres), (caractere) => {
                      _push3(`<button class="${ssrRenderClass({ selected: caractere.id === unref(selectedId), "is-disabled": caractere.status === "disabled" })}" data-v-7e16a380${_scopeId2}><span class="caractere-list__mark" data-v-7e16a380${_scopeId2}>${ssrInterpolate(caractere.emoticon)}</span><span data-v-7e16a380${_scopeId2}><strong data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(formatCaractereName)(caractere))}</strong><small data-v-7e16a380${_scopeId2}>`);
                      if (caractere.status === "disabled") {
                        _push3(`<span data-v-7e16a380${_scopeId2}>Désactivé · </span>`);
                      } else {
                        _push3(`<!---->`);
                      }
                    ...
                    _push3(`<!--]--></aside>`);
                    if (unref(draft)) {
                      _push3(`<form class="caractere-editor" data-v-7e16a380${_scopeId2}><section class="admin-card caractere-panel" data-v-7e16a380${_scopeId2}><div class="panel-title caractere-profile-title" data-v-7e16a380${_scopeId2}><div data-v-7e16a380${_scopeId2}><p class="admin-eyebrow" data-v-7e16a380${_scopeId2}>Profil partagé</p><h2 data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(draft).masculineName ? unref(formatCaractereName)(unref(draft)) : "Nouveau caractère")}</h2></div><div class="admin-field emoticon-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Icône *</span><button type="button" class="emoticon-trigger" aria-haspopup="dialog" data-v-7e16a380${_scopeId2}><span aria-hidden="true" data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(draft).emoticon)}</span><small data-v-7e16a380${_scopeId2}>Modifier</small></button></div><div class="caractere-profile-actions" data-v-7e16a380${_scopeId2}><button type="button" class="admin-button admin-button--primary caractere-help-button"${ssrIncludeBooleanAttr(unref(openingHelp) || unref(duplicatingCaractere) || unref(deletingCaractere)) ? " disabled" : ""} data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(openingHelp) ? "Ouverture de l’aide…" : "Voir l’aide automatique")}</button>`);
                      if (unref(draft).id) {
                        _push3(`<button type="button" class="admin-button admin-button--small"${ssrIncludeBooleanAttr(unref(openingHelp) || unref(duplicatingCaractere) || unref(deletingCaractere)) ? " disabled" : ""} data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(duplicatingCaractere) ? "Duplication…" : "Dupliquer")}</button>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      if (unref(draft).id) {
                        _push3(`<button type="button" class="admin-button admin-button--danger admin-button--small"${ssrIncludeBooleanAttr(unref(duplicatingCaractere) || unref(deletingCaractere)) ? " disabled" : ""} data-v-7e16a380${_scopeId2}>Désactiver</button>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      if (unref(draft).id) {
                        _push3(`<button type="button" class="admin-button admin-button--danger admin-button--small caractere-delete-button"${ssrIncludeBooleanAttr(unref(duplicatingCaractere) || unref(deletingCaractere)) ? " disabled" : ""} data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(deletingCaractere) ? "Suppression…" : "Supprimer")}</button>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</div></div>`);
                      if (unref(draft).id) {
                        _push3(`<div class="caractere-coaches" data-v-7e16a380${_scopeId2}><div data-v-7e16a380${_scopeId2}><strong data-v-7e16a380${_scopeId2}>Coaches utilisant ce caractère</strong><small data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(caractereCoaches).length)} coach${ssrInterpolate(unref(caractereCoaches).length > 1 ? "es" : "")}</small></div>`);
                        if (unref(caractereCoaches).length) {
                          _push3(`<div class="caractere-coaches__portraits" data-v-7e16a380${_scopeId2}><!--[-->`);
                          ssrRenderList(unref(caractereCoaches), (coach) => {
                            _push3(ssrRenderComponent(_component_NuxtLink, {
                              ...
                              default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                                if (_push4) {
                                  _push4(`<img${ssrRenderAttr("src", coach.avatarPath)} alt="" data-v-7e16a380${_scopeId3}><span data-v-7e16a380${_scopeId3}>${ssrInterpolate(coach.firstName)}</span>`);
                                } else {
                                  return [
                                    createVNode("img", {
                          ...
                          _push3(`<p data-v-7e16a380${_scopeId2}>Aucun coach n’utilise encore ce caractère.</p>`);
                        }
                        _push3(`</div>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`<div class="caractere-fields" data-v-7e16a380${_scopeId2}><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Nom *</span><input${ssrRenderAttr("value", unref(draft).masculineName)} required data-v-7e16a380${_scopeId2}></label><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Identifiant *</span><input${ssrRenderAttr("value", unref(draft).slug)} required data-v-7e16a380${_scopeId2}></label><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Ordre</span><input${ssrRenderAttr("value", unref(draft).sortOrder)} type="number" data-v-7e16a380${_scopeId2}></label><label class="admin-field wide" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Description courte *</span><textarea rows="3" required data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(draft).pedagogicalStyle)}</textarea></label><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Approche de l’aide</span><select${ssrRenderAttr("value", unref(draft).helpApproachId)} data-v-7e16a380${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(helpApproaches), (approach) => {
                        _push3(`<option${ssrRenderAttr("value", approach.id)} data-v-7e16a380${_scopeId2}>${ssrInterpolate(approach.name)}</option>`);
                      });
                      _push3(`<!--]--><option disabled data-v-7e16a380${_scopeId2}>──────────</option><option value="manage" data-v-7e16a380${_scopeId2}>Modifier les approches…</option></select></label><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Statut</span><select data-v-7e16a380${_scopeId2}><option value="draft" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(draft).status) ? ssrLooseContain(unref(draft).status, "draft") : ssrLooseEqual(unref(draft).status, "draft")) ? " selected" : ""}${_scopeId2}>Brouillon</option><option value="published" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(draft).status) ? ssrLooseContain(unref(draft).status, "published") : ssrLooseEqual(unref(draft).status, "published")) ? " selected" : ""}${_scopeId2}>Publié</option><option value="disabled" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(draft).status) ? ssrLooseContain(unref(draft).status, "disabled") : ssrLooseEqual(unref(draft).status, "disabled")) ? " selected" : ""}${_scopeId2}>Désactivé</option></select></label></div></section><section class="admin-card caractere-panel dialogue-panel" data-v-7e16a380${_scopeId2}><div class="panel-title" data-v-7e16a380${_scopeId2}><div data-v-7e16a380${_scopeId2}><p class="admin-eyebrow" data-v-7e16a380${_scopeId2}>Dialogue partagé</p><h2 data-v-7e16a380${_scopeId2}>Textes du caractère</h2></div><strong data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(draft).replies.length)} phrase(s)</strong></div><p class="admin-muted dialogue-intro" data-v-7e16a380${_scopeId2}>Les phrases sont classées selon le moment où elles peuvent apparaître dans la conversation. Ouvrez une catégorie pour gérer son contenu. <span class="required-note" data-v-7e16a380${_scopeId2}>* Catégorie obligatoire</span></p><details class="variables-help" data-v-7e16a380${_scopeId2}><summary data-v-7e16a380${_scopeId2}>Variables utilisables dans les phrases</summary><p data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(placeholdersLabel))}</p></details><div class="reply-groups" data-v-7e16a380${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(COACH_EVENTS), (eventType) => {
                        _push3(`<details class="reply-group"${ssrIncludeBooleanAttr(eventType === "introduction") ? " open" : ""} data-v-7e16a380${_scopeId2}><summary class="reply-group__summary" data-v-7e16a380${_scopeId2}><span class="reply-group__heading" data-v-7e16a380${_scopeId2}><strong data-v-7e16a380${_scopeId2}>${ssrInterpolate(EVENT_LABELS[eventType])}`);
                        if (unref(REQUIRED_REPLY_EVENTS).has(eventType)) {
                          _push3(`<span class="required-mark" aria-label="obligatoire" data-v-7e16a380${_scopeId2}> *</span>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`</strong><small data-v-7e16a380${_scopeId2}>${ssrInterpolate(EVENT_DESCRIPTIONS[eventType])}</small></span><span class="${ssrRenderClass([{ "is-empty": activeReplyCount(eventType) === 0 }, "reply-group__count"])}" data-v-7e16a380${_scopeId2}>${ssrInterpolate(activeReplyCount(eventType))} active(s)</span></summary><div class="reply-group__body" data-v-7e16a380${_scopeId2}>`);
                        if (!repliesFor(eventType).length) {
                          _push3(`<div class="reply-group__empty" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Aucune phrase dans cette catégorie.</span>`);
                          if (unref(REQUIRED_REPLY_EVENTS).has(eventType)) {
                            _push3(`<small data-v-7e16a380${_scopeId2}>Au moins une phrase active est nécessaire pour publier ce caractère.</small>`);
                          } else {
                            _push3(`<!---->`);
                          }
                          _push3(`</div>`);
                        } else {
                          _push3(`<div class="reply-list" data-v-7e16a380${_scopeId2}><!--[-->`);
                          ssrRenderList(repliesFor(eventType), (reply) => {
                            _push3(`<article class="${ssrRenderClass([{ "is-inactive": !reply.isActive }, "reply-card"])}" data-v-7e16a380${_scopeId2}><label class="reply-card__content" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Phrase</span><textarea rows="2" required data-v-7e16a380${_scopeId2}>${ssrInterpolate(reply.content)}</textarea></label><div class="reply-card__settings" data-v-7e16a380${_scopeId2}><label class="reply-active" data-v-7e16a380${_scopeId2}><input${ssrIncludeBooleanAttr(Array.isArray(reply.isActive) ? ssrLooseContain(reply.isActive, null) : reply.isActive) ? " checked" : ""} type="checkbox" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Active</span></label><label class="reply-weight" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Fréquence</span><input${ssrRenderAttr("value", reply.weight)} type="number" min="1" max="20" data-v-7e16a380${_scopeId2}><small data-v-7e16a380${_scopeId2}>1 = rare, 20 = fréquente</small></label><button type="button" class="reply-delete" aria-label="Supprimer cette phrase" data-v-7e16a380${_scopeId2}>Supprimer</button></div></article>`);
                          });
                          _push3(`<!--]--></div>`);
                        }
                        _push3(`<button type="button" class="admin-button admin-button--small reply-add" data-v-7e16a380${_scopeId2}>+ Ajouter une phrase</button></div></details>`);
                      });
                      _push3(`<!--]--></div></section><section class="admin-card caractere-panel reaction-media-panel" data-v-7e16a380${_scopeId2}><div class="panel-title" data-v-7e16a380${_scopeId2}><div data-v-7e16a380${_scopeId2}><p class="admin-eyebrow" data-v-7e16a380${_scopeId2}>Réactions partagées</p><h2 data-v-7e16a380${_scopeId2}>GIF animés et émojis</h2></div><strong data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(draft).assignments.length)} attribué(s)</strong></div><h3 data-v-7e16a380${_scopeId2}>Fréquence des réactions</h3><p class="admin-muted" data-v-7e16a380${_scopeId2}>Les fréquences s’appliquent une fois la pause écoulée : rarement = 20 %, moitié = 50 %, souvent = 80 %. Le GIF est tiré en premier ; un émoji peut apparaître si aucun GIF n’est choisi. La pause indique l’écart minimal entre les numéros des questions avec un média (0 = aucune pause, 2 = une question intermédiaire).</p><div class="rule-list" data-v-7e16a380${_scopeId2}><!--[-->`);
                      ssrRenderList(REACTION_EVENTS, (eventType) => {
                        _push3(`<div data-v-7e16a380${_scopeId2}><button type="button" data-v-7e16a380${_scopeId2}>${ssrInterpolate(EVENT_LABELS[eventType])}</button>`);
                        if (ruleFor(eventType)) {
                          _push3(`<!--[--><label data-v-7e16a380${_scopeId2}>GIF animés <select${ssrRenderAttr("value", ruleFor(eventType)?.animationProbability)} data-v-7e16a380${_scopeId2}><!--[-->`);
                          ssrRenderList(MEDIA_FREQUENCY_OPTIONS, (option) => {
                            _push3(`<option${ssrRenderAttr("value", option.value)} data-v-7e16a380${_scopeId2}>${ssrInterpolate(option.label)}</option>`);
                          });
                          _push3(`<!--]--></select></label><label data-v-7e16a380${_scopeId2}>Émojis <select${ssrRenderAttr("value", ruleFor(eventType)?.emojiProbability)} data-v-7e16a380${_scopeId2}><!--[-->`);
                          ssrRenderList(MEDIA_FREQUENCY_OPTIONS, (option) => {
                            _push3(`<option${ssrRenderAttr("value", option.value)} data-v-7e16a380${_scopeId2}>${ssrInterpolate(option.label)}</option>`);
                          });
                          _push3(`<!--]--></select></label><label data-v-7e16a380${_scopeId2}>Pause <input${ssrRenderAttr("value", ruleFor(eventType)?.cooldownQuestions)} type="number" min="0" data-v-7e16a380${_scopeId2}></label><!--]-->`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`</div>`);
                      });
                      _push3(`<!--]--></div><div class="response-media-groups" data-v-7e16a380${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(responseMediaGroups), (group) => {
                        _push3(`<section class="${ssrRenderClass([`response-media-group--${group.key}`, "response-media-group"])}" data-v-7e16a380${_scopeId2}><header data-v-7e16a380${_scopeId2}><div data-v-7e16a380${_scopeId2}><p class="admin-eyebrow" data-v-7e16a380${_scopeId2}>${ssrInterpolate(group.title)}</p><h3 data-v-7e16a380${_scopeId2}>${ssrInterpolate(group.title)}</h3><small data-v-7e16a380${_scopeId2}>${ssrInterpolate(group.description)}</small></div><div class="media-selection-actions" data-v-7e16a380${_scopeId2}><strong data-v-7e16a380${_scopeId2}>${ssrInterpolate(assignedMediaCount(group.items, group.key))}/${ssrInterpolate(group.items.length)}</strong><button type="button" class="admin-button admin-button--small" data-v-7e16a380${_scopeId2}>Tout sélectionner</button><button type="button" class="admin-button admin-button--small" data-v-7e16a380${_scopeId2}>Tout désélectionner</button></div></header>`);
                        if (!group.items.length) {
                          _push3(`<p class="admin-muted" data-v-7e16a380${_scopeId2}>Aucun média dans cette catégorie.</p>`);
                        } else {
                          _push3(`<div class="media-grid" data-v-7e16a380${_scopeId2}><!--[-->`);
                          ssrRenderList(group.items, (item) => {
                            _push3(`<article class="${ssrRenderClass({ assigned: assignmentFor(item.id, group.key) })}" data-v-7e16a380${_scopeId2}><button type="button" class="media-delete-button"${ssrRenderAttr("aria-label", `Supprimer définitivement ${item.name}`)} title="Supprimer définitivement" data-v-7e16a380${_scopeId2}>×</button><button type="button" data-v-7e16a380${_scopeId2}><img${ssrRenderAttr("src", item.filePath)}${ssrRenderAttr("alt", item.altText)} data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>${ssrInterpolate(assignmentFor(item.id, group.key) ? "✓" : "+")}</span></button><strong data-v-7e16a380${_scopeId2}>${ssrInterpolate(item.name)}</strong>`);
                            if (assignmentFor(item.id, group.key)) {
                              _push3(`<label data-v-7e16a380${_scopeId2}>Poids <input${ssrRenderAttr("value", assignmentFor(item.id, group.key)?.weight)} type="number" min="1" max="20" data-v-7e16a380${_scopeId2}></label>`);
                            } else {
                              _push3(`<!---->`);
                            }
                            _push3(`</article>`);
                        ...
                        if (group.key === "incorrect" && assignedMediaCount(group.items, group.key) === 0) {
                          _push3(`<p class="response-media-group__text-only" data-v-7e16a380${_scopeId2}>Aucun média sélectionné : les mauvaises réponses utiliseront uniquement du texte.</p>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`</section>`);
                      ...
                      if (unref(otherReactionMedia).length) {
                        _push3(`<details class="other-reaction-media" data-v-7e16a380${_scopeId2}><summary data-v-7e16a380${_scopeId2}>Autres moments de la conversation · ${ssrInterpolate(unref(otherReactionMedia).length)} média(s)</summary><div class="media-grid" data-v-7e16a380${_scopeId2}><!--[-->`);
                        ssrRenderList(unref(otherReactionMedia), (item) => {
                          _push3(`<article class="${ssrRenderClass({ assigned: assignmentFor(item.id) })}" data-v-7e16a380${_scopeId2}><button type="button" class="media-delete-button"${ssrRenderAttr("aria-label", `Supprimer définitivement ${item.name}`)} title="Supprimer définitivement" data-v-7e16a380${_scopeId2}>×</button><button type="button" data-v-7e16a380${_scopeId2}><img${ssrRenderAttr("src", item.filePath)}${ssrRenderAttr("alt", item.altText)} data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>${ssrInterpolate(assignmentFor(item.id) ? "✓" : "+")}</span></button><strong data-v-7e16a380${_scopeId2}>${ssrInterpolate(item.name)}</strong>`);
                          if (assignmentFor(item.id)) {
                            _push3(`<!--[--><select${ssrRenderAttr("value", assignmentFor(item.id)?.eventType)} data-v-7e16a380${_scopeId2}><!--[-->`);
                            ssrRenderList(unref(COACH_EVENTS), (eventType) => {
                              _push3(`<option${ssrRenderAttr("value", eventType)} data-v-7e16a380${_scopeId2}>${ssrInterpolate(EVENT_LABELS[eventType])}</option>`);
                            });
                            _push3(`<!--]--></select><label data-v-7e16a380${_scopeId2}>Poids <input${ssrRenderAttr("value", assignmentFor(item.id)?.weight)} type="number" min="1" max="20" data-v-7e16a380${_scopeId2}></label><!--]-->`);
                          } else {
                            _push3(`<!---->`);
                          }
                          _push3(`</article>`);
                      ...
                      _push3(`</section><div class="save-bar" data-v-7e16a380${_scopeId2}><p class="${ssrRenderClass([`is-${unref(autosaveState)}`, "autosave-status"])}" aria-live="polite" data-v-7e16a380${_scopeId2}><span aria-hidden="true" data-v-7e16a380${_scopeId2}></span>${ssrInterpolate(unref(autosaveLabel))}</p>`);
                      if (unref(autosaveState) === "error") {
                        _push3(`<button type="button" class="admin-button admin-button--small" data-v-7e16a380${_scopeId2}>Réessayer</button>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</div></form>`);
                    ...
                    _push3(`<div class="media-workspace" data-v-7e16a380${_scopeId2}><aside class="media-library admin-card" data-v-7e16a380${_scopeId2}><!--[-->`);
                    ssrRenderList(unref(media), (item) => {
                      _push3(`<button class="${ssrRenderClass({ selected: item.id === unref(selectedMediaId) })}" data-v-7e16a380${_scopeId2}><img${ssrRenderAttr("src", item.filePath)}${ssrRenderAttr("alt", item.altText)} data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}><strong data-v-7e16a380${_scopeId2}>${ssrInterpolate(item.name)}</strong><small data-v-7e16a380${_scopeId2}>${ssrInterpolate(item.mediaType)} · ${ssrInterpolate(item.safetyStatus)}</small></span></button>`);
                    });
                    _push3(`<!--]--></aside><form class="admin-card media-editor" data-v-7e16a380${_scopeId2}><div class="panel-title" data-v-7e16a380${_scopeId2}><h2 data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(mediaDraft).id ? "Modifier le média" : "Ajouter un média")}</h2>`);
                    if (unref(mediaDraft).filePath && unref(mediaDraft).mediaType !== "video") {
                      _push3(`<img${ssrRenderAttr("src", unref(mediaDraft).filePath)} alt="Aperçu" data-v-7e16a380${_scopeId2}>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Importer</span><input type="file" accept="image/png,image/jpeg,image/gif,image/webp,video/mp4,video/webm"${ssrIncludeBooleanAttr(unref(uploading)) ? " disabled" : ""} data-v-7e16a380${_scopeId2}></label><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Nom *</span><input${ssrRenderAttr("value", unref(mediaDraft).name)} required data-v-7e16a380${_scopeId2}></label><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Chemin *</span><input${ssrRenderAttr("value", unref(mediaDraft).filePath)} required data-v-7e16a380${_scopeId2}></label><div class="caractere-fields" data-v-7e16a380${_scopeId2}><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Type</span><select data-v-7e16a380${_scopeId2}><option data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).mediaType) ? ssrLooseContain(unref(mediaDraft).mediaType, null) : ssrLooseEqual(unref(mediaDraft).mediaType, null)) ? " selected" : ""}${_scopeId2}>emoji</option><option data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).mediaType) ? ssrLooseContain(unref(mediaDraft).mediaType, null) : ssrLooseEqual(unref(mediaDraft).mediaType, null)) ? " selected" : ""}${_scopeId2}>animation</option><option data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).mediaType) ? ssrLooseContain(unref(mediaDraft).mediaType, null) : ssrLooseEqual(unref(mediaDraft).mediaType, null)) ? " selected" : ""}${_scopeId2}>video</option><option data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).mediaType) ? ssrLooseContain(unref(mediaDraft).mediaType, null) : ssrLooseEqual(unref(mediaDraft).mediaType, null)) ? " selected" : ""}${_scopeId2}>image</option></select></label><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Catégorie</span><select data-v-7e16a380${_scopeId2}><option value="success" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).category) ? ssrLooseContain(unref(mediaDraft).category, "success") : ssrLooseEqual(unref(mediaDraft).category, "success")) ? " selected" : ""}${_scopeId2}>Réussite</option><option value="encouragement" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).category) ? ssrLooseContain(unref(mediaDraft).category, "encouragement") : ssrLooseEqual(unref(mediaDraft).category, "encouragement")) ? " selected" : ""}${_scopeId2}>Encouragement</option><option value="finish" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).category) ? ssrLooseContain(unref(mediaDraft).category, "finish") : ssrLooseEqual(unref(mediaDraft).category, "finish")) ? " selected" : ""}${_scopeId2}>Fin</option><option value="welcome" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).category) ? ssrLooseContain(unref(mediaDraft).category, "welcome") : ssrLooseEqual(unref(mediaDraft).category, "welcome")) ? " selected" : ""}${_scopeId2}>Accueil</option><option value="neutral" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).category) ? ssrLooseContain(unref(mediaDraft).category, "neutral") : ssrLooseEqual(unref(mediaDraft).category, "neutral")) ? " selected" : ""}${_scopeId2}>Neutre</option></select></label><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Droits</span><select data-v-7e16a380${_scopeId2}><option value="pending" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).rightsStatus) ? ssrLooseContain(unref(mediaDraft).rightsStatus, "pending") : ssrLooseEqual(unref(mediaDraft).rightsStatus, "pending")) ? " selected" : ""}${_scopeId2}>À vérifier</option><option value="verified" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).rightsStatus) ? ssrLooseContain(unref(mediaDraft).rightsStatus, "verified") : ssrLooseEqual(unref(mediaDraft).rightsStatus, "verified")) ? " selected" : ""}${_scopeId2}>Vérifiés</option><option value="rejected" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).rightsStatus) ? ssrLooseContain(unref(mediaDraft).rightsStatus, "rejected") : ssrLooseEqual(unref(mediaDraft).rightsStatus, "rejected")) ? " selected" : ""}${_scopeId2}>Refusés</option></select></label><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Sécurité mineurs</span><select data-v-7e16a380${_scopeId2}><option value="pending" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).safetyStatus) ? ssrLooseContain(unref(mediaDraft).safetyStatus, "pending") : ssrLooseEqual(unref(mediaDraft).safetyStatus, "pending")) ? " selected" : ""}${_scopeId2}>À vérifier</option><option value="approved" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).safetyStatus) ? ssrLooseContain(unref(mediaDraft).safetyStatus, "approved") : ssrLooseEqual(unref(mediaDraft).safetyStatus, "approved")) ? " selected" : ""}${_scopeId2}>Approuvée</option><option value="rejected" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(unref(mediaDraft).safetyStatus) ? ssrLooseContain(unref(mediaDraft).safetyStatus, "rejected") : ssrLooseEqual(unref(mediaDraft).safetyStatus, "rejected")) ? " selected" : ""}${_scopeId2}>Refusée</option></select></label></div><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Texte alternatif *</span><input${ssrRenderAttr("value", unref(mediaDraft).altText)} required data-v-7e16a380${_scopeId2}></label><button class="admin-button admin-button--primary"${ssrIncludeBooleanAttr(unref(saving) || unref(uploading)) ? " disabled" : ""} data-v-7e16a380${_scopeId2}>Enregistrer le média</button></form></div>`);
                  }
                  ssrRenderTeleport(_push3, (_push4) => {
                    if (unref(approachManagerOpen)) {
                      _push4(`<div class="icon-picker-backdrop" data-v-7e16a380${_scopeId2}><section class="icon-picker approach-manager" role="dialog" aria-modal="true" aria-labelledby="approach-manager-title" data-v-7e16a380${_scopeId2}><header data-v-7e16a380${_scopeId2}><div data-v-7e16a380${_scopeId2}><p class="admin-eyebrow" data-v-7e16a380${_scopeId2}>Aides automatiques</p><h2 id="approach-manager-title" data-v-7e16a380${_scopeId2}>Gérer les approches</h2></div><button type="button" class="icon-picker__close" aria-label="Fermer"${ssrIncludeBooleanAttr(Boolean(unref(approachSaving))) ? " disabled" : ""} data-v-7e16a380${_scopeId2}>×</button></header><p class="approach-manager__intro" data-v-7e16a380${_scopeId2}>Le nom est libre. Le comportement moteur indique la stratégie utilisée par le générateur automatique.</p>`);
                      if (unref(approachError)) {
                        _push4(`<p class="admin-notice admin-notice--error" data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(approachError))}</p>`);
                      } else {
                        _push4(`<!---->`);
                      }
                      _push4(`<div class="approach-manager__list" data-v-7e16a380${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(approachDrafts), (approach) => {
                        _push4(`<article data-v-7e16a380${_scopeId2}><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Nom</span><input${ssrRenderAttr("value", approach.name)} maxlength="80" data-v-7e16a380${_scopeId2}></label><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Comportement moteur</span><select data-v-7e16a380${_scopeId2}><option value="complete-avec-reponses" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(approach.engineKey) ? ssrLooseContain(approach.engineKey, "complete-avec-reponses") : ssrLooseEqual(approach.engineKey, "complete-avec-reponses")) ? " selected" : ""}${_scopeId2}>Complète avec réponses</option><option value="complete" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(approach.engineKey) ? ssrLooseContain(approach.engineKey, "complete") : ssrLooseEqual(approach.engineKey, "complete")) ? " selected" : ""}${_scopeId2}>Complète sans réponses</option><option value="tres-condensee" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(approach.engineKey) ? ssrLooseContain(approach.engineKey, "tres-condensee") : ssrLooseEqual(approach.engineKey, "tres-condensee")) ? " selected" : ""}${_scopeId2}>Très condensée</option><option value="allophone" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(approach.engineKey) ? ssrLooseContain(approach.engineKey, "allophone") : ssrLooseEqual(approach.engineKey, "allophone")) ? " selected" : ""}${_scopeId2}>Allophone</option></select></label><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Statut</span><select data-v-7e16a380${_scopeId2}><option value="draft" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(approach.status) ? ssrLooseContain(approach.status, "draft") : ssrLooseEqual(approach.status, "draft")) ? " selected" : ""}${_scopeId2}>Brouillon</option><option value="published" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(approach.status) ? ssrLooseContain(approach.status, "published") : ssrLooseEqual(approach.status, "published")) ? " selected" : ""}${_scopeId2}>Publié</option><option value="disabled" data-v-7e16a380${ssrIncludeBooleanAttr(Array.isArray(approach.status) ? ssrLooseContain(approach.status, "disabled") : ssrLooseEqual(approach.status, "disabled")) ? " selected" : ""}${_scopeId2}>Désactivé</option></select></label><span class="approach-manager__usage" data-v-7e16a380${_scopeId2}>${ssrInterpolate(approach.characterCount)} caractère${ssrInterpolate(approach.characterCount > 1 ? "s" : "")}</span><button type="button" class="admin-button admin-button--small"${ssrIncludeBooleanAttr(Boolean(unref(approachSaving)) || !approach.name.trim()) ? " disabled" : ""} data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(approachSaving) === approach.id ? "Enregistrement…" : "Enregistrer")}</button><button type="button" class="admin-button admin-button--danger admin-button--small"${ssrIncludeBooleanAttr(Boolean(unref(approachSaving)) || approach.characterCount > 0) ? " disabled" : ""}${ssrRenderAttr("title", approach.characterCount ? "Cette approche est encore utilisée" : "Supprimer cette approche")} data-v-7e16a380${_scopeId2}>Supprimer</button></article>`);
                      });
                      _push4(`<!--]--></div><form class="approach-manager__new" data-v-7e16a380${_scopeId2}><label class="admin-field" data-v-7e16a380${_scopeId2}><span data-v-7e16a380${_scopeId2}>Nouvelle approche</span><input${ssrRenderAttr("value", unref(newApproachName))} maxlength="80" placeholder="Nom de l’approche" data-v-7e16a380${_scopeId2}></label><button class="admin-button admin-button--primary"${ssrIncludeBooleanAttr(Boolean(unref(approachSaving)) || !unref(newApproachName).trim()) ? " disabled" : ""} data-v-7e16a380${_scopeId2}>${ssrInterpolate(unref(approachSaving) === "new" ? "Ajout…" : "Ajouter")}</button></form></section></div>`);
                    } else {
                      _push4(`<!---->`);
                    }
                  }, "body", false, _parent3);
                  ssrRenderTeleport(_push3, (_push4) => {
                    if (unref(iconPickerOpen)) {
                      _push4(`<div class="icon-picker-backdrop" data-v-7e16a380${_scopeId2}><section class="icon-picker" role="dialog" aria-modal="true" aria-labelledby="icon-picker-title" data-v-7e16a380${_scopeId2}><header data-v-7e16a380${_scopeId2}><div data-v-7e16a380${_scopeId2}><p class="admin-eyebrow" data-v-7e16a380${_scopeId2}>Caractère</p><h2 id="icon-picker-title" data-v-7e16a380${_scopeId2}>Choisir une icône</h2></div><button type="button" class="icon-picker__close" aria-label="Fermer" data-v-7e16a380${_scopeId2}>×</button></header><div class="icon-picker__groups" data-v-7e16a380${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(caractereIconGroups), (group) => {
                        _push4(`<section data-v-7e16a380${_scopeId2}><h3 data-v-7e16a380${_scopeId2}>${ssrInterpolate(group.label)}</h3><div class="icon-picker__grid" data-v-7e16a380${_scopeId2}><!--[-->`);
                        ssrRenderList(group.icons, (icon) => {
                          _push4(`<button type="button"${ssrRenderAttr("title", icon.label)}${ssrRenderAttr("aria-label", icon.label)}${ssrRenderAttr("aria-pressed", unref(draft)?.emoticon === icon.value)} data-v-7e16a380${_scopeId2}><span aria-hidden="true" data-v-7e16a380${_scopeId2}>${ssrInterpolate(icon.value)}</span><small data-v-7e16a380${_scopeId2}>${ssrInterpolate(icon.label)}</small></button>`);
                        });
                        _push4(`<!--]--></div></section>`);
                      });
                      _push4(`<!--]--></div><p class="icon-picker__hint" data-v-7e16a380${_scopeId2}>Le choix est enregistré immédiatement.</p></section></div>`);
                    } else {
                      _push4(`<!---->`);
                    }
                  }, "body", false, _parent3);
                      ...
                      unref(tab) === "caracteres" ? (openBlock(), createBlock("div", {
                        ...
                        unref(draft) ? (openBlock(), createBlock("form", {
                          ...
                          createVNode("section", { class: "admin-card caractere-panel reaction-media-panel" }, [
                            ...
                            createVNode("p", { class: "admin-muted" }, "Les fréquences s’appliquent une fois la pause écoulée : rarement = 20 %, moitié = 50 %, souvent = 80 %. Le GIF est tiré en premier ; un émoji peut apparaître si aucun GIF n’est choisi. La pause indique l’écart minimal entre les numéros des questions avec un média (0 = aucune pause, 2 = une question intermédiaire)."),
...
const caracteres = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7e16a380"]]);

export { caracteres as default };
//# sourceMappingURL=caracteres-Dr8QtA07.mjs.map
