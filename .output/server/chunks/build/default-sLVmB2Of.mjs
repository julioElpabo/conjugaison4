...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</main><footer class="site-footer"><p>${ssrInterpolate(unref(ui)("Un outil gratuit pour travailler la conjugaison française."))}</p><div class="site-footer__links">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath)("/exercices")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(ui)("Modes et temps"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(ui)("Modes et temps")), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=default-sLVmB2Of.mjs.map
