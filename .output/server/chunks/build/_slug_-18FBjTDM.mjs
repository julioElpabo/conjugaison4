...
import { W as WizardChallengeWorkspace } from './WizardChallengeWorkspace-GcGKeznV.mjs';
import { g as useRoute, f as useLanguagePreferences, m as createError, n as navigateTo, q as usePageSeoOverride, u as useHead, c as useRuntimeConfig } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "public-challenge" }, _attrs))} data-v-84667626>`);
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-84667626"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-18FBjTDM.mjs.map
