...
:global(:root[data-theme='dark'] .geo-zoom__marker-layer.is-additive){mix-blend-mode:screen}
@supports(mix-blend-mode:plus-lighter){:global(:root[data-theme='dark'] .geo-zoom__marker-layer.is-additive){mix-blend-mode:plus-lighter}}
