...
import { g as useLanguagePreferences, u as useHead, c as useRuntimeConfig } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "learner-auth-page" }, _attrs))} data-v-31f87f4f>`);
      if (unref(recovery)) {
        _push(`<section class="learner-card learner-recovery" aria-labelledby="recovery-title" data-v-31f87f4f><p class="learner-eyebrow" data-v-31f87f4f>${ssrInterpolate(unref(copy).created)}</p><h1 id="recovery-title" data-v-31f87f4f>${ssrInterpolate(unref(copy).keepCode)}</h1><p data-v-31f87f4f>${ssrInterpolate(unref(copy).recoveryInfo)}</p><dl data-v-31f87f4f><div data-v-31f87f4f><dt data-v-31f87f4f>${ssrInterpolate(unref(copy).username)}</dt><dd data-v-31f87f4f>${ssrInterpolate(unref(recovery).username)}</dd></div><div data-v-31f87f4f><dt data-v-31f87f4f>${ssrInterpolate(unref(copy).recoveryCode)}</dt><dd data-v-31f87f4f><code data-v-31f87f4f>${ssrInterpolate(unref(recovery).recoveryCode)}</code></dd></div></dl><div class="learner-actions" data-v-31f87f4f><button type="button" class="secondary-button" data-v-31f87f4f>${ssrInterpolate(unref(copied) ? unref(copy).codeCopied : unref(copy).copyCode)}</button><button type="button" class="secondary-button" data-v-31f87f4f>${ssrInterpolate(unref(copy).download)}</button>`);
        ...
        _push(`<section class="learner-card" aria-labelledby="learner-auth-title" data-v-31f87f4f><h1 id="learner-auth-title" data-v-31f87f4f>${ssrInterpolate(unref(mode) === "register" ? unref(copy).create : unref(copy).signIn)}</h1><p class="learner-intro" data-v-31f87f4f>${ssrInterpolate(unref(copy).intro)}</p><div class="learner-tabs" role="tablist"${ssrRenderAttr("aria-label", unref(copy).chooseAction)} data-v-31f87f4f><button type="button" role="tab"${ssrRenderAttr("aria-selected", unref(mode) === "login")} data-v-31f87f4f>${ssrInterpolate(unref(copy).signIn)}</button><button type="button" role="tab"${ssrRenderAttr("aria-selected", unref(mode) === "register")} data-v-31f87f4f>${ssrInterpolate(unref(copy).create)}</button></div>`);
        if (unref(errorMessage)) {
          _push(`<p class="learner-error" role="alert" data-v-31f87f4f>${ssrInterpolate(unref(errorMessage))}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(mode) === "register") {
          _push(`<form data-v-31f87f4f><div class="learner-field" data-v-31f87f4f><span data-v-31f87f4f>${ssrInterpolate(unref(copy).proposedUsername)}</span><div class="username-proposal" aria-live="polite" data-v-31f87f4f><strong data-v-31f87f4f>${ssrInterpolate(unref(loadingSuggestion) ? unref(copy).searching : unref(suggestion)?.username || unref(copy).unavailable)}</strong><button type="button"${ssrIncludeBooleanAttr(unref(loadingSuggestion)) ? " disabled" : ""} data-v-31f87f4f>${ssrInterpolate(unref(copy).anotherUsername)}</button></div></div><label class="learner-field" data-v-31f87f4f><span data-v-31f87f4f>${ssrInterpolate(unref(copy).choosePassword)}</span><input${ssrRenderAttr("value", unref(password))} type="password" minlength="10" maxlength="200" autocomplete="new-password" required data-v-31f87f4f><small data-v-31f87f4f>${ssrInterpolate(unref(copy).passwordHint)}</small></label><label class="learner-field" data-v-31f87f4f><span data-v-31f87f4f>${ssrInterpolate(unref(copy).confirmPassword)}</span><input${ssrRenderAttr("value", unref(passwordConfirmation))} type="password" minlength="10" maxlength="200" autocomplete="new-password" required data-v-31f87f4f></label><label class="honeypot" aria-hidden="true" data-v-31f87f4f> Site internet <input${ssrRenderAttr("value", unref(website))} name="website" type="text" tabindex="-1" autocomplete="off" data-v-31f87f4f></label><label class="privacy-check" data-v-31f87f4f><input${ssrIncludeBooleanAttr(Array.isArray(unref(privacyAccepted)) ? ssrLooseContain(unref(privacyAccepted), null) : unref(privacyAccepted)) ? " checked" : ""} type="checkbox" required data-v-31f87f4f><span data-v-31f87f4f>${ssrInterpolate(unref(copy).privacy)}</span></label>`);
          if (unref(turnstileSiteKey)) {
            _push(`<div class="cf-turnstile" data-v-31f87f4f></div>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(turnstileUnavailable)) {
            _push(`<p class="learner-error" role="alert" data-v-31f87f4f> Le contrôle antibot n’a pas pu se charger. Recharge la page ou vérifie que ton navigateur ne le bloque pas. </p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<button class="primary-button is-full" type="submit"${ssrIncludeBooleanAttr(unref(submitting) || unref(loadingSuggestion) || !unref(suggestion)) ? " disabled" : ""} data-v-31f87f4f>${ssrInterpolate(unref(submitting) ? unref(copy).creating : unref(copy).create)}</button></form>`);
        } else {
          _push(`<form data-v-31f87f4f><label class="learner-field" data-v-31f87f4f><span data-v-31f87f4f>${ssrInterpolate(unref(copy).username)}</span><input${ssrRenderAttr("value", unref(loginUsername))} type="text" maxlength="80" autocomplete="username" autocapitalize="none" spellcheck="false" required data-v-31f87f4f></label><label class="learner-field" data-v-31f87f4f><span data-v-31f87f4f>${ssrInterpolate(unref(copy).password)}</span><input${ssrRenderAttr("value", unref(loginPassword))} type="password" maxlength="200" autocomplete="current-password" required data-v-31f87f4f></label><button class="primary-button is-full" type="submit"${ssrIncludeBooleanAttr(unref(submitting)) ? " disabled" : ""} data-v-31f87f4f>${ssrInterpolate(unref(submitting) ? unref(copy).signingIn : unref(copy).signIn)}</button></form>`);
        }
        _push(`</section>`);
      }
      _push(`</div>`);
...
const signin = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-31f87f4f"]]);

export { signin as default };
//# sourceMappingURL=signin-BO7Z7Jvu.mjs.map
