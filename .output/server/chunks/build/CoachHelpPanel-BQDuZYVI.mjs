...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderStyle } from 'vue/server-renderer';
...
import { aZ as grammarModeCode } from '../nitro/nitro.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-70e190e3><span class="coach-help-badge" data-v-70e190e3>${ssrInterpolate(unref(ui)("Aide"))}</span><header class="coach-help-header" data-v-70e190e3><div data-v-70e190e3><h2 id="coach-help-title" data-v-70e190e3>${ssrInterpolate(unref(renderedHeaderTitle))}</h2>`);
      if (unref(renderedHeaderDescription)) {
        _push(`<div class="coach-help-header__description" data-v-70e190e3>${unref(renderedHeaderDescription) ?? ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (__props.showClose) {
        _push(`<button type="button"${ssrRenderAttr("aria-label", unref(ui)("Fermer l’aide"))} data-v-70e190e3>×</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</header><div class="coach-help-content" tabindex="0"${ssrRenderAttr("aria-label", unref(renderedHeaderTitle))} data-v-70e190e3>`);
      if (__props.allophoneMode) {
        ...
        if (__props.consultVerbId) {
          _push(`<section class="coach-help-consult" data-v-70e190e3><div data-v-70e190e3><strong data-v-70e190e3>${ssrInterpolate(unref(ui)("Conjugaison complète"))}</strong><p data-v-70e190e3>${ssrInterpolate(unref(ui)("Consulte toutes les formes du verbe {verb}.", { verb: __props.consultVerbLabel || "" }))}</p></div><button type="button" data-v-70e190e3>${ssrInterpolate(unref(ui)("Consulter le verbe"))}</button></section>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
      ...
      if (__props.showFeedback) {
        _push(`<section class="coach-help-feedback" aria-labelledby="coach-help-feedback-title" data-v-70e190e3><h3 id="coach-help-feedback-title" class="sr-only" data-v-70e190e3>${ssrInterpolate(unref(ui)("Retour sur l’aide automatique"))}</h3><p data-v-70e190e3>${ssrInterpolate(unref(ui)("Cette aide est générée automatiquement. Elle peut contenir une erreur ou manquer de clarté. Les retours permettent de l’améliorer."))}</p><div class="coach-help-feedback__actions" role="group"${ssrRenderAttr("aria-label", unref(ui)("Retour sur cette aide"))} data-v-70e190e3><!--[-->`);
        ssrRenderList(unref(feedbackOptions), (option) => {
          _push(`<button type="button" class="${ssrRenderClass({ "is-selected": unref(feedbackType) === option.type })}"${ssrIncludeBooleanAttr(unref(feedbackStatus) === "sending") ? " disabled" : ""} data-v-70e190e3><span aria-hidden="true" data-v-70e190e3>${ssrInterpolate(option.icon)}</span> ${ssrInterpolate(option.label)}</button>`);
        });
        _push(`<!--]--></div>`);
        if (unref(feedbackRequiresComment) && unref(feedbackStatus) !== "sent") {
          _push(`<form class="coach-help-feedback__form" data-v-70e190e3><label for="coach-help-feedback-comment" data-v-70e190e3>${ssrInterpolate(unref(ui)("Remarque optionnelle"))}</label><textarea id="coach-help-feedback-comment" rows="3" maxlength="2000"${ssrRenderAttr("placeholder", unref(ui)("Précision utile pour corriger ou améliorer l’aide…"))} data-v-70e190e3>${ssrInterpolate(unref(feedbackComment))}</textarea><button type="submit"${ssrIncludeBooleanAttr(unref(feedbackStatus) === "sending") ? " disabled" : ""} data-v-70e190e3>${ssrInterpolate(unref(feedbackStatus) === "sending" ? unref(ui)("Envoi…") : unref(ui)("Envoyer le retour"))}</button></form>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(feedbackStatus) === "sent") {
          _push(`<p class="coach-help-feedback__status" data-v-70e190e3>${ssrInterpolate(unref(ui)("Retour enregistré."))}</p>`);
        } else if (unref(feedbackError)) {
          _push(`<p class="coach-help-feedback__error" data-v-70e190e3>${ssrInterpolate(unref(feedbackError))}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</section>`);
      ...
      if (unref(recommendedApproaches).length && !__props.embedded) {
        _push(`<section class="coach-help-feedback coach-help-recommendation" aria-labelledby="coach-help-recommendation-title" data-v-70e190e3><strong id="coach-help-recommendation-title" data-v-70e190e3>${ssrInterpolate(unref(ui)("Changer de niveau d’aide"))}</strong>`);
        if (unref(recommendationLoading)) {
          _push(`<p data-v-70e190e3>${ssrInterpolate(unref(ui)("Chargement des coaches…"))}</p>`);
        } else if (unref(recommendedCoachGroups).length) {
          _push(`<div class="coach-help-recommendation__groups" data-v-70e190e3><!--[-->`);
          ssrRenderList(unref(recommendedCoachGroups), (group) => {
            _push(`<section class="coach-help-recommendation__group" data-v-70e190e3><header data-v-70e190e3><strong data-v-70e190e3>${ssrInterpolate(unref(ui)(group.title))}</strong><p data-v-70e190e3>${ssrInterpolate(unref(ui)(group.description))}</p></header><div class="coach-help-recommendation__coaches" data-v-70e190e3><!--[-->`);
            ssrRenderList(group.coaches, (recommendedCoach) => {
              _push(`<button type="button" style="${ssrRenderStyle({ "--recommended-coach-color": recommendedCoach.themeColor })}"${ssrRenderAttr("aria-label", unref(ui)("Choisir {name}", { name: recommendedCoach.firstName }))} data-v-70e190e3><img${ssrRenderAttr("src", recommendedCoach.avatarPath)}${ssrRenderAttr("alt", unref(ui)("Avatar de {name}", { name: recommendedCoach.firstName }))} data-v-70e190e3><span data-v-70e190e3><strong data-v-70e190e3>${ssrInterpolate(recommendedCoach.firstName)}</strong><small data-v-70e190e3>${ssrInterpolate(recommendedCoach.pedagogicalStyle)}</small></span></button>`);
            });
            _push(`<!--]--></div></section>`);
          });
          _push(`<!--]--><p class="coach-help-recommendation__note" data-v-70e190e3>${ssrInterpolate(unref(ui)("Le changement s’applique immédiatement à cette question."))}</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</section>`);
      ...
      _push(`</div><footer class="coach-help-footer" data-v-70e190e3><button type="button" data-v-70e190e3>${ssrInterpolate(unref(ui)("Fermer"))}</button></footer></aside>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-70e190e3"]]), { __name: "CoachHelpPanel" });
...
//# sourceMappingURL=CoachHelpPanel-BQDuZYVI.mjs.map
