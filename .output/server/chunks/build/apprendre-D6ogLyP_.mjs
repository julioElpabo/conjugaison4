...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "learning-page" }, _attrs))} data-v-c782ff04>`);
      if (unref(falcMode)) {
        _push(ssrRenderComponent(_component_LearningFalcLearningPage, null, null, _parent));
      } else {
        _push(`<!--[--><header class="learning-hero" data-v-c782ff04><p class="learning-eyebrow" data-v-c782ff04>${ssrInterpolate(unref(ui)("Les règles essentielles"))}</p><h1 data-v-c782ff04>${ssrInterpolate(unref(ui)("Apprendre la conjugaison française"))}</h1></header><nav class="learning-summary"${ssrRenderAttr("aria-label", unref(ui)("Sommaire des règles"))} data-v-c782ff04><!--[-->`);
        ssrRenderList(unref(sections), (section) => {
          _push(`<button type="button" data-v-c782ff04><span data-v-c782ff04>${ssrInterpolate(section.number)}</span><strong data-v-c782ff04>${ssrInterpolate(section.title)}</strong><small data-v-c782ff04>${ssrInterpolate(section.description)}</small></button>`);
        });
        _push(`<!--]--></nav><main class="learning-content" data-v-c782ff04><section id="modes" class="rule-section" data-v-c782ff04><header data-v-c782ff04><span data-v-c782ff04>01</span><div data-v-c782ff04><p class="learning-eyebrow" data-v-c782ff04>${ssrInterpolate(unref(modeExplorerCopy).eyebrow)}</p><h2 data-v-c782ff04>${ssrInterpolate(unref(modeExplorerCopy).title)}</h2><p class="mode-explorer-intro" data-v-c782ff04>${ssrInterpolate(unref(modeExplorerCopy).intro)}</p></div></header><div class="mode-selector" role="tablist"${ssrRenderAttr("aria-label", unref(modeExplorerCopy).tabsLabel)} data-v-c782ff04><!--[-->`);
        ssrRenderList(unref(learningModes), (mode) => {
          _push(`<button${ssrRenderAttr("id", `mode-tab-${mode.slug}`)} type="button" role="tab"${ssrRenderAttr("aria-controls", `mode-panel-${mode.slug}`)}${ssrRenderAttr("aria-selected", unref(selectedLearningMode) === mode.slug)}${ssrRenderAttr("tabindex", unref(selectedLearningMode) === mode.slug ? 0 : -1)} class="${ssrRenderClass({ "is-active": unref(selectedLearningMode) === mode.slug })}" data-v-c782ff04><strong data-v-c782ff04>${ssrInterpolate(mode.modeName)}</strong></button>`);
        });
        _push(`<!--]--></div><!--[-->`);
        ssrRenderList(unref(learningModes), (mode) => {
          _push(`<div${ssrRenderAttr("id", `mode-panel-${mode.slug}`)} class="mode-explorer-panel" role="tabpanel"${ssrRenderAttr("aria-labelledby", `mode-tab-${mode.slug}`)} style="${ssrRenderStyle(unref(selectedLearningMode) === mode.slug ? null : { display: "none" })}" data-v-c782ff04><div class="mode-explorer-purpose" data-v-c782ff04><p data-v-c782ff04>${ssrInterpolate(mode.eyebrow)}</p><h3 data-v-c782ff04>${ssrInterpolate(mode.purposeTitle)}</h3><p data-v-c782ff04>${ssrInterpolate(mode.purpose)}</p></div><div class="mode-explorer-details" data-v-c782ff04><section data-v-c782ff04><h4 data-v-c782ff04>${ssrInterpolate(mode.examplesTitle)}</h4><ul data-v-c782ff04><!--[-->`);
          ssrRenderList(mode.examples, (example) => {
            _push(`<li data-v-c782ff04>${ssrInterpolate(example)}</li>`);
          });
          _push(`<!--]--></ul></section><section data-v-c782ff04><h4 data-v-c782ff04>${ssrInterpolate(mode.watchTitle)}</h4><ul data-v-c782ff04><!--[-->`);
          ssrRenderList(mode.watchItems, (item) => {
            _push(`<li data-v-c782ff04>${ssrInterpolate(item)}</li>`);
          });
          _push(`<!--]--></ul></section></div><section class="mode-explorer-tenses"${ssrRenderAttr("aria-labelledby", `mode-panel-${mode.slug}-tenses`)} data-v-c782ff04><header data-v-c782ff04><h4${ssrRenderAttr("id", `mode-panel-${mode.slug}-tenses`)} data-v-c782ff04>${ssrInterpolate(mode.tensesTitle)}</h4><p data-v-c782ff04>${ssrInterpolate(unref(modeExplorerCopy).tenseHelp)}</p></header><nav${ssrRenderAttr("aria-label", mode.tensesTitle)} data-v-c782ff04><!--[-->`);
          ssrRenderList(mode.tenses, (tense) => {
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<strong data-v-c782ff04${_scopeId}>${ssrInterpolate(tense.label)}</strong><span aria-hidden="true" data-v-c782ff04${_scopeId}>→</span>`);
                } else {
                  return [
          ...
          _push(`<!--]--></nav></section><div class="mode-explorer-actions" data-v-c782ff04><p data-v-c782ff04>${ssrInterpolate(mode.ctaText)}</p>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: { path: unref(localePath)("/exercices-de-conjugaison"), query: { mode: mode.slug } }
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(mode.ctaLabel)} <span aria-hidden="true" data-v-c782ff04${_scopeId}>→</span>`);
              } else {
                return [
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span data-v-c782ff04${_scopeId}>S’entraîner à reconnaître les modes et les temps</span><span aria-hidden="true" data-v-c782ff04${_scopeId}>→</span>`);
            } else {
              return [
        ...
        _push(`</section><section id="bases" class="rule-section" data-v-c782ff04><header data-v-c782ff04><span data-v-c782ff04>02</span><div data-v-c782ff04><p class="learning-eyebrow" data-v-c782ff04>${ssrInterpolate(unref(ui)("Les fondations"))}</p><h2 data-v-c782ff04>${ssrInterpolate(unref(ui)("Comprendre le verbe"))}</h2></div></header><div class="rule-grid rule-grid--three" data-v-c782ff04><article data-v-c782ff04><h3 data-v-c782ff04>${ssrInterpolate(unref(ui)("Radical + terminaison"))}</h3><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Une forme conjuguée associe généralement un radical, qui porte le sens, et une terminaison, qui indique la personne, le mode et le temps."))}</p><p class="rule-example" data-v-c782ff04><strong data-v-c782ff04>nous chantions</strong><span data-v-c782ff04>chant- + -ions</span></p></article><article data-v-c782ff04><h3 data-v-c782ff04>${ssrInterpolate(unref(ui)("Les trois groupes"))}</h3><ul data-v-c782ff04><li data-v-c782ff04><strong data-v-c782ff04>${ssrInterpolate(unref(ui)("1er groupe :"))}</strong> ${ssrInterpolate(unref(ui)("verbes en -er, sauf aller."))}</li><li data-v-c782ff04><strong data-v-c782ff04>${ssrInterpolate(unref(ui)("2e groupe :"))}</strong> ${ssrInterpolate(unref(ui)("verbes en -ir faisant -issons."))}</li><li data-v-c782ff04><strong data-v-c782ff04>${ssrInterpolate(unref(ui)("3e groupe :"))}</strong> ${ssrInterpolate(unref(ui)("tous les autres verbes, souvent irréguliers."))}</li></ul></article><article data-v-c782ff04><h3 data-v-c782ff04>${ssrInterpolate(unref(ui)("Être et avoir"))}</h3><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Ces deux verbes ont leurs propres conjugaisons et servent aussi d’auxiliaires pour former les temps composés."))}</p><p class="rule-example" data-v-c782ff04><strong data-v-c782ff04>elle a fini</strong><span data-v-c782ff04>${ssrInterpolate(unref(ui)("auxiliaire + participe passé"))}</span></p></article></div></section><section id="accords" class="rule-section" data-v-c782ff04><header data-v-c782ff04><span data-v-c782ff04>03</span><div data-v-c782ff04><p class="learning-eyebrow" data-v-c782ff04>${ssrInterpolate(unref(ui)("Les correspondances"))}</p><h2 data-v-c782ff04>${ssrInterpolate(unref(ui)("Réussir les accords"))}</h2></div></header><div class="agreement-flow" data-v-c782ff04><article data-v-c782ff04><span data-v-c782ff04>1</span><div data-v-c782ff04><h3 data-v-c782ff04>${ssrInterpolate(unref(ui)("Trouver le sujet"))}</h3><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Le verbe s’accorde en personne et en nombre avec son sujet, même lorsque celui-ci est éloigné."))}</p><em data-v-c782ff04>Les élèves de cette classe réussissent.</em></div></article><article data-v-c782ff04><span data-v-c782ff04>2</span><div data-v-c782ff04><h3 data-v-c782ff04>${ssrInterpolate(unref(ui)("Identifier l’auxiliaire"))}</h3><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Avec être, le participe passé s’accorde généralement avec le sujet."))}</p><em data-v-c782ff04>Elles sont arrivées.</em></div></article><article data-v-c782ff04><span data-v-c782ff04>3</span><div data-v-c782ff04><h3 data-v-c782ff04>${ssrInterpolate(unref(ui)("Repérer le COD avec avoir"))}</h3><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Avec avoir, le participe passé s’accorde avec le COD seulement si celui-ci est placé avant."))}</p><em data-v-c782ff04>Les lettres qu’il a écrites.</em></div></article></div><aside class="rule-note rule-note--warning" data-v-c782ff04><strong data-v-c782ff04>${ssrInterpolate(unref(ui)("Verbes pronominaux"))}</strong><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Leur accord dépend de la fonction du pronom. Il faut déterminer si celui-ci est COD, COI ou fait partie du verbe."))}</p></aside></section><section id="orthographe" class="rule-section" data-v-c782ff04><header data-v-c782ff04><span data-v-c782ff04>04</span><div data-v-c782ff04><p class="learning-eyebrow" data-v-c782ff04>${ssrInterpolate(unref(ui)("Les pièges fréquents"))}</p><h2 data-v-c782ff04>${ssrInterpolate(unref(ui)("Préserver le son et l’orthographe"))}</h2></div></header><div class="trap-grid" data-v-c782ff04><article data-v-c782ff04><h3 data-v-c782ff04>-ger et -cer</h3><p data-v-c782ff04>${ssrInterpolate(unref(ui)("On ajoute parfois un e après g ou une cédille pour conserver le son."))}</p><em data-v-c782ff04>nous mangeons · nous plaçons</em></article><article data-v-c782ff04><h3 data-v-c782ff04>-yer</h3><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Le y peut devenir i devant un e muet. Pour certains verbes, les deux graphies sont admises."))}</p><em data-v-c782ff04>j’emploie · nous employons</em></article><article data-v-c782ff04><h3 data-v-c782ff04>e / è</h3><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Certains verbes changent l’accent lorsque la syllabe suivante contient un e muet."))}</p><em data-v-c782ff04>je lève · nous levons</em></article><article data-v-c782ff04><h3 data-v-c782ff04>${ssrInterpolate(unref(ui)("Consonne doublée"))}</h3><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Certains verbes en -eler et -eter doublent la consonne ; d’autres prennent un accent grave."))}</p><em data-v-c782ff04>j’appelle · j’achète</em></article><article data-v-c782ff04><h3 data-v-c782ff04>-é ou -er ?</h3><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Remplace le verbe par « vendre » : si « vendu » convient, écris le participe passé ; si « vendre » convient, écris l’infinitif."))}</p><em data-v-c782ff04>j’ai mangé · je vais manger</em></article><article data-v-c782ff04><h3 data-v-c782ff04>-rai ou -rais ?</h3><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Le futur exprime ce qui arrivera ; le conditionnel dépend d’une condition ou atténue une demande."))}</p><em data-v-c782ff04>je viendrai · je viendrais si…</em></article></div></section><section class="learning-journeys" aria-labelledby="journeys-title" data-v-c782ff04><header data-v-c782ff04><p class="learning-eyebrow" data-v-c782ff04>${ssrInterpolate(unref(ui)("À toi de jouer"))}</p><h2 id="journeys-title" data-v-c782ff04>${ssrInterpolate(unref(ui)("Passe de la règle à la pratique"))}</h2></header><div data-v-c782ff04><!--[-->`);
        ssrRenderList(unref(exerciseJourneys), (journey) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span data-v-c782ff04${_scopeId}>${ssrInterpolate(journey.eyebrow)}</span><strong data-v-c782ff04${_scopeId}>${ssrInterpolate(journey.title)}</strong><small data-v-c782ff04${_scopeId}>${ssrInterpolate(journey.description)}</small>`);
              } else {
                return [
        ...
        _push(`<!--]--></div></section><section class="learning-actions" aria-labelledby="continue-title" data-v-c782ff04><div data-v-c782ff04><p class="learning-eyebrow" data-v-c782ff04>${ssrInterpolate(unref(ui)("À toi de jouer"))}</p><h2 id="continue-title" data-v-c782ff04>${ssrInterpolate(unref(ui)("Passe de la règle à la pratique"))}</h2><p data-v-c782ff04>${ssrInterpolate(unref(ui)("Consulte un modèle complet ou crée un exercice ciblé pour vérifier ce que tu viens d’apprendre."))}</p></div><div data-v-c782ff04>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
...
const apprendre = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c782ff04"]]);

export { apprendre as default };
//# sourceMappingURL=apprendre-D6ogLyP_.mjs.map
