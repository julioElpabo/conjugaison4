...
import { am as grammarModeCode } from '../nitro/nitro.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const renderedTitle = computed(() => isDefinitionBlock.value ? ui("Définition") : isRadicalBlock.value ? "" : uiLabel(props.block.title));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-0f90f838>`);
      if (unref(renderedTitle)) {
        _push(`<h3 data-v-0f90f838>`);
        if (unref(orthographyKind)) {
          _push(`<span class="coach-help-block__letter" aria-hidden="true" data-v-0f90f838>${ssrInterpolate(unref(orthographyKind).toUpperCase())}</span>`);
        } else if (unref(isDefinitionBlock)) {
          _push(`<span class="coach-help-block__info-icon" aria-hidden="true" data-v-0f90f838>i</span>`);
        } else {
          _push(`<!---->`);
        }
      ...
      if (unref(renderedContent)) {
        _push(`<div class="${ssrRenderClass([{ "coach-help-block__content--radical": unref(isRadicalBlock), "coach-help-block__content--condensed-tense-rule": unref(isCondensedTenseRuleBlock) }, "coach-help-block__content"])}" data-v-0f90f838>${unref(renderedContent) ?? ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(activeChildren).length) {
        _push(`<div class="coach-help-block__children" data-v-0f90f838><!--[-->`);
...
const __nuxt_component_0$1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-0f90f838"]]), { __name: "CoachHelpBlockView" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const automaticAudit = computed(() => automaticAuditInput.value ? auditRenderedCoachHelp({
    ...
    function renderedBlockTitle(block) {
      ...
      if (content2 === "{definitionHelp}") return ui("Définition");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-6ed398e7><span class="coach-help-badge" data-v-6ed398e7>${ssrInterpolate(unref(ui)("Aide"))}</span><header class="coach-help-header" data-v-6ed398e7><div data-v-6ed398e7><h2 id="coach-help-title" data-v-6ed398e7>${ssrInterpolate(unref(renderedHeaderTitle))}</h2>`);
      if (unref(renderedHeaderDescription)) {
        _push(`<div class="coach-help-header__description" data-v-6ed398e7>${unref(renderedHeaderDescription) ?? ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (__props.showClose) {
        _push(`<button type="button"${ssrRenderAttr("aria-label", unref(ui)("Fermer l’aide"))} data-v-6ed398e7>×</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</header><div class="coach-help-content" data-v-6ed398e7><!--[-->`);
      ...
      if (__props.showFeedback) {
        _push(`<section class="coach-help-feedback" aria-labelledby="coach-help-feedback-title" data-v-6ed398e7><h3 id="coach-help-feedback-title" class="sr-only" data-v-6ed398e7>${ssrInterpolate(unref(ui)("Retour sur l’aide automatique"))}</h3><p data-v-6ed398e7>${ssrInterpolate(unref(ui)("Cette aide est générée automatiquement. Elle peut contenir une erreur ou manquer de clarté. Les retours permettent de l’améliorer."))}</p><div class="coach-help-feedback__actions" role="group"${ssrRenderAttr("aria-label", unref(ui)("Retour sur cette aide"))} data-v-6ed398e7><!--[-->`);
        ssrRenderList(unref(feedbackOptions), (option) => {
          _push(`<button type="button" class="${ssrRenderClass({ "is-selected": unref(feedbackType) === option.type })}"${ssrIncludeBooleanAttr(unref(feedbackStatus) === "sending") ? " disabled" : ""} data-v-6ed398e7><span aria-hidden="true" data-v-6ed398e7>${ssrInterpolate(option.icon)}</span> ${ssrInterpolate(option.label)}</button>`);
        });
        _push(`<!--]--></div>`);
        if (unref(feedbackRequiresComment) && unref(feedbackStatus) !== "sent") {
          _push(`<form class="coach-help-feedback__form" data-v-6ed398e7><label for="coach-help-feedback-comment" data-v-6ed398e7>${ssrInterpolate(unref(ui)("Remarque optionnelle"))}</label><textarea id="coach-help-feedback-comment" rows="3" maxlength="2000"${ssrRenderAttr("placeholder", unref(ui)("Précision utile pour corriger ou améliorer l’aide…"))} data-v-6ed398e7>${ssrInterpolate(unref(feedbackComment))}</textarea><button type="submit"${ssrIncludeBooleanAttr(unref(feedbackStatus) === "sending") ? " disabled" : ""} data-v-6ed398e7>${ssrInterpolate(unref(feedbackStatus) === "sending" ? unref(ui)("Envoi…") : unref(ui)("Envoyer le retour"))}</button></form>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(feedbackStatus) === "sent") {
          _push(`<p class="coach-help-feedback__status" data-v-6ed398e7>${ssrInterpolate(unref(ui)("Retour enregistré."))}</p>`);
        } else if (unref(feedbackError)) {
          _push(`<p class="coach-help-feedback__error" data-v-6ed398e7>${ssrInterpolate(unref(feedbackError))}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</section>`);
      ...
      _push(`</div><footer class="coach-help-footer" data-v-6ed398e7><button type="button" data-v-6ed398e7>${ssrInterpolate(unref(ui)("Fermer"))}</button></footer></aside>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-6ed398e7"]]), { __name: "CoachHelpPanel" });

export { __nuxt_component_0 as _, automaticCoachHelpApproach as a, conditionalCoachHelpBlocks as b, coachHelpQuestionVariables as c, areOnlyIndicativeTenses as d, localizedCoachVerbDefinition as l, renderCoachHelpContent as r, sanitizeCoachHtml as s, visibleCoachHelpBlocks as v, withoutIndicativeMode as w };
//# sourceMappingURL=CoachHelpPanel-Bf20pXup.mjs.map
