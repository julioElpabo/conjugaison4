...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-c55b7edd>`);
      _push(ssrRenderComponent(WizardChallengeWorkspace, {
        "home-heading": unref(ui)("Exercices de conjugaison française")
      }, null, _parent));
      _push(`<section class="tense-links" aria-labelledby="tense-links-title" data-v-c55b7edd><h2 id="tense-links-title" data-v-c55b7edd>Exercices par temps</h2><ul data-v-c55b7edd><!--[-->`);
      ssrRenderList(unref(TENSE_EXERCISE_PAGES), (page) => {
        _push(`<li data-v-c55b7edd>`);
...
const exercicesDeConjugaison = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c55b7edd"]]);

export { exercicesDeConjugaison as default };
//# sourceMappingURL=exercices-de-conjugaison-BFOETKig.mjs.map
