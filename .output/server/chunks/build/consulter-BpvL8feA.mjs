...
import { g as useLanguagePreferences, h as useRoute, a as useRouter, u as useHead } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    function acceptedFormColumnCount(rows) {
      return Math.max(1, ...rows.map((row) => row.forms.length));
    }
    function isIndicativeMode(mode) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-0b3b29fe>`);
      if (!unref(embeddedInChallenge)) {
        _push(`<header class="reference-hero" data-v-0b3b29fe><p class="reference-eyebrow" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Le conjugueur"))}</p><h1 data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Consulter un verbe"))}</h1></header>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(status) === "pending") {
        _push(`<div class="reference-state" role="status" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Chargement du catalogue…"))}</div>`);
      } else if (unref(error)) {
        _push(`<div class="reference-state reference-state--error" role="alert" data-v-0b3b29fe><p data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Le catalogue n’a pas pu être chargé."))}</p><button type="button" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Réessayer"))}</button></div>`);
      } else {
        _push(`<section class="consultation-container" aria-live="polite" data-v-0b3b29fe>`);
        if (!unref(showingDetail)) {
          _push(`<div class="consultation-panel selection-panel" data-v-0b3b29fe><div class="consultation-tabs" role="tablist"${ssrRenderAttr("aria-label", unref(ui)("Méthode de recherche du verbe"))} data-v-0b3b29fe><button id="search-tab" type="button" role="tab"${ssrRenderAttr("aria-selected", unref(activeTab) === "search")} aria-controls="search-panel" class="${ssrRenderClass({ "is-active": unref(activeTab) === "search" })}" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Rechercher un verbe"))}</button><button id="list-tab" type="button" role="tab"${ssrRenderAttr("aria-selected", unref(activeTab) === "list")} aria-controls="list-panel" class="${ssrRenderClass({ "is-active": unref(activeTab) === "list" })}" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Liste de A à Z"))}</button></div>`);
          if (unref(activeTab) === "search") {
            _push(`<div id="search-panel" class="tab-panel search-tab-panel" role="tabpanel" aria-labelledby="search-tab" data-v-0b3b29fe><div data-v-0b3b29fe><p class="reference-eyebrow" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Recherche rapide"))}</p><h2 data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Quel verbe cherches-tu ?"))}</h2><p data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Commence à écrire son infinitif, puis choisis-le dans les propositions."))}</p></div><div class="verb-combobox" data-v-0b3b29fe><input id="public-verb-search"${ssrRenderAttr("value", unref(query))} type="search" role="combobox" autocomplete="off" spellcheck="false"${ssrRenderAttr("placeholder", unref(ui)("Par exemple : venir"))}${ssrRenderAttr("aria-label", unref(ui)("Rechercher un verbe"))} aria-autocomplete="list" aria-controls="public-verb-suggestions"${ssrRenderAttr("aria-expanded", unref(suggestionsOpen))}${ssrRenderAttr("aria-activedescendant", unref(suggestionsOpen) ? `public-verb-option-${unref(suggestions)[unref(activeSuggestion)]?.id}` : void 0)} data-v-0b3b29fe>`);
            if (unref(suggestionsOpen)) {
              _push(`<ul id="public-verb-suggestions" role="listbox" data-v-0b3b29fe><!--[-->`);
              ssrRenderList(unref(suggestions), (verb, index) => {
                _push(`<li${ssrRenderAttr("id", `public-verb-option-${verb.id}`)} role="option"${ssrRenderAttr("aria-selected", index === unref(activeSuggestion))} data-v-0b3b29fe><button type="button" class="${ssrRenderClass({ "is-active": index === unref(activeSuggestion) })}" data-v-0b3b29fe><strong data-v-0b3b29fe>${ssrInterpolate(verb.infinitif)}</strong><small data-v-0b3b29fe>${ssrInterpolate(groupLabel(verb.groupeConjugaison))}</small></button></li>`);
              });
              _push(`<!--]--></ul>`);
            } else {
              _push(`<!---->`);
            ...
            _push(`<div id="list-panel" class="tab-panel list-tab-panel" role="tabpanel" aria-labelledby="list-tab" data-v-0b3b29fe><div class="alphabet-heading" data-v-0b3b29fe><div data-v-0b3b29fe><p class="reference-eyebrow" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Catalogue complet"))}</p><h2 data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Tous les verbes de A à Z"))}</h2></div><span data-v-0b3b29fe>${ssrInterpolate(unref(verbs).length)} ${ssrInterpolate(unref(verbs).length === 1 ? unref(ui)("verbe") : unref(ui)("verbes"))}</span></div><nav class="letter-nav"${ssrRenderAttr("aria-label", unref(ui)("Accès aux lettres"))} data-v-0b3b29fe><!--[-->`);
            ssrRenderList(unref(alphabetGroups), (group) => {
              _push(`<button type="button" data-v-0b3b29fe>${ssrInterpolate(group.letter)}</button>`);
            });
            _push(`<!--]--></nav><div class="alphabet-list" data-v-0b3b29fe><div class="alphabet-groups" data-v-0b3b29fe><!--[-->`);
            ssrRenderList(unref(alphabetGroups), (group) => {
              _push(`<section${ssrRenderAttr("id", `letter-${group.letter}`)} class="letter-group" data-v-0b3b29fe><h3 data-v-0b3b29fe>${ssrInterpolate(group.letter)}</h3><div data-v-0b3b29fe><!--[-->`);
              ssrRenderList(group.verbs, (verb) => {
                _push(`<button type="button" class="${ssrRenderClass({ "is-selected": unref(selectedId) === verb.id })}" data-v-0b3b29fe>${ssrInterpolate(verb.infinitif)}</button>`);
              });
              _push(`<!--]--></div></section>`);
            });
            _push(`<!--]--></div></div></div>`);
          ...
          _push(`<div class="${ssrRenderClass([{ "detail-panel--has-open-notes": unref(agreementOpen) || unref(trapsOpen) }, "consultation-panel detail-panel"])}" data-v-0b3b29fe><div class="detail-toolbar" data-v-0b3b29fe><button class="back-button" type="button" data-v-0b3b29fe><span aria-hidden="true" data-v-0b3b29fe>←</span> ${ssrInterpolate(unref(embeddedInChallenge) ? unref(ui)("Retour au défi") : unref(ui)("Retour au choix du verbe"))}</button>`);
          if (unref(detail)) {
            _push(`<button class="print-consultation-button" type="button" data-v-0b3b29fe><svg aria-hidden="true" viewBox="0 0 24 24" fill="none" data-v-0b3b29fe><path d="M7 2.75h6.8L19 7.95v13.3H7z" data-v-0b3b29fe></path><path d="M13.5 2.75v5.5H19" data-v-0b3b29fe></path><path d="M9.3 16.9v-4.4h1.45a1.35 1.35 0 0 1 0 2.7H9.3m4.05 1.7v-4.4h1.05c1.35 0 2.15.8 2.15 2.2s-.8 2.2-2.15 2.2zm4.7 0v-4.4h2.65m-2.65 1.85h2.2" data-v-0b3b29fe></path></svg> ${ssrInterpolate(unref(ui)("Exporter en PDF"))}</button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
          if (unref(detailLoading)) {
            _push(`<div class="reference-state" role="status" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Chargement de la conjugaison…"))}</div>`);
          } else if (unref(detailError)) {
            _push(`<div class="reference-state reference-state--error" role="alert" data-v-0b3b29fe><p data-v-0b3b29fe>${ssrInterpolate(unref(detailError))}</p><button type="button" data-v-0b3b29fe>${ssrInterpolate(unref(embeddedInChallenge) ? unref(ui)("Retour au défi") : unref(ui)("Retour à la liste"))}</button></div>`);
          } else if (unref(detail)) {
            _push(`<!--[--><header class="conjugation-heading" data-v-0b3b29fe><h2 data-v-0b3b29fe>${ssrInterpolate(unref(detail).verb.infinitif)}</h2><dl data-v-0b3b29fe><div data-v-0b3b29fe><dt data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Groupe"))}</dt><dd data-v-0b3b29fe>${ssrInterpolate(groupLabel(unref(detail).verb.groupeConjugaison))}</dd></div><div data-v-0b3b29fe><dt data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Auxiliaire"))}</dt><dd data-v-0b3b29fe>${ssrInterpolate(unref(detail).verb.auxiliaire)}</dd></div></dl></header><div class="conjugation-disclosures" data-v-0b3b29fe><button type="button"${ssrRenderAttr("aria-expanded", unref(agreementOpen))}${ssrRenderAttr("aria-controls", `agreement-panel-${unref(detail).verb.id}`)} data-v-0b3b29fe><span data-v-0b3b29fe>${ssrInterpolate(unref(agreementOpen) ? unref(ui)("Masquer le COD") : unref(ui)("Voir avec un COD"))}</span><span class="disclosure-chevron" aria-hidden="true" data-v-0b3b29fe>⌄</span></button><button type="button"${ssrRenderAttr("aria-expanded", unref(trapsOpen))} aria-controls="consult-trap-legend" data-v-0b3b29fe><span data-v-0b3b29fe>${ssrInterpolate(unref(trapsOpen) ? unref(ui)("Masquer les pièges") : unref(ui)("Voir les pièges"))}</span><span class="disclosure-chevron" aria-hidden="true" data-v-0b3b29fe>⌄</span></button></div><div class="${ssrRenderClass([{ "is-open": unref(agreementOpen) }, "detail-disclosure"])}"${ssrRenderAttr("aria-hidden", !unref(agreementOpen))}${ssrIncludeBooleanAttr(!unref(agreementOpen)) ? " inert" : ""} data-v-0b3b29fe><div class="detail-disclosure__inner" data-v-0b3b29fe><section${ssrRenderAttr("id", `agreement-panel-${unref(detail).verb.id}`)} class="agreement-panel"${ssrRenderAttr("aria-labelledby", `agreement-title-${unref(detail).verb.id}`)} data-v-0b3b29fe>`);
            if (unref(detail).pastParticipleAgreement) {
              _push(`<header data-v-0b3b29fe><p class="reference-eyebrow" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Le participe passé avec avoir"))}</p><h3${ssrRenderAttr("id", `agreement-title-${unref(detail).verb.id}`)} data-v-0b3b29fe>${ssrInterpolate(unref(ui)("La place du COD change l’accord"))}</h3></header>`);
            } else {
              _push(`<!---->`);
            }
            if (unref(detail).pastParticipleAgreement) {
              _push(`<div class="agreement-examples" data-v-0b3b29fe><article data-v-0b3b29fe><span class="agreement-badge" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("COD placé après"))}</span><p class="agreement-sentence" data-v-0b3b29fe>${ssrInterpolate(unref(detail).pastParticipleAgreement.afterSentence)}</p><p class="agreement-rule" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Avec avoir, le participe passé ne s’accorde pas avec le COD placé après."))}</p></article><article data-v-0b3b29fe><span class="agreement-badge agreement-badge--before" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("COD placé avant"))}</span><p class="agreement-sentence" data-v-0b3b29fe>${ssrInterpolate(unref(detail).pastParticipleAgreement.beforeSentenceStart)}${ssrInterpolate(unref(detail).pastParticipleAgreement.agreedParticipleStart)}<mark data-v-0b3b29fe>${ssrInterpolate(unref(detail).pastParticipleAgreement.agreementLetters)}</mark>${ssrInterpolate(unref(detail).pastParticipleAgreement.beforeSentenceEnd)}</p><p class="agreement-rule" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("COD « {cod} » placé avant : accord avec le COD ({gender}, {number}).", {
              ...
              _push(`<!--[--><header data-v-0b3b29fe><p class="reference-eyebrow" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Avec un COD"))}</p><h3${ssrRenderAttr("id", `agreement-title-${unref(detail).verb.id}`)} data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Exemple indisponible"))}</h3></header><p class="agreement-rule" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Aucun exemple avec un COD n’est disponible pour ce verbe."))}</p><!--]-->`);
            }
            _push(`</section></div></div><div class="${ssrRenderClass([{ "is-open": unref(trapsOpen) }, "detail-disclosure"])}"${ssrRenderAttr("aria-hidden", !unref(trapsOpen))}${ssrIncludeBooleanAttr(!unref(trapsOpen)) ? " inert" : ""} data-v-0b3b29fe><div class="detail-disclosure__inner" data-v-0b3b29fe><aside id="consult-trap-legend" class="trap-legend" data-v-0b3b29fe><header data-v-0b3b29fe><p class="reference-eyebrow" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Difficultés repérées"))}</p><h3 data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Pièges à surveiller pour « {verb} »", { verb: unref(detail).verb.infinitif }))}</h3></header>`);
            if (!unref(trapAnalysis).traps.length) {
              _push(`<p class="trap-legend__empty" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Aucun piège particulier n’a été détecté dans les formes de ce verbe."))}</p>`);
            } else {
              _push(`<ul data-v-0b3b29fe><!--[-->`);
              ssrRenderList(unref(trapAnalysis).traps, (trap) => {
                _push(`<li class="${ssrRenderClass(trapToneClass(trap))}" data-v-0b3b29fe><span aria-hidden="true" data-v-0b3b29fe></span><div data-v-0b3b29fe><strong data-v-0b3b29fe>${ssrInterpolate(unref(uiLabel)(trap.title))}</strong><p data-v-0b3b29fe>${ssrInterpolate(unref(uiLabel)(trap.explanation))}</p><!--[-->`);
                ssrRenderList(trap.examples, (example) => {
                  _push(`<small data-v-0b3b29fe>${ssrInterpolate(example)}</small>`);
                });
                _push(`<!--]--></div></li>`);
              });
              _push(`<!--]--></ul>`);
            }
            _push(`</aside></div></div><nav class="mode-nav"${ssrRenderAttr("aria-label", unref(ui)("Accès aux modes"))} data-v-0b3b29fe><!--[-->`);
            ssrRenderList(unref(groups), (group) => {
              _push(`<button type="button" data-v-0b3b29fe>${ssrInterpolate(unref(uiLabel)(group.mode.name))}</button>`);
            });
            _push(`<!--]--><button type="button" data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Formes non personnelles"))}</button></nav><!--[-->`);
            ssrRenderList(unref(groups), (group) => {
              _push(`<section${ssrRenderAttr("id", `consult-mode-${group.mode.id}`)} class="${ssrRenderClass([{ "mode-section--indicative": isIndicativeMode(group.mode.name) }, "mode-section"])}" data-v-0b3b29fe><h2 data-v-0b3b29fe>${ssrInterpolate(unref(uiLabel)(group.mode.name))}</h2><div class="tense-grid" data-v-0b3b29fe><!--[-->`);
              ssrRenderList(group.tenseRows, (tenseRow, rowIndex) => {
                _push(`<div class="tense-row" data-v-0b3b29fe><!--[-->`);
                ssrRenderList(tenseRow, (tense) => {
                  _push(`<article class="tense-consult-card" data-v-0b3b29fe><h3${ssrRenderAttr("id", `consult-tense-${tense.id}`)} data-v-0b3b29fe>${ssrInterpolate(unref(uiLabel)(unref(conjugationTenseLabel)(group.mode.name, tense.name)))}</h3><table class="${ssrRenderClass([{ "conjugation-table--alternatives": acceptedFormColumnCount(tense.rows) > 1 }, "conjugation-table"])}"${ssrRenderAttr("aria-labelledby", `consult-tense-${tense.id}`)} data-v-0b3b29fe><tbody data-v-0b3b29fe><!--[-->`);
                  ssrRenderList(tense.rows, (row) => {
                    _push(`<tr data-v-0b3b29fe><!--[-->`);
                    ssrRenderList(row.forms, (form, index) => {
                      _push(`<!--[--><td class="conjugation-form"${ssrRenderAttr("colspan", index === row.forms.length - 1 ? 2 * (acceptedFormColumnCount(tense.rows) - row.forms.length) + 1 : 1)} data-v-0b3b29fe><!--[-->`);
                      ssrRenderList(displayedFormSegments(row, form, group.mode.name), (segment, segmentIndex) => {
                        _push(`<!--[-->`);
                        if (segment.trap && unref(trapsOpen)) {
                          _push(`<mark class="${ssrRenderClass([trapToneClass(segment.trap), "conjugation-trap-mark"])}"${ssrRenderAttr("title", unref(uiLabel)(segment.trap.title))} data-v-0b3b29fe>${ssrInterpolate(segment.text)}</mark>`);
                        } else {
                          _push(`<span data-v-0b3b29fe>${ssrInterpolate(segment.text)}</span>`);
                        }
                        _push(`<!--]-->`);
                      });
                      _push(`<!--]--></td>`);
                      if (index < row.forms.length - 1) {
                        _push(`<td class="alternative-separator" data-v-0b3b29fe><span data-v-0b3b29fe>${ssrInterpolate(unref(ui)("ou"))}</span></td>`);
                      } else {
                        _push(`<!---->`);
                      }
                      _push(`<!--]-->`);
                  ...
                  _push(`<!--]--></tbody></table></article>`);
                });
                _push(`<!--]--></div>`);
              });
              _push(`<!--]--></div></section>`);
            });
            _push(`<!--]--><section id="consult-non-finite" class="mode-section" data-v-0b3b29fe><h2 data-v-0b3b29fe>${ssrInterpolate(unref(ui)("Formes non personnelles"))}</h2><div class="non-finite-grid" data-v-0b3b29fe><!--[-->`);
            ssrRenderList(unref(nonFiniteForms), (item) => {
              _push(`<article data-v-0b3b29fe><p data-v-0b3b29fe>${ssrInterpolate(unref(uiLabel)(item.mode))} · ${ssrInterpolate(unref(uiLabel)(item.tense))}</p><strong data-v-0b3b29fe>${ssrInterpolate(item.form)}</strong></article>`);
            });
            _push(`<!--]--></div></section>`);
            if (unref(embeddedInChallenge)) {
              _push(`<div class="consultation-return-bottom" data-v-0b3b29fe><button class="back-button" type="button" data-v-0b3b29fe><span aria-hidden="true" data-v-0b3b29fe>←</span> ${ssrInterpolate(unref(ui)("Retour au défi"))}</button></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`<!--]-->`);
...
const consulter = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0b3b29fe"]]);

export { consulter as default };
//# sourceMappingURL=consulter-BpvL8feA.mjs.map
