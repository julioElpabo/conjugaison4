...
const pages = {
  present: {
    ...
    translations: withDutchVariants({
      ...
      nl: {
        ...
        eyebrow: "Indicatief \xB7 tegenwoordige tijd",
        ...
        watchItems: ["Overeenkomst met het onderwerp.", "De vaak onuitgesproken uitgangen -e, -es en -ent.", "Veelgebruikte werkwoorden zoals \xEAtre, avoir, aller en faire."],
  ...
  imparfait: {
    ...
    translations: withDutchVariants({
      ...
      nl: {
        ...
        eyebrow: "Indicatief \xB7 imparfait",
        ruleTitle: "Hoe vorm je de imparfait?",
        rule: "Neem meestal de nous-vorm van de tegenwoordige tijd, verwijder -ons en voeg -ais, -ais, -ait, -ions, -iez of -aient toe. Het werkwoord \xEAtre gebruikt de stam \xE9t-.",
        examplesTitle: "Drie voorbeelden",
        examples: ["Je regardais la montagne.", "Nous choisissions un livre.", "Vous \xE9tiez d\xE9j\xE0 l\xE0."],
        watchTitle: "Aandachtspunten",
        watchItems: ["De uitgangen -ais, -ait en -aient klinken hetzelfde.", "Werkwoorden op -ger behouden soms een e: je mangeais.", "Werkwoorden op -cer krijgen een cedille: je commen\xE7ais."],
  ...
  "passe-compose": {
    ...
    translations: withDutchVariants({
      ...
      nl: {
        title: "Oefeningen op de Franse pass\xE9 compos\xE9",
        metaTitle: "Gratis oefeningen op de Franse pass\xE9 compos\xE9",
        description: "Oefen de Franse pass\xE9 compos\xE9, de keuze van het hulpwerkwoord en de overeenkomst met een online of afdrukbare oefening op maat.",
        eyebrow: "Indicatief \xB7 pass\xE9 compos\xE9",
        ruleTitle: "Hoe vorm je de pass\xE9 compos\xE9?",
        rule: "De Franse pass\xE9 compos\xE9 bestaat uit avoir of \xEAtre in de tegenwoordige tijd en het voltooid deelwoord van het werkwoord. Met \xEAtre komt het deelwoord meestal overeen met het onderwerp.",
        examplesTitle: "Drie voorbeelden",
        examples: ["Tu as termin\xE9 ton travail.", "Elles sont arriv\xE9es t\xF4t.", "Nous avons pris le train."],
        watchTitle: "Aandachtspunten",
        watchItems: ["Kiezen tussen avoir en \xEAtre.", "Voltooide deelwoorden met een onregelmatige vorm.", "Overeenkomst met \xEAtre en, in sommige gevallen, met avoir."],
        ctaTitle: "Stel je oefening op de pass\xE9 compos\xE9 samen",
        ctaText: "De pass\xE9 compos\xE9 is al geselecteerd. Kies werkwoorden om de vorming, de hulpwerkwoorden en de overeenkomst te oefenen.",
        ctaLabel: "Start een oefening op de pass\xE9 compos\xE9"
      }
    })
  }
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "falc-learning" }, _attrs))} data-v-1d4bdfc7><header class="falc-learning__hero" data-v-1d4bdfc7><h1 data-v-1d4bdfc7>${ssrInterpolate(unref(copy).title)}</h1></header><section class="falc-learning__section" aria-labelledby="falc-groups-title" data-v-1d4bdfc7><header data-v-1d4bdfc7><h2 id="falc-groups-title" data-v-1d4bdfc7>${ssrInterpolate(unref(copy).groupsTitle)}</h2><p data-v-1d4bdfc7>${ssrInterpolate(unref(copy).groupsIntro)}</p></header><div class="falc-learning__groups" data-v-1d4bdfc7><!--[-->`);
      ssrRenderList(unref(copy).groups, (group) => {
        _push(`<article class="${ssrRenderClass({ "is-easy": group.easy })}" data-v-1d4bdfc7><h3 data-v-1d4bdfc7>${ssrInterpolate(group.title)}</h3><p data-v-1d4bdfc7>${ssrInterpolate(group.text)}</p><strong data-v-1d4bdfc7>${ssrInterpolate(group.example)}</strong></article>`);
      });
      _push(`<!--]--></div></section><section class="falc-learning__section" aria-labelledby="falc-tenses-title" data-v-1d4bdfc7><header data-v-1d4bdfc7><h2 id="falc-tenses-title" data-v-1d4bdfc7>${ssrInterpolate(unref(copy).tensesTitle)}</h2><p data-v-1d4bdfc7>${ssrInterpolate(unref(copy).tensesIntro)}</p></header><div class="falc-learning__tenses" data-v-1d4bdfc7><!--[-->`);
      ssrRenderList(unref(copy).tenses, (tense, index) => {
        _push(`<article data-v-1d4bdfc7><span aria-hidden="true" data-v-1d4bdfc7>${ssrInterpolate(index + 1)}</span><div data-v-1d4bdfc7><h3 data-v-1d4bdfc7>${ssrInterpolate(tense.title)}</h3><p data-v-1d4bdfc7>${ssrInterpolate(tense.use)}</p><p data-v-1d4bdfc7>${ssrInterpolate(tense.rule)}</p><strong data-v-1d4bdfc7>${ssrInterpolate(tense.example)}</strong></div></article>`);
      });
      _push(`<!--]--></div></section><section class="falc-learning__practice" aria-labelledby="falc-practice-title" data-v-1d4bdfc7><div data-v-1d4bdfc7><h2 id="falc-practice-title" data-v-1d4bdfc7>${ssrInterpolate(unref(copy).practiceTitle)}</h2><p data-v-1d4bdfc7>${ssrInterpolate(unref(copy).practiceText)}</p></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-1d4bdfc7"]]), { __name: "LearningFalcLearningPage" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "learning-page" }, _attrs))} data-v-18e1a3bd>`);
      if (unref(falcMode)) {
        _push(ssrRenderComponent(_component_LearningFalcLearningPage, null, null, _parent));
      } else {
        _push(`<!--[--><header class="learning-hero" data-v-18e1a3bd><p class="learning-eyebrow" data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Les règles essentielles"))}</p><h1 data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Apprendre la conjugaison française"))}</h1></header><nav class="learning-summary"${ssrRenderAttr("aria-label", unref(ui)("Sommaire des règles"))} data-v-18e1a3bd><!--[-->`);
        ssrRenderList(unref(sections), (section) => {
          _push(`<button type="button" data-v-18e1a3bd><span data-v-18e1a3bd>${ssrInterpolate(section.number)}</span><strong data-v-18e1a3bd>${ssrInterpolate(section.title)}</strong><small data-v-18e1a3bd>${ssrInterpolate(section.description)}</small></button>`);
        });
        _push(`<!--]--></nav><main class="learning-content" data-v-18e1a3bd><section id="modes" class="rule-section" data-v-18e1a3bd><header data-v-18e1a3bd><span data-v-18e1a3bd>01</span><div data-v-18e1a3bd><p class="learning-eyebrow" data-v-18e1a3bd>${ssrInterpolate(unref(modeExplorerCopy).eyebrow)}</p><h2 data-v-18e1a3bd>${ssrInterpolate(unref(modeExplorerCopy).title)}</h2><p class="mode-explorer-intro" data-v-18e1a3bd>${ssrInterpolate(unref(modeExplorerCopy).intro)}</p></div></header><div class="mode-selector" role="tablist"${ssrRenderAttr("aria-label", unref(modeExplorerCopy).tabsLabel)} data-v-18e1a3bd><!--[-->`);
        ssrRenderList(unref(learningModes), (mode) => {
          _push(`<button${ssrRenderAttr("id", `mode-tab-${mode.slug}`)} type="button" role="tab"${ssrRenderAttr("aria-controls", `mode-panel-${mode.slug}`)}${ssrRenderAttr("aria-selected", unref(selectedLearningMode) === mode.slug)}${ssrRenderAttr("tabindex", unref(selectedLearningMode) === mode.slug ? 0 : -1)} class="${ssrRenderClass({ "is-active": unref(selectedLearningMode) === mode.slug })}" data-v-18e1a3bd><strong data-v-18e1a3bd>${ssrInterpolate(mode.modeName)}</strong></button>`);
        });
        _push(`<!--]--></div><!--[-->`);
        ssrRenderList(unref(learningModes), (mode) => {
          _push(`<div${ssrRenderAttr("id", `mode-panel-${mode.slug}`)} class="mode-explorer-panel" role="tabpanel"${ssrRenderAttr("aria-labelledby", `mode-tab-${mode.slug}`)} style="${ssrRenderStyle(unref(selectedLearningMode) === mode.slug ? null : { display: "none" })}" data-v-18e1a3bd><div class="mode-explorer-purpose" data-v-18e1a3bd><p data-v-18e1a3bd>${ssrInterpolate(mode.eyebrow)}</p><h3 data-v-18e1a3bd>${ssrInterpolate(mode.purposeTitle)}</h3><p data-v-18e1a3bd>${ssrInterpolate(mode.purpose)}</p></div><div class="mode-explorer-details" data-v-18e1a3bd><section data-v-18e1a3bd><h4 data-v-18e1a3bd>${ssrInterpolate(mode.examplesTitle)}</h4><ul data-v-18e1a3bd><!--[-->`);
          ssrRenderList(mode.examples, (example) => {
            _push(`<li data-v-18e1a3bd>${ssrInterpolate(example)}</li>`);
          });
          _push(`<!--]--></ul></section><section data-v-18e1a3bd><h4 data-v-18e1a3bd>${ssrInterpolate(mode.watchTitle)}</h4><ul data-v-18e1a3bd><!--[-->`);
          ssrRenderList(mode.watchItems, (item) => {
            _push(`<li data-v-18e1a3bd>${ssrInterpolate(item)}</li>`);
          });
          _push(`<!--]--></ul></section></div><section class="mode-explorer-tenses"${ssrRenderAttr("aria-labelledby", `mode-panel-${mode.slug}-tenses`)} data-v-18e1a3bd><header data-v-18e1a3bd><h4${ssrRenderAttr("id", `mode-panel-${mode.slug}-tenses`)} data-v-18e1a3bd>${ssrInterpolate(mode.tensesTitle)}</h4><p data-v-18e1a3bd>${ssrInterpolate(unref(modeExplorerCopy).tenseHelp)}</p></header><nav${ssrRenderAttr("aria-label", mode.tensesTitle)} data-v-18e1a3bd><!--[-->`);
          ssrRenderList(mode.tenses, (tense) => {
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<strong data-v-18e1a3bd${_scopeId}>${ssrInterpolate(tense.label)}</strong><span aria-hidden="true" data-v-18e1a3bd${_scopeId}>→</span>`);
                } else {
                  return [
          ...
          _push(`<!--]--></nav></section><div class="mode-explorer-actions" data-v-18e1a3bd><p data-v-18e1a3bd>${ssrInterpolate(mode.ctaText)}</p>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: { path: unref(localePath)("/exercices-de-conjugaison"), query: { mode: mode.slug } }
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(mode.ctaLabel)} <span aria-hidden="true" data-v-18e1a3bd${_scopeId}>→</span>`);
              } else {
                return [
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span data-v-18e1a3bd${_scopeId}>S’entraîner à reconnaître les modes et les temps</span><span aria-hidden="true" data-v-18e1a3bd${_scopeId}>→</span>`);
            } else {
              return [
        ...
        _push(`</section><section id="bases" class="rule-section" data-v-18e1a3bd><header data-v-18e1a3bd><span data-v-18e1a3bd>02</span><div data-v-18e1a3bd><p class="learning-eyebrow" data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Les fondations"))}</p><h2 data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Comprendre le verbe"))}</h2></div></header><div class="rule-grid rule-grid--three" data-v-18e1a3bd><article data-v-18e1a3bd><h3 data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Radical + terminaison"))}</h3><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Une forme conjuguée associe généralement un radical, qui porte le sens, et une terminaison, qui indique la personne, le mode et le temps."))}</p><p class="rule-example" data-v-18e1a3bd><strong data-v-18e1a3bd>nous chantions</strong><span data-v-18e1a3bd>chant- + -ions</span></p></article><article data-v-18e1a3bd><h3 data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Les trois groupes"))}</h3><ul data-v-18e1a3bd><li data-v-18e1a3bd><strong data-v-18e1a3bd>${ssrInterpolate(unref(ui)("1er groupe :"))}</strong> ${ssrInterpolate(unref(ui)("verbes en -er, sauf aller."))}</li><li data-v-18e1a3bd><strong data-v-18e1a3bd>${ssrInterpolate(unref(ui)("2e groupe :"))}</strong> ${ssrInterpolate(unref(ui)("verbes en -ir faisant -issons."))}</li><li data-v-18e1a3bd><strong data-v-18e1a3bd>${ssrInterpolate(unref(ui)("3e groupe :"))}</strong> ${ssrInterpolate(unref(ui)("tous les autres verbes, souvent irréguliers."))}</li></ul></article><article data-v-18e1a3bd><h3 data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Être et avoir"))}</h3><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Ces deux verbes ont leurs propres conjugaisons et servent aussi d’auxiliaires pour former les temps composés."))}</p><p class="rule-example" data-v-18e1a3bd><strong data-v-18e1a3bd>elle a fini</strong><span data-v-18e1a3bd>${ssrInterpolate(unref(ui)("auxiliaire + participe passé"))}</span></p></article></div></section><section id="accords" class="rule-section" data-v-18e1a3bd><header data-v-18e1a3bd><span data-v-18e1a3bd>03</span><div data-v-18e1a3bd><p class="learning-eyebrow" data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Les correspondances"))}</p><h2 data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Réussir les accords"))}</h2></div></header><div class="agreement-flow" data-v-18e1a3bd><article data-v-18e1a3bd><span data-v-18e1a3bd>1</span><div data-v-18e1a3bd><h3 data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Trouver le sujet"))}</h3><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Le verbe s’accorde en personne et en nombre avec son sujet, même lorsque celui-ci est éloigné."))}</p><em data-v-18e1a3bd>Les élèves de cette classe réussissent.</em></div></article><article data-v-18e1a3bd><span data-v-18e1a3bd>2</span><div data-v-18e1a3bd><h3 data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Identifier l’auxiliaire"))}</h3><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Avec être, le participe passé s’accorde généralement avec le sujet."))}</p><em data-v-18e1a3bd>Elles sont arrivées.</em></div></article><article data-v-18e1a3bd><span data-v-18e1a3bd>3</span><div data-v-18e1a3bd><h3 data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Repérer le COD avec avoir"))}</h3><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Avec avoir, le participe passé s’accorde avec le COD seulement si celui-ci est placé avant."))}</p><em data-v-18e1a3bd>Les lettres qu’il a écrites.</em></div></article></div><aside class="rule-note rule-note--warning" data-v-18e1a3bd><strong data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Verbes pronominaux"))}</strong><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Leur accord dépend de la fonction du pronom. Il faut déterminer si celui-ci est COD, COI ou fait partie du verbe."))}</p></aside></section><section id="orthographe" class="rule-section" data-v-18e1a3bd><header data-v-18e1a3bd><span data-v-18e1a3bd>04</span><div data-v-18e1a3bd><p class="learning-eyebrow" data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Les pièges fréquents"))}</p><h2 data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Préserver le son et l’orthographe"))}</h2></div></header><div class="trap-grid" data-v-18e1a3bd><article data-v-18e1a3bd><h3 data-v-18e1a3bd>-ger et -cer</h3><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("On ajoute parfois un e après g ou une cédille pour conserver le son."))}</p><em data-v-18e1a3bd>nous mangeons · nous plaçons</em></article><article data-v-18e1a3bd><h3 data-v-18e1a3bd>-yer</h3><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Le y peut devenir i devant un e muet. Pour certains verbes, les deux graphies sont admises."))}</p><em data-v-18e1a3bd>j’emploie · nous employons</em></article><article data-v-18e1a3bd><h3 data-v-18e1a3bd>e / è</h3><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Certains verbes changent l’accent lorsque la syllabe suivante contient un e muet."))}</p><em data-v-18e1a3bd>je lève · nous levons</em></article><article data-v-18e1a3bd><h3 data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Consonne doublée"))}</h3><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Certains verbes en -eler et -eter doublent la consonne ; d’autres prennent un accent grave."))}</p><em data-v-18e1a3bd>j’appelle · j’achète</em></article><article data-v-18e1a3bd><h3 data-v-18e1a3bd>-é ou -er ?</h3><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Remplace le verbe par « vendre » : si « vendu » convient, écris le participe passé ; si « vendre » convient, écris l’infinitif."))}</p><em data-v-18e1a3bd>j’ai mangé · je vais manger</em></article><article data-v-18e1a3bd><h3 data-v-18e1a3bd>-rai ou -rais ?</h3><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Le futur exprime ce qui arrivera ; le conditionnel dépend d’une condition ou atténue une demande."))}</p><em data-v-18e1a3bd>je viendrai · je viendrais si…</em></article></div></section><section class="learning-journeys" aria-labelledby="journeys-title" data-v-18e1a3bd><header data-v-18e1a3bd><p class="learning-eyebrow" data-v-18e1a3bd>${ssrInterpolate(unref(ui)("À toi de jouer"))}</p><h2 id="journeys-title" data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Passe de la règle à la pratique"))}</h2></header><div data-v-18e1a3bd><!--[-->`);
        ssrRenderList(unref(exerciseJourneys), (journey) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span data-v-18e1a3bd${_scopeId}>${ssrInterpolate(journey.eyebrow)}</span><strong data-v-18e1a3bd${_scopeId}>${ssrInterpolate(journey.title)}</strong><small data-v-18e1a3bd${_scopeId}>${ssrInterpolate(journey.description)}</small>`);
              } else {
                return [
        ...
        _push(`<!--]--></div></section><section class="learning-actions" aria-labelledby="continue-title" data-v-18e1a3bd><div data-v-18e1a3bd><p class="learning-eyebrow" data-v-18e1a3bd>${ssrInterpolate(unref(ui)("À toi de jouer"))}</p><h2 id="continue-title" data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Passe de la règle à la pratique"))}</h2><p data-v-18e1a3bd>${ssrInterpolate(unref(ui)("Consulte un modèle complet ou crée un exercice ciblé pour vérifier ce que tu viens d’apprendre."))}</p></div><div data-v-18e1a3bd>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
...
const apprendre = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-18e1a3bd"]]);

export { apprendre as default };
//# sourceMappingURL=apprendre-2EYIPkLg.mjs.map
