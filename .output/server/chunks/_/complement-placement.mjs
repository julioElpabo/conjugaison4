...
function inferAnteposedComplement(value) {
  ...
  const pluralGenders = /* @__PURE__ */ new Map([
    ["des acteurs", "masculin"],
    ["des amis \xE0 d\xEEner", "masculin"],
    ["des arbres", "masculin"],
    ["des bras", "masculin"],
    ["des briques d\u2019un mur", "feminin"],
    ["des cartes", "feminin"],
    ["des c\xE9r\xE9ales", "feminin"],
    ["des chiffres", "masculin"],
    ["des couleurs", "feminin"],
    ["des couleurs sur une toile", "feminin"],
    ["des connaissances", "feminin"],
    ["des \xE9l\xE9ments", "masculin"],
    ["des enfants \xE0 la campagne", "masculin"],
    ["des enfants \xE0 l\u2019\xE9cole", "masculin"],
    ["des fleurs", "feminin"],
    ["des fleurs dans un vase", "feminin"],
    ["des id\xE9es", "feminin"],
    ["des livres d\u2019une biblioth\xE8que", "masculin"],
    ["des marchandises dans un entrep\xF4t", "feminin"],
    ["des mat\xE9riaux", "masculin"],
    ["des meubles anciens", "masculin"],
    ["des noix", "feminin"],
    ["des pi\xE8ces", "feminin"],
    ["des pi\xE8ces de monnaie", "feminin"],
    ["des pieds", "masculin"],
    ["des poires", "feminin"],
    ["des secours", "masculin"],
    ["des spectateurs dans une salle", "masculin"],
    ["des vaches", "feminin"],
    ["des verres", "masculin"],
