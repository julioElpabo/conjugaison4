...
import { w as withDutchVariants, ah as localeLanguageTag } from '../nitro/nitro.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const copy = computed(() => withDutchVariants({
      ...
      nl: {
        eyebrow: "Frans als vreemde taal",
        title: "Gratis oefeningen op maat voor Franse vervoeging voor anderstaligen",
        intro: "Oefen nuttige Franse werkwoorden om dagelijkse situaties te begrijpen, te spreken en te schrijven.",
        whyTitle: "Leer Franse werkwoorden vervoegen als anderstalige",
        whyText: "Deze oefeningen zijn bedoeld voor anderstalige leerlingen Frans en voor leerkrachten die interactieve oefeningen zoeken. De stapsgewijze leertrajecten beginnen met veelgebruikte werkwoorden en voegen daarna meer tijden en vormen toe.",
        ...
        howTitle: "Oefeningen voor anderstaligen op maat van jouw doel",
        howText: "Kies hieronder een leertraject. Behoud de voorgestelde selectie of pas de werkwoorden, tijden en opties aan om op het juiste niveau te oefenen.",
        listTitle: "Kies een vervoegingsoefening Frans voor anderstaligen",
        start: "Start deze oefening",
        library: "Bekijk alle officiële uitdagingen",
        empty: "Er is momenteel geen oefening voor anderstaligen beschikbaar.",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "fle-page" }, _attrs))} data-v-6990e90e><header class="fle-page__hero" data-v-6990e90e><p data-v-6990e90e>${ssrInterpolate(unref(copy).eyebrow)}</p><h1 data-v-6990e90e>${ssrInterpolate(unref(copy).title)}</h1><span data-v-6990e90e>${ssrInterpolate(unref(copy).intro)}</span></header><section class="fle-page__explanation" data-v-6990e90e><div data-v-6990e90e><h2 data-v-6990e90e>${ssrInterpolate(unref(copy).whyTitle)}</h2><p data-v-6990e90e>${ssrInterpolate(unref(copy).whyText)}</p></div><ul data-v-6990e90e><!--[-->`);
      ssrRenderList(unref(copy).benefits, (benefit) => {
        _push(`<li data-v-6990e90e>${ssrInterpolate(benefit)}</li>`);
      });
      _push(`<!--]--></ul><div data-v-6990e90e><h2 data-v-6990e90e>${ssrInterpolate(unref(copy).howTitle)}</h2><p data-v-6990e90e>${ssrInterpolate(unref(copy).howText)}</p></div></section><section class="fle-page__exercises" data-v-6990e90e><div class="fle-page__heading" data-v-6990e90e><h2 data-v-6990e90e>${ssrInterpolate(unref(copy).listTitle)}</h2>`);
      ...
      if (!unref(exercises).length) {
        _push(`<p class="fle-page__empty" data-v-6990e90e>${ssrInterpolate(unref(copy).empty)}</p>`);
      } else {
        _push(`<div class="fle-page__grid" data-v-6990e90e><!--[-->`);
        ssrRenderList(unref(exercises), (exercise) => {
          _push(`<article data-v-6990e90e><h3 data-v-6990e90e>${ssrInterpolate(exercise.title)}</h3><p data-v-6990e90e>${ssrInterpolate(exercise.description)}</p>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: unref(localePath)(`/defis/${exercise.slug}`)
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(unref(copy).start)} <span aria-hidden="true" data-v-6990e90e${_scopeId}>→</span>`);
              } else {
                return [
...
const conjugaisonFle = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6990e90e"]]);

export { conjugaisonFle as default };
//# sourceMappingURL=conjugaison-fle-C5nA-Ju0.mjs.map
