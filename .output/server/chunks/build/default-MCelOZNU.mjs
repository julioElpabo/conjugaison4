...
import { u as useSiteAnalytics, a as useAnalyticsConsent } from './useSiteAnalytics-CWvs4oMj.mjs';
import { g as guidedTourCopy } from '../_/guided-tour.mjs';
import { u as useColorTheme, l as learnerSpaceCopy } from './useColorTheme-C6CCVHIc.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  __name: "AdminDailySessionsBadge",
  __ssrInlineRender: true,
  setup(__props) {
    const { isAuthenticated, handleUnauthorized } = useAdminAuth();
    const { localePath } = useLanguagePreferences();
    const count = ref(null);
    const source = ref(null);
    const loading = ref(false);
    let refreshTimer;
    const badgeLabel = computed(() => count.value === null ? "Chargement du nombre de visiteurs distincts depuis minuit" : source.value === "ga4" ? `${count.value.toLocaleString("fr-CH")} visiteur${count.value === 1 ? "" : "s"} distinct${count.value === 1 ? "" : "s"} depuis minuit selon GA4` : `${count.value.toLocaleString("fr-CH")} visiteur${count.value === 1 ? "" : "s"} estimé${count.value === 1 ? "" : "s"} depuis minuit selon la mesure locale`);
    async function refreshCount() {
      if (!isAuthenticated.value || loading.value || (void 0).visibilityState !== "visible") return;
      loading.value = true;
      try {
        const snapshot = await $fetch("/api/admin/daily-visitors", {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isAuthenticated)) {
        _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
          class: ["admin-daily-sessions-badge", { "is-loading": unref(loading) && unref(count) === null }],
          to: unref(localePath)("/admin/charts"),
          "aria-label": unref(badgeLabel),
          title: unref(badgeLabel),
          "aria-live": "polite"
        }, _attrs), {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<strong data-v-349881f5${_scopeId}>${ssrInterpolate(unref(count) === null ? "…" : unref(count).toLocaleString("fr-CH"))}</strong><span data-v-349881f5${_scopeId}>${ssrInterpolate(unref(source) === "local" ? "visiteurs estimés" : "visiteurs aujourd’hui")}</span>`);
            } else {
              return [
                createVNode("strong", null, toDisplayString(unref(count) === null ? "…" : unref(count).toLocaleString("fr-CH")), 1),
                createVNode("span", null, toDisplayString(unref(source) === "local" ? "visiteurs estimés" : "visiteurs aujourd’hui"), 1)
              ];
            }
          }),
          _: 1
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/admin/AdminDailySessionsBadge.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-349881f5"]]), { __name: "AdminDailySessionsBadge" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-07f7732c><section class="contact-dialog__card" data-v-07f7732c><button class="contact-dialog__close" type="button"${ssrRenderAttr("aria-label", unref(copy).close)}${ssrRenderAttr("title", unref(copy).close)}${ssrIncludeBooleanAttr(unref(submitting)) ? " disabled" : ""} data-v-07f7732c><span aria-hidden="true" data-v-07f7732c>×</span></button>`);
      if (unref(sent)) {
        _push(`<div class="contact-dialog__success" role="status" data-v-07f7732c><span class="contact-dialog__success-icon" aria-hidden="true" data-v-07f7732c>✓</span><h2 id="contact-success-title" data-v-07f7732c>${ssrInterpolate(unref(copy).successTitle)}</h2><p data-v-07f7732c>${ssrInterpolate(unref(copy).success)}</p><button class="contact-dialog__primary" type="button" data-v-07f7732c>${ssrInterpolate(unref(copy).close)}</button></div>`);
      } else {
        _push(`<!--[--><header class="contact-dialog__header" data-v-07f7732c><span class="contact-dialog__eyebrow" data-v-07f7732c>CONTACT</span><h2 id="contact-title" data-v-07f7732c>${ssrInterpolate(unref(copy).title)}</h2><p data-v-07f7732c>${ssrInterpolate(unref(copy).intro)}</p></header><form class="contact-dialog__form" data-v-07f7732c><label data-v-07f7732c><span data-v-07f7732c>${ssrInterpolate(unref(copy).email)}</span><input${ssrRenderAttr("value", unref(email))} type="email" maxlength="254" autocomplete="email"${ssrRenderAttr("placeholder", unref(copy).emailPlaceholder)} required data-v-07f7732c></label><label data-v-07f7732c><span data-v-07f7732c>${ssrInterpolate(unref(copy).subject)}</span><input${ssrRenderAttr("value", unref(subject))} type="text"${ssrRenderAttr("minlength", unref(constraints).subjectMinLength)}${ssrRenderAttr("maxlength", unref(constraints).subjectMaxLength)}${ssrRenderAttr("placeholder", unref(copy).subjectPlaceholder)} required data-v-07f7732c></label><label data-v-07f7732c><span data-v-07f7732c>${ssrInterpolate(unref(copy).message)}</span><textarea${ssrRenderAttr("minlength", unref(constraints).messageMinLength)}${ssrRenderAttr("maxlength", unref(constraints).messageMaxLength)} rows="6"${ssrRenderAttr("placeholder", unref(copy).messagePlaceholder)} required data-v-07f7732c>${ssrInterpolate(unref(message))}</textarea><small data-v-07f7732c>${ssrInterpolate(unref(copy).characters.replace("{count}", String(unref(constraints).messageMinLength)))}</small></label><label class="contact-dialog__honeypot" aria-hidden="true" data-v-07f7732c> Site internet <input${ssrRenderAttr("value", unref(website))} name="website" type="text" tabindex="-1" autocomplete="off" data-v-07f7732c></label>`);
        if (unref(turnstileSiteKey)) {
          _push(`<div class="cf-turnstile" data-v-07f7732c></div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(errorMessage)) {
          _push(`<p class="contact-dialog__error" role="alert" data-v-07f7732c>${ssrInterpolate(unref(errorMessage))}</p>`);
        } else if (!unref(constraints).enabled) {
          _push(`<p class="contact-dialog__error" role="status" data-v-07f7732c>${ssrInterpolate(unref(copy).unavailable)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<p class="contact-dialog__privacy" data-v-07f7732c>${ssrInterpolate(unref(copy).privacy)}</p><div class="contact-dialog__actions" data-v-07f7732c><button type="button"${ssrIncludeBooleanAttr(unref(submitting)) ? " disabled" : ""} data-v-07f7732c>${ssrInterpolate(unref(copy).cancel)}</button><button class="contact-dialog__primary" type="submit"${ssrIncludeBooleanAttr(unref(submitting) || !unref(constraints).enabled) ? " disabled" : ""} data-v-07f7732c>${ssrInterpolate(unref(submitting) ? unref(copy).sending : unref(copy).send)}</button></div></form><!--]-->`);
      }
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-07f7732c"]]), { __name: "ContactDialog" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "AnalyticsConsentDialog",
  __ssrInlineRender: true,
  setup(__props) {
    const { interfaceLocale } = useLanguagePreferences();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(visible)) {
          _push2(`<div class="analytics-consent-backdrop" data-v-c41d58c8><section class="analytics-consent-dialog" role="dialog" aria-modal="true" aria-labelledby="analytics-consent-title" aria-describedby="analytics-consent-description" data-v-c41d58c8><div class="analytics-consent-languages" role="group" aria-label="Language · Langue" data-v-c41d58c8><!--[-->`);
          ssrRenderList(languages, (language) => {
            _push2(`<button type="button" class="${ssrRenderClass({ "is-active": unref(interfaceLocale) === language.locale })}"${ssrRenderAttr("aria-label", language.label)}${ssrRenderAttr("aria-pressed", unref(interfaceLocale) === language.locale)}${ssrRenderAttr("title", language.label)} data-v-c41d58c8><span aria-hidden="true" data-v-c41d58c8>${ssrInterpolate(language.flag)}</span></button>`);
          });
          _push2(`<!--]--></div><h2 id="analytics-consent-title" data-v-c41d58c8>${ssrInterpolate(unref(text).title)}</h2><p id="analytics-consent-description" data-v-c41d58c8>${ssrInterpolate(unref(text).body)}</p><div class="analytics-consent-actions" data-v-c41d58c8><button type="button" class="analytics-consent-decline" data-v-c41d58c8>${ssrInterpolate(unref(text).decline)}</button><button type="button" class="analytics-consent-accept" data-v-c41d58c8>${ssrInterpolate(unref(text).accept)}</button></div></section></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/AnalyticsConsentDialog.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-c41d58c8"]]), { __name: "AnalyticsConsentDialog" });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const publicChallengesLabel = computed(() => withDutchVariants({
      fr: "Défis officiels",
      de: "Offizielle Aufgaben",
      en: "Official challenges",
      it: "Sfide ufficiali",
      es: "Retos oficiales",
      nl: "Officiële uitdagingen"
    ...
    ref(null);
    const mountainSvgWithExtendedBottoms = mountainSvgSource.replace("169.33 81.75v40.02H502.29l6.53-98.77Z", "169.33 81.75v340.02H502.29l6.53-398.77Z").replace("51.34 41.29 36 112.03H793.29z", "51.34 41.29 36 112.03v300H793.29z").replace("-98.67 19.47v85.36h781.33z", "-98.67 19.47v385.36h781.33z").replace("22 17.5l44 47v194h-801z", "22 17.5l44 47v494h-801z").replace("-35.33 33.56v89.1h632z", "-35.33 33.56v389.1h632z").replace("l26.67 13h36v152h-777.8v-31.33Z", "l26.67 13h36v452h-777.8v-31.33Z").replace("l-4.05-5.5-9.55-9.71v114.51h337.13Z", "l-4.05-5.5-9.55-9.71v414.51h337.13Z").replace("h497.33l2.92-65.75Z", "v300h497.33l2.92-365.75Z");
    const mountainSvg = mountainSvgWithExtendedBottoms.replace("<defs>", `<defs>
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      const _component_AdminDailySessionsBadge = __nuxt_component_1;
      const _component_ContactDialog = __nuxt_component_2;
      const _component_AnalyticsConsentDialog = __nuxt_component_3;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["site-shell", { "site-shell--embedded": unref(embeddedConsultation), "site-shell--falc": unref(falcMode), "site-shell--home": unref(isActualHomePage) }]
      ...
      if (!unref(embeddedConsultation)) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<strong${_scopeId}>TATITOTU</strong>`);
              if (unref(isActualHomePage)) {
                _push2(`<span${_scopeId}>${ssrInterpolate(unref(ui)("Défis de conjugaison"))}</span>`);
              } else {
                _push2(`<!---->`);
              }
            } else {
              return [
                ...
                unref(isActualHomePage) ? (openBlock(), createBlock("span", { key: 0 }, toDisplayString(unref(ui)("Défis de conjugaison")), 1)) : createCommentVNode("", true)
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(ssrRenderComponent(_component_AdminDailySessionsBadge, null, null, _parent));
        if (!unref(isActualHomePage) && !unref(falcMode) && !unref(isPhoneViewport)) {
        ...
        _push(`<div class="display-mode-switches"><button class="${ssrRenderClass([{ "is-dark": unref(isDark) }, "theme-switch"])}" type="button" role="switch"${ssrRenderAttr("aria-checked", unref(isDark))}${ssrRenderAttr("aria-label", unref(themeSwitchTitle))}${ssrRenderAttr("title", unref(themeSwitchTitle))}><span class="theme-switch__icon theme-switch__icon--moon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M20.1 15.4A8.7 8.7 0 0 1 8.6 3.9 8.8 8.8 0 1 0 20.1 15.4Z"></path></svg></span><span class="theme-switch__icon theme-switch__icon--sun" aria-hidden="true"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3.5"></circle><path d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4"></path></svg></span></button><button data-tour="falc-mode" class="${ssrRenderClass([{ "is-active": unref(falcMode) }, "falc-switch"])}" type="button" role="switch"${ssrRenderAttr("aria-checked", unref(falcMode))}${ssrRenderAttr("aria-label", unref(falcSwitchTitle))}${ssrRenderAttr("title", unref(falcSwitchTitle))}>${ssrInterpolate(unref(ui)("FALC"))}</button><div class="${ssrRenderClass([{ "is-open": unref(headerLanguageMenuOpen) }, "header-language-menu"])}"><button class="header-language-menu__trigger" type="button"${ssrRenderAttr("aria-label", unref(ui)("Langue de l’interface"))}${ssrRenderAttr("aria-expanded", unref(headerLanguageMenuOpen))}${ssrRenderAttr("title", unref(activeLanguageOption).label)}><span aria-hidden="true">${ssrInterpolate(unref(activeLanguageOption).flag)}</span></button><div class="language-selector header-language-menu__panel" role="group"${ssrRenderAttr("aria-label", unref(ui)("Langue de l’interface"))}${ssrRenderAttr("aria-hidden", !unref(headerLanguageMenuOpen))}><!--[-->`);
        ...
        if (unref(learner)) {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            class: { "is-active": unref(activeLearnerTab) === "saved" }
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(unref(learnerCopy).myChallenges)}`);
              } else {
                return [
                  createTextVNode(toDisplayString(unref(learnerCopy).myChallenges), 1)
                ];
              }
            }),
            _: 1
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span aria-hidden="true"${_scopeId}>✦</span> ${ssrInterpolate(unref(learnerCopy).account)}`);
              } else {
                return [
                  createVNode("span", { "aria-hidden": "true" }, "✦"),
                  createTextVNode(" " + toDisplayString(unref(learnerCopy).account), 1)
                ];
              }
            }),
            _: 1
      ...
      _push(`</main>`);
      if (!unref(embeddedConsultation)) {
        _push(`<footer class="site-footer"><p>${ssrInterpolate(unref(ui)("Ce site est gratuit. Toute utilisation commerciale de ce site ou de son contenu est strictement interdite."))}</p><div class="site-footer__links">`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: unref(localePath)("/defis")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(publicChallengesLabel))}`);
            } else {
              return [
                createTextVNode(toDisplayString(unref(publicChallengesLabel)), 1)
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(`<button type="button">${ssrInterpolate(unref(ui)("Contact"))}</button><button type="button">${ssrInterpolate(unref(ui)("Statistiques"))}</button>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(falcConfirmationOpen)) {
          _push2(`<div class="falc-confirmation"><section role="dialog" aria-modal="true" aria-labelledby="falc-confirmation-title" aria-describedby="falc-confirmation-description"><h2 id="falc-confirmation-title">${ssrInterpolate(unref(ui)("Mode FALC"))}</h2><p id="falc-confirmation-description">${ssrInterpolate(unref(ui)("Le mode FALC affiche seulement l’essentiel. Les mots et les étapes sont plus simples."))}</p><div class="falc-confirmation__actions"><button type="button" class="falc-confirmation__cancel">← ${ssrInterpolate(unref(ui)("Pas maintenant"))}</button><button type="button" class="falc-confirmation__confirm">${ssrInterpolate(unref(ui)("Mode FALC"))} →</button></div></section></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
      ...
      if (!unref(isAdminRoute)) {
        _push(ssrRenderComponent(_component_AnalyticsConsentDialog, null, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=default-MCelOZNU.mjs.map
