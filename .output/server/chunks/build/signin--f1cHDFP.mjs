...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "learner-auth-page" }, _attrs))} data-v-e9f8f820>`);
      if (unref(recovery)) {
        _push(`<section class="learner-card learner-recovery" aria-labelledby="recovery-title" data-v-e9f8f820><p class="learner-eyebrow" data-v-e9f8f820>${ssrInterpolate(unref(copy).created)}</p><h1 id="recovery-title" data-v-e9f8f820>${ssrInterpolate(unref(copy).keepCode)}</h1><p data-v-e9f8f820>${ssrInterpolate(unref(copy).recoveryInfo)}</p><dl data-v-e9f8f820><div data-v-e9f8f820><dt data-v-e9f8f820>${ssrInterpolate(unref(copy).username)}</dt><dd data-v-e9f8f820>${ssrInterpolate(unref(recovery).username)}</dd></div><div data-v-e9f8f820><dt data-v-e9f8f820>${ssrInterpolate(unref(copy).recoveryCode)}</dt><dd data-v-e9f8f820><code data-v-e9f8f820>${ssrInterpolate(unref(recovery).recoveryCode)}</code></dd></div></dl><div class="learner-actions" data-v-e9f8f820><button type="button" class="secondary-button" data-v-e9f8f820>${ssrInterpolate(unref(copied) ? unref(copy).codeCopied : unref(copy).copyCode)}</button><button type="button" class="secondary-button" data-v-e9f8f820>${ssrInterpolate(unref(copy).download)}</button>`);
        ...
        _push(`<section class="learner-card" aria-labelledby="learner-auth-title" data-v-e9f8f820><h1 id="learner-auth-title" data-v-e9f8f820>${ssrInterpolate(unref(mode) === "register" ? unref(copy).create : unref(copy).signIn)}</h1><p class="learner-intro" data-v-e9f8f820>${ssrInterpolate(unref(copy).intro)}</p><div class="learner-tabs" role="tablist"${ssrRenderAttr("aria-label", unref(copy).chooseAction)} data-v-e9f8f820><button type="button" role="tab"${ssrRenderAttr("aria-selected", unref(mode) === "login")} data-v-e9f8f820>${ssrInterpolate(unref(copy).signIn)}</button><button type="button" role="tab"${ssrRenderAttr("aria-selected", unref(mode) === "register")} data-v-e9f8f820>${ssrInterpolate(unref(copy).create)}</button></div>`);
        if (unref(errorMessage)) {
          _push(`<p class="learner-error" role="alert" data-v-e9f8f820>${ssrInterpolate(unref(errorMessage))}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(mode) === "register") {
          _push(`<form data-v-e9f8f820><div class="learner-field" data-v-e9f8f820><span data-v-e9f8f820>${ssrInterpolate(unref(copy).proposedUsername)}</span><div class="username-proposal" aria-live="polite" data-v-e9f8f820><strong data-v-e9f8f820>${ssrInterpolate(unref(loadingSuggestion) ? unref(copy).searching : unref(suggestion)?.username || unref(copy).unavailable)}</strong><button type="button"${ssrIncludeBooleanAttr(unref(loadingSuggestion)) ? " disabled" : ""} data-v-e9f8f820>${ssrInterpolate(unref(copy).anotherUsername)}</button></div></div><label class="learner-field" data-v-e9f8f820><span data-v-e9f8f820>${ssrInterpolate(unref(copy).choosePassword)}</span><input${ssrRenderAttr("value", unref(password))} type="password" minlength="10" maxlength="200" autocomplete="new-password" required data-v-e9f8f820><small data-v-e9f8f820>${ssrInterpolate(unref(copy).passwordHint)}</small></label><label class="learner-field" data-v-e9f8f820><span data-v-e9f8f820>${ssrInterpolate(unref(copy).confirmPassword)}</span><input${ssrRenderAttr("value", unref(passwordConfirmation))} type="password" minlength="10" maxlength="200" autocomplete="new-password" required data-v-e9f8f820></label><label class="honeypot" aria-hidden="true" data-v-e9f8f820> Site internet <input${ssrRenderAttr("value", unref(website))} name="website" type="text" tabindex="-1" autocomplete="off" data-v-e9f8f820></label><label class="privacy-check" data-v-e9f8f820><input${ssrIncludeBooleanAttr(Array.isArray(unref(privacyAccepted)) ? ssrLooseContain(unref(privacyAccepted), null) : unref(privacyAccepted)) ? " checked" : ""} type="checkbox" required data-v-e9f8f820><span data-v-e9f8f820>${ssrInterpolate(unref(copy).privacy)}</span></label>`);
          if (unref(turnstileSiteKey)) {
            _push(`<div class="cf-turnstile" data-v-e9f8f820></div>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(turnstileUnavailable)) {
            _push(`<p class="learner-error" role="alert" data-v-e9f8f820> Le contrôle antibot n’a pas pu se charger. Recharge la page ou vérifie que ton navigateur ne le bloque pas. </p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<button class="primary-button is-full" type="submit"${ssrIncludeBooleanAttr(unref(submitting) || unref(loadingSuggestion) || !unref(suggestion)) ? " disabled" : ""} data-v-e9f8f820>${ssrInterpolate(unref(submitting) ? unref(copy).creating : unref(copy).create)}</button></form>`);
        } else {
          _push(`<form data-v-e9f8f820><label class="learner-field" data-v-e9f8f820><span data-v-e9f8f820>${ssrInterpolate(unref(copy).username)}</span><input${ssrRenderAttr("value", unref(loginUsername))} type="text" maxlength="80" autocomplete="username" autocapitalize="none" spellcheck="false" required data-v-e9f8f820></label><label class="learner-field" data-v-e9f8f820><span data-v-e9f8f820>${ssrInterpolate(unref(copy).password)}</span><input${ssrRenderAttr("value", unref(loginPassword))} type="password" maxlength="200" autocomplete="current-password" required data-v-e9f8f820></label><button class="primary-button is-full" type="submit"${ssrIncludeBooleanAttr(unref(submitting)) ? " disabled" : ""} data-v-e9f8f820>${ssrInterpolate(unref(submitting) ? unref(copy).signingIn : unref(copy).signIn)}</button></form>`);
        }
        _push(`</section>`);
      }
      _push(`</div>`);
...
const signin = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e9f8f820"]]);

export { signin as default };
//# sourceMappingURL=signin--f1cHDFP.mjs.map
