...
| 25.07.2026 | Défis « Groupes de verbes » | Les six listes explicites ont été remplacées par des critères dynamiques ; 531 associations figées supprimées ; résultats locaux : 365 verbes du 1er groupe, 33 du 2e et 125 du 3e, dont 37 en `-ir`, 21 en `-oir` et 67 autres | La migration se réapplique automatiquement et sans doublon au démarrage sur Plesk |
