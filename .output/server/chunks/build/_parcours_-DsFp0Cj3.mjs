...
import { a as modeTensePages } from '../_/mode-tense-pages.mjs';
import { g as useRoute, f as useLanguagePreferences, k as createError, u as useHead, m as useSeoMeta } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "exercise-landing" }, _attrs))} data-v-78498c4f><div class="exercise-landing__navigation" data-v-78498c4f>`);
      ...
      _push(`</div><header class="exercise-landing__hero" data-v-78498c4f><p data-v-78498c4f>${ssrInterpolate(unref(page).eyebrow)}</p><h1 data-v-78498c4f>${ssrInterpolate(unref(page).title)}</h1><p data-v-78498c4f>${ssrInterpolate(unref(page).description)}</p>`);
      ...
      _push(`</header><div class="exercise-landing__content" data-v-78498c4f><section class="exercise-landing__rule" data-v-78498c4f><p class="exercise-landing__number" data-v-78498c4f>01</p><div data-v-78498c4f><h2 data-v-78498c4f>${ssrInterpolate(unref(page).ruleTitle)}</h2><p data-v-78498c4f>${ssrInterpolate(unref(page).rule)}</p></div></section><section class="exercise-landing__cards"${ssrRenderAttr("aria-labelledby", `${unref(slug)}-examples`)} data-v-78498c4f><h2${ssrRenderAttr("id", `${unref(slug)}-examples`)} data-v-78498c4f>${ssrInterpolate(unref(page).examplesTitle)}</h2><ul data-v-78498c4f><!--[-->`);
      ssrRenderList(unref(page).examples, (example) => {
        _push(`<li data-v-78498c4f>${ssrInterpolate(example)}</li>`);
      });
      _push(`<!--]--></ul></section><section class="exercise-landing__cards exercise-landing__cards--watch"${ssrRenderAttr("aria-labelledby", `${unref(slug)}-watch`)} data-v-78498c4f><h2${ssrRenderAttr("id", `${unref(slug)}-watch`)} data-v-78498c4f>${ssrInterpolate(unref(page).watchTitle)}</h2><ul data-v-78498c4f><!--[-->`);
      ssrRenderList(unref(page).watchItems, (item) => {
        _push(`<li data-v-78498c4f>${ssrInterpolate(item)}</li>`);
      });
      _push(`<!--]--></ul></section><section class="group-guide"${ssrRenderAttr("aria-labelledby", `${unref(slug)}-groups`)} data-v-78498c4f><header data-v-78498c4f><p class="exercise-landing__number" data-v-78498c4f>02</p><div data-v-78498c4f><h2${ssrRenderAttr("id", `${unref(slug)}-groups`)} data-v-78498c4f>${ssrInterpolate(unref(groupGuide).title)}</h2><p data-v-78498c4f>${ssrInterpolate(unref(groupGuide).intro)}</p></div></header><div class="group-guide__grid" data-v-78498c4f><!--[-->`);
      ssrRenderList(unref(groupGuide).groups, (group) => {
        _push(`<article data-v-78498c4f><header data-v-78498c4f><span data-v-78498c4f>${ssrInterpolate(group.label)}</span><strong data-v-78498c4f>${ssrInterpolate(group.model)}</strong></header><p data-v-78498c4f>${ssrInterpolate(group.explanation)}</p><code data-v-78498c4f>${ssrInterpolate(group.formula)}</code><ul data-v-78498c4f><!--[-->`);
        ssrRenderList(group.forms, (form) => {
          _push(`<li data-v-78498c4f>${ssrInterpolate(form)}</li>`);
        });
        _push(`<!--]--></ul><small data-v-78498c4f>${ssrInterpolate(group.note)}</small></article>`);
      });
      _push(`<!--]--></div><aside data-v-78498c4f><h3 data-v-78498c4f>${ssrInterpolate(unref(groupGuide).specialTitle)}</h3><ul data-v-78498c4f><!--[-->`);
      ssrRenderList(unref(groupGuide).specialCases, (item) => {
        _push(`<li data-v-78498c4f>${ssrInterpolate(item)}</li>`);
      });
      _push(`<!--]--></ul></aside></section><section class="exercise-landing__cta" data-v-78498c4f><div data-v-78498c4f><p data-v-78498c4f>${ssrInterpolate(unref(page).eyebrow)}</p><h2 data-v-78498c4f>${ssrInterpolate(unref(page).ctaTitle)}</h2><span data-v-78498c4f>${ssrInterpolate(unref(page).ctaText)}</span></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: unref(exerciseUrl) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(page).ctaLabel)} <span aria-hidden="true" data-v-78498c4f${_scopeId}>→</span>`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(page).ctaLabel) + " ", 1),
...
const _parcours_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-78498c4f"]]);

export { _parcours_ as default };
//# sourceMappingURL=_parcours_-DsFp0Cj3.mjs.map
