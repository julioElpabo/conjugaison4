...
import { g as useRoute, f as useLanguagePreferences, n as navigateTo, k as createError, u as useHead, o as useSeoMeta } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "tense-exercise-page" }, _attrs))} data-v-ace40dbf><header class="tense-exercise-page__hero" data-v-ace40dbf><p data-v-ace40dbf>Exercices de conjugaison · ${ssrInterpolate(unref(page).mode)}</p><h1 data-v-ace40dbf>${ssrInterpolate(unref(page).h1)}</h1><p data-v-ace40dbf>${ssrInterpolate(unref(page).intro)}</p>`);
      ...
      _push(`</header><section class="tense-exercise-page__practice" aria-labelledby="practice-title" data-v-ace40dbf><div data-v-ace40dbf><p data-v-ace40dbf>Temps présélectionné</p><h2 id="practice-title" data-v-ace40dbf>Créez votre exercice ${ssrInterpolate(practiceLabel)}</h2><span data-v-ace40dbf>Choisissez les verbes, le nombre de questions et le format de votre entraînement.</span></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: unref(exerciseUrl) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Commencer les exercices ${ssrInterpolate(practiceLabel)} <span aria-hidden="true" data-v-ace40dbf${_scopeId}>→</span>`);
          } else {
            return [
              createTextVNode("Commencer les exercices " + toDisplayString(practiceLabel) + " "),
      ...
      _push(`</section><section class="tense-exercise-page__explanation" data-v-ace40dbf><h2 data-v-ace40dbf>À quoi sert ${ssrInterpolate(definiteLabel)} ?</h2><p data-v-ace40dbf>${ssrInterpolate(unref(page).explanation)}</p></section><nav class="tense-exercise-page__related" aria-labelledby="related-title" data-v-ace40dbf><h2 id="related-title" data-v-ace40dbf>Autres exercices de conjugaison</h2><ul data-v-ace40dbf><!--[-->`);
      ssrRenderList(unref(relatedPages), (related) => {
        _push(`<li data-v-ace40dbf>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span aria-hidden="true" data-v-ace40dbf${_scopeId}>←</span> Retour aux exercices de conjugaison`);
          } else {
            return [
              createVNode("span", { "aria-hidden": "true" }, "←"),
...
const _parcours_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ace40dbf"]]);

export { _parcours_ as default };
//# sourceMappingURL=_parcours_-B0VhcsMH.mjs.map
