...
export const challengePresetDefinitions = [
  ...
  { id: 'CIF2', label: 'CIF 2', description: 'Deuxième parcours CIF historique.', group: 'cif', criteria: [{ field: 'parcoursCif', operator: 'includes', value: 'CIF2' }], tenseIds: [1, nearFutureTenseId], questionCount: 20 },
  { id: 'CIF3', label: 'CIF 3', description: 'Troisième parcours CIF historique.', group: 'cif', criteria: [{ field: 'parcoursCif', operator: 'includes', value: 'CIF3' }], tenseIds: [1, 2, 3, 4, nearFutureTenseId], questionCount: 20 },
  { id: 'CIF4', label: 'CIF 4', description: 'Quatrième parcours CIF historique.', group: 'cif', criteria: [{ field: 'parcoursCif', operator: 'includes', value: 'CIF4' }], tenseIds: [...coreTenses, nearFutureTenseId], questionCount: 20 },
