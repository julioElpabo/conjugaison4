...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    let refreshTimer;
    const badgeLabel = computed(() => count.value === null ? "Chargement du nombre de sessions depuis minuit" : `${count.value.toLocaleString("fr-CH")} session${count.value === 1 ? "" : "s"} ${source.value === "ga4" ? "GA4 " : "locales "}depuis minuit`);
    async function refreshCount() {
      if (!isAuthenticated.value || loading.value || (void 0).visibilityState !== "visible") return;
      loading.value = true;
      try {
        const snapshot = await $fetch("/api/admin/daily-sessions", {
      ...
      if (unref(isAuthenticated)) {
        _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<strong data-v-cd1031fb${_scopeId}>${ssrInterpolate(unref(count) === null ? "…" : unref(count).toLocaleString("fr-CH"))}</strong><span data-v-cd1031fb${_scopeId}>${ssrInterpolate(unref(source) === "local" ? "sessions locales" : "sessions aujourd’hui")}</span>`);
            } else {
              return [
                createVNode("strong", null, toDisplayString(unref(count) === null ? "…" : unref(count).toLocaleString("fr-CH")), 1),
                createVNode("span", null, toDisplayString(unref(source) === "local" ? "sessions locales" : "sessions aujourd’hui"), 1)
              ];
            }
          }),
          _: 1
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-cd1031fb"]]), { __name: "AdminDailySessionsBadge" });
...
//# sourceMappingURL=default-GZSFTzP6.mjs.map
