...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-349881f5"]]), { __name: "AdminDailySessionsBadge" });
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-4472aa63"]]), { __name: "ContactDialog" });
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(embeddedConsultation)) {
        ...
        _push(`<button type="button">${ssrInterpolate(unref(ui)("Contact"))}</button>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
...
//# sourceMappingURL=default-THKaBvbB.mjs.map
