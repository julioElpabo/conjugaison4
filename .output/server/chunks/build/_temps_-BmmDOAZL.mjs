...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const copy = computed(() => withDutchVariants({
      ...
      nl: { title: `${tense.label} — ${mode.value.modeName}`, description: `Begrijp aan de hand van concrete situaties waarom je ${tense.label} gebruikt binnen de ${mode.value.modeName}.`, endings: "Uitgangen", uses: `Wanneer gebruik je de ${tense.label} ${mode.value.modeName}?`, examples: "Voorbeeldzinnen: waarom gebruik je deze tijd?", examplesIntro: "Elke zin toont een gebruik van de tijd. De context geeft aanwijzingen en de uitleg verklaart de keuze.", example: "Voorbeeldzin", context: "Situatie en aanwijzingen", reason: "Waarom deze tijd wordt gebruikt", back: "Terug naar Leren", practise: `Oefen ${tense.label}` }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "tense-page" }, _attrs))} data-v-b1e7f07d>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span aria-hidden="true" data-v-b1e7f07d${_scopeId}>←</span> ${ssrInterpolate(unref(copy).back)}`);
          } else {
            return [
      ...
      _push(`<header class="tense-page__hero" data-v-b1e7f07d><p data-v-b1e7f07d>${ssrInterpolate(unref(mode).modeName)} · ${ssrInterpolate(unref(tense).label)}</p><h1 data-v-b1e7f07d>${ssrInterpolate(unref(copy).title)}</h1></header><div class="tense-page__content" data-v-b1e7f07d><section class="tense-page__panel tense-page__panel--uses" data-v-b1e7f07d><h2 data-v-b1e7f07d>${ssrInterpolate(unref(copy).uses)}</h2><ul data-v-b1e7f07d><!--[-->`);
      ssrRenderList(unref(pedagogy).uses, (use) => {
        _push(`<li data-v-b1e7f07d>${ssrInterpolate(use)}</li>`);
      });
      _push(`<!--]--></ul></section><section class="tense-page__endings" data-v-b1e7f07d><header data-v-b1e7f07d><h2 data-v-b1e7f07d>${ssrInterpolate(unref(copy).endings)}</h2><p data-v-b1e7f07d>${ssrInterpolate(unref(endingsGuide).intro)}</p></header>`);
      if (unref(endingPronouns).length && unref(endingTableGroups).length) {
        _push(`<div class="tense-page__table-wrap" data-v-b1e7f07d><table data-v-b1e7f07d><thead data-v-b1e7f07d><tr data-v-b1e7f07d><th scope="col" data-v-b1e7f07d>Pronom</th><!--[-->`);
        ssrRenderList(unref(endingTableGroups), (group) => {
          _push(`<th scope="col" data-v-b1e7f07d>${ssrInterpolate(group.label)}</th>`);
        });
        _push(`<!--]--></tr></thead><tbody data-v-b1e7f07d><!--[-->`);
        ssrRenderList(unref(endingPronouns), (pronoun, index) => {
          _push(`<tr data-v-b1e7f07d><th scope="row" data-v-b1e7f07d>${ssrInterpolate(pronoun)}</th><!--[-->`);
          ssrRenderList(unref(endingTableGroups), (group) => {
            _push(`<td data-v-b1e7f07d><strong data-v-b1e7f07d>${ssrInterpolate(endingForms(group.endings)[index])}</strong></td>`);
          });
          _push(`<!--]--></tr>`);
        });
      ...
      if (unref(endingReferenceGroups).length) {
        _push(`<div class="tense-page__table-wrap tense-page__table-wrap--reference" data-v-b1e7f07d><table data-v-b1e7f07d><thead data-v-b1e7f07d><tr data-v-b1e7f07d><th scope="col" data-v-b1e7f07d>Groupe ou élément</th><th scope="col" data-v-b1e7f07d>Terminaison ou construction</th><th scope="col" data-v-b1e7f07d>Exemple</th></tr></thead><tbody data-v-b1e7f07d><!--[-->`);
        ssrRenderList(unref(endingReferenceGroups), (group) => {
          _push(`<tr data-v-b1e7f07d><th scope="row" data-v-b1e7f07d>${ssrInterpolate(group.label)}</th><td data-v-b1e7f07d><strong data-v-b1e7f07d>${ssrInterpolate(group.endings)}</strong></td><td data-v-b1e7f07d>${ssrInterpolate(group.example)}</td></tr>`);
        });
        _push(`<!--]--></tbody></table></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="tense-page__ending-notes" data-v-b1e7f07d><!--[-->`);
      ssrRenderList(unref(endingsGuide).groups.filter((item) => item.note), (group) => {
        _push(`<p data-v-b1e7f07d><strong data-v-b1e7f07d>${ssrInterpolate(group.label)} :</strong> ${ssrInterpolate(group.note)}</p>`);
      });
      _push(`<!--]--></div></section><section class="tense-page__examples"${ssrRenderAttr("aria-labelledby", `${unref(modeSlug)}-${unref(tenseSlug)}-examples`)} data-v-b1e7f07d><header data-v-b1e7f07d><p data-v-b1e7f07d>02</p><div data-v-b1e7f07d><h2${ssrRenderAttr("id", `${unref(modeSlug)}-${unref(tenseSlug)}-examples`)} data-v-b1e7f07d>${ssrInterpolate(unref(copy).examples)}</h2><p data-v-b1e7f07d>${ssrInterpolate(unref(copy).examplesIntro)}</p></div></header><div data-v-b1e7f07d><!--[-->`);
      ssrRenderList(unref(pedagogy).examples, (example, index) => {
        _push(`<article data-v-b1e7f07d><p class="tense-page__example-label" data-v-b1e7f07d>${ssrInterpolate(unref(copy).example)} ${ssrInterpolate(String(index + 1).padStart(2, "0"))}</p><blockquote data-v-b1e7f07d>${ssrInterpolate(example.sentence)}</blockquote><dl data-v-b1e7f07d><div data-v-b1e7f07d><dt data-v-b1e7f07d>${ssrInterpolate(unref(copy).context)}</dt><dd data-v-b1e7f07d>${ssrInterpolate(example.context)}</dd></div><div data-v-b1e7f07d><dt data-v-b1e7f07d>${ssrInterpolate(unref(copy).reason)}</dt><dd data-v-b1e7f07d>${ssrInterpolate(example.reason)}</dd></div></dl></article>`);
      });
      _push(`<!--]--></div></section></div><footer class="tense-page__actions" data-v-b1e7f07d>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(copy).practise)} <span aria-hidden="true" data-v-b1e7f07d${_scopeId}>→</span>`);
          } else {
            return [
...
const _temps_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b1e7f07d"]]);

export { _temps_ as default };
//# sourceMappingURL=_temps_-BmmDOAZL.mjs.map
