...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    function loadClassicExercise() {
      classicExercisePromise ??= import('./ClassicExercise-DJ4RGSNc.mjs').then((module) => module.default).catch((error) => {
    ...
    function loadChatExercise() {
      chatExercisePromise ??= import('./ChatExercise-BPbjtSR5.mjs').then((module) => module.default).catch((error) => {
...
//# sourceMappingURL=WizardChallengeWorkspace-DIiZ00P4.mjs.map
