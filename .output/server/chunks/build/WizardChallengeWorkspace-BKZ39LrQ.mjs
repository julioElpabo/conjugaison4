...
import { ar as challengePresetGroupLabels, W as legacyComplementOptions, H as getRequestURL, X as legacyComplementConfig, aq as challengePresetGroupOrder, aD as ultimateChallengeId } from '../nitro/nitro.mjs';
...
import { f as useLanguagePreferences, g as useRoute, h as useState, o as useRequestEvent, n as navigateTo } from './server.mjs';
...
import { c as createLearnerTrackingContext } from './main-A_ELVmjx.mjs';
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-82f9cf67>`);
      if (!__props.falcMode) {
        _push(`<div class="builder-card__header" data-v-82f9cf67><div data-v-82f9cf67><p class="builder-card__eyebrow" data-v-82f9cf67>${ssrInterpolate(__props.eyebrow ?? "Étape 3")}</p><h2${ssrRenderAttr("id", unref(optionsTitleId))} data-v-82f9cf67>${ssrInterpolate(unref(ui)("Mes options"))}</h2></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="${ssrRenderClass([{ "options-layout--columns": __props.gridLayout }, "options-layout"])}" data-v-82f9cf67><div class="${ssrRenderClass([{ "options-fields--columns": __props.gridLayout }, "options-fields"])}" data-v-82f9cf67><div class="options-main-column" data-v-82f9cf67><div class="option-group-card option-group-card--questions" data-v-82f9cf67><label class="field-stack question-count-field"${ssrRenderAttr("for", unref(questionCountId))} data-v-82f9cf67><span data-v-82f9cf67>${ssrInterpolate(unref(ui)("Nombre de questions"))}</span><input${ssrRenderAttr("id", unref(questionCountId))} type="number" inputmode="numeric" min="1" max="99" step="1"${ssrRenderAttr("value", unref(displayedQuestionCount))} data-v-82f9cf67></label></div>`);
      if (!__props.falcMode) {
        _push(`<fieldset class="option-fieldset option-group-card option-group-card--pronouns" data-v-82f9cf67><legend data-v-82f9cf67>${ssrInterpolate(unref(ui)("Pronoms"))}</legend><label class="check-row" data-v-82f9cf67><input type="checkbox"${ssrIncludeBooleanAttr(__props.inclusivePronouns) ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67>${ssrInterpolate(unref(ui)("Inclure les pronoms"))} <strong data-v-82f9cf67>iel / iels</strong><small data-v-82f9cf67>${ssrInterpolate(unref(ui)("Ils apparaîtront ponctuellement dans les questions."))}</small></span></label><label class="check-row" data-v-82f9cf67><input type="checkbox"${ssrIncludeBooleanAttr(__props.includeOnPronoun) ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67>${ssrInterpolate(unref(ui)("Inclure le pronom"))} <strong data-v-82f9cf67>on</strong><small data-v-82f9cf67>${ssrInterpolate(unref(ui)("Il apparaîtra ponctuellement dans les questions à la troisième personne du singulier."))}</small></span></label></fieldset>`);
      } else {
        _push(`<!---->`);
      }
      if (!__props.falcMode) {
        _push(`<fieldset class="option-fieldset option-group-card option-group-card--learning-support" data-v-82f9cf67><legend class="option-group-card__icon-legend" data-v-82f9cf67>`);
        _push(ssrRenderComponent(unref(FontAwesomeIcon), {
          icon: unref(faVolume),
          "aria-hidden": "true"
        }, null, _parent));
        _push(`<span data-v-82f9cf67>${ssrInterpolate(unref(ui)("Aide audio"))}</span></legend><div class="segmented-control segmented-control--stacked" data-v-82f9cf67><label data-v-82f9cf67><input type="radio"${ssrRenderAttr("name", unref(learningSupportModeName))} value="normal"${ssrIncludeBooleanAttr(__props.learningSupportMode === "normal") ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67><strong data-v-82f9cf67>${ssrInterpolate(unref(ui)("Normal"))}</strong></span></label><label data-v-82f9cf67><input type="radio"${ssrRenderAttr("name", unref(learningSupportModeName))} value="cif-fle"${ssrIncludeBooleanAttr(__props.learningSupportMode === "cif-fle") ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67><strong data-v-82f9cf67>${ssrInterpolate(unref(ui)("CIF / FLE"))}</strong><small data-v-82f9cf67>${ssrInterpolate(unref(ui)("Aide à l’écoute pour les personnes allophones."))}</small></span></label></div></fieldset>`);
      } else {
        _push(`<!---->`);
      }
      if (!__props.falcMode) {
        _push(`<fieldset class="option-fieldset option-group-card option-group-card--exercise" data-v-82f9cf67><legend data-v-82f9cf67>${ssrInterpolate(unref(ui)("Type d’exercice"))}</legend><div class="segmented-control" data-v-82f9cf67><label data-v-82f9cf67><input type="radio"${ssrRenderAttr("name", unref(exerciseKindName))} value="conjugation"${ssrIncludeBooleanAttr(__props.exerciseKind === "conjugation") ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67>${ssrInterpolate(unref(ui)("Conjuguer"))}</span></label><label data-v-82f9cf67><input type="radio"${ssrRenderAttr("name", unref(exerciseKindName))} value="tense-identification"${ssrIncludeBooleanAttr(__props.exerciseKind === "tense-identification") ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67>${ssrInterpolate(unref(ui)("Trouver le mode et le temps"))}</span></label></div>`);
        if (__props.exerciseKind === "tense-identification") {
          _push(`<div class="identification-source-panel" data-v-82f9cf67><div class="segmented-control segmented-control--stacked" data-v-82f9cf67><label data-v-82f9cf67><input type="radio"${ssrRenderAttr("name", unref(identificationSourceName))} value="selected-verbs"${ssrIncludeBooleanAttr(__props.identificationSource === "selected-verbs") ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67><strong data-v-82f9cf67>${ssrInterpolate(unref(ui)("Avec mes verbes"))}</strong><small data-v-82f9cf67>${ssrInterpolate(unref(ui)("Formes conjuguées simples, sans citation."))}</small></span></label><label data-v-82f9cf67><input type="radio"${ssrRenderAttr("name", unref(identificationSourceName))} value="literary-corpus"${ssrIncludeBooleanAttr(__props.identificationSource === "literary-corpus") ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67><strong data-v-82f9cf67>${ssrInterpolate(unref(ui)("Avec n’importe quel verbe"))}</strong><small data-v-82f9cf67>${ssrInterpolate(unref(ui)("Construits avec des phrases littéraires."))}</small></span></label></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</fieldset>`);
      ...
      if (!__props.falcMode) {
        _push(`<fieldset class="${ssrRenderClass([{ "option-group-card--disabled": __props.exerciseKind !== "conjugation" }, "option-fieldset option-group-card option-group-card--voice voice-mode-fieldset"])}"${ssrIncludeBooleanAttr(__props.exerciseKind !== "conjugation") ? " disabled" : ""} data-v-82f9cf67><legend data-v-82f9cf67>${ssrInterpolate(unref(ui)("Voix du verbe"))}</legend><div class="segmented-control segmented-control--stacked" data-v-82f9cf67><label data-v-82f9cf67><input type="radio"${ssrRenderAttr("name", unref(voiceModeName))} value="active"${ssrIncludeBooleanAttr(__props.voiceMode === "active") ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67><strong data-v-82f9cf67>${ssrInterpolate(unref(ui)("Active uniquement"))}</strong></span></label><label data-v-82f9cf67><input type="radio"${ssrRenderAttr("name", unref(voiceModeName))} value="passive"${ssrIncludeBooleanAttr(__props.voiceMode === "passive") ? " checked" : ""}${ssrIncludeBooleanAttr(!unref(passiveAvailable)) ? " disabled" : ""} data-v-82f9cf67><span data-v-82f9cf67><strong data-v-82f9cf67>${ssrInterpolate(unref(ui)("Passive uniquement"))}</strong><small data-v-82f9cf67>${ssrInterpolate(unref(ui)("Le COD devient le sujet de la phrase."))}</small></span></label><label data-v-82f9cf67><input type="radio"${ssrRenderAttr("name", unref(voiceModeName))} value="mixed"${ssrIncludeBooleanAttr(__props.voiceMode === "mixed") ? " checked" : ""}${ssrIncludeBooleanAttr(!unref(passiveAvailable)) ? " disabled" : ""} data-v-82f9cf67><span data-v-82f9cf67><strong data-v-82f9cf67>${ssrInterpolate(unref(ui)("Active et passive"))}</strong><small data-v-82f9cf67>${ssrInterpolate(unref(ui)("Les deux voix alterneront dans le défi."))}</small></span></label></div>`);
        if (!unref(passiveAvailable)) {
          _push(`<small class="field-hint" data-v-82f9cf67>${ssrInterpolate(unref(ui)("Aucun verbe sélectionné ne possède de COD validé."))}</small>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</fieldset>`);
      ...
      if (!__props.falcMode) {
        ...
        }, "complement-options"])}" data-v-82f9cf67>`);
        if (__props.gridLayout) {
          _push(`<h3 class="complement-options__title" data-v-82f9cf67>${ssrInterpolate(unref(ui)("Compléments d’objets :"))}</h3>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.gridLayout) {
          _push(`<p class="complement-options__description" data-v-82f9cf67>${ssrInterpolate(unref(ui)("Ajoute des COD (CVD) ou des COI (CVI)."))}</p>`);
        } else {
          _push(`<button class="complement-options__trigger" type="button"${ssrIncludeBooleanAttr(!unref(complementsAvailable)) ? " disabled" : ""}${ssrRenderAttr("aria-expanded", unref(complementsOpen))}${ssrRenderAttr("aria-controls", unref(complementPanelId))} data-v-82f9cf67><span data-v-82f9cf67>${ssrInterpolate(unref(ui)("Compléments d’objets :"))} <small data-v-82f9cf67>${ssrInterpolate(unref(ui)("nouveau"))}</small></span><span aria-hidden="true" data-v-82f9cf67>${ssrInterpolate(unref(complementsOpen) ? "−" : "+")}</span></button>`);
        }
        if (!unref(complementsAvailable)) {
          _push(`<p class="complement-options__unavailable" data-v-82f9cf67>${ssrInterpolate(__props.exerciseKind !== "conjugation" ? unref(ui)("Disponible uniquement pour un exercice de conjugaison.") : __props.voiceMode === "passive" ? unref(ui)("Au passif, le COD devient le sujet : ces options ne s’appliquent pas.") : unref(ui)("Les verbes choisis ne proposent pas de complément."))}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.gridLayout || unref(complementsOpen)) {
          _push(`<fieldset${ssrRenderAttr("id", unref(complementPanelId))} class="complement-options__panel" data-v-82f9cf67><legend class="sr-only" data-v-82f9cf67>${ssrInterpolate(unref(ui)("Présentation des compléments d’objets"))}</legend><label data-v-82f9cf67><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(codAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("cod-after")) ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67><strong data-v-82f9cf67>${ssrInterpolate(unref(ui)("COD (CVD) placé après"))}</strong>`);
          if (unref(complementsAvailable) && !unref(codAvailable)) {
            _push(`<small data-v-82f9cf67>${ssrInterpolate(unref(ui)("Aucun verbe choisi ne possède de COD (CVD) validé."))}</small>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</span></label><label data-v-82f9cf67><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(codBeforeAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("cod-before")) ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67><strong data-v-82f9cf67>${ssrInterpolate(unref(ui)("COD (CVD) placé avant"))}</strong>`);
          if (unref(complementsAvailable) && !unref(codBeforeAvailable)) {
            _push(`<small data-v-82f9cf67>${ssrInterpolate(unref(ui)("Aucun COD (CVD) validé ne peut être placé avant avec les verbes choisis."))}</small>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</span></label><label data-v-82f9cf67><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(coiAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("coi-after")) ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67><strong data-v-82f9cf67>${ssrInterpolate(unref(ui)("COI (CVI) placé après"))}</strong>`);
          if (unref(complementsAvailable) && !unref(coiAvailable)) {
            _push(`<small data-v-82f9cf67>${ssrInterpolate(unref(ui)("Aucun verbe choisi ne possède de COI (CVI) validé."))}</small>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</span></label><label data-v-82f9cf67><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(coiBeforeAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("coi-before")) ? " checked" : ""} data-v-82f9cf67><span data-v-82f9cf67><strong data-v-82f9cf67>${ssrInterpolate(unref(ui)("COI (CVI) placé avant"))}</strong>`);
          if (unref(complementsAvailable) && !unref(coiBeforeAvailable)) {
            _push(`<small data-v-82f9cf67>${ssrInterpolate(unref(ui)("Aucun COI (CVI) validé ne peut être placé avant avec les verbes choisis."))}</small>`);
          } else {
            _push(`<!---->`);
          }
      ...
      if (!__props.falcMode && __props.gridLayout && (__props.conjugationExampleLoading || unref(hasConjugationExample))) {
        _push(`<div data-tour="options-preview" class="${ssrRenderClass([{ "conjugation-example--wide": __props.exerciseKind === "tense-identification" }, "conjugation-example"])}" aria-live="polite" aria-atomic="true" data-v-82f9cf67><div class="conjugation-example__header" data-v-82f9cf67><span class="conjugation-example__preview-icon" aria-hidden="true" data-v-82f9cf67><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" data-v-82f9cf67><path d="M1.5 12s3.8-7 10.5-7 10.5 7 10.5 7-3.8 7-10.5 7S1.5 12 1.5 12Z" data-v-82f9cf67></path><circle cx="12" cy="12" r="3" data-v-82f9cf67></circle></svg></span><div class="conjugation-example__heading" data-v-82f9cf67><span data-v-82f9cf67>${ssrInterpolate(unref(ui)("Aperçu d’une question"))}</span></div></div><div class="conjugation-example__screen" data-v-82f9cf67>`);
        if (__props.conjugationExampleLoading) {
          _push(`<div class="conjugation-example__loading" role="status" data-v-82f9cf67><span class="conjugation-example__spinner" aria-hidden="true" data-v-82f9cf67></span><span class="sr-only" data-v-82f9cf67>${ssrInterpolate(unref(ui)("Préparation de l’aperçu"))}</span></div>`);
        } else {
          _push(`<div class="conjugation-example__body" data-v-82f9cf67>`);
          if (unref(exampleRevealStage) >= 1) {
            _push(`<div class="conjugation-example__question" data-v-82f9cf67><span class="conjugation-example__block-label" data-v-82f9cf67>${ssrInterpolate(unref(ui)("Exemple de question"))}</span>`);
            if (__props.exerciseKind === "tense-identification" && __props.conjugationInstruction && __props.conjugationQuestion) {
              _push(`<!--[--><p class="conjugation-example__instruction" data-v-82f9cf67>${ssrInterpolate(__props.conjugationInstruction)}</p>`);
              if (__props.conjugationLiteraryCitation) {
                _push(`<blockquote class="conjugation-example__citation" data-v-82f9cf67><p data-v-82f9cf67><span data-v-82f9cf67>${ssrInterpolate(__props.conjugationLiteraryCitation.before)}</span><mark data-v-82f9cf67>${ssrInterpolate(__props.conjugationLiteraryCitation.target)}</mark><span data-v-82f9cf67>${ssrInterpolate(__props.conjugationLiteraryCitation.after)}</span></p><footer data-v-82f9cf67>${ssrInterpolate(__props.conjugationLiteraryCitation.author)}, <cite data-v-82f9cf67>${ssrInterpolate(__props.conjugationLiteraryCitation.work)}</cite></footer></blockquote>`);
              } else {
                _push(`<p class="conjugation-example__question-line" data-v-82f9cf67><span class="conjugation-example__prompt" data-v-82f9cf67>${ssrInterpolate(unref(identificationQuestion))}</span></p>`);
              }
              _push(`<!--]-->`);
            } else {
              _push(`<!--[-->`);
              ...
              if (__props.conjugationQuestionContext) {
                _push(`<p class="conjugation-example__question-line" data-v-82f9cf67><span class="conjugation-example__context" data-v-82f9cf67>${ssrInterpolate(__props.conjugationQuestionContext)}</span></p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
          ...
          if (unref(exampleRevealStage) >= 2) {
            _push(`<div class="conjugation-example__correction" data-v-82f9cf67><span data-v-82f9cf67>${ssrInterpolate(unref(ui)("Réponse attendue"))}</span><p data-v-82f9cf67>`);
            if (__props.conjugationExampleEmphasis) {
              _push(`<!--[--><span data-v-82f9cf67>${ssrInterpolate(__props.conjugationExamplePrefix)}</span><strong data-v-82f9cf67>${ssrInterpolate(__props.conjugationExampleEmphasis)}</strong><span data-v-82f9cf67>${ssrInterpolate(__props.conjugationExampleSuffix)}</span><!--]-->`);
            } else {
              _push(`<span data-v-82f9cf67>${ssrInterpolate(__props.conjugationExample)}</span>`);
            }
            _push(`</p></div>`);
          } else {
            _push(`<!---->`);
...
const ChallengeOptions = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["__scopeId", "data-v-82f9cf67"]]), { __name: "ChallengeOptions" });
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-c2925419>`);
      if (__props.compact) {
        _push(`<div class="preset-browser" data-v-c2925419><div class="preset-browser__scroll" data-v-c2925419><div class="preset-browser__columns" data-v-c2925419><section class="preset-browser__column" data-browser-column="1" aria-labelledby="preset-browser-groups" data-v-c2925419><h3 id="preset-browser-groups" data-v-c2925419>${ssrInterpolate(unref(ui)("Catégories"))}</h3><div class="preset-browser__list" data-v-c2925419><!--[-->`);
        ssrRenderList(unref(groupedPresets), (group) => {
          _push(`<button type="button" class="${ssrRenderClass({ "is-selected": unref(compactGroupId) === group.id })}"${ssrRenderAttr("aria-pressed", unref(compactGroupId) === group.id)} data-v-c2925419><span data-v-c2925419>${ssrInterpolate(group.label)}</span><span class="preset-browser__chevron" aria-hidden="true" data-v-c2925419>›</span></button>`);
        });
        _push(`<!--]--></div></section>`);
        if (unref(compactGroup)) {
          _push(`<section class="preset-browser__column" data-browser-column="2"${ssrRenderAttr("aria-label", `Défis de ${unref(compactGroup).label}`)} data-v-c2925419><div class="preset-browser__list" data-v-c2925419><!--[-->`);
          ssrRenderList(unref(compactGroup).presets, (preset) => {
            _push(`<div class="preset-browser__preset-row" data-v-c2925419><div class="preset-browser__info" data-preset-info data-v-c2925419><button class="preset-browser__info-button" type="button"${ssrRenderAttr("aria-expanded", infoIsOpen(preset.id))}${ssrRenderAttr("aria-controls", `preset-info-${preset.id}`)}${ssrRenderAttr("aria-label", `Informations sur ${preset.label}`)} data-v-c2925419>i</button>`);
            if (infoIsOpen(preset.id)) {
              _push(`<section${ssrRenderAttr("id", `preset-info-${preset.id}`)} class="preset-browser__tooltip" aria-live="polite" data-v-c2925419><header data-v-c2925419><strong data-v-c2925419>${ssrInterpolate(preset.label)}</strong><span data-v-c2925419>${ssrInterpolate(preset.questionCount)} ${ssrInterpolate(unref(ui)("questions"))}</span></header><div class="preset-browser__tooltip-section" data-v-c2925419><h4 data-v-c2925419>${ssrInterpolate(unref(ui)("Verbes"))}</h4><div class="preset-browser__verb-badges" data-v-c2925419><!--[-->`);
              ssrRenderList(infoVerbNames(preset), (verb) => {
                _push(`<span data-v-c2925419>${ssrInterpolate(verb)}</span>`);
              });
              _push(`<!--]--></div>`);
              if (preset.verbIds.length > 12) {
                _push(`<p class="preset-browser__other-verbs" data-v-c2925419>+ ${ssrInterpolate(preset.verbIds.length - 12)} ${ssrInterpolate(unref(ui)("autres verbes"))}</p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</div><div class="preset-browser__tooltip-section" data-v-c2925419><h4 data-v-c2925419>${ssrInterpolate(unref(ui)("Temps"))}</h4><dl data-v-c2925419><!--[-->`);
              ssrRenderList(infoTenseGroups(preset), (group) => {
                _push(`<div data-v-c2925419><dt data-v-c2925419>${ssrInterpolate(group.mode)}</dt><dd data-v-c2925419>${ssrInterpolate(group.tenses.join(", "))}</dd></div>`);
              });
              _push(`<!--]--></dl></div></section>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><button type="button" class="${ssrRenderClass([{ "is-selected": unref(selectedCompactPresetId) === preset.id || __props.activePresetId === preset.id }, "preset-browser__preset-button"])}"${ssrRenderAttr("aria-pressed", unref(selectedCompactPresetId) === preset.id)} data-v-c2925419><span data-v-c2925419><strong data-v-c2925419>${ssrInterpolate(preset.label)}</strong></span><span class="preset-browser__chevron" aria-hidden="true" data-v-c2925419>›</span></button></div>`);
          });
          _push(`<!--]--></div></section>`);
        } else {
          _push(`<!---->`);
        ...
        if (unref(selectedCompactPreset)) {
          _push(`<section class="preset-browser__column preset-browser__column--quantity" data-browser-column="3"${ssrRenderAttr("aria-label", unref(ui)("Choisir le nombre de verbes"))} data-v-c2925419><div class="preset-browser__list" data-v-c2925419>`);
          if (unref(selectedCompactPreset).id === unref(ultimateChallengeId)) {
            _push(`<!--[-->`);
            if (unref(selectedCompactPreset).verbIds.length >= 30) {
              _push(`<button type="button" data-v-c2925419><span data-v-c2925419><strong data-v-c2925419>${ssrInterpolate(unref(ui)("30 au hasard"))}</strong></span><span class="preset-browser__count" data-v-c2925419>30</span><span class="preset-browser__launch" aria-hidden="true" data-v-c2925419>→</span></button>`);
            } else {
              _push(`<!---->`);
            }
            _push(`<span class="preset-browser__quantity-separator" aria-hidden="true" data-v-c2925419></span><!--[-->`);
            ssrRenderList([3, 5, 10], (count) => {
              _push(`<button type="button" style="${ssrRenderStyle(unref(selectedCompactPreset).verbIds.length >= count ? null : { display: "none" })}" data-v-c2925419><span data-v-c2925419><strong data-v-c2925419>${ssrInterpolate(unref(ui)("{count} au hasard", { count }))}</strong></span><span class="preset-browser__count" data-v-c2925419>${ssrInterpolate(count)}</span><span class="preset-browser__launch" aria-hidden="true" data-v-c2925419>→</span></button>`);
            });
            _push(`<!--]--><!--]-->`);
          } else {
            _push(`<!--[--><button type="button" data-v-c2925419><span data-v-c2925419><strong data-v-c2925419>${ssrInterpolate(unref(ui)("Tous les verbes"))}</strong></span><span class="preset-browser__count" data-v-c2925419>${ssrInterpolate(unref(selectedCompactPreset).verbIds.length)}</span><span class="preset-browser__launch" aria-hidden="true" data-v-c2925419>→</span></button><span class="preset-browser__quantity-separator" aria-hidden="true" data-v-c2925419></span>`);
            if (unref(selectedCompactPreset).verbIds.length >= 1 && unref(selectedCompactPreset).verbIds.length < 5) {
              _push(`<button type="button" data-v-c2925419><span data-v-c2925419><strong data-v-c2925419>${ssrInterpolate(unref(ui)("1 au hasard"))}</strong></span><span class="preset-browser__count" data-v-c2925419>1</span><span class="preset-browser__launch" aria-hidden="true" data-v-c2925419>→</span></button>`);
            } else {
              _push(`<!---->`);
            }
            if (unref(selectedCompactPreset).verbIds.length >= 2 && unref(selectedCompactPreset).verbIds.length < 5) {
              _push(`<button type="button" data-v-c2925419><span data-v-c2925419><strong data-v-c2925419>${ssrInterpolate(unref(ui)("2 au hasard"))}</strong></span><span class="preset-browser__count" data-v-c2925419>2</span><span class="preset-browser__launch" aria-hidden="true" data-v-c2925419>→</span></button>`);
            } else {
              _push(`<!---->`);
            }
            if (unref(selectedCompactPreset).verbIds.length >= 3) {
              _push(`<button type="button" data-v-c2925419><span data-v-c2925419><strong data-v-c2925419>${ssrInterpolate(unref(ui)("3 au hasard"))}</strong></span><span class="preset-browser__count" data-v-c2925419>3</span><span class="preset-browser__launch" aria-hidden="true" data-v-c2925419>→</span></button>`);
            } else {
              _push(`<!---->`);
            }
            if (unref(selectedCompactPreset).verbIds.length >= 5) {
              _push(`<button type="button" data-v-c2925419><span data-v-c2925419><strong data-v-c2925419>${ssrInterpolate(unref(ui)("5 au hasard"))}</strong></span><span class="preset-browser__count" data-v-c2925419>5</span><span class="preset-browser__launch" aria-hidden="true" data-v-c2925419>→</span></button>`);
            } else {
              _push(`<!---->`);
            }
            if (unref(selectedCompactPreset).verbIds.length >= 10) {
              _push(`<button type="button" data-v-c2925419><span data-v-c2925419><strong data-v-c2925419>${ssrInterpolate(unref(ui)("10 au hasard"))}</strong></span><span class="preset-browser__count" data-v-c2925419>10</span><span class="preset-browser__launch" aria-hidden="true" data-v-c2925419>→</span></button>`);
            } else {
              _push(`<!---->`);
            }
            _push(`<!--]-->`);
        ...
        _push(`<!--[--><div class="preset-panel__intro" data-v-c2925419><div data-v-c2925419><p class="builder-card__eyebrow" data-v-c2925419>${ssrInterpolate(unref(ui)("Pour démarrer rapidement"))}</p><h2 id="presets-title" data-v-c2925419>${ssrInterpolate(unref(ui)("Défis prêts à l’emploi"))}</h2></div><p data-v-c2925419>${ssrInterpolate(unref(ui)("Choisissez un niveau ou une famille de verbes, puis ajustez librement la sélection."))}</p></div><label class="preset-mobile-select" data-v-c2925419><span data-v-c2925419>${ssrInterpolate(unref(ui)("Choisir un défi prêt à l’emploi"))}</span><select${ssrRenderAttr("value", __props.activePresetId ?? unref(mobilePresetId))} data-v-c2925419><option value="" data-v-c2925419>${ssrInterpolate(unref(ui)("Choisir un niveau ou un entraînement…"))}</option><!--[-->`);
        ssrRenderList(unref(groupedPresets), (group) => {
          _push(`<optgroup${ssrRenderAttr("label", group.label)} data-v-c2925419><!--[-->`);
          ssrRenderList(group.presets, (preset) => {
            _push(`<option${ssrRenderAttr("value", preset.id)} data-v-c2925419>${ssrInterpolate(preset.label)} — ${ssrInterpolate(preset.verbIds.length)} ${ssrInterpolate(unref(ui)("verbes"))}</option>`);
          });
          _push(`<!--]--></optgroup>`);
        });
        _push(`<!--]--></select></label><div class="preset-groups" role="tablist"${ssrRenderAttr("aria-label", unref(ui)("Catégories de défis"))} data-v-c2925419><!--[-->`);
        ssrRenderList(unref(groupedPresets), (group, index) => {
          _push(`<button${ssrRenderAttr("id", `preset-tab-${group.id}`)} class="${ssrRenderClass([{ "preset-group-button--active": unref(activeGroup)?.id === group.id }, "preset-group-button"])}" type="button" role="tab"${ssrRenderAttr("aria-selected", unref(activeGroup)?.id === group.id)}${ssrRenderAttr("aria-controls", `preset-content-${group.id}`)}${ssrRenderAttr("tabindex", unref(activeGroup)?.id === group.id ? 0 : -1)} data-v-c2925419>${ssrInterpolate(group.label)}</button>`);
        });
        _push(`<!--]--></div>`);
        if (unref(activeGroup)) {
          _push(`<div${ssrRenderAttr("id", `preset-content-${unref(activeGroup).id}`)} class="preset-list" role="tabpanel"${ssrRenderAttr("aria-labelledby", `preset-tab-${unref(activeGroup).id}`)} data-v-c2925419><!--[-->`);
          ssrRenderList(unref(activeGroup).presets, (preset) => {
            _push(`<article class="${ssrRenderClass([{ "preset-card--active": __props.activePresetId === preset.id }, "preset-card"])}" data-v-c2925419><button type="button" data-v-c2925419><strong data-v-c2925419>${ssrInterpolate(preset.label)}</strong><span data-v-c2925419>${ssrInterpolate(preset.description)}</span><small data-v-c2925419>${ssrInterpolate(preset.verbIds.length)} verbes · ${ssrInterpolate(preset.questionCount)} ${ssrInterpolate(unref(ui)("questions"))}</small></button>`);
            if (preset.verbIds.length > 5) {
              _push(`<div class="preset-card__random" data-v-c2925419>${ssrInterpolate(unref(ui)("Au hasard :"))} <button type="button" data-v-c2925419>1</button><button type="button" data-v-c2925419>5</button><button type="button" data-v-c2925419>10</button></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</article>`);
...
const PresetPicker = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-c2925419"]]), { __name: "ChallengePresetPicker" });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    function loadClassicExercise() {
      classicExercisePromise ??= import('./ClassicExercise-giDjNw9x.mjs').then((module) => module.default).catch((error) => {
    ...
    function loadChatExercise() {
      chatExercisePromise ??= import('./ChatExercise-CJ5DhELx.mjs').then((module) => module.default).catch((error) => {
    ...
    function loadCoachPicker() {
      coachPickerPromise ??= import('./CoachPicker-BDhegtjB.mjs').then((module) => module.default).catch((error) => {
    ...
    watch(isPrintOpen, async (open) => {
      ...
      printPreviewComponent.value = markRaw((await import('./PrintPreview-IxKvi3Hg.mjs')).default);
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "wizard-entry-page" }, _attrs))} data-v-dfe956b5><div class="challenge-page wizard-page" data-v-dfe956b5>`);
      if (!props.startAtLaunch) {
        _push(`<header class="wizard-hero" data-v-dfe956b5>`);
        if (unref(currentStep) === 0 && !unref(falcMode)) {
          _push(`<p class="wizard-hero__brand" data-v-dfe956b5>${ssrInterpolate(unref(heroTitle))}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(currentStep) === 0 && !unref(falcMode) && !props.embedded) {
          _push(`<h1 class="wizard-hero__subtitle" data-v-dfe956b5>${ssrInterpolate(props.homeHeading || unref(ui)("Exercices de conjugaison française, gratuits et sans publicité"))}</h1>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(currentStep) === 0 && !unref(falcMode) && props.embedded) {
          _push(`<h2 class="wizard-hero__subtitle" data-v-dfe956b5>${ssrInterpolate(props.homeHeading || unref(ui)("Exercices de conjugaison française, gratuits et sans publicité"))}</h2>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(currentStep) !== 0 && !unref(falcMode) && !props.embedded) {
          _push(`<h1 class="${ssrRenderClass({ "wizard-hero__preset": unref(isPrefilledChallenge) })}" data-v-dfe956b5>${ssrInterpolate(unref(heroTitle))}</h1>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(currentStep) !== 0 && !unref(falcMode) && props.embedded) {
          _push(`<h2 class="${ssrRenderClass({ "wizard-hero__preset": unref(isPrefilledChallenge) })}" data-v-dfe956b5>${ssrInterpolate(unref(heroTitle))}</h2>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(currentStep) === 0 && !unref(falcMode) && !unref(guidedTourDisabled)) {
          _push(`<button class="tour-entry-button" type="button" data-v-dfe956b5><span aria-hidden="true" data-v-dfe956b5>?</span>${ssrInterpolate(unref(tourCopy).discover)}</button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</header>`);
      ...
      _push(`<main class="wizard-shell" data-v-dfe956b5>`);
      if (unref(catalogueStatus) === "loading") {
        _push(`<div class="page-state" role="status" data-v-dfe956b5><span class="loader" aria-hidden="true" data-v-dfe956b5></span> ${ssrInterpolate(unref(ui)("Chargement du catalogue de conjugaison…"))}</div>`);
      } else if (unref(catalogueStatus) === "error") {
        _push(`<div class="page-state page-state--error" role="alert" data-v-dfe956b5><strong data-v-dfe956b5>${ssrInterpolate(unref(ui)("Le catalogue n’a pas pu être chargé."))}</strong><span data-v-dfe956b5>${ssrInterpolate(unref(catalogueError))}</span><button class="primary-button" type="button" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Réessayer"))}</button></div>`);
      } else {
        _push(`<!--[-->`);
        if (unref(actionError)) {
          _push(`<p class="workspace-message workspace-message--error" role="alert" data-v-dfe956b5>${ssrInterpolate(unref(actionError))}</p>`);
        } else if (unref(notice)) {
          _push(`<p class="workspace-message workspace-message--success" aria-live="polite" data-v-dfe956b5>${ssrInterpolate(unref(notice))}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<section class="${ssrRenderClass([{ "wizard-panel--autocomplete-open": unref(currentStep) === 1 }, "wizard-panel"])}" tabindex="-1" aria-labelledby="wizard-title" data-v-dfe956b5><h2 id="wizard-title" class="sr-only" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Composer un défi personnalisé"))}</h2>`);
        if (unref(currentStep) !== 0) {
          _push(`<nav class="${ssrRenderClass([{ "wizard-steps--falc": unref(falcMode) }, "wizard-steps"])}" data-tour="wizard-steps"${ssrRenderAttr("aria-label", unref(ui)("Étapes de création du défi"))} data-v-dfe956b5><button data-tour-wizard-step="1" class="${ssrRenderClass([{
            "is-active": unref(currentStep) === 1,
            "is-complete": unref(stepStatus).verbs > 0,
            "tour-secondary-focus": unref(tourSecondaryWizardStep) === 1
          }, "wizard-step-tab wizard-step-tab--verbs"])}" type="button" data-v-dfe956b5><span data-v-dfe956b5>1</span><span data-v-dfe956b5><strong data-v-dfe956b5>${ssrInterpolate(unref(ui)("Verbes"))}</strong>`);
          if (!unref(falcMode)) {
            _push(`<small data-v-dfe956b5>${ssrInterpolate(unref(stepStatus).verbs ? unref(ui)(unref(stepStatus).verbs > 1 ? "{count} choisis" : "{count} choisi", { count: unref(stepStatus).verbs }) : unref(ui)("À choisir"))}</small>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</span></button><span class="wizard-steps__line" aria-hidden="true" data-v-dfe956b5></span><button data-tour-wizard-step="2" class="${ssrRenderClass([{
            "is-active": unref(currentStep) === 2,
            "is-complete": unref(stepStatus).tenses > 0,
            "tour-secondary-focus": unref(tourSecondaryWizardStep) === 2
          }, "wizard-step-tab wizard-step-tab--tenses"])}" type="button"${ssrIncludeBooleanAttr(unref(stepStatus).verbs === 0) ? " disabled" : ""} data-v-dfe956b5><span data-v-dfe956b5>2</span><span data-v-dfe956b5><strong data-v-dfe956b5><span class="mobile-label-hidden" data-v-dfe956b5>${ssrInterpolate(unref(falcMode) ? unref(ui)("Temps") : unref(ui)("Modes et temps"))}</span><span class="mobile-label-only" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Temps"))}</span></strong>`);
          if (!unref(falcMode)) {
            _push(`<small data-v-dfe956b5>${ssrInterpolate(unref(stepStatus).tenses ? unref(ui)(unref(stepStatus).tenses > 1 ? "{count} choisis" : "{count} choisi", { count: unref(stepStatus).tenses }) : unref(ui)("À choisir"))}</small>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</span></button><span class="wizard-steps__line" aria-hidden="true" data-v-dfe956b5></span><button data-tour-wizard-step="3" class="${ssrRenderClass({
            "is-active": unref(currentStep) === 3,
            "is-complete": unref(currentStep) === 4,
            "tour-secondary-focus": unref(tourSecondaryWizardStep) === 3
          })}" type="button"${ssrIncludeBooleanAttr(!unref(isReady)) ? " disabled" : ""} data-v-dfe956b5><span data-v-dfe956b5>3</span><span data-v-dfe956b5><strong data-v-dfe956b5>${ssrInterpolate(unref(ui)("Options"))}</strong>`);
          if (!unref(falcMode)) {
            _push(`<small data-v-dfe956b5>${ssrInterpolate(unref(ui)("Finaliser le défi"))}</small>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</span></button>`);
          if (!unref(falcMode)) {
            _push(`<span class="wizard-steps__line" aria-hidden="true" data-v-dfe956b5></span>`);
          } else {
            _push(`<!---->`);
          }
          if (!unref(falcMode)) {
            ...
            })}" type="button"${ssrIncludeBooleanAttr(!unref(isReady) || unref(isPreparingStep4)) ? " disabled" : ""} data-v-dfe956b5><span data-v-dfe956b5>4</span><span data-v-dfe956b5><strong data-v-dfe956b5>${ssrInterpolate(props.startAtLaunch ? unref(ui)("Commencer") : unref(ui)("Créer"))}</strong><small data-v-dfe956b5>${ssrInterpolate(unref(ui)("Utiliser le défi"))}</small></span></button>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(tourSecondaryWizardStep) !== null) {
            _push(`<span class="tour-wizard-step-indicator" style="${ssrRenderStyle(unref(tourWizardIndicatorStyle))}" aria-hidden="true" data-v-dfe956b5></span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</nav>`);
        ...
        _push(`<div class="${ssrRenderClass([{ "wizard-content--home": unref(currentStep) === 0 }, "wizard-content"])}" data-v-dfe956b5>`);
        if (unref(isPreparingStep4)) {
          _push(`<div class="wizard-step-preparing" role="status" aria-live="polite" data-v-dfe956b5><span class="loader wizard-step-preparing__spinner" aria-hidden="true" data-v-dfe956b5></span><strong data-v-dfe956b5>${ssrInterpolate(unref(ui)("Préparation de ton défi…"))}</strong></div>`);
        } else if (unref(currentStep) === 0) {
          _push(`<div class="${ssrRenderClass([{ "wizard-home--falc": unref(falcMode) }, "wizard-home"])}" data-tour="home" data-v-dfe956b5>`);
          if (unref(falcMode)) {
            _push(`<!--[-->`);
            if (unref(falcHomePanel) === null) {
              _push(`<div class="falc-home-actions" style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column" })}" data-v-dfe956b5><button class="falc-home-action" type="button" data-v-dfe956b5>${ssrInterpolate(unref(ui)("J’ai un code"))}</button><button class="falc-home-action" type="button" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Choisir un défi"))}</button><button class="falc-home-action falc-home-action--primary" type="button" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Créer mon exercice"))}</button></div>`);
            } else if (unref(falcHomePanel) === "code") {
              _push(`<div class="falc-home-panel code-loader" role="search"${ssrRenderAttr("aria-label", unref(ui)("Charger un défi avec son code"))} data-v-dfe956b5><button class="falc-panel-back" type="button"${ssrRenderAttr("aria-label", unref(ui)("Retour"))} data-v-dfe956b5>←</button><label id="wizard-falc-code-label" for="wizard-falc-code" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Écris le code du défi"))}</label><div class="code-loader__control" data-v-dfe956b5><div id="wizard-falc-code" class="code-loader__code-entry" role="textbox" contenteditable="plaintext-only" aria-labelledby="wizard-falc-code-label" data-placeholder="AB-CD-EF-23"${ssrRenderAttr("aria-invalid", Boolean(unref(codeError)))} data-v-dfe956b5></div><button class="primary-button" type="button"${ssrIncludeBooleanAttr(unref(busyAction) === "load") ? " disabled" : ""} data-v-dfe956b5>${ssrInterpolate(unref(busyAction) === "load" ? unref(ui)("Chargement…") : unref(ui)("Ouvrir le défi"))}</button></div>`);
              if (unref(codeError)) {
                _push(`<p class="code-loader__error" role="alert" data-v-dfe956b5>${ssrInterpolate(unref(codeError))}</p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</div>`);
            } else {
              _push(`<div class="falc-home-panel" data-v-dfe956b5><button class="falc-panel-back" type="button"${ssrRenderAttr("aria-label", unref(ui)("Retour"))} data-v-dfe956b5>←</button><h2 data-v-dfe956b5>${ssrInterpolate(unref(ui)("Choisis un défi"))}</h2>`);
            ...
            _push(`<!--[--><div data-tour="code-loader" class="${ssrRenderClass([{ "is-arrival-highlighted": unref(highlightChallengeLoader) }, "code-loader"])}" role="search"${ssrRenderAttr("aria-label", unref(ui)("Charger un défi avec son code"))} data-v-dfe956b5><div class="code-loader__heading" data-v-dfe956b5><span class="code-loader__icon" aria-hidden="true" data-v-dfe956b5><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-dfe956b5><path d="M12 3v12" data-v-dfe956b5></path><path d="m7 10 5 5 5-5" data-v-dfe956b5></path><path d="M5 21h14" data-v-dfe956b5></path></svg></span><div data-v-dfe956b5><strong data-v-dfe956b5>${ssrInterpolate(unref(ui)("Tu as reçu un défi ?"))}</strong><small data-v-dfe956b5>${ssrInterpolate(unref(ui)("Colle son code pour le reprendre immédiatement."))}</small></div></div><div class="code-loader__control" data-v-dfe956b5><span id="wizard-challenge-code-label" class="sr-only" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Code du défi"))}</span><div id="wizard-challenge-code" class="code-loader__code-entry" role="textbox" contenteditable="plaintext-only" aria-labelledby="wizard-challenge-code-label" data-placeholder="AB-CD-EF-23"${ssrRenderAttr("aria-invalid", Boolean(unref(codeError)))} data-v-dfe956b5></div><button class="primary-button wizard-home__outline-action" type="button"${ssrIncludeBooleanAttr(unref(catalogueStatus) !== "success" || unref(busyAction) === "load") ? " disabled" : ""} data-v-dfe956b5>${ssrInterpolate(unref(busyAction) === "load" ? unref(ui)("Chargement…") : unref(ui)("Charger"))}</button></div>`);
            if (unref(codeError)) {
              _push(`<p class="code-loader__error" role="alert" data-v-dfe956b5>${ssrInterpolate(unref(codeError))}</p>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="wizard-home__choices" data-v-dfe956b5>`);
            if (!unref(presetExpanded)) {
              _push(`<button class="wizard-home__choice wizard-home__choice--preset is-collapsed" data-tour="presets" type="button" data-v-dfe956b5><span class="wizard-home__choice-icon" aria-hidden="true" data-v-dfe956b5>★</span><div data-v-dfe956b5><h2 data-v-dfe956b5>${ssrInterpolate(unref(ui)("Tu veux travailler un de nos défis ?"))}</h2></div><span class="secondary-button wizard-home__outline-action" aria-hidden="true" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Découvrir"))}</span></button>`);
            } else {
              _push(`<article data-tour="presets" class="${ssrRenderClass([{ "is-preset-selection": unref(presetStage) === "presets" }, "wizard-home__choice wizard-home__choice--preset"])}" data-v-dfe956b5><span class="wizard-home__choice-icon" aria-hidden="true" data-v-dfe956b5>★</span><div data-v-dfe956b5><h2 data-v-dfe956b5>${ssrInterpolate(unref(ui)("Tu veux travailler un de nos défis ?"))}</h2></div>`);
              _push(ssrRenderComponent(PresetPicker, {
            ...
            _push(`<article class="wizard-home__choice wizard-home__choice--custom" data-tour="build-custom" data-v-dfe956b5><span class="wizard-home__choice-icon" aria-hidden="true" data-v-dfe956b5>✎</span><div data-v-dfe956b5><h2 data-v-dfe956b5>${ssrInterpolate(unref(ui)("Tu veux construire ton propre défi ?"))}</h2><p data-v-dfe956b5>${ssrInterpolate(unref(ui)("Choisis les verbes, les modes, les temps et les options."))}</p></div><button class="${ssrRenderClass([{ "wizard-next-pulse": !unref(highlightChallengeLoader) }, "primary-button"])}" type="button" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Construire un nouveau défi →"))}</button></article></div><div class="wizard-home__separator" aria-hidden="true" data-v-dfe956b5></div><section class="wizard-home__seo-intro" aria-labelledby="home-features-title" data-v-dfe956b5><header data-v-dfe956b5><p class="wizard-home__seo-eyebrow" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Tout pour progresser"))}</p><h2 id="home-features-title" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Des exercices de conjugaison adaptés à tes besoins"))}</h2><p data-v-dfe956b5>${ssrInterpolate(unref(ui)("TATITOTU propose des exercices de conjugaison française entièrement gratuits, interactifs et personnalisables, sans publicité."))}</p></header><div class="wizard-home__feature-grid" data-v-dfe956b5><article data-v-dfe956b5><h3 data-v-dfe956b5>${ssrInterpolate(unref(ui)("Pour les élèves"))}</h3><p data-v-dfe956b5>${ssrInterpolate(unref(ui)("Choisis les verbes, les modes et les temps que tu souhaites travailler, personnalise les questions, puis commence ton entraînement."))}</p><p data-v-dfe956b5>${ssrInterpolate(unref(ui)("Les exercices peuvent être réalisés dans un format classique ou sous la forme d’un dialogue avec un coach virtuel qui t’aide pour chaque question."))}</p></article><article data-v-dfe956b5><h3 data-v-dfe956b5>${ssrInterpolate(unref(ui)("Pour les enseignants"))}</h3><p data-v-dfe956b5>${ssrInterpolate(unref(ui)("Tes propres exercices peuvent être partagés avec tes élèves."))}</p><p data-v-dfe956b5>${ssrInterpolate(unref(ui)("Les élèves peuvent aussi te partager leurs bilans pour un meilleur suivi."))}</p><p data-v-dfe956b5>${ssrInterpolate(unref(ui)("Tu peux aussi imprimer l’exercice en PDF ou DOCX avec corrigé."))}</p></article><article data-v-dfe956b5><h3 data-v-dfe956b5>${ssrInterpolate(unref(ui)("Des ressources utiles"))}</h3><p data-v-dfe956b5>${ssrInterpolate(unref(ui)("Pour apprendre et réviser, le site propose aussi des explications sur les modes et les temps."))}</p><p data-v-dfe956b5>${ssrInterpolate(unref(ui)("Tu peux également consulter la conjugaison complète des verbes français, les règles d’accord du participe passé et les principales difficultés à éviter."))}</p></article></div></section><!--]-->`);
          }
          _push(`</div>`);
        } else if (unref(currentStep) === 1) {
          _push(`<div class="wizard-step wizard-step--selection" aria-labelledby="verbs-title" data-v-dfe956b5><div class="wizard-step__actions wizard-step__actions--split" data-v-dfe956b5><button class="secondary-button" type="button"${ssrRenderAttr("aria-label", unref(ui)("Étape précédente"))} data-v-dfe956b5>${ssrInterpolate(unref(falcMode) ? "←" : unref(ui)("← Nouveau défi"))}</button><div class="wizard-step__controls" data-v-dfe956b5><button class="primary-button wizard-step__cta wizard-next-pulse" type="button"${ssrRenderAttr("aria-label", unref(ui)("Étape suivante"))}${ssrIncludeBooleanAttr(!unref(selectedVerbs).length) ? " disabled" : ""} data-v-dfe956b5>${ssrInterpolate(unref(falcMode) ? "→" : unref(ui)("Choisir les temps →"))}</button></div></div>`);
          if (unref(activePreset) && !unref(isPresetVerbEditing)) {
            _push(`<div class="wizard-step__intro wizard-step__intro--selection" data-v-dfe956b5><h2 id="verbs-title" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Verbes du défi"))}</h2></div>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(activePreset) && !unref(isPresetVerbEditing)) {
            _push(`<section class="preset-verb-overview" data-v-dfe956b5><header data-v-dfe956b5><div data-v-dfe956b5><p data-v-dfe956b5>${ssrInterpolate(unref(selectedVerbs).length)} ${ssrInterpolate(unref(selectedVerbs).length === 1 ? unref(ui)("verbe") : unref(ui)("verbes"))} ${ssrInterpolate(unref(selectedVerbs).length === 1 ? unref(ui)("sélectionné") : unref(ui)("sélectionnés"))}</p><button class="preset-verb-overview__edit" type="button" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Modifier la liste"))}</button></div></header><ul${ssrRenderAttrs({ name: "preset-verb" })} data-v-dfe956b5>`);
            ssrRenderList(unref(displayedSelectedVerbs), (verb) => {
              _push(`<li data-v-dfe956b5>${ssrInterpolate(verb.infinitif)}</li>`);
            });
            _push(`</ul></section>`);
          } else {
            _push(`<!--[--><div class="wizard-step__intro wizard-step__intro--selection" data-v-dfe956b5><h2 id="verbs-title" data-v-dfe956b5>${ssrInterpolate(unref(isPrefilledChallenge) ? unref(ui)("Verbes du défi") : unref(ui)("Choisis les verbes"))}</h2></div>`);
          ...
          _push(`<div class="wizard-step__bottom-actions" data-v-dfe956b5><button class="primary-button wizard-step__cta wizard-next-pulse" type="button"${ssrRenderAttr("aria-label", unref(ui)("Étape suivante"))}${ssrIncludeBooleanAttr(!unref(selectedVerbs).length) ? " disabled" : ""} data-v-dfe956b5>${ssrInterpolate(unref(falcMode) ? "→" : unref(ui)("Choisir les temps →"))}</button></div></div>`);
        } else if (unref(currentStep) === 2) {
          _push(`<div class="wizard-step wizard-step--selection" aria-labelledby="tenses-title" data-v-dfe956b5><div class="wizard-step__actions wizard-step__actions--split" data-v-dfe956b5><button class="secondary-button" type="button"${ssrRenderAttr("aria-label", unref(ui)("Étape précédente"))} data-v-dfe956b5>${ssrInterpolate(unref(falcMode) ? "←" : unref(ui)("← Verbes"))}</button><div class="wizard-step__controls" data-v-dfe956b5><button class="primary-button wizard-step__cta wizard-next-pulse" type="button"${ssrRenderAttr("aria-label", unref(ui)("Étape suivante"))}${ssrIncludeBooleanAttr(!unref(selectedTenses).length) ? " disabled" : ""} data-v-dfe956b5>${ssrInterpolate(unref(falcMode) ? "→" : unref(ui)("Choisir les options →"))}</button></div></div><div class="wizard-step__intro wizard-step__intro--selection" data-v-dfe956b5><h2 data-v-dfe956b5>${ssrInterpolate(unref(falcMode) ? unref(ui)("Choisis les temps") : unref(isPrefilledChallenge) ? unref(ui)("Modes et temps") : unref(ui)("Choisis les modes et les temps"))}</h2></div>`);
          ...
          _push(`<div class="wizard-step wizard-review" data-v-dfe956b5><div class="wizard-step__actions wizard-step__actions--split" data-v-dfe956b5><button class="secondary-button" type="button"${ssrRenderAttr("aria-label", unref(ui)("Étape précédente"))} data-v-dfe956b5> ← `);
          if (!unref(falcMode)) {
            _push(`<!--[--><span class="mobile-label-hidden" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Modes et temps"))}</span><span class="mobile-label-only" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Temps"))}</span><!--]-->`);
          } else {
            _push(`<!---->`);
          }
          _push(`</button><div class="wizard-step__controls" data-v-dfe956b5><button class="primary-button wizard-step__cta wizard-step__cta--launch wizard-next-pulse" type="button" data-v-dfe956b5>${ssrInterpolate(unref(falcMode) ? unref(ui)("Commencer") : unref(ui)("Créer le défi"))}</button></div></div>`);
          if (!unref(falcMode)) {
            _push(`<div class="wizard-step__intro wizard-step__intro--selection" data-v-dfe956b5><h2 data-v-dfe956b5>${ssrInterpolate(unref(ui)("Options du défi"))}</h2></div>`);
          } else {
            _push(`<!---->`);
          }
          ...
          if (!unref(falcMode)) {
            _push(`<div class="wizard-step__bottom-actions" data-v-dfe956b5><button class="primary-button wizard-step__cta wizard-step__cta--launch wizard-next-pulse" type="button" data-v-dfe956b5>${ssrInterpolate(unref(falcMode) ? unref(ui)("Commencer") : unref(ui)("Créer le défi"))}</button></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        } else {
          _push(`<div class="wizard-step wizard-launch-step" data-v-dfe956b5>`);
          if (!props.startAtLaunch) {
            _push(`<div class="wizard-step__actions wizard-step__actions--split" data-v-dfe956b5><button class="secondary-button" type="button" data-v-dfe956b5>${ssrInterpolate(unref(ui)("← Options"))}</button></div>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(showLaunchSummary) || unref(showSavedChallengeSummary)) {
            _push(`<section class="launch-summary"${ssrRenderAttr("aria-labelledby", __props.launchTitle || unref(activePreset) || unref(savedChallengeTitle) ? "launch-challenge-title" : void 0)} data-v-dfe956b5><div class="${ssrRenderClass([{ "launch-summary__heading--public": __props.launchTitle }, "launch-summary__heading"])}" data-v-dfe956b5><div data-v-dfe956b5>`);
            if (__props.launchCategory || unref(activePreset)) {
              _push(`<p class="builder-card__eyebrow" data-v-dfe956b5>${ssrInterpolate(__props.launchCategory || unref(activePresetGroupLabel))}</p>`);
            } else {
              _push(`<!---->`);
            }
            if (__props.launchTitle) {
              _push(`<h1 id="launch-challenge-title" data-v-dfe956b5>${ssrInterpolate(__props.launchTitle)}</h1>`);
            } else if (unref(activePreset) || unref(savedChallengeTitle)) {
              _push(`<h2 id="launch-challenge-title" data-v-dfe956b5>${ssrInterpolate(unref(activePreset)?.label || unref(savedChallengeTitle))}</h2>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="launch-summary__counts" data-v-dfe956b5><span data-v-dfe956b5>${ssrInterpolate(unref(ui)(unref(selectedVerbs).length > 1 ? "{count} verbes" : "{count} verbe", { count: unref(selectedVerbs).length }))}</span><span data-v-dfe956b5>${ssrInterpolate(unref(ui)("{count} temps", { count: unref(selectedTenses).length }))}</span></div></div>`);
            if (__props.launchDescription || unref(activePreset)?.description || unref(savedChallengeDescription)) {
              _push(`<p class="launch-summary__description" data-v-dfe956b5>${ssrInterpolate(__props.launchDescription || unref(activePreset)?.description || unref(savedChallengeDescription))}</p>`);
            } else {
              _push(`<!---->`);
            }
            if (__props.launchEditHint) {
              _push(`<p class="launch-summary__edit-hint" data-v-dfe956b5><span data-v-dfe956b5>${ssrInterpolate(__props.launchEditHint.before)}</span><button class="launch-summary__step launch-summary__step--verbs" type="button"${ssrRenderAttr("aria-label", __props.launchEditHint.verbsLabel)} data-v-dfe956b5>1</button><span data-v-dfe956b5>${ssrInterpolate(__props.launchEditHint.between)}</span><button class="launch-summary__step launch-summary__step--tenses" type="button"${ssrRenderAttr("aria-label", __props.launchEditHint.tensesLabel)} data-v-dfe956b5>2</button><span data-v-dfe956b5>${ssrInterpolate(__props.launchEditHint.after)}</span></p>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</section>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(isTourWelcomeOpen) && !unref(guidedTourDisabled)) {
          _push2(`<div class="tour-welcome-backdrop" data-v-dfe956b5><section class="tour-welcome-dialog" role="dialog" aria-modal="true" aria-labelledby="tour-welcome-title" data-v-dfe956b5><div class="tour-welcome-dialog__languages" role="group"${ssrRenderAttr("aria-label", unref(ui)("Langue de l’interface"))} data-v-dfe956b5><!--[-->`);
          ssrRenderList(unref(tourLanguageOptions), (option) => {
            _push2(`<button type="button" class="${ssrRenderClass({ "is-active": unref(interfaceLocale) === option.value })}"${ssrRenderAttr("aria-label", option.label)}${ssrRenderAttr("aria-pressed", unref(interfaceLocale) === option.value)}${ssrRenderAttr("title", option.label)} data-v-dfe956b5><span aria-hidden="true" data-v-dfe956b5>${ssrInterpolate(option.flag)}</span></button>`);
          });
          _push2(`<!--]--></div><button class="tour-welcome-dialog__close" type="button"${ssrRenderAttr("aria-label", unref(ui)("Fermer"))} data-v-dfe956b5>×</button><span class="tour-welcome-dialog__icon" aria-hidden="true" data-v-dfe956b5>?</span><h2 id="tour-welcome-title" data-v-dfe956b5>${ssrInterpolate(unref(tourCopy).welcomeTitle)}</h2><p data-v-dfe956b5>${ssrInterpolate(unref(tourCopy).welcomeBody)}</p><div class="tour-welcome-dialog__choices" data-v-dfe956b5><button type="button" data-v-dfe956b5><strong data-v-dfe956b5>${ssrInterpolate(unref(tourCopy).quickTitle)}</strong><small data-v-dfe956b5>${ssrInterpolate(unref(tourCopy).quickMeta)}</small></button><button type="button" data-v-dfe956b5><strong data-v-dfe956b5>${ssrInterpolate(unref(tourCopy).fullTitle)}</strong><small data-v-dfe956b5>${ssrInterpolate(unref(tourCopy).fullMeta)}</small></button></div><button class="tour-welcome-dialog__later" type="button" data-v-dfe956b5>${ssrInterpolate(unref(ui)("Fermer"))}</button></section></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
const WizardChallengeWorkspace = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-dfe956b5"]]), { __name: "ChallengeWizardChallengeWorkspace" });

export { WizardChallengeWorkspace as W };
//# sourceMappingURL=WizardChallengeWorkspace-BKZ39LrQ.mjs.map
