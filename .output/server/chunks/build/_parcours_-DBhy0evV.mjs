...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "exercise-landing" }, _attrs))} data-v-5239dc7a><div class="exercise-landing__navigation" data-v-5239dc7a>`);
      ...
      _push(`</div><header class="exercise-landing__hero" data-v-5239dc7a><p data-v-5239dc7a>${ssrInterpolate(unref(page).eyebrow)}</p><h1 data-v-5239dc7a>${ssrInterpolate(unref(page).title)}</h1><p data-v-5239dc7a>${ssrInterpolate(unref(page).description)}</p>`);
      ...
      _push(`</header><div class="exercise-landing__content" data-v-5239dc7a><section class="exercise-landing__rule" data-v-5239dc7a><p class="exercise-landing__number" data-v-5239dc7a>01</p><div data-v-5239dc7a><h2 data-v-5239dc7a>${ssrInterpolate(unref(page).ruleTitle)}</h2><p data-v-5239dc7a>${ssrInterpolate(unref(page).rule)}</p></div></section><section class="exercise-landing__cards"${ssrRenderAttr("aria-labelledby", `${unref(slug)}-examples`)} data-v-5239dc7a><h2${ssrRenderAttr("id", `${unref(slug)}-examples`)} data-v-5239dc7a>${ssrInterpolate(unref(page).examplesTitle)}</h2><ul data-v-5239dc7a><!--[-->`);
      ssrRenderList(unref(page).examples, (example) => {
        _push(`<li data-v-5239dc7a>${ssrInterpolate(example)}</li>`);
      });
      _push(`<!--]--></ul></section><section class="exercise-landing__cards exercise-landing__cards--watch"${ssrRenderAttr("aria-labelledby", `${unref(slug)}-watch`)} data-v-5239dc7a><h2${ssrRenderAttr("id", `${unref(slug)}-watch`)} data-v-5239dc7a>${ssrInterpolate(unref(page).watchTitle)}</h2><ul data-v-5239dc7a><!--[-->`);
      ssrRenderList(unref(page).watchItems, (item) => {
        _push(`<li data-v-5239dc7a>${ssrInterpolate(item)}</li>`);
      });
      _push(`<!--]--></ul></section><section class="group-guide"${ssrRenderAttr("aria-labelledby", `${unref(slug)}-groups`)} data-v-5239dc7a><header data-v-5239dc7a><p class="exercise-landing__number" data-v-5239dc7a>02</p><div data-v-5239dc7a><h2${ssrRenderAttr("id", `${unref(slug)}-groups`)} data-v-5239dc7a>${ssrInterpolate(unref(groupGuide).title)}</h2><p data-v-5239dc7a>${ssrInterpolate(unref(groupGuide).intro)}</p></div></header><div class="group-guide__grid" data-v-5239dc7a><!--[-->`);
      ssrRenderList(unref(groupGuide).groups, (group) => {
        _push(`<article data-v-5239dc7a><header data-v-5239dc7a><span data-v-5239dc7a>${ssrInterpolate(group.label)}</span><strong data-v-5239dc7a>${ssrInterpolate(group.model)}</strong></header><p data-v-5239dc7a>${ssrInterpolate(group.explanation)}</p><code data-v-5239dc7a>${ssrInterpolate(group.formula)}</code><ul data-v-5239dc7a><!--[-->`);
        ssrRenderList(group.forms, (form) => {
          _push(`<li data-v-5239dc7a>${ssrInterpolate(form)}</li>`);
        });
        _push(`<!--]--></ul><small data-v-5239dc7a>${ssrInterpolate(group.note)}</small></article>`);
      });
      _push(`<!--]--></div><aside data-v-5239dc7a><h3 data-v-5239dc7a>${ssrInterpolate(unref(groupGuide).specialTitle)}</h3><ul data-v-5239dc7a><!--[-->`);
      ssrRenderList(unref(groupGuide).specialCases, (item) => {
        _push(`<li data-v-5239dc7a>${ssrInterpolate(item)}</li>`);
      });
      _push(`<!--]--></ul></aside></section><section class="exercise-landing__cta" data-v-5239dc7a><div data-v-5239dc7a><p data-v-5239dc7a>${ssrInterpolate(unref(page).eyebrow)}</p><h2 data-v-5239dc7a>${ssrInterpolate(unref(page).ctaTitle)}</h2><span data-v-5239dc7a>${ssrInterpolate(unref(page).ctaText)}</span></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: unref(exerciseUrl) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(page).ctaLabel)} <span aria-hidden="true" data-v-5239dc7a${_scopeId}>→</span>`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(page).ctaLabel) + " ", 1),
...
const _parcours_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5239dc7a"]]);

export { _parcours_ as default };
//# sourceMappingURL=_parcours_-DBhy0evV.mjs.map
