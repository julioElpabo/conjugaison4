...
function concealedRequestedFormsHtml(html, question) {
  var _a, _b;
  const forms = [...new Set([
    (_a = question.conjugaison1) == null ? void 0 : _a.trim(),
    (_b = question.conjugaison2) == null ? void 0 : _b.trim()
  ...
  return forms.reduce((rendered, form) => {
    ...
    return rendered.replace(
      ...
      (element, tag, attributes, content) => {
        const concealed = content.replace(exactForm, "<kbd>forme \xE0 trouver</kbd>");
...
function coachPairForPicker(coaches, random = Math.random) {
  ...
  const selectedIds = /* @__PURE__ */ new Set([female.id, male.id]);
  return coaches.filter((coach) => selectedIds.has(coach.id));
}

const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "CoachAllophoneHelpContent",
  ...
  setup(__props) {
    ...
    const displayedTenses = computed(() => props.tenses.filter((tense) => tense.selected !== false).map((tense) => ({
      ...tense,
    ...
    function tenseMode(tense) {
      return tense.mode?.name || "";
    }
    function lineText(row, tense) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "allophone-help" }, _attrs))} data-v-15e4acc2><section class="allophone-help__definition" data-v-15e4acc2><header data-v-15e4acc2><h3 data-v-15e4acc2>${ssrInterpolate(unref(ui)("Définition"))}</h3>`);
      if (__props.audioEnabled && __props.verbLabel && __props.definition) {
        _push(`<button type="button" class="${ssrRenderClass([{ "has-error": unref(audioErrorKey) === "definition" }, "allophone-help__audio"])}"${ssrRenderAttr("aria-label", unref(ui)("Écouter la définition"))}${ssrRenderAttr("aria-pressed", unref(audioPlayingKey) === "definition")}${ssrRenderAttr("title", unref(audioErrorKey) === "definition" ? unref(ui)("La lecture audio a échoué. Réessayer.") : void 0)} data-v-15e4acc2>`);
        _push(ssrRenderComponent(unref(FontAwesomeIcon), {
          icon: unref(audioLoadingKey) === "definition" ? unref(faSpinner) : unref(audioPlayingKey) === "definition" ? unref(faStop) : unref(faVolume),
          spin: unref(audioLoadingKey) === "definition",
          "aria-hidden": "true"
        }, null, _parent));
        _push(`</button>`);
      } else {
      ...
      _push(`</header><p data-v-15e4acc2><strong data-v-15e4acc2>${ssrInterpolate(__props.verbLabel)}</strong>`);
      if (__props.definition) {
        _push(`<!--[--> = ${ssrInterpolate(__props.definition)}<!--]-->`);
      } else {
        _push(`<!---->`);
      }
      _push(`</p></section>`);
      if (unref(loading)) {
        _push(`<p class="allophone-help__status" data-v-15e4acc2>${ssrInterpolate(unref(ui)("Chargement de la conjugaison…"))}</p>`);
      } else if (unref(loadError)) {
        _push(`<div class="allophone-help__error" role="alert" data-v-15e4acc2><p data-v-15e4acc2>${ssrInterpolate(unref(loadError))}</p><button type="button" data-v-15e4acc2>${ssrInterpolate(unref(ui)("Réessayer"))}</button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ssrRenderList(unref(displayedTenses), (tense) => {
        _push(`<details class="allophone-help__tense" data-v-15e4acc2><summary data-v-15e4acc2><span class="allophone-help__tense-title" data-v-15e4acc2><span class="allophone-help__expand" aria-hidden="true" data-v-15e4acc2>`);
        _push(ssrRenderComponent(unref(FontAwesomeIcon), {
          class: "allophone-help__expand-collapsed",
          icon: unref(faChevronRight)
        }, null, _parent));
        _push(ssrRenderComponent(unref(FontAwesomeIcon), {
          class: "allophone-help__expand-open",
          icon: unref(faChevronDown)
        }, null, _parent));
        _push(`</span><span data-v-15e4acc2>${ssrInterpolate(unref(uiLabel)(tense.name))}</span></span>`);
        if (__props.audioEnabled) {
          _push(`<button type="button" class="${ssrRenderClass([{ "has-error": unref(audioErrorKey) === `tense-${tense.id}` }, "allophone-help__audio"])}"${ssrRenderAttr("aria-label", unref(ui)("Écouter le nom du temps"))}${ssrRenderAttr("aria-pressed", unref(audioPlayingKey) === `tense-${tense.id}`)}${ssrRenderAttr("title", unref(audioErrorKey) === `tense-${tense.id}` ? unref(ui)("La lecture audio a échoué. Réessayer.") : void 0)} data-v-15e4acc2>`);
          _push(ssrRenderComponent(unref(FontAwesomeIcon), {
            icon: unref(audioLoadingKey) === `tense-${tense.id}` ? unref(faSpinner) : unref(audioPlayingKey) === `tense-${tense.id}` ? unref(faStop) : unref(faVolume),
            spin: unref(audioLoadingKey) === `tense-${tense.id}`,
            "aria-hidden": "true"
          }, null, _parent));
          _push(`</button>`);
        } else {
        ...
        _push(`</summary><ul data-v-15e4acc2><!--[-->`);
        ssrRenderList(tense.rows, (row) => {
          _push(`<li data-v-15e4acc2><span class="allophone-help__forms" data-v-15e4acc2><!--[-->`);
          ssrRenderList(row.forms, (form, index) => {
            _push(`<!--[-->`);
            if (index) {
              _push(`<span class="allophone-help__or" data-v-15e4acc2>${ssrInterpolate(unref(ui)("ou"))}</span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`<span data-v-15e4acc2>${ssrInterpolate(displayedForm(row, form, tenseMode(tense)))}</span><!--]-->`);
          });
          _push(`<!--]--></span>`);
          if (__props.audioEnabled && lineText(row, tense)) {
            _push(`<button type="button" class="${ssrRenderClass([{ "has-error": unref(audioErrorKey) === `line-${row.id}` }, "allophone-help__audio"])}"${ssrRenderAttr("aria-label", unref(ui)("Écouter cette ligne"))}${ssrRenderAttr("aria-pressed", unref(audioPlayingKey) === `line-${row.id}`)}${ssrRenderAttr("title", unref(audioErrorKey) === `line-${row.id}` ? unref(ui)("La lecture audio a échoué. Réessayer.") : void 0)} data-v-15e4acc2>`);
            _push(ssrRenderComponent(unref(FontAwesomeIcon), {
              icon: unref(audioLoadingKey) === `line-${row.id}` ? unref(faSpinner) : unref(audioPlayingKey) === `line-${row.id}` ? unref(faStop) : unref(faVolume),
              spin: unref(audioLoadingKey) === `line-${row.id}`,
              "aria-hidden": "true"
            }, null, _parent));
            _push(`</button>`);
          } else {
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/coach/CoachAllophoneHelpContent.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_0$1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-15e4acc2"]]), { __name: "CoachAllophoneHelpContent" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_CoachHelpBlockView = __nuxt_component_1;
      ...
      }, _attrs))} data-v-30641fa9>`);
      if (unref(renderedTitle)) {
        _push(`<h3 data-v-30641fa9>`);
        if (unref(orthographyKind)) {
          _push(`<span class="coach-help-block__letter" aria-hidden="true" data-v-30641fa9>${ssrInterpolate(unref(orthographyKind).toUpperCase())}</span>`);
        } else if (unref(isDefinitionBlock)) {
          _push(`<span class="coach-help-block__info-icon" aria-hidden="true" data-v-30641fa9>i</span>`);
        } else {
          _push(`<!---->`);
        }
      ...
      if (unref(renderedContent)) {
        _push(`<div class="${ssrRenderClass([{ "coach-help-block__content--radical": unref(isRadicalBlock), "coach-help-block__content--condensed-tense-rule": unref(isCondensedTenseRuleBlock) }, "coach-help-block__content"])}" data-v-30641fa9>${unref(renderedContent) ?? ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(activeChildren).length) {
        _push(`<div class="coach-help-block__children" data-v-30641fa9><!--[-->`);
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-30641fa9"]]), { __name: "CoachHelpBlockView" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    consultVerbId: {},
    consultVerbLabel: {},
    allophoneMode: { type: Boolean, default: false },
    allophoneDefinition: {},
    allophoneTenses: { default: () => [] },
    allophoneCoachId: {},
    allophoneAudioEnabled: { type: Boolean, default: false },
    revealedAnswers: { default: () => [] }
  },
  emits: ["close", "contentScroll", "previewScroll", "userScroll", "consultVerb", "changeCoach"],
  setup(__props, { emit: __emit }) {
    ...
    const recommendedApproaches = computed(() => {
    ...
    const recommendedCoachGroups = ref([]);
    ...
    async function loadRecommendedCoaches() {
      ...
      try {
        ...
        recommendedCoachGroups.value = approaches.map((approach) => {
          const available = response.coaches.filter((coach) => coach.status === "published" && coach.helpApproach === approach).sort((left, right) => left.sortOrder - right.sortOrder || left.firstName.localeCompare(right.firstName, "fr"));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_CoachAllophoneHelpContent = __nuxt_component_0$1;
      const _component_CoachHelpBlockView = __nuxt_component_1;
      ...
      }, _attrs))} data-v-cb90b06b><span class="coach-help-badge" data-v-cb90b06b>${ssrInterpolate(unref(ui)("Aide"))}</span><header class="coach-help-header" data-v-cb90b06b><div data-v-cb90b06b><h2 id="coach-help-title" data-v-cb90b06b>${ssrInterpolate(unref(renderedHeaderTitle))}</h2>`);
      if (unref(renderedHeaderDescription)) {
        _push(`<div class="coach-help-header__description" data-v-cb90b06b>${unref(renderedHeaderDescription) ?? ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (__props.showClose) {
        _push(`<button type="button"${ssrRenderAttr("aria-label", unref(ui)("Fermer l’aide"))} data-v-cb90b06b>×</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</header><div class="coach-help-content" tabindex="0"${ssrRenderAttr("aria-label", unref(renderedHeaderTitle))} data-v-cb90b06b>`);
      if (__props.revealedAnswers.length) {
        _push(`<section class="coach-help-revealed-answers" aria-live="polite" data-v-cb90b06b><strong data-v-cb90b06b>${ssrInterpolate(unref(ui)("Réponse après la première tentative"))}</strong><div data-v-cb90b06b><!--[-->`);
        ssrRenderList(__props.revealedAnswers, (answer) => {
          _push(`<span data-v-cb90b06b>${ssrInterpolate(answer)}</span>`);
        });
        _push(`<!--]--></div></section>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.allophoneMode) {
        _push(ssrRenderComponent(_component_CoachAllophoneHelpContent, {
          "verb-id": __props.consultVerbId,
          "verb-label": __props.consultVerbLabel,
          definition: __props.allophoneDefinition,
          tenses: __props.allophoneTenses,
          "coach-id": __props.allophoneCoachId,
          "audio-enabled": __props.allophoneAudioEnabled
        }, null, _parent));
      } else {
        _push(`<!--[-->`);
        if (__props.consultVerbId) {
          _push(`<section class="coach-help-consult" data-v-cb90b06b><div data-v-cb90b06b><strong data-v-cb90b06b>${ssrInterpolate(unref(ui)("Conjugaison complète"))}</strong><p data-v-cb90b06b>${ssrInterpolate(unref(ui)("Consulte toutes les formes du verbe {verb}.", { verb: __props.consultVerbLabel || "" }))}</p></div><button type="button" data-v-cb90b06b>${ssrInterpolate(unref(ui)("Consulter le verbe"))}</button></section>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
      ...
      if (__props.showFeedback) {
        _push(`<section class="coach-help-feedback" aria-labelledby="coach-help-feedback-title" data-v-cb90b06b><h3 id="coach-help-feedback-title" class="sr-only" data-v-cb90b06b>${ssrInterpolate(unref(ui)("Retour sur l’aide automatique"))}</h3><p data-v-cb90b06b>${ssrInterpolate(unref(ui)("Cette aide est générée automatiquement. Elle peut contenir une erreur ou manquer de clarté. Les retours permettent de l’améliorer."))}</p><div class="coach-help-feedback__actions" role="group"${ssrRenderAttr("aria-label", unref(ui)("Retour sur cette aide"))} data-v-cb90b06b><!--[-->`);
        ssrRenderList(unref(feedbackOptions), (option) => {
          _push(`<button type="button" class="${ssrRenderClass({ "is-selected": unref(feedbackType) === option.type })}"${ssrIncludeBooleanAttr(unref(feedbackStatus) === "sending") ? " disabled" : ""} data-v-cb90b06b><span aria-hidden="true" data-v-cb90b06b>${ssrInterpolate(option.icon)}</span> ${ssrInterpolate(option.label)}</button>`);
        });
        _push(`<!--]--></div>`);
        if (unref(feedbackRequiresComment) && unref(feedbackStatus) !== "sent") {
          _push(`<form class="coach-help-feedback__form" data-v-cb90b06b><label for="coach-help-feedback-comment" data-v-cb90b06b>${ssrInterpolate(unref(ui)("Remarque optionnelle"))}</label><textarea id="coach-help-feedback-comment" rows="3" maxlength="2000"${ssrRenderAttr("placeholder", unref(ui)("Précision utile pour corriger ou améliorer l’aide…"))} data-v-cb90b06b>${ssrInterpolate(unref(feedbackComment))}</textarea><button type="submit"${ssrIncludeBooleanAttr(unref(feedbackStatus) === "sending") ? " disabled" : ""} data-v-cb90b06b>${ssrInterpolate(unref(feedbackStatus) === "sending" ? unref(ui)("Envoi…") : unref(ui)("Envoyer le retour"))}</button></form>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(feedbackStatus) === "sent") {
          _push(`<p class="coach-help-feedback__status" data-v-cb90b06b>${ssrInterpolate(unref(ui)("Retour enregistré."))}</p>`);
        } else if (unref(feedbackError)) {
          _push(`<p class="coach-help-feedback__error" data-v-cb90b06b>${ssrInterpolate(unref(feedbackError))}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</section>`);
      ...
      if (unref(recommendedApproaches).length && !__props.embedded) {
        _push(`<section class="coach-help-feedback coach-help-recommendation" aria-labelledby="coach-help-recommendation-title" data-v-cb90b06b><strong id="coach-help-recommendation-title" data-v-cb90b06b>${ssrInterpolate(unref(ui)("Changer de niveau d’aide"))}</strong>`);
        if (unref(recommendationLoading)) {
          _push(`<p data-v-cb90b06b>${ssrInterpolate(unref(ui)("Chargement des coaches…"))}</p>`);
        } else if (unref(recommendedCoachGroups).length) {
          _push(`<div class="coach-help-recommendation__groups" data-v-cb90b06b><!--[-->`);
          ssrRenderList(unref(recommendedCoachGroups), (group) => {
            _push(`<section class="coach-help-recommendation__group" data-v-cb90b06b><header data-v-cb90b06b><strong data-v-cb90b06b>${ssrInterpolate(unref(ui)(group.title))}</strong><p data-v-cb90b06b>${ssrInterpolate(unref(ui)(group.description))}</p></header><div class="coach-help-recommendation__coaches" data-v-cb90b06b><!--[-->`);
            ssrRenderList(group.coaches, (recommendedCoach) => {
              _push(`<button type="button" style="${ssrRenderStyle({ "--recommended-coach-color": recommendedCoach.themeColor })}"${ssrRenderAttr("aria-label", unref(ui)("Choisir {name}", { name: recommendedCoach.firstName }))} data-v-cb90b06b><img${ssrRenderAttr("src", recommendedCoach.avatarPath)}${ssrRenderAttr("alt", unref(ui)("Avatar de {name}", { name: recommendedCoach.firstName }))} data-v-cb90b06b><span data-v-cb90b06b><strong data-v-cb90b06b>${ssrInterpolate(recommendedCoach.firstName)}</strong><small data-v-cb90b06b>${ssrInterpolate(recommendedCoach.pedagogicalStyle)}</small></span></button>`);
            });
            _push(`<!--]--></div></section>`);
          });
          _push(`<!--]--><p class="coach-help-recommendation__note" data-v-cb90b06b>${ssrInterpolate(unref(ui)("Le changement s’applique immédiatement à cette question."))}</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</section>`);
      ...
      _push(`</div><footer class="coach-help-footer" data-v-cb90b06b><button type="button" data-v-cb90b06b>${ssrInterpolate(unref(ui)("Fermer"))}</button></footer></aside>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-cb90b06b"]]), { __name: "CoachHelpPanel" });
...
//# sourceMappingURL=CoachHelpPanel-BQHM-KrB.mjs.map
