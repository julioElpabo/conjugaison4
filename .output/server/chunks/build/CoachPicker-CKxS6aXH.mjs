  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        _push2(`<div class="coach-picker-overlay" data-tour="coach-picker" data-v-752f8a12><section class="coach-picker" role="dialog" aria-modal="true" aria-labelledby="coach-picker-title"${ssrRenderAttr("aria-busy", __props.selectionPending)} data-v-752f8a12><header data-v-752f8a12><div data-v-752f8a12><h2 id="coach-picker-title" data-v-752f8a12>${ssrInterpolate(unref(ui)("Choisis ton coach"))}</h2></div><button type="button"${ssrRenderAttr("aria-label", unref(ui)("Fermer"))}${ssrIncludeBooleanAttr(__props.selectionPending) ? " disabled" : ""} data-v-752f8a12>×</button></header>`);
        if (__props.selectionPending) {
          _push2(`<p class="coach-picker__state coach-picker__state--pending" role="status" data-v-752f8a12>${ssrInterpolate(unref(ui)("Préparation de la séance…"))}</p>`);
        } else if (__props.selectionError) {
          _push2(`<p class="coach-picker__state coach-picker__state--error" role="alert" data-v-752f8a12>${ssrInterpolate(__props.selectionError)}</p>`);
        } else {
          _push2(`<!---->`);
        }
        if (unref(loading)) {
          _push2(`<p class="coach-picker__state" data-v-752f8a12>${ssrInterpolate(unref(ui)("Chargement des coaches…"))}</p>`);
        } else if (unref(error)) {
          _push2(`<p class="coach-picker__state coach-picker__state--error" data-v-752f8a12>${ssrInterpolate(unref(error))}</p>`);
        } else {
          _push2(`<div class="coach-picker__groups" data-v-752f8a12><!--[-->`);
          ssrRenderList(unref(coachGroups), (group) => {
            _push2(`<section class="coach-caractere-group"${ssrRenderAttr("data-tour", group.approach === "complete" ? "coach-complete-group" : void 0)} data-v-752f8a12>`);
            if (!unref(allophoneOnly)) {
              _push2(`<header class="coach-caractere-group__header" data-v-752f8a12><div data-v-752f8a12><h3 data-v-752f8a12>${ssrInterpolate(group.label)}</h3><p data-v-752f8a12>${ssrInterpolate(group.description)}</p></div></header>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="coach-picker__grid" data-v-752f8a12><!--[-->`);
            ssrRenderList(group.coaches, (coach) => {
              _push2(`<button type="button" class="coach-card" style="${ssrRenderStyle({ "--coach-color": coach.themeColor })}"${ssrIncludeBooleanAttr(__props.selectionPending) ? " disabled" : ""} data-v-752f8a12><img${ssrRenderAttr("src", coach.avatarPath)}${ssrRenderAttr("alt", unref(ui)("Avatar de {name}", { name: coach.firstName }))} data-v-752f8a12><strong data-v-752f8a12>${ssrInterpolate(coach.firstName)}</strong></button>`);
            });
            _push2(`<!--]--></div></section>`);
          });
          _push2(`<!--]--></div>`);
...
const CoachPicker = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-752f8a12"]]), { __name: "ExerciseCoachPicker" });

export { CoachPicker as default };
//# sourceMappingURL=CoachPicker-CKxS6aXH.mjs.map
