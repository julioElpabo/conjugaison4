import { X as challengePresetGroupLabels, y as getRequestURL, F as legacyComplementOptions, G as legacyComplementConfig, a2 as challengePresetGroupOrder } from '../nitro/nitro.mjs';
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["updateQuestionCount", "updateExerciseKind", "updateInclusivePronouns", "updateComplementOptions", "prefilledOptionsRevealStart"],
  setup(__props, { emit: __emit }) {
    const { ui } = useLanguagePreferences();
    const props = __props;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-0408ee7c><div class="builder-card__header" data-v-0408ee7c><div data-v-0408ee7c><p class="builder-card__eyebrow" data-v-0408ee7c>${ssrInterpolate(__props.eyebrow ?? "Étape 3")}</p><h2${ssrRenderAttr("id", unref(optionsTitleId))} data-v-0408ee7c>${ssrInterpolate(unref(ui)("Mes options"))}</h2></div></div><div class="${ssrRenderClass([{ "options-layout--columns": __props.gridLayout }, "options-layout"])}" data-v-0408ee7c><div class="${ssrRenderClass([{ "options-fields--columns": __props.gridLayout }, "options-fields"])}" data-v-0408ee7c><div class="options-main-column" data-v-0408ee7c><label class="field-stack question-count-field"${ssrRenderAttr("for", unref(questionCountId))} data-v-0408ee7c><span data-v-0408ee7c>${ssrInterpolate(unref(ui)("Nombre de questions"))}</span><input${ssrRenderAttr("id", unref(questionCountId))} type="number" inputmode="numeric" min="1" max="99" step="1"${ssrRenderAttr("value", unref(displayedQuestionCount))} data-v-0408ee7c></label><label class="check-row" data-v-0408ee7c><input type="checkbox"${ssrIncludeBooleanAttr(__props.inclusivePronouns) ? " checked" : ""} data-v-0408ee7c><span data-v-0408ee7c>${ssrInterpolate(unref(ui)("Inclure les pronoms"))} <strong data-v-0408ee7c>iel / iels</strong><small data-v-0408ee7c>${ssrInterpolate(unref(ui)("Ils apparaîtront ponctuellement dans les questions."))}</small></span></label><fieldset class="option-fieldset" data-v-0408ee7c><legend data-v-0408ee7c>${ssrInterpolate(unref(ui)("Type d’exercice"))}</legend><div class="segmented-control" data-v-0408ee7c><label data-v-0408ee7c><input type="radio"${ssrRenderAttr("name", unref(exerciseKindName))} value="conjugation"${ssrIncludeBooleanAttr(__props.exerciseKind === "conjugation") ? " checked" : ""} data-v-0408ee7c><span data-v-0408ee7c>${ssrInterpolate(unref(ui)("Conjuguer"))}</span></label><label data-v-0408ee7c><input type="radio"${ssrRenderAttr("name", unref(exerciseKindName))} value="tense-identification"${ssrIncludeBooleanAttr(__props.exerciseKind === "tense-identification") ? " checked" : ""} data-v-0408ee7c><span data-v-0408ee7c>${ssrInterpolate(unref(ui)("Trouver le mode et le temps"))}</span></label></div></fieldset></div><div data-tour="options-complements" class="${ssrRenderClass([{
      ...
      }, "complement-options"])}"${ssrRenderAttr("aria-hidden", __props.gridLayout && __props.exerciseKind === "tense-identification" ? "true" : void 0)} data-v-0408ee7c>`);
      if (__props.gridLayout) {
        _push(`<h3 class="complement-options__title" data-v-0408ee7c>${ssrInterpolate(unref(ui)("Compléments d’objets :"))}</h3>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.gridLayout) {
        _push(`<p class="complement-options__description" data-v-0408ee7c>${ssrInterpolate(unref(ui)("Ajoute des compléments d’objets directs ou indirects."))}</p>`);
      } else {
        _push(`<button class="complement-options__trigger" type="button"${ssrIncludeBooleanAttr(!unref(complementsAvailable)) ? " disabled" : ""}${ssrRenderAttr("aria-expanded", unref(complementsOpen))}${ssrRenderAttr("aria-controls", unref(complementPanelId))} data-v-0408ee7c><span data-v-0408ee7c>${ssrInterpolate(unref(ui)("Compléments d’objets :"))} <small data-v-0408ee7c>${ssrInterpolate(unref(ui)("nouveau"))}</small></span><span aria-hidden="true" data-v-0408ee7c>${ssrInterpolate(unref(complementsOpen) ? "−" : "+")}</span></button>`);
      }
      if (!unref(complementsAvailable)) {
        _push(`<p class="complement-options__unavailable" data-v-0408ee7c>${ssrInterpolate(__props.exerciseKind !== "conjugation" ? "Disponible uniquement pour un exercice de conjugaison." : "Les verbes choisis ne proposent pas de complément.")}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.gridLayout || unref(complementsOpen)) {
        _push(`<fieldset${ssrRenderAttr("id", unref(complementPanelId))} class="complement-options__panel" data-v-0408ee7c><legend class="sr-only" data-v-0408ee7c>${ssrInterpolate(unref(ui)("Présentation des compléments d’objets"))}</legend><label data-v-0408ee7c><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(codAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("cod-after")) ? " checked" : ""} data-v-0408ee7c><span data-v-0408ee7c><strong data-v-0408ee7c>${ssrInterpolate(unref(ui)("COD placé après"))}</strong></span></label><label data-v-0408ee7c><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(codBeforeAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("cod-before")) ? " checked" : ""} data-v-0408ee7c><span data-v-0408ee7c><strong data-v-0408ee7c>${ssrInterpolate(unref(ui)("COD placé avant"))}</strong></span></label><label data-v-0408ee7c><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(coiAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("coi-after")) ? " checked" : ""} data-v-0408ee7c><span data-v-0408ee7c><strong data-v-0408ee7c>${ssrInterpolate(unref(ui)("COI placé après"))}</strong></span></label><label data-v-0408ee7c><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(coiBeforeAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("coi-before")) ? " checked" : ""} data-v-0408ee7c><span data-v-0408ee7c><strong data-v-0408ee7c>${ssrInterpolate(unref(ui)("COI placé avant"))}</strong></span></label></fieldset>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
      if (__props.gridLayout && (__props.conjugationExampleLoading || unref(hasConjugationExample))) {
        _push(`<div data-tour="options-preview" class="${ssrRenderClass([{ "conjugation-example--wide": __props.exerciseKind === "tense-identification" }, "conjugation-example"])}" aria-live="polite" aria-atomic="true" data-v-0408ee7c><div class="conjugation-example__header" data-v-0408ee7c><span class="conjugation-example__preview-icon" aria-hidden="true" data-v-0408ee7c><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" data-v-0408ee7c><path d="M1.5 12s3.8-7 10.5-7 10.5 7 10.5 7-3.8 7-10.5 7S1.5 12 1.5 12Z" data-v-0408ee7c></path><circle cx="12" cy="12" r="3" data-v-0408ee7c></circle></svg></span><div class="conjugation-example__heading" data-v-0408ee7c><span data-v-0408ee7c>${ssrInterpolate(unref(ui)("Aperçu d’une question"))}</span></div></div><div class="conjugation-example__screen" data-v-0408ee7c>`);
        if (__props.conjugationExampleLoading) {
          _push(`<div class="conjugation-example__loading" role="status" data-v-0408ee7c><span class="conjugation-example__spinner" aria-hidden="true" data-v-0408ee7c></span><span class="sr-only" data-v-0408ee7c>${ssrInterpolate(unref(ui)("Préparation de l’aperçu"))}</span></div>`);
        } else {
          _push(`<div class="conjugation-example__body" data-v-0408ee7c>`);
          if (unref(exampleRevealStage) >= 1) {
            _push(`<div class="conjugation-example__question" data-v-0408ee7c><span class="conjugation-example__block-label" data-v-0408ee7c>${ssrInterpolate(unref(ui)("Exemple de question"))}</span>`);
            if (__props.exerciseKind === "tense-identification" && __props.conjugationInstruction && __props.conjugationQuestion) {
              _push(`<p class="conjugation-example__question-line" data-v-0408ee7c><span class="conjugation-example__context" data-v-0408ee7c>${ssrInterpolate(__props.conjugationInstruction)}</span><span class="conjugation-example__question-separator" aria-hidden="true" data-v-0408ee7c>—</span><span class="conjugation-example__prompt" data-v-0408ee7c>${ssrInterpolate(unref(identificationQuestion))}</span></p>`);
            } else {
              _push(`<!--[-->`);
              if (__props.conjugationInstruction) {
                _push(`<p class="conjugation-example__instruction" data-v-0408ee7c>${ssrInterpolate(__props.conjugationInstruction)}</p>`);
              } else {
                _push(`<!---->`);
              }
              if (__props.conjugationQuestionContext) {
                _push(`<p class="conjugation-example__question-line" data-v-0408ee7c><span class="conjugation-example__context" data-v-0408ee7c>${ssrInterpolate(__props.conjugationQuestionContext)}</span></p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
          ...
          if (unref(exampleRevealStage) >= 2) {
            _push(`<div class="conjugation-example__correction" data-v-0408ee7c><span data-v-0408ee7c>${ssrInterpolate(unref(ui)("Réponse attendue"))}</span><p data-v-0408ee7c>`);
            if (__props.conjugationExampleEmphasis) {
              _push(`<!--[--><span data-v-0408ee7c>${ssrInterpolate(__props.conjugationExamplePrefix)}</span><strong data-v-0408ee7c>${ssrInterpolate(__props.conjugationExampleEmphasis)}</strong><span data-v-0408ee7c>${ssrInterpolate(__props.conjugationExampleSuffix)}</span><!--]-->`);
            } else {
              _push(`<span data-v-0408ee7c>${ssrInterpolate(__props.conjugationExample)}</span>`);
            }
            _push(`</p></div>`);
          } else {
            _push(`<!---->`);
...
const ChallengeOptions = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["__scopeId", "data-v-0408ee7c"]]), { __name: "ChallengeOptions" });
  ...
  setup(__props, { emit: __emit }) {
    ...
    const exercisePages = computed(() => paginateByHeight(
      ...
      (question) => {
        ...
        return exerciseItemHeight(printableQuestion(question, props.exerciseKind), questionSpacingMm.value) + (printable.suffixOnNextLine ? 6 : 0);
      }
    ));
    ...
    async function buildPdf() {
      ...
      function drawExercisePage(page, continuation) {
        ...
        page.forEach(({ item: question, index }) => {
          ...
          const completionLines = printable.fillBlank ? [pdfSafe(capitalizePrintLine(printable.completion))] : pdf.splitTextToSize(pdfSafe(capitalizePrintLine(printable.completion)), completionWidth);
      ...
      function drawCorrectionPage(page, continuation) {
        ...
        page.forEach(({ item: question, index }) => {
          ...
          const answer = printableCorrectionAnswers(question).flatMap((value) => pdf.splitTextToSize(pdfSafe(capitalizePrintText(value)), 82));
...
//# sourceMappingURL=url-DAL47GEB.mjs.map
