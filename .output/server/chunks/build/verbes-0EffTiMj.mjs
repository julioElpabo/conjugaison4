    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(searchOpen)) {
        ...
        ssrRenderList(unref(suggestions), (verb, index) => {
          _push(`<li${ssrRenderAttr("id", `admin-verb-option-${verb.id}`)} role="option"${ssrRenderAttr("aria-selected", index === unref(activeIndex))} data-v-06f17d2d><button type="button" class="${ssrRenderClass({ "is-active": index === unref(activeIndex) })}" data-v-06f17d2d><strong data-v-06f17d2d>${ssrInterpolate(verb.infinitif)}</strong><span data-v-06f17d2d>auxiliaire ${ssrInterpolate(verb.auxiliaire)}</span></button></li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
        _push(`<!---->`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_AdminShell, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="admin-home" data-v-98eece0d${_scopeId2}><header class="admin-section-heading admin-home__heading" data-v-98eece0d${_scopeId2}><div data-v-98eece0d${_scopeId2}><p class="admin-eyebrow" data-v-98eece0d${_scopeId2}>Données de conjugaison</p><h1 data-v-98eece0d${_scopeId2}>Gestion des verbes</h1><p class="admin-muted" data-v-98eece0d${_scopeId2}> Modifiez les fiches, les formes conjuguées et les variantes acceptées. </p></div></header>`);
                  if (unref(catalogueError)) {
                    _push3(`<p class="admin-notice admin-notice--error" role="alert" data-v-98eece0d${_scopeId2}>${ssrInterpolate(unref(catalogueError))} <button class="admin-button admin-button--small" type="button" data-v-98eece0d${_scopeId2}> Réessayer </button></p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<div class="admin-home__workspace" data-v-98eece0d${_scopeId2}>`);
                  ...
                  _push3(`<div class="admin-home__editor" data-v-98eece0d${_scopeId2}>`);
                  if (unref(showCreate)) {
                    ...
                    _push3(`<div class="admin-home__placeholder" role="status" data-v-98eece0d${_scopeId2}><span class="admin-spinner" aria-hidden="true" data-v-98eece0d${_scopeId2}></span><p data-v-98eece0d${_scopeId2}>Chargement du verbe…</p></div>`);
                  } else if (unref(detailError)) {
                    _push3(`<div class="admin-home__placeholder" data-v-98eece0d${_scopeId2}><p class="admin-notice admin-notice--error" role="alert" data-v-98eece0d${_scopeId2}>${ssrInterpolate(unref(detailError))}</p>`);
                    if (unref(selectedId)) {
                      _push3(`<button class="admin-button" type="button" data-v-98eece0d${_scopeId2}> Réessayer </button>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div>`);
                    ...
                    _push3(`<div class="admin-home__placeholder" data-v-98eece0d${_scopeId2}><p class="admin-muted" data-v-98eece0d${_scopeId2}>Sélectionnez un verbe dans le catalogue ou créez-en un nouveau.</p></div>`);
                  }
                  _push3(`</div></div></div>`);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/verbes.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const verbes = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-98eece0d"]]);

export { verbes as default };
//# sourceMappingURL=verbes-0EffTiMj.mjs.map
