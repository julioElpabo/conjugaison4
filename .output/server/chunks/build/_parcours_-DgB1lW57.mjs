...
import { g as useRoute, f as useLanguagePreferences, k as createError, n as navigateTo, u as useHead, m as useSeoMeta } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => navigateTo(localePath(`/modes/indicatif/${slug}`), { redirectCode: 301 })), await __temp, __restore();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "exercise-landing" }, _attrs))} data-v-3bab40e1><div class="exercise-landing__navigation" data-v-3bab40e1>`);
      ...
      _push(`</div><header class="exercise-landing__hero" data-v-3bab40e1><p data-v-3bab40e1>${ssrInterpolate(unref(page).eyebrow)}</p><h1 data-v-3bab40e1>${ssrInterpolate(unref(page).title)}</h1><p data-v-3bab40e1>${ssrInterpolate(unref(page).description)}</p>`);
      ...
      _push(`</header><div class="exercise-landing__content" data-v-3bab40e1><section class="exercise-landing__rule" data-v-3bab40e1><p class="exercise-landing__number" data-v-3bab40e1>01</p><div data-v-3bab40e1><h2 data-v-3bab40e1>${ssrInterpolate(unref(page).ruleTitle)}</h2><p data-v-3bab40e1>${ssrInterpolate(unref(page).rule)}</p></div></section><section class="exercise-landing__cards"${ssrRenderAttr("aria-labelledby", `${unref(slug)}-examples`)} data-v-3bab40e1><h2${ssrRenderAttr("id", `${unref(slug)}-examples`)} data-v-3bab40e1>${ssrInterpolate(unref(page).examplesTitle)}</h2><ul data-v-3bab40e1><!--[-->`);
      ssrRenderList(unref(page).examples, (example) => {
        _push(`<li data-v-3bab40e1>${ssrInterpolate(example)}</li>`);
      });
      _push(`<!--]--></ul></section><section class="exercise-landing__cards exercise-landing__cards--watch"${ssrRenderAttr("aria-labelledby", `${unref(slug)}-watch`)} data-v-3bab40e1><h2${ssrRenderAttr("id", `${unref(slug)}-watch`)} data-v-3bab40e1>${ssrInterpolate(unref(page).watchTitle)}</h2><ul data-v-3bab40e1><!--[-->`);
      ssrRenderList(unref(page).watchItems, (item) => {
        _push(`<li data-v-3bab40e1>${ssrInterpolate(item)}</li>`);
      });
      _push(`<!--]--></ul></section><section class="group-guide"${ssrRenderAttr("aria-labelledby", `${unref(slug)}-groups`)} data-v-3bab40e1><header data-v-3bab40e1><p class="exercise-landing__number" data-v-3bab40e1>02</p><div data-v-3bab40e1><h2${ssrRenderAttr("id", `${unref(slug)}-groups`)} data-v-3bab40e1>${ssrInterpolate(unref(groupGuide).title)}</h2><p data-v-3bab40e1>${ssrInterpolate(unref(groupGuide).intro)}</p></div></header><div class="group-guide__grid" data-v-3bab40e1><!--[-->`);
      ssrRenderList(unref(groupGuide).groups, (group) => {
        _push(`<article data-v-3bab40e1><header data-v-3bab40e1><span data-v-3bab40e1>${ssrInterpolate(group.label)}</span><strong data-v-3bab40e1>${ssrInterpolate(group.model)}</strong></header><p data-v-3bab40e1>${ssrInterpolate(group.explanation)}</p><code data-v-3bab40e1>${ssrInterpolate(group.formula)}</code><ul data-v-3bab40e1><!--[-->`);
        ssrRenderList(group.forms, (form) => {
          _push(`<li data-v-3bab40e1>${ssrInterpolate(form)}</li>`);
        });
        _push(`<!--]--></ul><small data-v-3bab40e1>${ssrInterpolate(group.note)}</small></article>`);
      });
      _push(`<!--]--></div><aside data-v-3bab40e1><h3 data-v-3bab40e1>${ssrInterpolate(unref(groupGuide).specialTitle)}</h3><ul data-v-3bab40e1><!--[-->`);
      ssrRenderList(unref(groupGuide).specialCases, (item) => {
        _push(`<li data-v-3bab40e1>${ssrInterpolate(item)}</li>`);
      });
      _push(`<!--]--></ul></aside></section><section class="exercise-landing__cta" data-v-3bab40e1><div data-v-3bab40e1><p data-v-3bab40e1>${ssrInterpolate(unref(page).eyebrow)}</p><h2 data-v-3bab40e1>${ssrInterpolate(unref(page).ctaTitle)}</h2><span data-v-3bab40e1>${ssrInterpolate(unref(page).ctaText)}</span></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: unref(exerciseUrl) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(page).ctaLabel)} <span aria-hidden="true" data-v-3bab40e1${_scopeId}>→</span>`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(page).ctaLabel) + " ", 1),
...
const _parcours_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3bab40e1"]]);

export { _parcours_ as default };
//# sourceMappingURL=_parcours_-DgB1lW57.mjs.map
