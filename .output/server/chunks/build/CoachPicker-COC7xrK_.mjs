...
import { ssrRenderTeleport, ssrRenderAttr, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrRenderComponent, ssrRenderAttrs } from 'vue/server-renderer';
import { az as SUBJECT_PRONOUN_PLACEHOLDER, Q as validateConjugationAnswer, R as validateAnswer, ai as conjugationRequiresSubjectPronoun, aA as conjugationAnswerPlaceholder, aB as getAlternativeCorrections, aC as impossibleSingularEndingReminderMessage, W as grammarTenseCode, aD as localizedLearnerErrorMessage, aE as isFutureSimpleInsteadOfNearFuture, aF as findConjugationConfusions, aG as findImpossibleSingularEnding, aH as diagnoseCoachAgreement, aI as diagnoseCoachAnswer, V as learnerErrorDetails, aJ as mergeLearnerErrorDetails, aK as learnerErrorInsteadOf } from '../nitro/nitro.mjs';
...
const LearnerErrorDetailMessage = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$6, [["__scopeId", "data-v-56038c0b"]]), { __name: "ExerciseLearnerErrorDetailMessage" });
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["__scopeId", "data-v-dbdb34db"]]), { __name: "ExerciseSummaryPrintPreview" });
...
const LearnerErrorFeedback = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-c69925e4"]]), { __name: "ExerciseLearnerErrorFeedback" });
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        _push2(`<div class="summary-share-overlay" data-v-d2b3ffb9><section class="summary-share-dialog" role="dialog" aria-modal="true" aria-labelledby="summary-share-title" tabindex="-1" data-v-d2b3ffb9><button class="summary-share-dialog__close" type="button"${ssrRenderAttr("aria-label", unref(ui)("Fermer"))} data-v-d2b3ffb9>×</button><p class="summary-share-dialog__kicker" data-v-d2b3ffb9>${ssrInterpolate(unref(ui)("PARTAGER MON BILAN"))}</p><h2 id="summary-share-title" data-v-d2b3ffb9>${ssrInterpolate(unref(ui)("Mon bilan est prêt à être envoyé"))}</h2><p data-v-d2b3ffb9>${ssrInterpolate(unref(ui)("Il te suffit d’envoyer ce lien à la personne de ton choix, par e-mail, WhatsApp ou tout autre moyen. En l’ouvrant, elle verra directement ton bilan. Le lien restera disponible pendant un mois."))}</p>`);
        if (unref(busy)) {
          _push2(`<div class="summary-share-dialog__state" role="status" data-v-d2b3ffb9><span aria-hidden="true" data-v-d2b3ffb9></span><strong data-v-d2b3ffb9>${ssrInterpolate(unref(ui)("Création du lien…"))}</strong></div>`);
        } else if (unref(shareUrl)) {
          _push2(`<!--[--><label for="shared-summary-url" data-v-d2b3ffb9>${ssrInterpolate(unref(ui)("Lien complet à envoyer"))}</label><div class="summary-share-dialog__link" data-v-d2b3ffb9><input id="shared-summary-url"${ssrRenderAttr("value", unref(shareUrl))} readonly data-v-d2b3ffb9><button class="primary-button" type="button" data-v-d2b3ffb9>${ssrInterpolate(unref(ui)("Copier le lien"))}</button></div>`);
          if (unref(copyStatus)) {
            _push2(`<p class="summary-share-dialog__copy-status" role="status" data-v-d2b3ffb9>${ssrInterpolate(unref(copyStatus))}</p>`);
          } else {
            _push2(`<!---->`);
          }
          if (unref(canNativeShare)) {
            _push2(`<button class="secondary-button summary-share-dialog__native-share" type="button" data-v-d2b3ffb9>${ssrInterpolate(unref(ui)("Partager avec une application…"))}</button>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<small data-v-d2b3ffb9>${ssrInterpolate(unref(ui)("Toute personne qui possède ce lien peut consulter le bilan."))}</small><!--]-->`);
        } else {
          _push2(`<div class="summary-share-dialog__error" role="alert" data-v-d2b3ffb9><p data-v-d2b3ffb9>${ssrInterpolate(unref(error))}</p><button class="primary-button" type="button" data-v-d2b3ffb9>${ssrInterpolate(unref(ui)("Réessayer"))}</button></div>`);
        }
        _push2(`</section></div>`);
      }, "body", false, _parent);
    };
...
const ShareExerciseSummaryDialog = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-d2b3ffb9"]]), { __name: "ExerciseShareExerciseSummaryDialog" });
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        _push2(`<div class="chat-overlay" data-tour="chat-exercise" style="${ssrRenderStyle(unref(tourDemoReady) ? null : { display: "none" })}" data-v-13157351><div class="${ssrRenderClass([{ "chat-dialogs--with-help": unref(helpOpen), "chat-dialogs--confirming": unref(closeConfirmationOpen) }, "chat-dialogs"])}" style="${ssrRenderStyle({ "--coach-color": __props.coach.themeColor })}" role="dialog" aria-modal="true" aria-labelledby="chat-title" tabindex="-1" data-v-13157351><section class="chat-dialog" data-tour="chat-dialog" role="region" aria-labelledby="chat-title" data-v-13157351><header class="chat-header" data-v-13157351><img class="coach-avatar"${ssrRenderAttr("src", __props.coach.avatarPath)} alt="" data-v-13157351><div class="chat-header__identity" data-v-13157351><h2 id="chat-title" data-v-13157351>${ssrInterpolate(__props.coach.firstName)}</h2>`);
        if (__props.coach.likes) {
          _push2(`<p class="chat-header__likes" data-v-13157351><strong data-v-13157351>${ssrInterpolate(unref(ui)("Aime :"))}</strong> ${ssrInterpolate(__props.coach.likes)}</p>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</div><div class="chat-header__actions" data-v-13157351><button type="button" class="chat-close"${ssrRenderAttr("aria-label", unref(ui)("Quitter le chat"))} data-v-13157351>×</button></div></header><div class="chat-progress"${ssrRenderAttr("aria-label", unref(ui)("Progression"))} data-v-13157351><span style="${ssrRenderStyle({ width: `${unref(finished) ? 100 : (unref(questionNumberOffset) + unref(currentIndex)) / unref(displayedQuestionCount) * 100}%` })}" data-v-13157351></span></div>`);
        if (!unref(finished) && unref(currentQuestion)) {
          _push2(`<div class="chat-instruction" data-v-13157351><span data-v-13157351>${ssrInterpolate(unref(ui)("Question {current} sur {total}", { current: unref(displayedQuestionNumber), total: unref(displayedQuestionCount) }))}</span></div>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<div class="chat-thread" aria-live="polite" data-v-13157351><!--[-->`);
        ssrRenderList(unref(visibleMessages), (message) => {
          ...
          if (message.errorDetails?.length) {
            ...
            _push2(`<div class="chat-literary-question" data-v-13157351><blockquote class="chat-literary-citation" data-v-13157351><p data-v-13157351><span data-v-13157351>${ssrInterpolate(message.literaryCitation.before)}</span><mark data-v-13157351>${ssrInterpolate(message.literaryCitation.target)}</mark><span data-v-13157351>${ssrInterpolate(message.literaryCitation.after)}</span></p><footer data-v-13157351>${ssrInterpolate(message.literaryCitation.author)}, <cite data-v-13157351>${ssrInterpolate(message.literaryCitation.work)}</cite></footer></blockquote></div>`);
          } else if (message.identificationForm) {
            _push2(`<p class="chat-identification-form" data-v-13157351><span data-v-13157351>${ssrInterpolate(message.identificationForm.before)}</span><mark data-v-13157351>${ssrInterpolate(message.identificationForm.target)}</mark><span data-v-13157351>${ssrInterpolate(message.identificationForm.after)}</span></p>`);
          } else if (message.answerComparison) {
            _push2(`<div class="answer-comparison" data-v-13157351><strong data-v-13157351>${ssrInterpolate(message.answerComparison.mode === "focused" ? unref(ui)("Regarde où ça change :") : unref(ui)("Repars de la correction complète :"))}</strong><div class="answer-comparison__line answer-comparison__line--learner" data-v-13157351><small data-v-13157351>${ssrInterpolate(unref(ui)("Ta réponse"))}</small><p data-v-13157351><!--[-->`);
            ssrRenderList(message.answerComparison.learnerParts, (part, partIndex) => {
              _push2(`<span class="${ssrRenderClass(`answer-comparison__part--${part.kind}`)}" data-v-13157351>${ssrInterpolate(part.text)}</span>`);
            });
            _push2(`<!--]--></p></div><div class="answer-comparison__line answer-comparison__line--expected" data-v-13157351><small data-v-13157351>${ssrInterpolate(unref(ui)("Correction"))}</small><p data-v-13157351><!--[-->`);
            ssrRenderList(message.answerComparison.expectedParts, (part, partIndex) => {
              _push2(`<span class="${ssrRenderClass(`answer-comparison__part--${part.kind}`)}" data-v-13157351>${ssrInterpolate(part.text)}</span>`);
            });
            _push2(`<!--]--></p></div>`);
            if (message.answerComparison.mode === "full") {
              _push2(`<small class="answer-comparison__guidance" data-v-13157351>${ssrInterpolate(unref(ui)("Les deux réponses sont très différentes : observe d’abord la construction complète."))}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
          } else if (message.text && message.author === "coach") {
            _push2(`<span class="${ssrRenderClass([{ "chat-message__text--emphasis": message.emphasis }, "chat-message__text"])}" data-v-13157351>${unref(sanitizeCoachHtml)(message.text) ?? ""}</span>`);
          } else if (message.text && message.emphasis) {
            _push2(`<strong data-v-13157351>${ssrInterpolate(message.text)}</strong>`);
          } else if (message.text) {
            _push2(`<span data-v-13157351>${ssrInterpolate(message.text)}</span>`);
          } else {
            _push2(`<!---->`);
          }
          if (message.media?.mediaType === "video") {
            _push2(`<video${ssrRenderAttr("src", message.media.filePath)}${ssrRenderAttr("aria-label", message.media.altText)} muted playsinline controls data-v-13157351></video>`);
          } else if (message.media) {
            _push2(`<img class="${ssrRenderClass({ "chat-media--emoji": message.media.mediaType === "emoji" })}"${ssrRenderAttr("src", message.media.filePath)}${ssrRenderAttr("alt", message.media.altText)} data-v-13157351>`);
          } else {
            _push2(`<!---->`);
          }
          if (message.identificationPrompt && message.questionIndex === unref(currentIndex)) {
            _push2(`<div class="chat-identification-choices" data-v-13157351>`);
            if (unref(activeExerciseKind) === "tense-identification" && unref(selectedIdentificationMode)) {
              _push2(`<div class="chat-tense-choice-step" data-v-13157351><div class="chat-tense-choice-step__header" data-v-13157351><button type="button" data-v-13157351>← ${ssrInterpolate(unref(ui)("Modes"))}</button><strong data-v-13157351>${ssrInterpolate(unref(ui)("Choisis le temps"))}</strong></div><div class="chat-tense-choices" role="group"${ssrRenderAttr("aria-label", unref(ui)("Choisis le temps"))} data-v-13157351><!--[-->`);
              ssrRenderList(unref(selectedModeTenseRows), (row) => {
                _push2(`<div class="chat-tense-choice-row" data-v-13157351>`);
                if (row.simple) {
                  _push2(`<button type="button"${ssrIncludeBooleanAttr(unref(waitingForNext) || unref(posingQuestion) || unref(deliveringFeedback)) ? " disabled" : ""} data-v-13157351>${ssrInterpolate(unref(uiLabel)(row.simple.name))}</button>`);
                } else {
                  _push2(`<span aria-hidden="true" data-v-13157351></span>`);
                }
                if (row.compound) {
                  _push2(`<button type="button"${ssrIncludeBooleanAttr(unref(waitingForNext) || unref(posingQuestion) || unref(deliveringFeedback)) ? " disabled" : ""} data-v-13157351>${ssrInterpolate(unref(uiLabel)(row.compound.name))}</button>`);
                } else {
                  _push2(`<span aria-hidden="true" data-v-13157351></span>`);
                }
                _push2(`</div>`);
              ...
              _push2(`<div class="chat-mode-choices" role="group"${ssrRenderAttr("aria-label", unref(ui)("Choisis le mode"))} data-v-13157351><!--[-->`);
              ssrRenderList(unref(displayedIdentificationModeChoices), (choice) => {
                _push2(`<button type="button"${ssrIncludeBooleanAttr(unref(waitingForNext) || unref(posingQuestion) || unref(deliveringFeedback)) ? " disabled" : ""} data-v-13157351>${ssrInterpolate(choice.label)}</button>`);
              });
              _push2(`<!--]--></div>`);
            }
            _push2(`</div>`);
        ...
        if (unref(finalSummaryPreparing)) {
          _push2(`<div class="chat-summary-loading" role="status" aria-live="polite" data-v-13157351><span aria-hidden="true" data-v-13157351></span><strong data-v-13157351>${ssrInterpolate(unref(ui)("Création du bilan"))}</strong></div>`);
        } else {
          _push2(`<!---->`);
        }
        if (unref(finalSummaryVisible)) {
          _push2(`<section class="chat-summary-tool" aria-labelledby="chat-summary-title" data-v-13157351><header data-v-13157351><div data-v-13157351><h3 id="chat-summary-title" data-v-13157351>${ssrInterpolate(unref(ui)("Bilan du défi"))}</h3></div><strong data-v-13157351>${ssrInterpolate(unref(score))} %</strong></header><ol class="chat-summary-list" data-v-13157351><!--[-->`);
          ssrRenderList(unref(attemptSummaries), (item) => {
            _push2(`<li class="${ssrRenderClass([`is-${item.status}`, { "is-help-selected": unref(helpOpen) && item.questionIndex === unref(helpQuestionIndex) }])}" style="${ssrRenderStyle({ "--summary-item-index": `${item.index - 1}` })}" role="button" tabindex="0"${ssrRenderAttr("aria-label", unref(ui)("Voir l’aide de la question {number} : {question}", { number: item.index, question: item.questionLabel }))} data-v-13157351><span class="chat-summary-list__status" aria-hidden="true" data-v-13157351>${ssrInterpolate(item.status === "correct" ? "✓" : "×")}</span><div data-v-13157351><strong class="chat-summary-list__question" data-v-13157351><span data-v-13157351>${ssrInterpolate(unref(ui)("Question"))} ${ssrInterpolate(item.index)}</span><span data-v-13157351>${ssrInterpolate(item.questionLabel)}</span></strong>`);
            if (item.identificationForm) {
              _push2(`<blockquote class="chat-summary-list__citation" data-v-13157351><p data-v-13157351><span data-v-13157351>${ssrInterpolate(item.identificationForm.before)}</span><mark data-v-13157351>${ssrInterpolate(item.identificationForm.target)}</mark><span data-v-13157351>${ssrInterpolate(item.identificationForm.after)}</span></p>`);
              if (item.literaryCitation) {
                _push2(`<footer data-v-13157351>${ssrInterpolate(item.literaryCitation.author)}, <cite data-v-13157351>${ssrInterpolate(item.literaryCitation.work)}</cite></footer>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</blockquote>`);
            ...
            _push2(`<dl data-v-13157351><div data-v-13157351><dt data-v-13157351>${ssrInterpolate(unref(ui)("Réponse donnée"))}</dt><dd data-v-13157351>${ssrInterpolate(item.learnerAnswer)}</dd></div><div data-v-13157351><dt data-v-13157351>${ssrInterpolate(unref(ui)("Bonne réponse"))}</dt><dd data-v-13157351>${ssrInterpolate(item.expectedAnswer)}</dd></div></dl></div></li>`);
          });
          _push2(`<!--]--></ol><footer data-v-13157351><strong data-v-13157351>${ssrInterpolate(unref(correctCount))} / ${ssrInterpolate(unref(attempts).length)}</strong><span data-v-13157351>${ssrInterpolate(unref(correctCount) === 1 ? unref(ui)("réponse juste") : unref(ui)("réponses justes"))}</span></footer></section>`);
        } else {
          _push2(`<!---->`);
        }
        if (unref(finalSummaryVisible)) {
          _push2(`<div class="chat-message chat-message--coach chat-restart-prompt" data-v-13157351><span data-v-13157351>${ssrInterpolate(unref(ui)("Tu veux refaire ce défi ?"))}</span><div class="chat-restart-prompt__actions" data-v-13157351><button type="button" class="chat-restart-prompt__same"${ssrIncludeBooleanAttr(unref(regeneratingQuestions)) ? " disabled" : ""} data-v-13157351><span aria-hidden="true" data-v-13157351>↻</span>${ssrInterpolate(unref(ui)("Avec les mêmes questions"))}</button><button type="button" class="chat-restart-prompt__new"${ssrIncludeBooleanAttr(unref(regeneratingQuestions)) ? " disabled" : ""} data-v-13157351><span aria-hidden="true" data-v-13157351>↻</span>${ssrInterpolate(unref(regeneratingQuestions) ? unref(ui)("Préparation…") : unref(ui)("Avec d’autres questions"))}</button><button type="button" class="chat-restart-prompt__share"${ssrIncludeBooleanAttr(unref(regeneratingQuestions)) ? " disabled" : ""} data-v-13157351><span aria-hidden="true" data-v-13157351>↗</span>${ssrInterpolate(unref(ui)("Partager mon bilan"))}</button><button type="button" class="chat-restart-prompt__print"${ssrIncludeBooleanAttr(unref(regeneratingQuestions)) ? " disabled" : ""} data-v-13157351><span aria-hidden="true" data-v-13157351>⎙</span>${ssrInterpolate(unref(ui)("Imprimer mon bilan"))}</button><button type="button" class="chat-restart-prompt__quit"${ssrIncludeBooleanAttr(unref(regeneratingQuestions)) ? " disabled" : ""} data-v-13157351>${ssrInterpolate(unref(ui)("Quitter le chat"))}</button></div>`);
          if (unref(restartError)) {
            _push2(`<small class="chat-restart-prompt__error" role="alert" data-v-13157351>${ssrInterpolate(unref(restartError))}</small>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div>`);
        ...
        _push2(`</div>`);
        if (!unref(finished)) {
          _push2(`<form class="chat-composer" data-v-13157351><input id="chat-answer"${ssrRenderAttr("value", unref(answer))} type="text" autocomplete="off"${ssrRenderAttr("aria-label", unref(ui)("Ta réponse"))}${ssrIncludeBooleanAttr(unref(waitingForNext)) ? " disabled" : ""}${ssrRenderAttr("placeholder", unref(chatAnswerPlaceholder))} data-v-13157351><button type="submit"${ssrIncludeBooleanAttr(unref(waitingForNext) || unref(posingQuestion) || unref(deliveringFeedback) || !unref(answer).trim()) ? " disabled" : ""} data-v-13157351>${ssrInterpolate(unref(posingQuestion) ? unref(ui)("Question…") : unref(deliveringFeedback) ? unref(ui)("Réponse…") : unref(waitingForNext) ? unref(ui)("Suite…") : unref(ui)("Envoyer"))}</button></form>`);
        } else {
          _push2(`<!---->`);
        }
        if (unref(helpOpen) && unref(helpQuestionIndex) !== null) {
          _push2(`<button type="button" class="${ssrRenderClass([{ "chat-latest-help--above-composer": !unref(finished) }, "chat-latest-help"])}"${ssrRenderAttr("aria-label", unref(finished) ? unref(ui)("Revenir à l’aide de la dernière question") : unref(ui)("Revenir à l’aide de la question actuelle"))}${ssrRenderAttr("title", unref(finished) ? unref(ui)("Voir l’aide de la dernière question") : unref(ui)("Voir l’aide de la question actuelle"))} data-v-13157351><span aria-hidden="true" data-v-13157351>↓</span></button>`);
        } else {
          _push2(`<!---->`);
        }
        if (unref(closeConfirmationOpen)) {
          _push2(`<div class="chat-close-confirmation" data-v-13157351><section role="alertdialog" aria-modal="true" aria-labelledby="chat-close-title" aria-describedby="chat-close-description" data-v-13157351><span class="chat-close-confirmation__icon" aria-hidden="true" data-v-13157351>?</span><h3 id="chat-close-title" data-v-13157351>${ssrInterpolate(unref(ui)("Quitter le chat ?"))}</h3><p id="chat-close-description" data-v-13157351>${ssrInterpolate(unref(ui)("Ta progression actuelle sera perdue."))}</p><div class="chat-close-confirmation__actions" data-v-13157351><button class="secondary-button" type="button" data-v-13157351>${ssrInterpolate(unref(ui)("Continuer l’exercice"))}</button><button class="primary-button chat-close-confirmation__leave" type="button" data-v-13157351>${ssrInterpolate(unref(ui)("Quitter"))}</button></div></section></div>`);
        } else {
          _push2(`<!---->`);
        }
...
const ChatExercise = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-13157351"]]), { __name: "ExerciseChatExercise" });
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (!unref(isFinished) && unref(currentQuestion)) {
          ...
          if (__props.exerciseKind === "conjugation" && unref(currentQuestion).complement) {
            ...
            _push2(`</p><form class="${ssrRenderClass([{ "is-awaiting-retry": unref(retryMessageVisible) }, "completion-form"])}"><label class="completion-form__label" for="exercise-answer">${ssrInterpolate(unref(ui)("Ta réponse"))}</label><div class="completion-sentence">`);
          ...
          _push2(`<!--]--></tbody></table></div><div class="dialog-actions exercise-results__actions"><button class="secondary-button exercise-result-action" type="button"><span aria-hidden="true">↗</span>${ssrInterpolate(unref(ui)("Partager mon bilan"))}</button><button class="secondary-button exercise-result-action" type="button"><span aria-hidden="true">⎙</span>${ssrInterpolate(unref(ui)("Imprimer mon bilan"))}</button><button class="primary-button exercise-result-action" type="button"><span aria-hidden="true">↻</span>${ssrInterpolate(unref(ui)("Recommencer"))}</button><button class="secondary-button exercise-results__close" type="button">${ssrInterpolate(unref(ui)("Fermer"))}</button></div></div>`);
        }
        if (unref(closeConfirmationOpen)) {
...
//# sourceMappingURL=CoachPicker-COC7xrK_.mjs.map
