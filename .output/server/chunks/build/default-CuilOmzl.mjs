...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</main>`);
      if (!unref(embeddedConsultation)) {
        _push(`<footer class="site-footer"><p>${ssrInterpolate(unref(ui)("Un outil gratuit pour travailler la conjugaison française."))}</p><div class="site-footer__links">`);
        _push(ssrRenderComponent(_component_NuxtLink, {
...
//# sourceMappingURL=default-CuilOmzl.mjs.map
