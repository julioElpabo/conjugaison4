...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "wizard-entry-page" }, _attrs))} data-v-f8a4ad92><div class="challenge-page wizard-page" data-v-f8a4ad92><header class="wizard-hero" data-v-f8a4ad92><h1 class="${ssrRenderClass({ "wizard-hero__brand": unref(currentStep) === 0, "wizard-hero__preset": unref(currentStep) !== 0 && unref(isPrefilledChallenge) })}" data-v-f8a4ad92>${ssrInterpolate(unref(heroTitle))}</h1>`);
      if (unref(currentStep) === 0) {
        _push(`<p class="wizard-hero__subtitle" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Exercices de conjugaison française, gratuits et sans publicité"))}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(currentStep) === 0) {
        _push(`<button class="tour-entry-button" type="button" data-v-f8a4ad92><span aria-hidden="true" data-v-f8a4ad92>?</span>${ssrInterpolate(unref(tourCopy).discover)}</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</header><main class="wizard-shell" data-v-f8a4ad92>`);
      if (unref(catalogueStatus) === "loading") {
        _push(`<div class="page-state" role="status" data-v-f8a4ad92><span class="loader" aria-hidden="true" data-v-f8a4ad92></span> ${ssrInterpolate(unref(ui)("Chargement du catalogue de conjugaison…"))}</div>`);
      } else if (unref(catalogueStatus) === "error") {
        _push(`<div class="page-state page-state--error" role="alert" data-v-f8a4ad92><strong data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Le catalogue n’a pas pu être chargé."))}</strong><span data-v-f8a4ad92>${ssrInterpolate(unref(catalogueError))}</span><button class="primary-button" type="button" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Réessayer"))}</button></div>`);
      } else {
        _push(`<!--[-->`);
        if (unref(actionError)) {
          _push(`<p class="workspace-message workspace-message--error" role="alert" data-v-f8a4ad92>${ssrInterpolate(unref(actionError))}</p>`);
        } else if (unref(notice)) {
          _push(`<p class="workspace-message workspace-message--success" aria-live="polite" data-v-f8a4ad92>${ssrInterpolate(unref(notice))}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<section class="${ssrRenderClass([{ "wizard-panel--autocomplete-open": unref(currentStep) === 1 }, "wizard-panel"])}" tabindex="-1" aria-labelledby="wizard-title" data-v-f8a4ad92><h2 id="wizard-title" class="sr-only" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Composer un défi personnalisé"))}</h2>`);
        if (unref(currentStep) !== 0) {
          _push(`<nav class="wizard-steps" data-tour="wizard-steps"${ssrRenderAttr("aria-label", unref(ui)("Étapes de création du défi"))} data-v-f8a4ad92><button data-tour-wizard-step="1" class="${ssrRenderClass([{
            "is-active": unref(currentStep) === 1,
            "is-complete": unref(stepStatus).verbs > 0,
            "tour-secondary-focus": unref(tourSecondaryWizardStep) === 1
          }, "wizard-step-tab wizard-step-tab--verbs"])}" type="button" data-v-f8a4ad92><span data-v-f8a4ad92>1</span><span data-v-f8a4ad92><strong data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Verbes"))}</strong><small data-v-f8a4ad92>${ssrInterpolate(unref(stepStatus).verbs ? unref(ui)(unref(stepStatus).verbs > 1 ? "{count} choisis" : "{count} choisi", { count: unref(stepStatus).verbs }) : unref(ui)("À choisir"))}</small></span></button><span class="wizard-steps__line" aria-hidden="true" data-v-f8a4ad92></span><button data-tour-wizard-step="2" class="${ssrRenderClass([{
            "is-active": unref(currentStep) === 2,
            "is-complete": unref(stepStatus).tenses > 0,
            "tour-secondary-focus": unref(tourSecondaryWizardStep) === 2
          }, "wizard-step-tab wizard-step-tab--tenses"])}" type="button"${ssrIncludeBooleanAttr(unref(stepStatus).verbs === 0) ? " disabled" : ""} data-v-f8a4ad92><span data-v-f8a4ad92>2</span><span data-v-f8a4ad92><strong data-v-f8a4ad92><span class="mobile-label-hidden" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Modes et temps"))}</span><span class="mobile-label-only" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Temps"))}</span></strong><small data-v-f8a4ad92>${ssrInterpolate(unref(stepStatus).tenses ? unref(ui)(unref(stepStatus).tenses > 1 ? "{count} choisis" : "{count} choisi", { count: unref(stepStatus).tenses }) : unref(ui)("À choisir"))}</small></span></button><span class="wizard-steps__line" aria-hidden="true" data-v-f8a4ad92></span><button data-tour-wizard-step="3" class="${ssrRenderClass({
            "is-active": unref(currentStep) === 3,
            "is-complete": unref(currentStep) === 4,
            "tour-secondary-focus": unref(tourSecondaryWizardStep) === 3
          })}" type="button"${ssrIncludeBooleanAttr(!unref(isReady)) ? " disabled" : ""} data-v-f8a4ad92><span data-v-f8a4ad92>3</span><span data-v-f8a4ad92><strong data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Options"))}</strong><small data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Finaliser le défi"))}</small></span></button><span class="wizard-steps__line" aria-hidden="true" data-v-f8a4ad92></span><button data-tour-wizard-step="4" class="${ssrRenderClass({
            "is-active": unref(currentStep) === 4,
            "tour-secondary-focus": unref(tourSecondaryWizardStep) === 4
          })}" type="button"${ssrIncludeBooleanAttr(!unref(isReady) || unref(isPreparingStep4)) ? " disabled" : ""} data-v-f8a4ad92><span data-v-f8a4ad92>4</span><span data-v-f8a4ad92><strong data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Créer"))}</strong><small data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Utiliser le défi"))}</small></span></button>`);
          if (unref(tourSecondaryWizardStep) !== null) {
            _push(`<span class="tour-wizard-step-indicator" style="${ssrRenderStyle(unref(tourWizardIndicatorStyle))}" aria-hidden="true" data-v-f8a4ad92></span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</nav>`);
        ...
        _push(`<div class="${ssrRenderClass([{ "wizard-content--home": unref(currentStep) === 0 }, "wizard-content"])}" data-v-f8a4ad92>`);
        if (unref(isPreparingStep4)) {
          _push(`<div class="wizard-step-preparing" role="status" aria-live="polite" data-v-f8a4ad92><span class="loader wizard-step-preparing__spinner" aria-hidden="true" data-v-f8a4ad92></span><strong data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Préparation de ton défi…"))}</strong></div>`);
        } else if (unref(currentStep) === 0) {
          _push(`<div class="wizard-home" data-tour="home" data-v-f8a4ad92><div data-tour="code-loader" class="${ssrRenderClass([{ "is-arrival-highlighted": unref(highlightChallengeLoader) }, "code-loader"])}" role="search"${ssrRenderAttr("aria-label", unref(ui)("Charger un défi avec son code"))} data-v-f8a4ad92><div class="code-loader__heading" data-v-f8a4ad92><span class="code-loader__icon" aria-hidden="true" data-v-f8a4ad92><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-f8a4ad92><path d="M12 3v12" data-v-f8a4ad92></path><path d="m7 10 5 5 5-5" data-v-f8a4ad92></path><path d="M5 21h14" data-v-f8a4ad92></path></svg></span><div data-v-f8a4ad92><strong data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Tu as reçu un défi ?"))}</strong><small data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Colle son code pour le reprendre immédiatement."))}</small></div></div><div class="code-loader__control" data-v-f8a4ad92><span id="wizard-challenge-code-label" class="sr-only" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Code du défi"))}</span><div id="wizard-challenge-code" class="code-loader__code-entry" role="textbox" contenteditable="plaintext-only" aria-labelledby="wizard-challenge-code-label" data-placeholder="AB-CD-EF-23"${ssrRenderAttr("aria-invalid", Boolean(unref(codeError)))} data-v-f8a4ad92></div><button class="primary-button wizard-home__outline-action" type="button"${ssrIncludeBooleanAttr(unref(catalogueStatus) !== "success" || unref(busyAction) === "load") ? " disabled" : ""} data-v-f8a4ad92>${ssrInterpolate(unref(busyAction) === "load" ? unref(ui)("Chargement…") : unref(ui)("Charger"))}</button></div>`);
          if (unref(codeError)) {
            _push(`<p class="code-loader__error" role="alert" data-v-f8a4ad92>${ssrInterpolate(unref(codeError))}</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div><div class="wizard-home__choices" data-v-f8a4ad92>`);
          if (!unref(presetExpanded)) {
            _push(`<button class="wizard-home__choice wizard-home__choice--preset is-collapsed" data-tour="presets" type="button" data-v-f8a4ad92><span class="wizard-home__choice-icon" aria-hidden="true" data-v-f8a4ad92>★</span><div data-v-f8a4ad92><h2 data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Tu veux travailler un de nos défis ?"))}</h2></div><span class="secondary-button wizard-home__outline-action" aria-hidden="true" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Découvrir"))}</span></button>`);
          } else {
            _push(`<article data-tour="presets" class="${ssrRenderClass([{ "is-preset-selection": unref(presetStage) === "presets" }, "wizard-home__choice wizard-home__choice--preset"])}" data-v-f8a4ad92><span class="wizard-home__choice-icon" aria-hidden="true" data-v-f8a4ad92>★</span><div data-v-f8a4ad92><h2 data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Tu veux travailler un de nos défis ?"))}</h2></div>`);
          ...
          _push(`<article class="wizard-home__choice wizard-home__choice--custom" data-tour="build-custom" data-v-f8a4ad92><span class="wizard-home__choice-icon" aria-hidden="true" data-v-f8a4ad92>✎</span><div data-v-f8a4ad92><h2 data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Tu veux construire ton propre défi ?"))}</h2><p data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Choisis les verbes, les modes, les temps et les options."))}</p></div><button class="${ssrRenderClass([{ "wizard-next-pulse": !unref(highlightChallengeLoader) }, "primary-button"])}" type="button" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Construire un nouveau défi →"))}</button></article></div></div>`);
        } else if (unref(currentStep) === 1) {
          _push(`<div class="wizard-step wizard-step--selection" aria-labelledby="verbs-title" data-v-f8a4ad92><div class="wizard-step__actions wizard-step__actions--split" data-v-f8a4ad92><button class="secondary-button" type="button" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("← Nouveau défi"))}</button><div class="wizard-step__controls" data-v-f8a4ad92><button class="primary-button wizard-step__cta wizard-next-pulse" type="button"${ssrIncludeBooleanAttr(!unref(selectedVerbs).length) ? " disabled" : ""} data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Choisir les temps →"))}</button></div></div>`);
          if (unref(activePreset) && !unref(isPresetVerbEditing)) {
            _push(`<div class="wizard-step__intro wizard-step__intro--selection" data-v-f8a4ad92><h2 id="verbs-title" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Verbes du défi"))}</h2></div>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(activePreset) && !unref(isPresetVerbEditing)) {
            _push(`<section class="preset-verb-overview" data-v-f8a4ad92><header data-v-f8a4ad92><div data-v-f8a4ad92><p data-v-f8a4ad92>${ssrInterpolate(unref(selectedVerbs).length)} ${ssrInterpolate(unref(selectedVerbs).length === 1 ? unref(ui)("verbe") : unref(ui)("verbes"))} ${ssrInterpolate(unref(selectedVerbs).length === 1 ? unref(ui)("sélectionné") : unref(ui)("sélectionnés"))}</p><button class="preset-verb-overview__edit" type="button" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Modifier la liste"))}</button></div></header><ul${ssrRenderAttrs({ name: "preset-verb" })} data-v-f8a4ad92>`);
            ssrRenderList(unref(displayedSelectedVerbs), (verb) => {
              _push(`<li data-v-f8a4ad92>${ssrInterpolate(verb.infinitif)}</li>`);
            });
            _push(`</ul></section>`);
          } else {
            _push(`<!--[--><div class="wizard-step__intro wizard-step__intro--selection" data-v-f8a4ad92><h2 id="verbs-title" data-v-f8a4ad92>${ssrInterpolate(unref(isPrefilledChallenge) ? unref(savedChallengeTitle) || unref(ui)("Verbes du défi") : unref(ui)("Choisis les verbes"))}</h2>`);
            if (unref(isPrefilledChallenge) && unref(savedChallengeDescription)) {
              _push(`<p class="wizard-step__loaded-description" data-v-f8a4ad92>${ssrInterpolate(unref(savedChallengeDescription))}</p>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
          ...
          _push(`<div class="wizard-step__bottom-actions" data-v-f8a4ad92><button class="primary-button wizard-step__cta wizard-next-pulse" type="button"${ssrIncludeBooleanAttr(!unref(selectedVerbs).length) ? " disabled" : ""} data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Choisir les temps →"))}</button></div></div>`);
        } else if (unref(currentStep) === 2) {
          _push(`<div class="wizard-step wizard-step--selection" aria-labelledby="tenses-title" data-v-f8a4ad92><div class="wizard-step__actions wizard-step__actions--split" data-v-f8a4ad92><button class="secondary-button" type="button" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("← Verbes"))}</button><div class="wizard-step__controls" data-v-f8a4ad92><button class="primary-button wizard-step__cta wizard-next-pulse" type="button"${ssrIncludeBooleanAttr(!unref(selectedTenses).length) ? " disabled" : ""} data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Choisir les options →"))}</button></div></div><div class="wizard-step__intro wizard-step__intro--selection" data-v-f8a4ad92><h2 data-v-f8a4ad92>${ssrInterpolate(unref(isPrefilledChallenge) ? unref(ui)("Modes et temps") : unref(ui)("Choisis les modes et les temps"))}</h2></div>`);
          ...
          _push(`<div class="wizard-step__bottom-actions" data-v-f8a4ad92><button class="primary-button wizard-step__cta wizard-next-pulse" type="button"${ssrIncludeBooleanAttr(!unref(selectedTenses).length) ? " disabled" : ""} data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Choisir les options →"))}</button></div></div>`);
        } else if (unref(currentStep) === 3) {
          _push(`<div class="wizard-step wizard-review" data-v-f8a4ad92><div class="wizard-step__actions wizard-step__actions--split" data-v-f8a4ad92><button class="secondary-button" type="button" data-v-f8a4ad92> ← <span class="mobile-label-hidden" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Modes et temps"))}</span><span class="mobile-label-only" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Temps"))}</span></button><div class="wizard-step__controls" data-v-f8a4ad92><button class="primary-button wizard-step__cta wizard-step__cta--launch wizard-next-pulse" type="button" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Créer le défi"))}</button></div></div><div class="wizard-step__intro wizard-step__intro--selection" data-v-f8a4ad92><h2 data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Options du défi"))}</h2></div>`);
          ...
          _push(`<div class="wizard-step__bottom-actions" data-v-f8a4ad92><button class="primary-button wizard-step__cta wizard-step__cta--launch wizard-next-pulse" type="button" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("Créer le défi"))}</button></div></div>`);
        } else {
          _push(`<div class="wizard-step wizard-launch-step" data-v-f8a4ad92><div class="wizard-step__actions wizard-step__actions--split" data-v-f8a4ad92><button class="secondary-button" type="button" data-v-f8a4ad92>${ssrInterpolate(unref(ui)("← Options"))}</button></div>`);
          if (unref(showLaunchSummary)) {
            _push(`<section class="launch-summary" aria-labelledby="launch-verbs-title" data-v-f8a4ad92><div class="launch-summary__heading" data-v-f8a4ad92><div data-v-f8a4ad92>`);
            if (unref(activePreset)) {
              _push(`<p class="builder-card__eyebrow" data-v-f8a4ad92>${ssrInterpolate(unref(activePresetGroupLabel))}</p>`);
            } else {
              _push(`<!---->`);
            }
            _push(`<h2 id="launch-verbs-title" data-v-f8a4ad92>${ssrInterpolate(unref(activePreset)?.label ?? unref(ui)("Verbes choisis"))}</h2></div><span data-v-f8a4ad92>${ssrInterpolate(unref(ui)(unref(selectedVerbs).length > 1 ? "{count} verbes" : "{count} verbe", { count: unref(selectedVerbs).length }))}</span></div>`);
            if (unref(activePreset)) {
              _push(`<p class="launch-summary__description" data-v-f8a4ad92>${ssrInterpolate(unref(activePreset).description)}</p>`);
            } else {
              _push(`<!---->`);
            }
            _push(`<ul class="launch-verb-list"${ssrRenderAttr("aria-label", unref(ui)("Aperçu des verbes choisis"))} data-v-f8a4ad92><!--[-->`);
            ssrRenderList(unref(launchVerbPreview), (verb) => {
              _push(`<li data-v-f8a4ad92>${ssrInterpolate(verb.infinitif)}</li>`);
            });
            _push(`<!--]--></ul>`);
            if (unref(areAllLaunchVerbsVisible)) {
              _push(`<div class="launch-verbs-expand" data-v-f8a4ad92><ul class="launch-verb-list launch-verb-list--remaining"${ssrRenderAttr("aria-label", unref(ui)("Autres verbes choisis"))} data-v-f8a4ad92><!--[-->`);
            ...
            if (unref(remainingLaunchVerbs).length) {
              _push(`<button class="launch-summary__toggle" type="button"${ssrRenderAttr("aria-expanded", unref(areAllLaunchVerbsVisible))} data-v-f8a4ad92>${ssrInterpolate(unref(areAllLaunchVerbsVisible) ? unref(ui)("Réduire") : unref(ui)("Voir tout ({count})", { count: unref(selectedVerbs).length }))} <span aria-hidden="true" data-v-f8a4ad92>${ssrInterpolate(unref(areAllLaunchVerbsVisible) ? "↑" : "↓")}</span></button>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</section>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(isTourWelcomeOpen)) {
          _push2(`<div class="tour-welcome-backdrop" data-v-f8a4ad92><section class="tour-welcome-dialog" role="dialog" aria-modal="true" aria-labelledby="tour-welcome-title" data-v-f8a4ad92><div class="tour-welcome-dialog__languages" role="group"${ssrRenderAttr("aria-label", unref(ui)("Langue de l’interface"))} data-v-f8a4ad92><!--[-->`);
          ssrRenderList(unref(tourLanguageOptions), (option) => {
            _push2(`<button type="button" class="${ssrRenderClass({ "is-active": unref(interfaceLocale) === option.value })}"${ssrRenderAttr("aria-label", option.label)}${ssrRenderAttr("aria-pressed", unref(interfaceLocale) === option.value)}${ssrRenderAttr("title", option.label)} data-v-f8a4ad92><span aria-hidden="true" data-v-f8a4ad92>${ssrInterpolate(option.flag)}</span></button>`);
          });
          _push2(`<!--]--></div><button class="tour-welcome-dialog__close" type="button"${ssrRenderAttr("aria-label", unref(tourWelcomeSource) === "reminder" ? unref(ui)("Fermer") : unref(tourCopy).later)} data-v-f8a4ad92>×</button><span class="tour-welcome-dialog__icon" aria-hidden="true" data-v-f8a4ad92>?</span><h2 id="tour-welcome-title" data-v-f8a4ad92>${ssrInterpolate(unref(tourCopy).welcomeTitle)}</h2><p data-v-f8a4ad92>${ssrInterpolate(unref(tourCopy).welcomeBody)}</p><div class="tour-welcome-dialog__choices" data-v-f8a4ad92><button type="button" data-v-f8a4ad92><strong data-v-f8a4ad92>${ssrInterpolate(unref(tourCopy).quickTitle)}</strong><small data-v-f8a4ad92>${ssrInterpolate(unref(tourCopy).quickMeta)}</small></button><button type="button" data-v-f8a4ad92><strong data-v-f8a4ad92>${ssrInterpolate(unref(tourCopy).fullTitle)}</strong><small data-v-f8a4ad92>${ssrInterpolate(unref(tourCopy).fullMeta)}</small></button></div><button class="tour-welcome-dialog__later" type="button" data-v-f8a4ad92>${ssrInterpolate(unref(tourWelcomeSource) === "reminder" ? unref(ui)("Fermer") : unref(tourCopy).later)}</button></section></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
const WizardChallengeWorkspace = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-f8a4ad92"]]), { __name: "ChallengeWizardChallengeWorkspace" });

export { WizardChallengeWorkspace as W };
//# sourceMappingURL=WizardChallengeWorkspace-CbyakDMG.mjs.map
