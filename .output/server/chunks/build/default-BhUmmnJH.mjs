...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-3ba71a2a><section class="contact-dialog__card" data-v-3ba71a2a><button class="contact-dialog__close" type="button"${ssrRenderAttr("aria-label", unref(copy).close)}${ssrRenderAttr("title", unref(copy).close)}${ssrIncludeBooleanAttr(unref(submitting)) ? " disabled" : ""} data-v-3ba71a2a><span aria-hidden="true" data-v-3ba71a2a>×</span></button>`);
      if (unref(sent)) {
        _push(`<div class="contact-dialog__success" role="status" data-v-3ba71a2a><span class="contact-dialog__success-icon" aria-hidden="true" data-v-3ba71a2a>✓</span><h2 id="contact-success-title" data-v-3ba71a2a>${ssrInterpolate(unref(copy).successTitle)}</h2><p data-v-3ba71a2a>${ssrInterpolate(unref(copy).success)}</p><button class="contact-dialog__primary" type="button" data-v-3ba71a2a>${ssrInterpolate(unref(copy).close)}</button></div>`);
      } else {
        _push(`<!--[--><header class="contact-dialog__header" data-v-3ba71a2a><span class="contact-dialog__eyebrow" data-v-3ba71a2a>CONTACT</span><h2 id="contact-title" data-v-3ba71a2a>${ssrInterpolate(unref(copy).title)}</h2><p data-v-3ba71a2a>${ssrInterpolate(unref(copy).intro)}</p></header><form class="contact-dialog__form" data-v-3ba71a2a><label data-v-3ba71a2a><span data-v-3ba71a2a>${ssrInterpolate(unref(copy).email)}</span><input${ssrRenderAttr("value", unref(email))} type="email" maxlength="254" autocomplete="email"${ssrRenderAttr("placeholder", unref(copy).emailPlaceholder)} required data-v-3ba71a2a></label><label data-v-3ba71a2a><span data-v-3ba71a2a>${ssrInterpolate(unref(copy).subject)}</span><input${ssrRenderAttr("value", unref(subject))} type="text"${ssrRenderAttr("minlength", unref(constraints).subjectMinLength)}${ssrRenderAttr("maxlength", unref(constraints).subjectMaxLength)}${ssrRenderAttr("placeholder", unref(copy).subjectPlaceholder)} required data-v-3ba71a2a></label><label data-v-3ba71a2a><span data-v-3ba71a2a>${ssrInterpolate(unref(copy).message)}</span><textarea${ssrRenderAttr("minlength", unref(constraints).messageMinLength)}${ssrRenderAttr("maxlength", unref(constraints).messageMaxLength)} rows="6"${ssrRenderAttr("placeholder", unref(copy).messagePlaceholder)} required data-v-3ba71a2a>${ssrInterpolate(unref(message))}</textarea><small data-v-3ba71a2a>${ssrInterpolate(unref(copy).characters.replace("{count}", String(unref(constraints).messageMinLength)))}</small></label><label class="contact-dialog__honeypot" aria-hidden="true" data-v-3ba71a2a> Site internet <input${ssrRenderAttr("value", unref(website))} name="website" type="text" tabindex="-1" autocomplete="off" data-v-3ba71a2a></label>`);
        if (unref(turnstileSiteKey)) {
          _push(`<div class="cf-turnstile" data-v-3ba71a2a></div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(errorMessage)) {
          _push(`<p class="contact-dialog__error" role="alert" data-v-3ba71a2a>${ssrInterpolate(unref(errorMessage))}</p>`);
        } else if (!unref(constraints).enabled) {
          _push(`<p class="contact-dialog__error" role="status" data-v-3ba71a2a>${ssrInterpolate(unref(copy).unavailable)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<p class="contact-dialog__privacy" data-v-3ba71a2a>${ssrInterpolate(unref(copy).privacy)}</p><div class="contact-dialog__actions" data-v-3ba71a2a><button type="button"${ssrIncludeBooleanAttr(unref(submitting)) ? " disabled" : ""} data-v-3ba71a2a>${ssrInterpolate(unref(copy).cancel)}</button><button class="contact-dialog__primary" type="submit"${ssrIncludeBooleanAttr(unref(submitting) || !unref(constraints).enabled) ? " disabled" : ""} data-v-3ba71a2a>${ssrInterpolate(unref(submitting) ? unref(copy).sending : unref(copy).send)}</button></div></form><!--]-->`);
      }
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-3ba71a2a"]]), { __name: "ContactDialog" });
...
//# sourceMappingURL=default-BhUmmnJH.mjs.map
