...
import { _ as __nuxt_component_0$1 } from './CoachHelpPanel-Bf20pXup.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const selectedFeedback = computed(() => feedbacks2.value.find((item) => item.id === selectedId.value) || feedbacks2.value[0] || null);
    ...
    async function loadFeedbacks(keepSelection = true) {
      ...
      error.value = "";
      try {
        const response = await $fetch("/api/admin/coach-help-feedbacks", { credentials: "same-origin" });
        feedbacks2.value = response.feedbacks;
        if (keepSelection && selectedId.value && feedbacks2.value.some((item) => item.id === selectedId.value)) return;
        selectedId.value = feedbacks2.value[0]?.id || null;
      } catch (caught) {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_AdminShell, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<main class="feedback-admin" data-v-a4d81d17${_scopeId2}><header class="admin-section-heading feedback-admin__heading" data-v-a4d81d17${_scopeId2}><div data-v-a4d81d17${_scopeId2}><p class="admin-eyebrow" data-v-a4d81d17${_scopeId2}>Retours utilisateurs</p><h1 data-v-a4d81d17${_scopeId2}>Feedbacks</h1><p class="admin-muted" data-v-a4d81d17${_scopeId2}>Tous les retours sur les aides automatiques, du plus ancien au plus récent.</p></div><div class="feedback-admin__top-actions" data-v-a4d81d17${_scopeId2}><button class="admin-button admin-button--danger" type="button"${ssrIncludeBooleanAttr(unref(deletingTreated) || !unref(disposableCount)) ? " disabled" : ""} data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(deletingTreated) ? "Suppression…" : `Supprimer les feedbacks validés ou retirés (${unref(disposableCount)})`)}</button><button class="admin-button admin-button--primary" type="button"${ssrIncludeBooleanAttr(unref(copying)) ? " disabled" : ""} data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(copying) ? "Copie…" : "Copier tous les feedbacks validés")}</button><button class="admin-button admin-button--small" type="button"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(loading) ? "Chargement…" : "Actualiser")}</button></div></header>`);
                  if (unref(error)) {
                    _push3(`<p class="admin-notice admin-notice--error" data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(error))}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (unref(success)) {
                    _push3(`<p class="admin-notice admin-notice--success" data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(success))}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<section class="feedback-admin__summary" data-v-a4d81d17${_scopeId2}><span data-v-a4d81d17${_scopeId2}><strong data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(feedbacks2).length)}</strong> feedbacks</span><span data-v-a4d81d17${_scopeId2}><strong data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(validatedCount))}</strong> validés actifs</span><span data-v-a4d81d17${_scopeId2}><strong data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(unvalidatedCount))}</strong> non-validés actifs</span><span data-v-a4d81d17${_scopeId2}><strong data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(removedCount))}</strong> retirés</span></section><div class="feedback-admin__workspace" data-v-a4d81d17${_scopeId2}><aside class="admin-card feedback-list" aria-label="Liste des feedbacks" data-v-a4d81d17${_scopeId2}>`);
                  if (unref(loading) && !unref(feedbacks2).length) {
                    _push3(`<p class="feedback-empty" data-v-a4d81d17${_scopeId2}>Chargement…</p>`);
                  } else if (!unref(feedbacks2).length) {
                    _push3(`<p class="feedback-empty" data-v-a4d81d17${_scopeId2}>Aucun feedback enregistré.</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<!--[-->`);
                  ssrRenderList(unref(feedbacks2), (feedback) => {
                    ...
                    ])}" data-v-a4d81d17${_scopeId2}><span data-v-a4d81d17${_scopeId2}><strong data-v-a4d81d17${_scopeId2}>${ssrInterpolate(feedbackLabels[feedback.feedbackType])}</strong><small data-v-a4d81d17${_scopeId2}>${ssrInterpolate(formatDate(feedback.createdAt))}</small></span><span data-v-a4d81d17${_scopeId2}><b data-v-a4d81d17${_scopeId2}>${ssrInterpolate(questionLine(feedback))}</b><small data-v-a4d81d17${_scopeId2}>${ssrInterpolate(feedback.comment || "Sans commentaire")}</small></span><em class="${ssrRenderClass([`is-${feedback.validationStatus}`, `is-${feedback.moderationStatus}`])}" data-v-a4d81d17${_scopeId2}>${ssrInterpolate(feedback.moderationStatus === "removed" ? "Retiré" : feedback.validationStatus === "validated" ? "Validé" : "Non-validé")}</em></button>`);
                  });
                  _push3(`<!--]--></aside>`);
                  if (unref(selectedFeedback)) {
                    _push3(`<section class="feedback-detail" data-v-a4d81d17${_scopeId2}><article class="admin-card feedback-panel" data-v-a4d81d17${_scopeId2}><header class="feedback-panel__header" data-v-a4d81d17${_scopeId2}><div data-v-a4d81d17${_scopeId2}><p class="admin-eyebrow" data-v-a4d81d17${_scopeId2}>Feedback #${ssrInterpolate(unref(selectedFeedback).id)}</p><h2 data-v-a4d81d17${_scopeId2}>${ssrInterpolate(feedbackLabels[unref(selectedFeedback).feedbackType])} · ${ssrInterpolate(questionLine(unref(selectedFeedback)))}</h2><p class="admin-muted" data-v-a4d81d17${_scopeId2}>${ssrInterpolate(formatDate(unref(selectedFeedback).createdAt))} · ${ssrInterpolate(unref(selectedFeedback).coachName || "coach inconnu")} · ${ssrInterpolate(unref(selectedFeedback).helpName || "aide inconnue")}</p></div><div class="feedback-panel__actions" data-v-a4d81d17${_scopeId2}>`);
                    if (unref(selectedFeedback).validationStatus === "unvalidated") {
                      _push3(`<button class="admin-button admin-button--primary admin-button--small" type="button"${ssrIncludeBooleanAttr(unref(saving) || unref(selectedFeedback).moderationStatus === "removed") ? " disabled" : ""} data-v-a4d81d17${_scopeId2}> Valider </button>`);
                    } else {
                      _push3(`<button class="admin-button admin-button--small" type="button"${ssrIncludeBooleanAttr(unref(saving) || unref(selectedFeedback).moderationStatus === "removed") ? " disabled" : ""} data-v-a4d81d17${_scopeId2}> Remettre non-validé </button>`);
                    }
                    if (unref(selectedFeedback).moderationStatus === "active") {
                      _push3(`<button class="admin-button admin-button--danger admin-button--small" type="button"${ssrIncludeBooleanAttr(unref(saving)) ? " disabled" : ""} data-v-a4d81d17${_scopeId2}> Supprimer </button>`);
                    } else {
                      _push3(`<button class="admin-button admin-button--small" type="button"${ssrIncludeBooleanAttr(unref(saving)) ? " disabled" : ""} data-v-a4d81d17${_scopeId2}> Restaurer </button>`);
                    }
                    _push3(`</div></header><dl class="feedback-facts" data-v-a4d81d17${_scopeId2}><div data-v-a4d81d17${_scopeId2}><dt data-v-a4d81d17${_scopeId2}>Statut</dt><dd data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(selectedFeedback).validationStatus === "validated" ? "Validé" : "Non-validé")}</dd></div><div data-v-a4d81d17${_scopeId2}><dt data-v-a4d81d17${_scopeId2}>Modération</dt><dd data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(selectedFeedback).moderationStatus === "removed" ? "Retiré" : "Actif")}</dd></div><div data-v-a4d81d17${_scopeId2}><dt data-v-a4d81d17${_scopeId2}>Question</dt><dd data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(selectedFeedback).questionNumber ?? "—")}</dd></div><div data-v-a4d81d17${_scopeId2}><dt data-v-a4d81d17${_scopeId2}>Session</dt><dd data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(selectedFeedback).sessionId || "—")}</dd></div></dl><section class="feedback-section" data-v-a4d81d17${_scopeId2}><h3 data-v-a4d81d17${_scopeId2}>Commentaire du feedback</h3><p class="feedback-comment" data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(selectedFeedback).comment || "Aucun commentaire.")}</p></section><section class="feedback-section" data-v-a4d81d17${_scopeId2}><h3 data-v-a4d81d17${_scopeId2}>Question demandée</h3><dl class="feedback-question" data-v-a4d81d17${_scopeId2}><div data-v-a4d81d17${_scopeId2}><dt data-v-a4d81d17${_scopeId2}>Personne</dt><dd data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(selectedFeedback).person || "—")}</dd></div><div data-v-a4d81d17${_scopeId2}><dt data-v-a4d81d17${_scopeId2}>Verbe</dt><dd data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(selectedFeedback).verb || "—")}</dd></div><div data-v-a4d81d17${_scopeId2}><dt data-v-a4d81d17${_scopeId2}>Temps</dt><dd data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(selectedFeedback).tense || "—")}</dd></div><div data-v-a4d81d17${_scopeId2}><dt data-v-a4d81d17${_scopeId2}>Mode</dt><dd data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(selectedFeedback).mode || "—")}</dd></div><div data-v-a4d81d17${_scopeId2}><dt data-v-a4d81d17${_scopeId2}>Réponse attendue</dt><dd data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(selectedFeedback).expectedAnswer || "—")}</dd></div><div data-v-a4d81d17${_scopeId2}><dt data-v-a4d81d17${_scopeId2}>Réponse fournie</dt><dd data-v-a4d81d17${_scopeId2}>${ssrInterpolate(unref(selectedAnswer) || "Aucune réponse donnée avant le feedback.")}</dd></div></dl><details data-v-a4d81d17${_scopeId2}><summary data-v-a4d81d17${_scopeId2}>Objet question complet</summary><pre data-v-a4d81d17${_scopeId2}>${ssrInterpolate(stringify(unref(selectedQuestion)))}</pre></details></section><section class="feedback-section" data-v-a4d81d17${_scopeId2}><h3 data-v-a4d81d17${_scopeId2}>Messages du chat au moment du feedback</h3>`);
                    if (unref(selectedMessages).length) {
                      _push3(`<ol class="feedback-messages" data-v-a4d81d17${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(selectedMessages), (message) => {
                        _push3(`<li data-v-a4d81d17${_scopeId2}><strong data-v-a4d81d17${_scopeId2}>${ssrInterpolate(message.author === "coach" ? "Coach" : "Utilisateur")}</strong><span data-v-a4d81d17${_scopeId2}>${ssrInterpolate(message.text || "[média]")}</span></li>`);
                      });
                      _push3(`<!--]--></ol>`);
                    } else {
                      _push3(`<p class="admin-muted" data-v-a4d81d17${_scopeId2}>Aucun message capturé.</p>`);
                    }
                    _push3(`</section></article><article class="admin-card feedback-help-preview" data-v-a4d81d17${_scopeId2}><header data-v-a4d81d17${_scopeId2}><div data-v-a4d81d17${_scopeId2}><p class="admin-eyebrow" data-v-a4d81d17${_scopeId2}>Aide fournie</p><h2 data-v-a4d81d17${_scopeId2}>Composant affiché à l’utilisateur</h2></div></header>`);
                    if (unref(selectedHelpBlocks).length) {
                      ...
                      _push3(`<p class="feedback-empty" data-v-a4d81d17${_scopeId2}>Aucun composant d’aide capturé pour ce feedback.</p>`);
                    }
                    _push3(`</article><article class="admin-card feedback-raw" data-v-a4d81d17${_scopeId2}><details data-v-a4d81d17${_scopeId2}><summary data-v-a4d81d17${_scopeId2}>Données complètes enregistrées</summary><pre data-v-a4d81d17${_scopeId2}>${ssrInterpolate(stringify(unref(selectedFeedback)))}</pre></details></article></section>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div></main>`);
                    ...
                    createVNode("main", { class: "feedback-admin" }, [
                      createVNode("header", { class: "admin-section-heading feedback-admin__heading" }, [
                        createVNode("div", null, [
                          ...
                          createVNode("p", { class: "admin-muted" }, "Tous les retours sur les aides automatiques, du plus ancien au plus récent.")
                        ]),
                      ...
                      createVNode("div", { class: "feedback-admin__workspace" }, [
                        createVNode("aside", {
                          ...
                          }, "Chargement…")) : !unref(feedbacks2).length ? (openBlock(), createBlock("p", {
                            key: 1,
                            class: "feedback-empty"
                          }, "Aucun feedback enregistré.")) : createCommentVNode("", true),
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(feedbacks2), (feedback) => {
...
const feedbacks = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a4d81d17"]]);

export { feedbacks as default };
//# sourceMappingURL=feedbacks-Q7uN9jS9.mjs.map
