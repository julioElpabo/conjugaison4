          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_AdminShell, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="challenge-admin" data-v-26d59128${_scopeId2}><header class="admin-section-heading challenge-admin__heading" data-v-26d59128${_scopeId2}><div data-v-26d59128${_scopeId2}><p class="admin-eyebrow" data-v-26d59128${_scopeId2}>Catalogue d’exercices</p><h1 data-v-26d59128${_scopeId2}>Gestion des défis</h1><p class="admin-muted" data-v-26d59128${_scopeId2}>Configure les défis proposés, leurs verbes, leurs temps et toutes leurs options.</p></div><div class="challenge-tabs" role="tablist" aria-label="Gestion des défis" data-v-26d59128${_scopeId2}><button type="button" class="${ssrRenderClass({ active: unref(tab) === "presets" })}" data-v-26d59128${_scopeId2}>Défis</button><button type="button" class="${ssrRenderClass({ active: unref(tab) === "categories" })}" data-v-26d59128${_scopeId2}>Catégories</button></div></header>`);
                  if (unref(error)) {
                    _push3(`<p class="admin-notice admin-notice--error" role="alert" data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(error))}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (unref(success)) {
                    _push3(`<p class="admin-notice admin-notice--success" role="status" data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(success))}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (unref(loading)) {
                    _push3(`<p class="admin-muted" data-v-26d59128${_scopeId2}>Chargement…</p>`);
                  } else if (unref(tab) === "presets") {
                    _push3(`<div class="challenge-workspace" data-v-26d59128${_scopeId2}><aside class="challenge-list admin-card" data-v-26d59128${_scopeId2}><header data-v-26d59128${_scopeId2}><strong data-v-26d59128${_scopeId2}>Défis</strong><button type="button" class="admin-button admin-button--small admin-button--primary" data-v-26d59128${_scopeId2}>Nouveau</button></header><!--[-->`);
                    ssrRenderList(unref(presetGroups), (group) => {
                      _push3(`<section class="challenge-list__group" data-v-26d59128${_scopeId2}><h2 data-v-26d59128${_scopeId2}><button type="button"${ssrRenderAttr("aria-expanded", unref(openPresetCategoryId) === group.category.id)}${ssrRenderAttr("aria-controls", `preset-category-${group.category.id}`)} data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>${ssrInterpolate(group.category.name)}</span><small data-v-26d59128${_scopeId2}>${ssrInterpolate(group.presets.length)}</small><i aria-hidden="true" data-v-26d59128${_scopeId2}>⌄</i></button></h2><div${ssrRenderAttr("id", `preset-category-${group.category.id}`)} class="challenge-list__items" style="${ssrRenderStyle(unref(openPresetCategoryId) === group.category.id ? null : { display: "none" })}" data-v-26d59128${_scopeId2}><!--[-->`);
                      ssrRenderList(group.presets, (preset) => {
                        _push3(`<button type="button" draggable="true" class="${ssrRenderClass({ selected: preset.databaseId === unref(presetDraft)?.databaseId, dragging: preset.databaseId === unref(draggedPresetId), "drag-over": preset.databaseId === unref(dragOverPresetId) && preset.databaseId !== unref(draggedPresetId) })}"${ssrRenderAttr("title", `Glisser pour déplacer ${preset.label}`)} data-v-26d59128${_scopeId2}><b class="drag-handle" aria-hidden="true" data-v-26d59128${_scopeId2}>⠿</b><span data-v-26d59128${_scopeId2}><strong data-v-26d59128${_scopeId2}>${ssrInterpolate(preset.label)}</strong><small data-v-26d59128${_scopeId2}>№ ${ssrInterpolate(preset.sortOrder)} · ${ssrInterpolate(preset.verbIds.length)} verbes · ${ssrInterpolate(preset.tenseIds.length)} temps</small></span><i class="${ssrRenderClass({ inactive: !preset.isActive })}" data-v-26d59128${_scopeId2}>${ssrInterpolate(preset.isActive ? "Actif" : "Masqué")}</i></button>`);
                      });
                      _push3(`<!--]--></div></section>`);
                    });
                    _push3(`<!--]--></aside>`);
                    if (unref(presetDraft)) {
                      _push3(`<form class="challenge-editor admin-card" data-v-26d59128${_scopeId2}><div class="editor-title" data-v-26d59128${_scopeId2}><div data-v-26d59128${_scopeId2}><p class="admin-eyebrow" data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(presetDraft).databaseId ? "Défi existant" : "Nouveau défi")}</p><h2 data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(presetDraft).label || "Sans nom")}</h2></div><label class="switch" data-v-26d59128${_scopeId2}><input${ssrIncludeBooleanAttr(Array.isArray(unref(presetDraft).isActive) ? ssrLooseContain(unref(presetDraft).isActive, null) : unref(presetDraft).isActive) ? " checked" : ""} type="checkbox" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Visible</span></label></div><section class="editor-section" data-v-26d59128${_scopeId2}><h3 data-v-26d59128${_scopeId2}>Informations</h3><div class="field-grid" data-v-26d59128${_scopeId2}><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Nom *</span><input${ssrRenderAttr("value", unref(presetDraft).label)} required data-v-26d59128${_scopeId2}></label><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Identifiant *</span><input${ssrRenderAttr("value", unref(presetDraft).id)} required pattern="[A-Za-z0-9][A-Za-z0-9_-]*" data-v-26d59128${_scopeId2}></label><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Catégorie *</span><select required data-v-26d59128${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(sortedCategories), (category) => {
                        _push3(`<option${ssrRenderAttr("value", category.id)} data-v-26d59128${ssrIncludeBooleanAttr(Array.isArray(unref(presetDraft).categoryId) ? ssrLooseContain(unref(presetDraft).categoryId, category.id) : ssrLooseEqual(unref(presetDraft).categoryId, category.id)) ? " selected" : ""}${_scopeId2}>${ssrInterpolate(category.name)}</option>`);
                      });
                      _push3(`<!--]--></select></label><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Ordre dans la catégorie</span><input${ssrRenderAttr("value", unref(presetDraft).sortOrder)} type="number" min="1"${ssrRenderAttr("max", unref(presets).filter((preset) => preset.categoryId === unref(presetDraft).categoryId && preset.databaseId !== unref(presetDraft).databaseId).length + 1)} required data-v-26d59128${_scopeId2}></label><label class="admin-field wide" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Description</span><textarea rows="2" maxlength="500" data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(presetDraft).description)}</textarea></label></div></section><section class="editor-section" data-v-26d59128${_scopeId2}><div class="section-heading" data-v-26d59128${_scopeId2}><div data-v-26d59128${_scopeId2}><h3 data-v-26d59128${_scopeId2}>Verbes</h3><small data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(presetDraft).verbIds.length)} sélectionné(s)</small></div></div><div class="${ssrRenderClass([{ empty: !unref(selectedVerbs).length }, "selected-verbs"])}" data-v-26d59128${_scopeId2}><div class="selected-verbs__heading" data-v-26d59128${_scopeId2}><strong data-v-26d59128${_scopeId2}>Verbes sélectionnés</strong>`);
                      if (unref(selectedVerbs).length) {
                        _push3(`<button type="button" data-v-26d59128${_scopeId2}>Tout retirer</button>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</div>`);
                      if (!unref(selectedVerbs).length) {
                        _push3(`<p data-v-26d59128${_scopeId2}>Aucun verbe sélectionné.</p>`);
                      } else {
                        _push3(`<div class="selected-verbs__badges" data-v-26d59128${_scopeId2}><!--[-->`);
                        ssrRenderList(unref(selectedVerbs), (verb) => {
                          _push3(`<button type="button"${ssrRenderAttr("aria-label", `Retirer ${verb.infinitif}`)}${ssrRenderAttr("title", `Retirer ${verb.infinitif}`)} data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>${ssrInterpolate(verb.infinitif)}</span><i aria-hidden="true" data-v-26d59128${_scopeId2}>×</i></button>`);
                        });
                        _push3(`<!--]--></div>`);
                      }
                      _push3(`</div><div class="verb-catalogue-heading" data-v-26d59128${_scopeId2}><strong data-v-26d59128${_scopeId2}>Tous les verbes</strong><input${ssrRenderAttr("value", unref(verbSearch))} class="search" type="search" placeholder="Rechercher un verbe…" data-v-26d59128${_scopeId2}></div><div class="selection-actions" data-v-26d59128${_scopeId2}><button type="button" class="admin-button admin-button--small" data-v-26d59128${_scopeId2}>Sélectionner les résultats</button><button type="button" class="admin-button admin-button--small" data-v-26d59128${_scopeId2}>Retirer les résultats</button></div><div class="choice-grid verb-grid" data-v-26d59128${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(filteredVerbs), (verb) => {
                        _push3(`<label class="${ssrRenderClass({ selected: unref(presetDraft).verbIds.includes(verb.id) })}" data-v-26d59128${_scopeId2}><input type="checkbox"${ssrIncludeBooleanAttr(unref(presetDraft).verbIds.includes(verb.id)) ? " checked" : ""} data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>${ssrInterpolate(verb.infinitif)}</span></label>`);
                      });
                      _push3(`<!--]--></div></section><section class="editor-section" data-v-26d59128${_scopeId2}><div class="section-heading" data-v-26d59128${_scopeId2}><div data-v-26d59128${_scopeId2}><h3 data-v-26d59128${_scopeId2}>Temps</h3><small data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(presetDraft).tenseIds.length)} sélectionné(s)</small></div></div><div class="tense-groups" data-v-26d59128${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(tensesByMode), (group) => {
                        _push3(`<div data-v-26d59128${_scopeId2}><header data-v-26d59128${_scopeId2}><strong data-v-26d59128${_scopeId2}>${ssrInterpolate(group.mode.name)}</strong><span data-v-26d59128${_scopeId2}><button type="button" data-v-26d59128${_scopeId2}>Tous</button><button type="button" data-v-26d59128${_scopeId2}>Aucun</button></span></header><div class="choice-grid" data-v-26d59128${_scopeId2}><!--[-->`);
                        ssrRenderList(group.tenses, (tense) => {
                          _push3(`<label class="${ssrRenderClass({ selected: unref(presetDraft).tenseIds.includes(tense.id) })}" data-v-26d59128${_scopeId2}><input type="checkbox"${ssrIncludeBooleanAttr(unref(presetDraft).tenseIds.includes(tense.id)) ? " checked" : ""} data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>${ssrInterpolate(tense.name)}</span></label>`);
                        });
                        _push3(`<!--]--></div></div>`);
                      });
                      _push3(`<!--]--></div></section><section class="editor-section" data-v-26d59128${_scopeId2}><h3 data-v-26d59128${_scopeId2}>Options</h3><div class="field-grid" data-v-26d59128${_scopeId2}><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Nombre de questions</span><input${ssrRenderAttr("value", unref(presetDraft).questionCount)} type="number" min="1" max="100" required data-v-26d59128${_scopeId2}></label><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Type d’exercice</span><select data-v-26d59128${_scopeId2}><option value="conjugation" data-v-26d59128${ssrIncludeBooleanAttr(Array.isArray(unref(presetDraft).exerciseKind) ? ssrLooseContain(unref(presetDraft).exerciseKind, "conjugation") : ssrLooseEqual(unref(presetDraft).exerciseKind, "conjugation")) ? " selected" : ""}${_scopeId2}>Conjugaison</option><option value="tense-identification" data-v-26d59128${ssrIncludeBooleanAttr(Array.isArray(unref(presetDraft).exerciseKind) ? ssrLooseContain(unref(presetDraft).exerciseKind, "tense-identification") : ssrLooseEqual(unref(presetDraft).exerciseKind, "tense-identification")) ? " selected" : ""}${_scopeId2}>Identifier le temps</option></select></label><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Mode CIF / FLE</span><select data-v-26d59128${_scopeId2}><option value="normal" data-v-26d59128${ssrIncludeBooleanAttr(Array.isArray(unref(presetDraft).learningSupportMode) ? ssrLooseContain(unref(presetDraft).learningSupportMode, "normal") : ssrLooseEqual(unref(presetDraft).learningSupportMode, "normal")) ? " selected" : ""}${_scopeId2}>Non</option><option value="cif-fle" data-v-26d59128${ssrIncludeBooleanAttr(Array.isArray(unref(presetDraft).learningSupportMode) ? ssrLooseContain(unref(presetDraft).learningSupportMode, "cif-fle") : ssrLooseEqual(unref(presetDraft).learningSupportMode, "cif-fle")) ? " selected" : ""}${_scopeId2}>Oui — aide audio pour personnes allophones</option></select></label><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Pronoms au passé simple</span><select data-v-26d59128${_scopeId2}><option value="all" data-v-26d59128${ssrIncludeBooleanAttr(Array.isArray(unref(presetDraft).pastSimplePronouns) ? ssrLooseContain(unref(presetDraft).pastSimplePronouns, "all") : ssrLooseEqual(unref(presetDraft).pastSimplePronouns, "all")) ? " selected" : ""}${_scopeId2}>Tous les pronoms</option><option value="third-person-only" data-v-26d59128${ssrIncludeBooleanAttr(Array.isArray(unref(presetDraft).pastSimplePronouns) ? ssrLooseContain(unref(presetDraft).pastSimplePronouns, "third-person-only") : ssrLooseEqual(unref(presetDraft).pastSimplePronouns, "third-person-only")) ? " selected" : ""}${_scopeId2}>3e personnes seulement</option></select></label><label class="check-line" data-v-26d59128${_scopeId2}><input${ssrIncludeBooleanAttr(Array.isArray(unref(presetDraft).inclusivePronouns) ? ssrLooseContain(unref(presetDraft).inclusivePronouns, null) : unref(presetDraft).inclusivePronouns) ? " checked" : ""} type="checkbox" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Inclure les pronoms « iel / iels »</span></label></div><div data-v-26d59128${_scopeId2}><strong class="option-title" data-v-26d59128${_scopeId2}>Compléments proposés</strong><div class="choice-grid complement-grid" data-v-26d59128${_scopeId2}><!--[-->`);
                      ssrRenderList(COMPLEMENT_OPTIONS, (option) => {
                        _push3(`<label class="${ssrRenderClass({ selected: unref(presetDraft).complementOptions.includes(option.value) })}" data-v-26d59128${_scopeId2}><input type="checkbox"${ssrIncludeBooleanAttr(unref(presetDraft).complementOptions.includes(option.value)) ? " checked" : ""} data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>${ssrInterpolate(option.label)}</span></label>`);
                      });
                      _push3(`<!--]--></div></div></section><section id="seo-publications" class="editor-section publication-editor" data-v-26d59128${_scopeId2}><div class="section-heading" data-v-26d59128${_scopeId2}><div data-v-26d59128${_scopeId2}><h3 data-v-26d59128${_scopeId2}>Publication SEO</h3><small data-v-26d59128${_scopeId2}>Pages publiques multilingues rattachées à ce défi officiel</small></div>`);
                      if (unref(presetDraft).databaseId) {
                        _push3(`<button type="button" class="admin-button admin-button--small"${ssrIncludeBooleanAttr(unref(publicationReloading)) ? " disabled" : ""} data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(publicationReloading) ? "Rechargement…" : "Recharger les textes")}</button>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</div>`);
                      if (!unref(presetDraft).databaseId) {
                        _push3(`<p class="admin-notice" data-v-26d59128${_scopeId2}>Enregistre d’abord le défi pour pouvoir préparer ses pages publiques.</p>`);
                      } else if (unref(publicationDraft)) {
                        _push3(`<!--[--><div class="publication-tabs" role="tablist" aria-label="Langue de la publication" data-v-26d59128${_scopeId2}><!--[-->`);
                        ssrRenderList(PUBLICATION_LOCALES, (localeOption) => {
                          _push3(`<button type="button" role="tab"${ssrRenderAttr("aria-selected", unref(publicationLocale) === localeOption.value)} class="${ssrRenderClass({ active: unref(publicationLocale) === localeOption.value, ready: unref(publications).some((publication) => publication.locale === localeOption.value && publication.isPublished) })}" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>${ssrInterpolate(localeOption.label)}</span><small data-v-26d59128${_scopeId2}>${ssrInterpolate(publicationState(localeOption.value))}</small></button>`);
                        });
                        _push3(`<!--]--></div><div class="publication-switches" data-v-26d59128${_scopeId2}><label class="switch" data-v-26d59128${_scopeId2}><input${ssrIncludeBooleanAttr(Array.isArray(unref(publicationDraft).isPublished) ? ssrLooseContain(unref(publicationDraft).isPublished, null) : unref(publicationDraft).isPublished) ? " checked" : ""} type="checkbox" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Publiée</span></label></div><p class="admin-muted" data-v-26d59128${_scopeId2}>Une publication peut rester en brouillon. Lorsqu’elle est publiée, elle apparaît sur le site, devient indexable et est ajoutée au sitemap.</p><div class="field-grid" data-v-26d59128${_scopeId2}><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Slug *</span><input${ssrRenderAttr("value", unref(publicationDraft).slug)} placeholder="defi-verbes-en-ger" pattern="[a-z0-9]+(?:-[a-z0-9]+)*" data-v-26d59128${_scopeId2}></label><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Titre visible (H1) *</span><input${ssrRenderAttr("value", unref(publicationDraft).title)} maxlength="160" data-v-26d59128${_scopeId2}></label><label class="admin-field wide" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Meta title *</span><input${ssrRenderAttr("value", unref(publicationDraft).metaTitle)} maxlength="160" data-v-26d59128${_scopeId2}></label><label class="admin-field wide" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Description visible *</span><textarea rows="3" maxlength="1000" data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(publicationDraft).description)}</textarea></label><label class="admin-field wide" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Meta description *</span><textarea rows="3" maxlength="320" data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(publicationDraft).metaDescription)}</textarea></label></div>`);
                        if (unref(publicationUrl)) {
                          _push3(`<p class="publication-url" data-v-26d59128${_scopeId2}><strong data-v-26d59128${_scopeId2}>URL :</strong> ${ssrInterpolate(unref(publicationUrl))}</p>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        if (unref(publishedSlugChanged)) {
                          _push3(`<p class="admin-notice admin-notice--warning" data-v-26d59128${_scopeId2}>Le slug publié a changé. L’ancienne URL sera conservée comme redirection permanente lors de l’enregistrement.</p>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`<p class="${ssrRenderClass([`is-${unref(publicationAutosaveState)}`, "autosave-status publication-status"])}" aria-live="polite" data-v-26d59128${_scopeId2}><i aria-hidden="true" data-v-26d59128${_scopeId2}></i>${ssrInterpolate(unref(publicationAutosaveLabel))} `);
                        if (unref(publicationAutosaveState) === "error") {
                          _push3(`<button type="button" data-v-26d59128${_scopeId2}>Réessayer</button>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`</p><!--]-->`);
                      ...
                      _push3(`</section><footer class="editor-actions" data-v-26d59128${_scopeId2}>`);
                      if (unref(presetDraft).databaseId) {
                        _push3(`<button type="button" class="admin-button danger"${ssrIncludeBooleanAttr(unref(saving)) ? " disabled" : ""} data-v-26d59128${_scopeId2}>Supprimer</button>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`<span data-v-26d59128${_scopeId2}></span><p class="${ssrRenderClass([`is-${unref(presetAutosaveState)}`, "autosave-status"])}" aria-live="polite" data-v-26d59128${_scopeId2}><i aria-hidden="true" data-v-26d59128${_scopeId2}></i>${ssrInterpolate(unref(presetAutosaveLabel))} `);
                      ...
                      _push3(`<div class="empty admin-card" data-v-26d59128${_scopeId2}><p data-v-26d59128${_scopeId2}>Sélectionne un défi ou crée-en un nouveau.</p></div>`);
                    }
                    _push3(`</div>`);
                  } else {
                    _push3(`<div class="challenge-workspace category-workspace" data-v-26d59128${_scopeId2}><aside class="challenge-list category-list admin-card" data-v-26d59128${_scopeId2}><header data-v-26d59128${_scopeId2}><strong data-v-26d59128${_scopeId2}>Catégories</strong><button type="button" class="admin-button admin-button--small admin-button--primary" data-v-26d59128${_scopeId2}>Nouvelle</button></header><!--[-->`);
                    ssrRenderList(unref(sortedCategories), (category) => {
                      _push3(`<button type="button" draggable="true" class="${ssrRenderClass({ selected: category.id === unref(categoryDraft)?.id, dragging: category.id === unref(draggedCategoryId), "drag-over": category.id === unref(dragOverCategoryId) && category.id !== unref(draggedCategoryId) })}"${ssrRenderAttr("title", `Glisser pour déplacer ${category.name}`)} data-v-26d59128${_scopeId2}><b class="drag-handle" aria-hidden="true" data-v-26d59128${_scopeId2}>⠿</b><span data-v-26d59128${_scopeId2}><strong data-v-26d59128${_scopeId2}>${ssrInterpolate(category.name)}</strong><small data-v-26d59128${_scopeId2}>№ ${ssrInterpolate(category.sortOrder)} · ${ssrInterpolate(unref(presets).filter((preset) => preset.categoryId === category.id).length)} défi(s)</small></span><i class="${ssrRenderClass({ inactive: !category.isActive })}" data-v-26d59128${_scopeId2}>${ssrInterpolate(category.isActive ? "Active" : "Masquée")}</i></button>`);
                    });
                    _push3(`<!--]--></aside>`);
                    if (unref(categoryDraft)) {
                      _push3(`<form class="challenge-editor admin-card category-editor" data-v-26d59128${_scopeId2}><div class="editor-title" data-v-26d59128${_scopeId2}><div data-v-26d59128${_scopeId2}><p class="admin-eyebrow" data-v-26d59128${_scopeId2}>Catégorie</p><h2 data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(categoryDraft).name || "Sans nom")}</h2></div><label class="switch" data-v-26d59128${_scopeId2}><input${ssrIncludeBooleanAttr(Array.isArray(unref(categoryDraft).isActive) ? ssrLooseContain(unref(categoryDraft).isActive, null) : unref(categoryDraft).isActive) ? " checked" : ""} type="checkbox" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Visible</span></label></div><div class="field-grid" data-v-26d59128${_scopeId2}><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Nom *</span><input${ssrRenderAttr("value", unref(categoryDraft).name)} required data-v-26d59128${_scopeId2}></label><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Identifiant *</span><input${ssrRenderAttr("value", unref(categoryDraft).slug)} required data-v-26d59128${_scopeId2}></label><label class="admin-field" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Ordre</span><input${ssrRenderAttr("value", unref(categoryDraft).sortOrder)} type="number" required data-v-26d59128${_scopeId2}></label><label class="admin-field wide" data-v-26d59128${_scopeId2}><span data-v-26d59128${_scopeId2}>Description</span><textarea rows="4" maxlength="500" data-v-26d59128${_scopeId2}>${ssrInterpolate(unref(categoryDraft).description)}</textarea></label></div><p class="admin-muted" data-v-26d59128${_scopeId2}>Une catégorie masquée masque aussi tous ses défis dans le catalogue public.</p><footer class="editor-actions" data-v-26d59128${_scopeId2}>`);
                      if (unref(categoryDraft).id) {
                        _push3(`<button type="button" class="admin-button danger"${ssrIncludeBooleanAttr(unref(saving)) ? " disabled" : ""} data-v-26d59128${_scopeId2}>Supprimer</button>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`<span data-v-26d59128${_scopeId2}></span><p class="${ssrRenderClass([`is-${unref(categoryAutosaveState)}`, "autosave-status"])}" aria-live="polite" data-v-26d59128${_scopeId2}><i aria-hidden="true" data-v-26d59128${_scopeId2}></i>${ssrInterpolate(unref(categoryAutosaveLabel))} `);
...
const challenges = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-26d59128"]]);

export { challenges as default };
//# sourceMappingURL=challenges-CdQADni8.mjs.map
