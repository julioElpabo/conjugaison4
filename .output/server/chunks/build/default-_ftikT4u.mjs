...
import { defineComponent, ref, computed, withAsyncContext, watch, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, toDisplayString, createCommentVNode, createTextVNode, useSSRContext, reactive } from 'vue';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(embeddedConsultation)) {
        ...
        if (!unref(isActualHomePage) && !unref(falcMode)) {
...
//# sourceMappingURL=default-_ftikT4u.mjs.map
