...
import { c as createLearnerTrackingContext } from './main-CrmznQVJ.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    function loadClassicExercise() {
      classicExercisePromise ??= import('./ClassicExercise-CAse5Sga.mjs').then((module) => module.default).catch((error) => {
    ...
    function loadChatExercise() {
      chatExercisePromise ??= import('./ChatExercise--8qtCt8J.mjs').then((module) => module.default).catch((error) => {
    ...
    watch(isPrintOpen, async (open) => {
      ...
      printPreviewComponent.value = markRaw((await import('./PrintPreview-Bv6ndnEv.mjs')).default);
    });
...
//# sourceMappingURL=WizardChallengeWorkspace-CPuznDLN.mjs.map
