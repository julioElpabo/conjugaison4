...
import { f as useLanguagePreferences, g as useRoute, m as useRequestEvent } from './server.mjs';
...
import { C as ClassicExercise, a as ChatExercise, b as CoachPicker, c as createLearnerTrackingContext } from './main-IaTxB2d2.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-840fae66><div class="builder-card__header" data-v-840fae66><div data-v-840fae66><p class="builder-card__eyebrow" data-v-840fae66>${ssrInterpolate(__props.eyebrow ?? "Étape 3")}</p><h2${ssrRenderAttr("id", unref(optionsTitleId))} data-v-840fae66>${ssrInterpolate(unref(ui)("Mes options"))}</h2></div></div><div class="${ssrRenderClass([{ "options-layout--columns": __props.gridLayout }, "options-layout"])}" data-v-840fae66><div class="${ssrRenderClass([{ "options-fields--columns": __props.gridLayout }, "options-fields"])}" data-v-840fae66><div class="options-main-column" data-v-840fae66><div class="option-group-card option-group-card--questions" data-v-840fae66><label class="field-stack question-count-field"${ssrRenderAttr("for", unref(questionCountId))} data-v-840fae66><span data-v-840fae66>${ssrInterpolate(unref(ui)("Nombre de questions"))}</span><input${ssrRenderAttr("id", unref(questionCountId))} type="number" inputmode="numeric" min="1" max="99" step="1"${ssrRenderAttr("value", unref(displayedQuestionCount))} data-v-840fae66></label></div><fieldset class="option-fieldset option-group-card option-group-card--pronouns" data-v-840fae66><legend data-v-840fae66>${ssrInterpolate(unref(ui)("Pronoms"))}</legend><label class="check-row" data-v-840fae66><input type="checkbox"${ssrIncludeBooleanAttr(__props.inclusivePronouns) ? " checked" : ""} data-v-840fae66><span data-v-840fae66>${ssrInterpolate(unref(ui)("Inclure les pronoms"))} <strong data-v-840fae66>iel / iels</strong><small data-v-840fae66>${ssrInterpolate(unref(ui)("Ils apparaîtront ponctuellement dans les questions."))}</small></span></label><label class="check-row" data-v-840fae66><input type="checkbox"${ssrIncludeBooleanAttr(__props.includeOnPronoun) ? " checked" : ""} data-v-840fae66><span data-v-840fae66>${ssrInterpolate(unref(ui)("Inclure le pronom"))} <strong data-v-840fae66>on</strong><small data-v-840fae66>${ssrInterpolate(unref(ui)("Il apparaîtra ponctuellement dans les questions à la troisième personne du singulier."))}</small></span></label></fieldset><fieldset class="option-fieldset option-group-card option-group-card--exercise" data-v-840fae66><legend data-v-840fae66>${ssrInterpolate(unref(ui)("Type d’exercice"))}</legend><div class="segmented-control" data-v-840fae66><label data-v-840fae66><input type="radio"${ssrRenderAttr("name", unref(exerciseKindName))} value="conjugation"${ssrIncludeBooleanAttr(__props.exerciseKind === "conjugation") ? " checked" : ""} data-v-840fae66><span data-v-840fae66>${ssrInterpolate(unref(ui)("Conjuguer"))}</span></label><label data-v-840fae66><input type="radio"${ssrRenderAttr("name", unref(exerciseKindName))} value="tense-identification"${ssrIncludeBooleanAttr(__props.exerciseKind === "tense-identification") ? " checked" : ""} data-v-840fae66><span data-v-840fae66>${ssrInterpolate(unref(ui)("Trouver le mode et le temps"))}</span></label></div>`);
      if (__props.exerciseKind === "tense-identification") {
        _push(`<div class="identification-source-panel" data-v-840fae66><div class="segmented-control segmented-control--stacked" data-v-840fae66><label data-v-840fae66><input type="radio"${ssrRenderAttr("name", unref(identificationSourceName))} value="selected-verbs"${ssrIncludeBooleanAttr(__props.identificationSource === "selected-verbs") ? " checked" : ""} data-v-840fae66><span data-v-840fae66><strong data-v-840fae66>${ssrInterpolate(unref(ui)("Avec mes verbes"))}</strong><small data-v-840fae66>${ssrInterpolate(unref(ui)("Formes conjuguées simples, sans citation."))}</small></span></label><label data-v-840fae66><input type="radio"${ssrRenderAttr("name", unref(identificationSourceName))} value="literary-corpus"${ssrIncludeBooleanAttr(__props.identificationSource === "literary-corpus") ? " checked" : ""} data-v-840fae66><span data-v-840fae66><strong data-v-840fae66>${ssrInterpolate(unref(ui)("Avec n’importe quel verbe"))}</strong><small data-v-840fae66>${ssrInterpolate(unref(ui)("Construits avec des phrases littéraires."))}</small></span></label></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</fieldset><fieldset class="${ssrRenderClass([{ "option-group-card--disabled": __props.exerciseKind !== "conjugation" }, "option-fieldset option-group-card option-group-card--voice voice-mode-fieldset"])}"${ssrIncludeBooleanAttr(__props.exerciseKind !== "conjugation") ? " disabled" : ""} data-v-840fae66><legend data-v-840fae66>${ssrInterpolate(unref(ui)("Voix du verbe"))}</legend><div class="segmented-control segmented-control--stacked" data-v-840fae66><label data-v-840fae66><input type="radio"${ssrRenderAttr("name", unref(voiceModeName))} value="active"${ssrIncludeBooleanAttr(__props.voiceMode === "active") ? " checked" : ""} data-v-840fae66><span data-v-840fae66><strong data-v-840fae66>${ssrInterpolate(unref(ui)("Active uniquement"))}</strong></span></label><label data-v-840fae66><input type="radio"${ssrRenderAttr("name", unref(voiceModeName))} value="passive"${ssrIncludeBooleanAttr(__props.voiceMode === "passive") ? " checked" : ""}${ssrIncludeBooleanAttr(!unref(passiveAvailable)) ? " disabled" : ""} data-v-840fae66><span data-v-840fae66><strong data-v-840fae66>${ssrInterpolate(unref(ui)("Passive uniquement"))}</strong><small data-v-840fae66>${ssrInterpolate(unref(ui)("Le COD devient le sujet de la phrase."))}</small></span></label><label data-v-840fae66><input type="radio"${ssrRenderAttr("name", unref(voiceModeName))} value="mixed"${ssrIncludeBooleanAttr(__props.voiceMode === "mixed") ? " checked" : ""}${ssrIncludeBooleanAttr(!unref(passiveAvailable)) ? " disabled" : ""} data-v-840fae66><span data-v-840fae66><strong data-v-840fae66>${ssrInterpolate(unref(ui)("Active et passive"))}</strong><small data-v-840fae66>${ssrInterpolate(unref(ui)("Les deux voix alterneront dans le défi."))}</small></span></label></div>`);
      if (!unref(passiveAvailable)) {
        _push(`<small class="field-hint" data-v-840fae66>${ssrInterpolate(unref(ui)("Aucun verbe sélectionné ne possède de COD validé."))}</small>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</fieldset></div><div data-tour="options-complements" class="${ssrRenderClass([{
        "complement-options--disabled": !unref(complementsAvailable)
      }, "complement-options"])}" data-v-840fae66>`);
      if (__props.gridLayout) {
        _push(`<h3 class="complement-options__title" data-v-840fae66>${ssrInterpolate(unref(ui)("Compléments d’objets :"))}</h3>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.gridLayout) {
        _push(`<p class="complement-options__description" data-v-840fae66>${ssrInterpolate(unref(ui)("Ajoute des compléments d’objets directs ou indirects."))}</p>`);
      } else {
        _push(`<button class="complement-options__trigger" type="button"${ssrIncludeBooleanAttr(!unref(complementsAvailable)) ? " disabled" : ""}${ssrRenderAttr("aria-expanded", unref(complementsOpen))}${ssrRenderAttr("aria-controls", unref(complementPanelId))} data-v-840fae66><span data-v-840fae66>${ssrInterpolate(unref(ui)("Compléments d’objets :"))} <small data-v-840fae66>${ssrInterpolate(unref(ui)("nouveau"))}</small></span><span aria-hidden="true" data-v-840fae66>${ssrInterpolate(unref(complementsOpen) ? "−" : "+")}</span></button>`);
      }
      if (!unref(complementsAvailable)) {
        _push(`<p class="complement-options__unavailable" data-v-840fae66>${ssrInterpolate(__props.exerciseKind !== "conjugation" ? unref(ui)("Disponible uniquement pour un exercice de conjugaison.") : __props.voiceMode === "passive" ? unref(ui)("Au passif, le COD devient le sujet : ces options ne s’appliquent pas.") : unref(ui)("Les verbes choisis ne proposent pas de complément."))}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.gridLayout || unref(complementsOpen)) {
        _push(`<fieldset${ssrRenderAttr("id", unref(complementPanelId))} class="complement-options__panel" data-v-840fae66><legend class="sr-only" data-v-840fae66>${ssrInterpolate(unref(ui)("Présentation des compléments d’objets"))}</legend><label data-v-840fae66><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(codAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("cod-after")) ? " checked" : ""} data-v-840fae66><span data-v-840fae66><strong data-v-840fae66>${ssrInterpolate(unref(ui)("COD placé après"))}</strong></span></label><label data-v-840fae66><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(codBeforeAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("cod-before")) ? " checked" : ""} data-v-840fae66><span data-v-840fae66><strong data-v-840fae66>${ssrInterpolate(unref(ui)("COD placé avant"))}</strong></span></label><label data-v-840fae66><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(coiAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("coi-after")) ? " checked" : ""} data-v-840fae66><span data-v-840fae66><strong data-v-840fae66>${ssrInterpolate(unref(ui)("COI placé après"))}</strong></span></label><label data-v-840fae66><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(coiBeforeAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("coi-before")) ? " checked" : ""} data-v-840fae66><span data-v-840fae66><strong data-v-840fae66>${ssrInterpolate(unref(ui)("COI placé avant"))}</strong></span></label></fieldset>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
      if (__props.gridLayout && (__props.conjugationExampleLoading || unref(hasConjugationExample))) {
        _push(`<div data-tour="options-preview" class="${ssrRenderClass([{ "conjugation-example--wide": __props.exerciseKind === "tense-identification" }, "conjugation-example"])}" aria-live="polite" aria-atomic="true" data-v-840fae66><div class="conjugation-example__header" data-v-840fae66><span class="conjugation-example__preview-icon" aria-hidden="true" data-v-840fae66><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" data-v-840fae66><path d="M1.5 12s3.8-7 10.5-7 10.5 7 10.5 7-3.8 7-10.5 7S1.5 12 1.5 12Z" data-v-840fae66></path><circle cx="12" cy="12" r="3" data-v-840fae66></circle></svg></span><div class="conjugation-example__heading" data-v-840fae66><span data-v-840fae66>${ssrInterpolate(unref(ui)("Aperçu d’une question"))}</span></div></div><div class="conjugation-example__screen" data-v-840fae66>`);
        if (__props.conjugationExampleLoading) {
          _push(`<div class="conjugation-example__loading" role="status" data-v-840fae66><span class="conjugation-example__spinner" aria-hidden="true" data-v-840fae66></span><span class="sr-only" data-v-840fae66>${ssrInterpolate(unref(ui)("Préparation de l’aperçu"))}</span></div>`);
        } else {
          _push(`<div class="conjugation-example__body" data-v-840fae66>`);
          if (unref(exampleRevealStage) >= 1) {
            _push(`<div class="conjugation-example__question" data-v-840fae66><span class="conjugation-example__block-label" data-v-840fae66>${ssrInterpolate(unref(ui)("Exemple de question"))}</span>`);
            if (__props.exerciseKind === "tense-identification" && __props.conjugationInstruction && __props.conjugationQuestion) {
              _push(`<!--[--><p class="conjugation-example__instruction" data-v-840fae66>${ssrInterpolate(__props.conjugationInstruction)}</p>`);
              if (__props.conjugationLiteraryCitation) {
                _push(`<blockquote class="conjugation-example__citation" data-v-840fae66><p data-v-840fae66><span data-v-840fae66>${ssrInterpolate(__props.conjugationLiteraryCitation.before)}</span><mark data-v-840fae66>${ssrInterpolate(__props.conjugationLiteraryCitation.target)}</mark><span data-v-840fae66>${ssrInterpolate(__props.conjugationLiteraryCitation.after)}</span></p><footer data-v-840fae66>${ssrInterpolate(__props.conjugationLiteraryCitation.author)}, <cite data-v-840fae66>${ssrInterpolate(__props.conjugationLiteraryCitation.work)}</cite></footer></blockquote>`);
              } else {
                _push(`<p class="conjugation-example__question-line" data-v-840fae66><span class="conjugation-example__prompt" data-v-840fae66>${ssrInterpolate(unref(identificationQuestion))}</span></p>`);
              }
              _push(`<!--]-->`);
            } else {
              _push(`<!--[-->`);
              ...
              if (__props.conjugationQuestionContext) {
                _push(`<p class="conjugation-example__question-line" data-v-840fae66><span class="conjugation-example__context" data-v-840fae66>${ssrInterpolate(__props.conjugationQuestionContext)}</span></p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
          ...
          if (unref(exampleRevealStage) >= 2) {
            _push(`<div class="conjugation-example__correction" data-v-840fae66><span data-v-840fae66>${ssrInterpolate(unref(ui)("Réponse attendue"))}</span><p data-v-840fae66>`);
            if (__props.conjugationExampleEmphasis) {
              _push(`<!--[--><span data-v-840fae66>${ssrInterpolate(__props.conjugationExamplePrefix)}</span><strong data-v-840fae66>${ssrInterpolate(__props.conjugationExampleEmphasis)}</strong><span data-v-840fae66>${ssrInterpolate(__props.conjugationExampleSuffix)}</span><!--]-->`);
            } else {
              _push(`<span data-v-840fae66>${ssrInterpolate(__props.conjugationExample)}</span>`);
            }
            _push(`</p></div>`);
          } else {
            _push(`<!---->`);
...
const ChallengeOptions = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$6, [["__scopeId", "data-v-840fae66"]]), { __name: "ChallengeOptions" });
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-2ac69bd0><div class="builder-card__header" data-v-2ac69bd0><div data-v-2ac69bd0><p class="builder-card__eyebrow" data-v-2ac69bd0>${ssrInterpolate(unref(ui)("Étape 2"))}</p><h2 id="tenses-title" data-v-2ac69bd0>${ssrInterpolate(unref(ui)("Mes temps"))}</h2></div><span class="count-badge"${ssrRenderAttr("aria-label", `${__props.selectedIds.length} temps sélectionnés`)} data-v-2ac69bd0>${ssrInterpolate(__props.selectedIds.length)}</span></div><div class="selection-toolbar" data-v-2ac69bd0><button class="text-button" type="button" data-v-2ac69bd0>${ssrInterpolate(unref(ui)("Tout cocher"))}</button><button class="text-button text-button--danger" type="button" data-v-2ac69bd0>${ssrInterpolate(unref(ui)("Tout décocher"))}</button></div><div class="tense-groups" data-v-2ac69bd0><!--[-->`);
      ssrRenderList(unref(groups), (group) => {
        _push(`<section class="tense-group" role="group"${ssrRenderAttr("aria-labelledby", `tense-mode-${group.mode.id}`)} data-v-2ac69bd0><h3${ssrRenderAttr("id", `tense-mode-${group.mode.id}`)} class="tense-group__title" data-v-2ac69bd0>${ssrInterpolate(unref(uiLabel)(group.mode.name))}</h3><div class="${ssrRenderClass([{ "tense-group__columns--single": group.columns.length === 1 }, "tense-group__columns"])}" data-v-2ac69bd0><!--[-->`);
        ssrRenderList(group.columns, (column, columnIndex) => {
          _push(`<div class="tense-group__column" data-v-2ac69bd0><div class="tense-group__items" data-v-2ac69bd0><!--[-->`);
          ssrRenderList(column, (tense) => {
            _push(`<div class="tense-entry" data-v-2ac69bd0><div class="tense-row" data-v-2ac69bd0><span class="tense-info" data-v-2ac69bd0><button type="button"${ssrRenderAttr("aria-label", `${unref(ui)("Voir un exemple :")} ${unref(uiLabel)(tense.name)}`)}${ssrRenderAttr("aria-describedby", `tense-example-${tense.id}`)} data-v-2ac69bd0>i</button><span${ssrRenderAttr("id", `tense-example-${tense.id}`)} class="tense-tooltip" role="tooltip" data-v-2ac69bd0>`);
            if (unref(examples)[tense.id]) {
              _push(`<!--[-->${ssrInterpolate(unref(ui)("Exemple:"))} <strong data-v-2ac69bd0>${ssrInterpolate(unref(examples)[tense.id].emphasis)}</strong>`);
            ...
            _push(`</span></span><label class="switch-row" data-v-2ac69bd0><input type="checkbox"${ssrIncludeBooleanAttr(unref(selectedSet).has(tense.id)) ? " checked" : ""} data-v-2ac69bd0><span class="switch-row__control" aria-hidden="true" data-v-2ac69bd0></span><span data-v-2ac69bd0>${ssrInterpolate(unref(uiLabel)(tense.name))}</span></label></div>`);
            if (isPastSimple(tense) && unref(selectedSet).has(tense.id)) {
              _push(`<div class="past-simple-option" data-v-2ac69bd0><label class="past-simple-option__choice" data-v-2ac69bd0><input type="checkbox"${ssrIncludeBooleanAttr(__props.pastSimplePronouns === "third-person-only") ? " checked" : ""} data-v-2ac69bd0><span data-v-2ac69bd0><strong data-v-2ac69bd0>${ssrInterpolate(unref(ui)("Uniquement il / ils"))}</strong></span></label></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
        ...
        if (group.trailingTenses.length) {
          _push(`<div class="tense-group__trailing" data-v-2ac69bd0><!--[-->`);
          ssrRenderList(group.trailingTenses, (tense) => {
            ...
            _push(`</span></span><label class="switch-row" data-v-2ac69bd0><input type="checkbox"${ssrIncludeBooleanAttr(unref(selectedSet).has(tense.id)) ? " checked" : ""} data-v-2ac69bd0><span class="switch-row__control" aria-hidden="true" data-v-2ac69bd0></span><span data-v-2ac69bd0>${ssrInterpolate(unref(uiLabel)(tense.name))}</span></label></div></div>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<!---->`);
...
const TensePicker = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-2ac69bd0"]]), { __name: "ChallengeTensePicker" });
...
const VerbPicker = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-f03191bf"]]), { __name: "ChallengeVerbPicker" });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "wizard-entry-page" }, _attrs))} data-v-e030d9c3><div class="challenge-page wizard-page" data-v-e030d9c3><header class="wizard-hero" data-v-e030d9c3>`);
      if (unref(currentStep) === 0) {
        _push(`<p class="wizard-hero__brand" data-v-e030d9c3>${ssrInterpolate(unref(heroTitle))}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(currentStep) === 0) {
        _push(`<h1 class="wizard-hero__subtitle" data-v-e030d9c3>${ssrInterpolate(props.homeHeading || unref(ui)("Exercices de conjugaison française, gratuits et sans publicité"))}</h1>`);
      } else {
        _push(`<h1 class="${ssrRenderClass({ "wizard-hero__preset": unref(isPrefilledChallenge) })}" data-v-e030d9c3>${ssrInterpolate(unref(heroTitle))}</h1>`);
      }
      if (unref(currentStep) === 0) {
        _push(`<button class="tour-entry-button" type="button" data-v-e030d9c3><span aria-hidden="true" data-v-e030d9c3>?</span>${ssrInterpolate(unref(tourCopy).discover)}</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</header><main class="wizard-shell" data-v-e030d9c3>`);
      if (unref(catalogueStatus) === "loading") {
        _push(`<div class="page-state" role="status" data-v-e030d9c3><span class="loader" aria-hidden="true" data-v-e030d9c3></span> ${ssrInterpolate(unref(ui)("Chargement du catalogue de conjugaison…"))}</div>`);
      } else if (unref(catalogueStatus) === "error") {
        _push(`<div class="page-state page-state--error" role="alert" data-v-e030d9c3><strong data-v-e030d9c3>${ssrInterpolate(unref(ui)("Le catalogue n’a pas pu être chargé."))}</strong><span data-v-e030d9c3>${ssrInterpolate(unref(catalogueError))}</span><button class="primary-button" type="button" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Réessayer"))}</button></div>`);
      } else {
        _push(`<!--[-->`);
        if (unref(actionError)) {
          _push(`<p class="workspace-message workspace-message--error" role="alert" data-v-e030d9c3>${ssrInterpolate(unref(actionError))}</p>`);
        } else if (unref(notice)) {
          _push(`<p class="workspace-message workspace-message--success" aria-live="polite" data-v-e030d9c3>${ssrInterpolate(unref(notice))}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<section class="${ssrRenderClass([{ "wizard-panel--autocomplete-open": unref(currentStep) === 1 }, "wizard-panel"])}" tabindex="-1" aria-labelledby="wizard-title" data-v-e030d9c3><h2 id="wizard-title" class="sr-only" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Composer un défi personnalisé"))}</h2>`);
        if (unref(currentStep) !== 0) {
          _push(`<nav class="wizard-steps" data-tour="wizard-steps"${ssrRenderAttr("aria-label", unref(ui)("Étapes de création du défi"))} data-v-e030d9c3><button data-tour-wizard-step="1" class="${ssrRenderClass([{
            "is-active": unref(currentStep) === 1,
            "is-complete": unref(stepStatus).verbs > 0,
            "tour-secondary-focus": unref(tourSecondaryWizardStep) === 1
          }, "wizard-step-tab wizard-step-tab--verbs"])}" type="button" data-v-e030d9c3><span data-v-e030d9c3>1</span><span data-v-e030d9c3><strong data-v-e030d9c3>${ssrInterpolate(unref(ui)("Verbes"))}</strong><small data-v-e030d9c3>${ssrInterpolate(unref(stepStatus).verbs ? unref(ui)(unref(stepStatus).verbs > 1 ? "{count} choisis" : "{count} choisi", { count: unref(stepStatus).verbs }) : unref(ui)("À choisir"))}</small></span></button><span class="wizard-steps__line" aria-hidden="true" data-v-e030d9c3></span><button data-tour-wizard-step="2" class="${ssrRenderClass([{
            "is-active": unref(currentStep) === 2,
            "is-complete": unref(stepStatus).tenses > 0,
            "tour-secondary-focus": unref(tourSecondaryWizardStep) === 2
          }, "wizard-step-tab wizard-step-tab--tenses"])}" type="button"${ssrIncludeBooleanAttr(unref(stepStatus).verbs === 0) ? " disabled" : ""} data-v-e030d9c3><span data-v-e030d9c3>2</span><span data-v-e030d9c3><strong data-v-e030d9c3><span class="mobile-label-hidden" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Modes et temps"))}</span><span class="mobile-label-only" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Temps"))}</span></strong><small data-v-e030d9c3>${ssrInterpolate(unref(stepStatus).tenses ? unref(ui)(unref(stepStatus).tenses > 1 ? "{count} choisis" : "{count} choisi", { count: unref(stepStatus).tenses }) : unref(ui)("À choisir"))}</small></span></button><span class="wizard-steps__line" aria-hidden="true" data-v-e030d9c3></span><button data-tour-wizard-step="3" class="${ssrRenderClass({
            "is-active": unref(currentStep) === 3,
            "is-complete": unref(currentStep) === 4,
            "tour-secondary-focus": unref(tourSecondaryWizardStep) === 3
          })}" type="button"${ssrIncludeBooleanAttr(!unref(isReady)) ? " disabled" : ""} data-v-e030d9c3><span data-v-e030d9c3>3</span><span data-v-e030d9c3><strong data-v-e030d9c3>${ssrInterpolate(unref(ui)("Options"))}</strong><small data-v-e030d9c3>${ssrInterpolate(unref(ui)("Finaliser le défi"))}</small></span></button><span class="wizard-steps__line" aria-hidden="true" data-v-e030d9c3></span><button data-tour-wizard-step="4" class="${ssrRenderClass({
            "is-active": unref(currentStep) === 4,
            "tour-secondary-focus": unref(tourSecondaryWizardStep) === 4
          })}" type="button"${ssrIncludeBooleanAttr(!unref(isReady) || unref(isPreparingStep4)) ? " disabled" : ""} data-v-e030d9c3><span data-v-e030d9c3>4</span><span data-v-e030d9c3><strong data-v-e030d9c3>${ssrInterpolate(unref(ui)("Créer"))}</strong><small data-v-e030d9c3>${ssrInterpolate(unref(ui)("Utiliser le défi"))}</small></span></button>`);
          if (unref(tourSecondaryWizardStep) !== null) {
            _push(`<span class="tour-wizard-step-indicator" style="${ssrRenderStyle(unref(tourWizardIndicatorStyle))}" aria-hidden="true" data-v-e030d9c3></span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</nav>`);
        ...
        _push(`<div class="${ssrRenderClass([{ "wizard-content--home": unref(currentStep) === 0 }, "wizard-content"])}" data-v-e030d9c3>`);
        if (unref(isPreparingStep4)) {
          _push(`<div class="wizard-step-preparing" role="status" aria-live="polite" data-v-e030d9c3><span class="loader wizard-step-preparing__spinner" aria-hidden="true" data-v-e030d9c3></span><strong data-v-e030d9c3>${ssrInterpolate(unref(ui)("Préparation de ton défi…"))}</strong></div>`);
        } else if (unref(currentStep) === 0) {
          _push(`<div class="wizard-home" data-tour="home" data-v-e030d9c3><div data-tour="code-loader" class="${ssrRenderClass([{ "is-arrival-highlighted": unref(highlightChallengeLoader) }, "code-loader"])}" role="search"${ssrRenderAttr("aria-label", unref(ui)("Charger un défi avec son code"))} data-v-e030d9c3><div class="code-loader__heading" data-v-e030d9c3><span class="code-loader__icon" aria-hidden="true" data-v-e030d9c3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-e030d9c3><path d="M12 3v12" data-v-e030d9c3></path><path d="m7 10 5 5 5-5" data-v-e030d9c3></path><path d="M5 21h14" data-v-e030d9c3></path></svg></span><div data-v-e030d9c3><strong data-v-e030d9c3>${ssrInterpolate(unref(ui)("Tu as reçu un défi ?"))}</strong><small data-v-e030d9c3>${ssrInterpolate(unref(ui)("Colle son code pour le reprendre immédiatement."))}</small></div></div><div class="code-loader__control" data-v-e030d9c3><span id="wizard-challenge-code-label" class="sr-only" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Code du défi"))}</span><div id="wizard-challenge-code" class="code-loader__code-entry" role="textbox" contenteditable="plaintext-only" aria-labelledby="wizard-challenge-code-label" data-placeholder="AB-CD-EF-23"${ssrRenderAttr("aria-invalid", Boolean(unref(codeError)))} data-v-e030d9c3></div><button class="primary-button wizard-home__outline-action" type="button"${ssrIncludeBooleanAttr(unref(catalogueStatus) !== "success" || unref(busyAction) === "load") ? " disabled" : ""} data-v-e030d9c3>${ssrInterpolate(unref(busyAction) === "load" ? unref(ui)("Chargement…") : unref(ui)("Charger"))}</button></div>`);
          if (unref(codeError)) {
            _push(`<p class="code-loader__error" role="alert" data-v-e030d9c3>${ssrInterpolate(unref(codeError))}</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div><div class="wizard-home__choices" data-v-e030d9c3>`);
          if (!unref(presetExpanded)) {
            _push(`<button class="wizard-home__choice wizard-home__choice--preset is-collapsed" data-tour="presets" type="button" data-v-e030d9c3><span class="wizard-home__choice-icon" aria-hidden="true" data-v-e030d9c3>★</span><div data-v-e030d9c3><h2 data-v-e030d9c3>${ssrInterpolate(unref(ui)("Tu veux travailler un de nos défis ?"))}</h2></div><span class="secondary-button wizard-home__outline-action" aria-hidden="true" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Découvrir"))}</span></button>`);
          } else {
            _push(`<article data-tour="presets" class="${ssrRenderClass([{ "is-preset-selection": unref(presetStage) === "presets" }, "wizard-home__choice wizard-home__choice--preset"])}" data-v-e030d9c3><span class="wizard-home__choice-icon" aria-hidden="true" data-v-e030d9c3>★</span><div data-v-e030d9c3><h2 data-v-e030d9c3>${ssrInterpolate(unref(ui)("Tu veux travailler un de nos défis ?"))}</h2></div>`);
          ...
          _push(`<article class="wizard-home__choice wizard-home__choice--custom" data-tour="build-custom" data-v-e030d9c3><span class="wizard-home__choice-icon" aria-hidden="true" data-v-e030d9c3>✎</span><div data-v-e030d9c3><h2 data-v-e030d9c3>${ssrInterpolate(unref(ui)("Tu veux construire ton propre défi ?"))}</h2><p data-v-e030d9c3>${ssrInterpolate(unref(ui)("Choisis les verbes, les modes, les temps et les options."))}</p></div><button class="${ssrRenderClass([{ "wizard-next-pulse": !unref(highlightChallengeLoader) }, "primary-button"])}" type="button" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Construire un nouveau défi →"))}</button></article></div><div class="wizard-home__separator" aria-hidden="true" data-v-e030d9c3></div><section class="wizard-home__seo-intro" aria-labelledby="home-features-title" data-v-e030d9c3><header data-v-e030d9c3><p class="wizard-home__seo-eyebrow" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Tout pour progresser"))}</p><h2 id="home-features-title" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Des exercices de conjugaison adaptés à tes besoins"))}</h2><p data-v-e030d9c3>${ssrInterpolate(unref(ui)("TATITOTU propose des exercices de conjugaison française entièrement gratuits, interactifs et personnalisables, sans publicité."))}</p></header><div class="wizard-home__feature-grid" data-v-e030d9c3><article data-v-e030d9c3><h3 data-v-e030d9c3>${ssrInterpolate(unref(ui)("Pour les élèves"))}</h3><p data-v-e030d9c3>${ssrInterpolate(unref(ui)("Choisis les verbes, les modes et les temps que tu souhaites travailler, personnalise les questions, puis commence ton entraînement."))}</p><p data-v-e030d9c3>${ssrInterpolate(unref(ui)("Les exercices peuvent être réalisés dans un format classique ou sous la forme d’un dialogue avec un coach virtuel qui t’aide pour chaque question."))}</p></article><article data-v-e030d9c3><h3 data-v-e030d9c3>${ssrInterpolate(unref(ui)("Pour les enseignants"))}</h3><p data-v-e030d9c3>${ssrInterpolate(unref(ui)("Tes propres exercices peuvent être partagés avec tes élèves."))}</p><p data-v-e030d9c3>${ssrInterpolate(unref(ui)("Les élèves peuvent aussi te partager leurs bilans pour un meilleur suivi."))}</p><p data-v-e030d9c3>${ssrInterpolate(unref(ui)("Tu peux aussi imprimer l’exercice en PDF ou DOCX avec corrigé."))}</p></article><article data-v-e030d9c3><h3 data-v-e030d9c3>${ssrInterpolate(unref(ui)("Des ressources utiles"))}</h3><p data-v-e030d9c3>${ssrInterpolate(unref(ui)("Pour apprendre et réviser, le site propose aussi des explications sur les modes et les temps."))}</p><p data-v-e030d9c3>${ssrInterpolate(unref(ui)("Tu peux également consulter la conjugaison complète des verbes français, les règles d’accord du participe passé et les principales difficultés à éviter."))}</p></article></div></section></div>`);
        } else if (unref(currentStep) === 1) {
          _push(`<div class="wizard-step wizard-step--selection" aria-labelledby="verbs-title" data-v-e030d9c3><div class="wizard-step__actions wizard-step__actions--split" data-v-e030d9c3><button class="secondary-button" type="button" data-v-e030d9c3>${ssrInterpolate(unref(ui)("← Nouveau défi"))}</button><div class="wizard-step__controls" data-v-e030d9c3><button class="primary-button wizard-step__cta wizard-next-pulse" type="button"${ssrIncludeBooleanAttr(!unref(selectedVerbs).length) ? " disabled" : ""} data-v-e030d9c3>${ssrInterpolate(unref(ui)("Choisir les temps →"))}</button></div></div>`);
          if (unref(activePreset) && !unref(isPresetVerbEditing)) {
            _push(`<div class="wizard-step__intro wizard-step__intro--selection" data-v-e030d9c3><h2 id="verbs-title" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Verbes du défi"))}</h2></div>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(activePreset) && !unref(isPresetVerbEditing)) {
            _push(`<section class="preset-verb-overview" data-v-e030d9c3><header data-v-e030d9c3><div data-v-e030d9c3><p data-v-e030d9c3>${ssrInterpolate(unref(selectedVerbs).length)} ${ssrInterpolate(unref(selectedVerbs).length === 1 ? unref(ui)("verbe") : unref(ui)("verbes"))} ${ssrInterpolate(unref(selectedVerbs).length === 1 ? unref(ui)("sélectionné") : unref(ui)("sélectionnés"))}</p><button class="preset-verb-overview__edit" type="button" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Modifier la liste"))}</button></div></header><ul${ssrRenderAttrs({ name: "preset-verb" })} data-v-e030d9c3>`);
            ssrRenderList(unref(displayedSelectedVerbs), (verb) => {
              _push(`<li data-v-e030d9c3>${ssrInterpolate(verb.infinitif)}</li>`);
            });
            _push(`</ul></section>`);
          } else {
            _push(`<!--[--><div class="wizard-step__intro wizard-step__intro--selection" data-v-e030d9c3><h2 id="verbs-title" data-v-e030d9c3>${ssrInterpolate(unref(isPrefilledChallenge) ? unref(ui)("Verbes du défi") : unref(ui)("Choisis les verbes"))}</h2></div>`);
          ...
          _push(`<div class="wizard-step__bottom-actions" data-v-e030d9c3><button class="primary-button wizard-step__cta wizard-next-pulse" type="button"${ssrIncludeBooleanAttr(!unref(selectedVerbs).length) ? " disabled" : ""} data-v-e030d9c3>${ssrInterpolate(unref(ui)("Choisir les temps →"))}</button></div></div>`);
        } else if (unref(currentStep) === 2) {
          _push(`<div class="wizard-step wizard-step--selection" aria-labelledby="tenses-title" data-v-e030d9c3><div class="wizard-step__actions wizard-step__actions--split" data-v-e030d9c3><button class="secondary-button" type="button" data-v-e030d9c3>${ssrInterpolate(unref(ui)("← Verbes"))}</button><div class="wizard-step__controls" data-v-e030d9c3><button class="primary-button wizard-step__cta wizard-next-pulse" type="button"${ssrIncludeBooleanAttr(!unref(selectedTenses).length) ? " disabled" : ""} data-v-e030d9c3>${ssrInterpolate(unref(ui)("Choisir les options →"))}</button></div></div><div class="wizard-step__intro wizard-step__intro--selection" data-v-e030d9c3><h2 data-v-e030d9c3>${ssrInterpolate(unref(isPrefilledChallenge) ? unref(ui)("Modes et temps") : unref(ui)("Choisis les modes et les temps"))}</h2></div>`);
          ...
          _push(`<div class="wizard-step__bottom-actions" data-v-e030d9c3><button class="primary-button wizard-step__cta wizard-next-pulse" type="button"${ssrIncludeBooleanAttr(!unref(selectedTenses).length) ? " disabled" : ""} data-v-e030d9c3>${ssrInterpolate(unref(ui)("Choisir les options →"))}</button></div></div>`);
        } else if (unref(currentStep) === 3) {
          _push(`<div class="wizard-step wizard-review" data-v-e030d9c3><div class="wizard-step__actions wizard-step__actions--split" data-v-e030d9c3><button class="secondary-button" type="button" data-v-e030d9c3> ← <span class="mobile-label-hidden" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Modes et temps"))}</span><span class="mobile-label-only" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Temps"))}</span></button><div class="wizard-step__controls" data-v-e030d9c3><button class="primary-button wizard-step__cta wizard-step__cta--launch wizard-next-pulse" type="button" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Créer le défi"))}</button></div></div><div class="wizard-step__intro wizard-step__intro--selection" data-v-e030d9c3><h2 data-v-e030d9c3>${ssrInterpolate(unref(ui)("Options du défi"))}</h2></div>`);
          ...
          _push(`<div class="wizard-step__bottom-actions" data-v-e030d9c3><button class="primary-button wizard-step__cta wizard-step__cta--launch wizard-next-pulse" type="button" data-v-e030d9c3>${ssrInterpolate(unref(ui)("Créer le défi"))}</button></div></div>`);
        } else {
          _push(`<div class="wizard-step wizard-launch-step" data-v-e030d9c3><div class="wizard-step__actions wizard-step__actions--split" data-v-e030d9c3><button class="secondary-button" type="button" data-v-e030d9c3>${ssrInterpolate(unref(ui)("← Options"))}</button></div>`);
          if (unref(showLaunchSummary) || unref(showSavedChallengeSummary)) {
            _push(`<section class="launch-summary"${ssrRenderAttr("aria-labelledby", unref(activePreset) || unref(savedChallengeTitle) ? "launch-challenge-title" : void 0)} data-v-e030d9c3><div class="launch-summary__heading" data-v-e030d9c3><div data-v-e030d9c3>`);
            if (unref(activePreset)) {
              _push(`<p class="builder-card__eyebrow" data-v-e030d9c3>${ssrInterpolate(unref(activePresetGroupLabel))}</p>`);
            } else {
              _push(`<!---->`);
            }
            if (unref(activePreset) || unref(savedChallengeTitle)) {
              _push(`<h2 id="launch-challenge-title" data-v-e030d9c3>${ssrInterpolate(unref(activePreset)?.label || unref(savedChallengeTitle))}</h2>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="launch-summary__counts" data-v-e030d9c3><span data-v-e030d9c3>${ssrInterpolate(unref(ui)(unref(selectedVerbs).length > 1 ? "{count} verbes" : "{count} verbe", { count: unref(selectedVerbs).length }))}</span><span data-v-e030d9c3>${ssrInterpolate(unref(ui)("{count} temps", { count: unref(selectedTenses).length }))}</span></div></div>`);
            if (unref(activePreset)?.description || unref(savedChallengeDescription)) {
              _push(`<p class="launch-summary__description" data-v-e030d9c3>${ssrInterpolate(unref(activePreset)?.description || unref(savedChallengeDescription))}</p>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</section>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(isTourWelcomeOpen)) {
          _push2(`<div class="tour-welcome-backdrop" data-v-e030d9c3><section class="tour-welcome-dialog" role="dialog" aria-modal="true" aria-labelledby="tour-welcome-title" data-v-e030d9c3><div class="tour-welcome-dialog__languages" role="group"${ssrRenderAttr("aria-label", unref(ui)("Langue de l’interface"))} data-v-e030d9c3><!--[-->`);
          ssrRenderList(unref(tourLanguageOptions), (option) => {
            _push2(`<button type="button" class="${ssrRenderClass({ "is-active": unref(interfaceLocale) === option.value })}"${ssrRenderAttr("aria-label", option.label)}${ssrRenderAttr("aria-pressed", unref(interfaceLocale) === option.value)}${ssrRenderAttr("title", option.label)} data-v-e030d9c3><span aria-hidden="true" data-v-e030d9c3>${ssrInterpolate(option.flag)}</span></button>`);
          });
          _push2(`<!--]--></div><button class="tour-welcome-dialog__close" type="button"${ssrRenderAttr("aria-label", unref(tourWelcomeSource) === "reminder" ? unref(ui)("Fermer") : unref(tourCopy).later)} data-v-e030d9c3>×</button><span class="tour-welcome-dialog__icon" aria-hidden="true" data-v-e030d9c3>?</span><h2 id="tour-welcome-title" data-v-e030d9c3>${ssrInterpolate(unref(tourCopy).welcomeTitle)}</h2><p data-v-e030d9c3>${ssrInterpolate(unref(tourCopy).welcomeBody)}</p><div class="tour-welcome-dialog__choices" data-v-e030d9c3><button type="button" data-v-e030d9c3><strong data-v-e030d9c3>${ssrInterpolate(unref(tourCopy).quickTitle)}</strong><small data-v-e030d9c3>${ssrInterpolate(unref(tourCopy).quickMeta)}</small></button><button type="button" data-v-e030d9c3><strong data-v-e030d9c3>${ssrInterpolate(unref(tourCopy).fullTitle)}</strong><small data-v-e030d9c3>${ssrInterpolate(unref(tourCopy).fullMeta)}</small></button></div><button class="tour-welcome-dialog__later" type="button" data-v-e030d9c3>${ssrInterpolate(unref(tourWelcomeSource) === "reminder" ? unref(ui)("Fermer") : unref(tourCopy).later)}</button></section></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
const WizardChallengeWorkspace = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-e030d9c3"]]), { __name: "ChallengeWizardChallengeWorkspace" });

export { WizardChallengeWorkspace as W };
//# sourceMappingURL=WizardChallengeWorkspace-D2CTEzKr.mjs.map
