...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "tense-page" }, _attrs))} data-v-9a4bdb48>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span aria-hidden="true" data-v-9a4bdb48${_scopeId}>←</span> ${ssrInterpolate(unref(copy).back)}`);
          } else {
            return [
      ...
      _push(`<header class="tense-page__hero" data-v-9a4bdb48><p data-v-9a4bdb48>${ssrInterpolate(unref(mode).modeName)} · ${ssrInterpolate(unref(tense).label)}</p><h1 data-v-9a4bdb48>${ssrInterpolate(unref(copy).title)}</h1></header><div class="tense-page__content" data-v-9a4bdb48><section class="tense-page__panel tense-page__panel--uses" data-v-9a4bdb48><h2 data-v-9a4bdb48>${ssrInterpolate(unref(copy).uses)}</h2><ul data-v-9a4bdb48><!--[-->`);
      ssrRenderList(unref(pedagogy).uses, (use) => {
        _push(`<li data-v-9a4bdb48>${ssrInterpolate(use)}</li>`);
      });
      _push(`<!--]--></ul></section><section class="tense-page__endings" data-v-9a4bdb48><header data-v-9a4bdb48><h2 data-v-9a4bdb48>${ssrInterpolate(unref(copy).endings)}</h2><p data-v-9a4bdb48>${ssrInterpolate(unref(endingsGuide).intro)}</p></header>`);
      if (unref(endingPronouns).length && unref(endingTableGroups).length) {
        _push(`<div class="tense-page__table-wrap" data-v-9a4bdb48><table data-v-9a4bdb48><thead data-v-9a4bdb48><tr data-v-9a4bdb48><th scope="col" data-v-9a4bdb48>Pronom</th><!--[-->`);
        ssrRenderList(unref(endingTableGroups), (group) => {
          _push(`<th scope="col" data-v-9a4bdb48>${ssrInterpolate(group.label)}</th>`);
        });
        _push(`<!--]--></tr></thead><tbody data-v-9a4bdb48><!--[-->`);
        ssrRenderList(unref(endingPronouns), (pronoun, index) => {
          _push(`<tr data-v-9a4bdb48><th scope="row" data-v-9a4bdb48>${ssrInterpolate(pronoun)}</th><!--[-->`);
          ssrRenderList(unref(endingTableGroups), (group) => {
            _push(`<td data-v-9a4bdb48><strong data-v-9a4bdb48>${ssrInterpolate(endingForms(group.endings)[index])}</strong></td>`);
          });
          _push(`<!--]--></tr>`);
        });
      ...
      if (unref(endingReferenceGroups).length) {
        _push(`<div class="tense-page__table-wrap tense-page__table-wrap--reference" data-v-9a4bdb48><table data-v-9a4bdb48><thead data-v-9a4bdb48><tr data-v-9a4bdb48><th scope="col" data-v-9a4bdb48>Groupe ou élément</th><th scope="col" data-v-9a4bdb48>Terminaison ou construction</th><th scope="col" data-v-9a4bdb48>Exemple</th></tr></thead><tbody data-v-9a4bdb48><!--[-->`);
        ssrRenderList(unref(endingReferenceGroups), (group) => {
          _push(`<tr data-v-9a4bdb48><th scope="row" data-v-9a4bdb48>${ssrInterpolate(group.label)}</th><td data-v-9a4bdb48><strong data-v-9a4bdb48>${ssrInterpolate(group.endings)}</strong></td><td data-v-9a4bdb48>${ssrInterpolate(group.example)}</td></tr>`);
        });
        _push(`<!--]--></tbody></table></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="tense-page__ending-notes" data-v-9a4bdb48><!--[-->`);
      ssrRenderList(unref(endingsGuide).groups.filter((item) => item.note), (group) => {
        _push(`<p data-v-9a4bdb48><strong data-v-9a4bdb48>${ssrInterpolate(group.label)} :</strong> ${ssrInterpolate(group.note)}</p>`);
      });
      _push(`<!--]--></div></section><section class="tense-page__examples"${ssrRenderAttr("aria-labelledby", `${unref(modeSlug)}-${unref(tenseSlug)}-examples`)} data-v-9a4bdb48><header data-v-9a4bdb48><p data-v-9a4bdb48>02</p><div data-v-9a4bdb48><h2${ssrRenderAttr("id", `${unref(modeSlug)}-${unref(tenseSlug)}-examples`)} data-v-9a4bdb48>${ssrInterpolate(unref(copy).examples)}</h2><p data-v-9a4bdb48>${ssrInterpolate(unref(copy).examplesIntro)}</p></div></header><div data-v-9a4bdb48><!--[-->`);
      ssrRenderList(unref(pedagogy).examples, (example, index) => {
        _push(`<article data-v-9a4bdb48><p class="tense-page__example-label" data-v-9a4bdb48>${ssrInterpolate(unref(copy).example)} ${ssrInterpolate(String(index + 1).padStart(2, "0"))}</p><blockquote data-v-9a4bdb48>${ssrInterpolate(example.sentence)}</blockquote><dl data-v-9a4bdb48><div data-v-9a4bdb48><dt data-v-9a4bdb48>${ssrInterpolate(unref(copy).context)}</dt><dd data-v-9a4bdb48>${ssrInterpolate(example.context)}</dd></div><div data-v-9a4bdb48><dt data-v-9a4bdb48>${ssrInterpolate(unref(copy).reason)}</dt><dd data-v-9a4bdb48>${ssrInterpolate(example.reason)}</dd></div></dl></article>`);
      });
      _push(`<!--]--></div></section></div><footer class="tense-page__actions" data-v-9a4bdb48>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(copy).practise)} <span aria-hidden="true" data-v-9a4bdb48${_scopeId}>→</span>`);
          } else {
            return [
...
const _temps_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9a4bdb48"]]);

export { _temps_ as default };
//# sourceMappingURL=_temps_-DD6bdIEF.mjs.map
