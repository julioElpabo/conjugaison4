...
import { C as ClassicExercise, a as ChatExercise, b as CoachPicker, c as createLearnerTrackingContext } from './main-DqeAJjLI.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-0960ca12><div class="builder-card__header" data-v-0960ca12><div data-v-0960ca12><p class="builder-card__eyebrow" data-v-0960ca12>${ssrInterpolate(__props.eyebrow ?? "Étape 3")}</p><h2${ssrRenderAttr("id", unref(optionsTitleId))} data-v-0960ca12>${ssrInterpolate(unref(ui)("Mes options"))}</h2></div></div><div class="${ssrRenderClass([{ "options-layout--columns": __props.gridLayout }, "options-layout"])}" data-v-0960ca12><div class="${ssrRenderClass([{ "options-fields--columns": __props.gridLayout }, "options-fields"])}" data-v-0960ca12><div class="options-main-column" data-v-0960ca12><div class="option-group-card option-group-card--questions" data-v-0960ca12><label class="field-stack question-count-field"${ssrRenderAttr("for", unref(questionCountId))} data-v-0960ca12><span data-v-0960ca12>${ssrInterpolate(unref(ui)("Nombre de questions"))}</span><input${ssrRenderAttr("id", unref(questionCountId))} type="number" inputmode="numeric" min="1" max="99" step="1"${ssrRenderAttr("value", unref(displayedQuestionCount))} data-v-0960ca12></label></div><fieldset class="option-fieldset option-group-card option-group-card--pronouns" data-v-0960ca12><legend data-v-0960ca12>${ssrInterpolate(unref(ui)("Pronoms"))}</legend><label class="check-row" data-v-0960ca12><input type="checkbox"${ssrIncludeBooleanAttr(__props.inclusivePronouns) ? " checked" : ""} data-v-0960ca12><span data-v-0960ca12>${ssrInterpolate(unref(ui)("Inclure les pronoms"))} <strong data-v-0960ca12>iel / iels</strong><small data-v-0960ca12>${ssrInterpolate(unref(ui)("Ils apparaîtront ponctuellement dans les questions."))}</small></span></label><label class="check-row" data-v-0960ca12><input type="checkbox"${ssrIncludeBooleanAttr(__props.includeOnPronoun) ? " checked" : ""} data-v-0960ca12><span data-v-0960ca12>${ssrInterpolate(unref(ui)("Inclure le pronom"))} <strong data-v-0960ca12>on</strong><small data-v-0960ca12>${ssrInterpolate(unref(ui)("Il apparaîtra ponctuellement dans les questions à la troisième personne du singulier."))}</small></span></label></fieldset><fieldset class="option-fieldset option-group-card option-group-card--exercise" data-v-0960ca12><legend data-v-0960ca12>${ssrInterpolate(unref(ui)("Type d’exercice"))}</legend><div class="segmented-control" data-v-0960ca12><label data-v-0960ca12><input type="radio"${ssrRenderAttr("name", unref(exerciseKindName))} value="conjugation"${ssrIncludeBooleanAttr(__props.exerciseKind === "conjugation") ? " checked" : ""} data-v-0960ca12><span data-v-0960ca12>${ssrInterpolate(unref(ui)("Conjuguer"))}</span></label><label data-v-0960ca12><input type="radio"${ssrRenderAttr("name", unref(exerciseKindName))} value="tense-identification"${ssrIncludeBooleanAttr(__props.exerciseKind === "tense-identification") ? " checked" : ""} data-v-0960ca12><span data-v-0960ca12>${ssrInterpolate(unref(ui)("Trouver le mode et le temps"))}</span></label></div>`);
      if (__props.exerciseKind === "tense-identification") {
        _push(`<div class="identification-source-panel" data-v-0960ca12><div class="segmented-control segmented-control--stacked" data-v-0960ca12><label data-v-0960ca12><input type="radio"${ssrRenderAttr("name", unref(identificationSourceName))} value="selected-verbs"${ssrIncludeBooleanAttr(__props.identificationSource === "selected-verbs") ? " checked" : ""} data-v-0960ca12><span data-v-0960ca12><strong data-v-0960ca12>${ssrInterpolate(unref(ui)("Avec mes verbes"))}</strong><small data-v-0960ca12>${ssrInterpolate(unref(ui)("Formes conjuguées simples, sans citation."))}</small></span></label><label data-v-0960ca12><input type="radio"${ssrRenderAttr("name", unref(identificationSourceName))} value="literary-corpus"${ssrIncludeBooleanAttr(__props.identificationSource === "literary-corpus") ? " checked" : ""} data-v-0960ca12><span data-v-0960ca12><strong data-v-0960ca12>${ssrInterpolate(unref(ui)("Avec n’importe quel verbe"))}</strong><small data-v-0960ca12>${ssrInterpolate(unref(ui)("Construits avec des phrases littéraires."))}</small></span></label></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</fieldset><fieldset class="${ssrRenderClass([{ "option-group-card--disabled": __props.exerciseKind !== "conjugation" }, "option-fieldset option-group-card option-group-card--voice voice-mode-fieldset"])}"${ssrIncludeBooleanAttr(__props.exerciseKind !== "conjugation") ? " disabled" : ""} data-v-0960ca12><legend data-v-0960ca12>${ssrInterpolate(unref(ui)("Voix du verbe"))}</legend><div class="segmented-control segmented-control--stacked" data-v-0960ca12><label data-v-0960ca12><input type="radio"${ssrRenderAttr("name", unref(voiceModeName))} value="active"${ssrIncludeBooleanAttr(__props.voiceMode === "active") ? " checked" : ""} data-v-0960ca12><span data-v-0960ca12><strong data-v-0960ca12>${ssrInterpolate(unref(ui)("Active uniquement"))}</strong></span></label><label data-v-0960ca12><input type="radio"${ssrRenderAttr("name", unref(voiceModeName))} value="passive"${ssrIncludeBooleanAttr(__props.voiceMode === "passive") ? " checked" : ""}${ssrIncludeBooleanAttr(!unref(passiveAvailable)) ? " disabled" : ""} data-v-0960ca12><span data-v-0960ca12><strong data-v-0960ca12>${ssrInterpolate(unref(ui)("Passive uniquement"))}</strong><small data-v-0960ca12>${ssrInterpolate(unref(ui)("Le COD devient le sujet de la phrase."))}</small></span></label><label data-v-0960ca12><input type="radio"${ssrRenderAttr("name", unref(voiceModeName))} value="mixed"${ssrIncludeBooleanAttr(__props.voiceMode === "mixed") ? " checked" : ""}${ssrIncludeBooleanAttr(!unref(passiveAvailable)) ? " disabled" : ""} data-v-0960ca12><span data-v-0960ca12><strong data-v-0960ca12>${ssrInterpolate(unref(ui)("Active et passive"))}</strong><small data-v-0960ca12>${ssrInterpolate(unref(ui)("Les deux voix alterneront dans le défi."))}</small></span></label></div>`);
      if (!unref(passiveAvailable)) {
        _push(`<small class="field-hint" data-v-0960ca12>${ssrInterpolate(unref(ui)("Aucun verbe sélectionné ne possède de COD validé."))}</small>`);
      } else {
        _push(`<!---->`);
      }
      ...
      }, "complement-options"])}" data-v-0960ca12>`);
      if (__props.gridLayout) {
        _push(`<h3 class="complement-options__title" data-v-0960ca12>${ssrInterpolate(unref(ui)("Compléments d’objets :"))}</h3>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.gridLayout) {
        _push(`<p class="complement-options__description" data-v-0960ca12>${ssrInterpolate(unref(ui)("Ajoute des compléments d’objets directs ou indirects."))}</p>`);
      } else {
        _push(`<button class="complement-options__trigger" type="button"${ssrIncludeBooleanAttr(!unref(complementsAvailable)) ? " disabled" : ""}${ssrRenderAttr("aria-expanded", unref(complementsOpen))}${ssrRenderAttr("aria-controls", unref(complementPanelId))} data-v-0960ca12><span data-v-0960ca12>${ssrInterpolate(unref(ui)("Compléments d’objets :"))} <small data-v-0960ca12>${ssrInterpolate(unref(ui)("nouveau"))}</small></span><span aria-hidden="true" data-v-0960ca12>${ssrInterpolate(unref(complementsOpen) ? "−" : "+")}</span></button>`);
      }
      if (!unref(complementsAvailable)) {
        _push(`<p class="complement-options__unavailable" data-v-0960ca12>${ssrInterpolate(__props.exerciseKind !== "conjugation" ? unref(ui)("Disponible uniquement pour un exercice de conjugaison.") : __props.voiceMode === "passive" ? unref(ui)("Au passif, le COD devient le sujet : ces options ne s’appliquent pas.") : unref(ui)("Les verbes choisis ne proposent pas de complément."))}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.gridLayout || unref(complementsOpen)) {
        _push(`<fieldset${ssrRenderAttr("id", unref(complementPanelId))} class="complement-options__panel" data-v-0960ca12><legend class="sr-only" data-v-0960ca12>${ssrInterpolate(unref(ui)("Présentation des compléments d’objets"))}</legend><label data-v-0960ca12><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(codAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("cod-after")) ? " checked" : ""} data-v-0960ca12><span data-v-0960ca12><strong data-v-0960ca12>${ssrInterpolate(unref(ui)("COD placé après"))}</strong></span></label><label data-v-0960ca12><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(codBeforeAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("cod-before")) ? " checked" : ""} data-v-0960ca12><span data-v-0960ca12><strong data-v-0960ca12>${ssrInterpolate(unref(ui)("COD placé avant"))}</strong></span></label><label data-v-0960ca12><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(coiAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("coi-after")) ? " checked" : ""} data-v-0960ca12><span data-v-0960ca12><strong data-v-0960ca12>${ssrInterpolate(unref(ui)("COI placé après"))}</strong></span></label><label data-v-0960ca12><input type="checkbox"${ssrIncludeBooleanAttr(!unref(complementsAvailable) || !unref(coiBeforeAvailable)) ? " disabled" : ""}${ssrIncludeBooleanAttr(unref(displayedComplementOptions).includes("coi-before")) ? " checked" : ""} data-v-0960ca12><span data-v-0960ca12><strong data-v-0960ca12>${ssrInterpolate(unref(ui)("COI placé avant"))}</strong></span></label></fieldset>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
      if (__props.gridLayout && (__props.conjugationExampleLoading || unref(hasConjugationExample))) {
        _push(`<div data-tour="options-preview" class="${ssrRenderClass([{ "conjugation-example--wide": __props.exerciseKind === "tense-identification" }, "conjugation-example"])}" aria-live="polite" aria-atomic="true" data-v-0960ca12><div class="conjugation-example__header" data-v-0960ca12><span class="conjugation-example__preview-icon" aria-hidden="true" data-v-0960ca12><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" data-v-0960ca12><path d="M1.5 12s3.8-7 10.5-7 10.5 7 10.5 7-3.8 7-10.5 7S1.5 12 1.5 12Z" data-v-0960ca12></path><circle cx="12" cy="12" r="3" data-v-0960ca12></circle></svg></span><div class="conjugation-example__heading" data-v-0960ca12><span data-v-0960ca12>${ssrInterpolate(unref(ui)("Aperçu d’une question"))}</span></div></div><div class="conjugation-example__screen" data-v-0960ca12>`);
        if (__props.conjugationExampleLoading) {
          _push(`<div class="conjugation-example__loading" role="status" data-v-0960ca12><span class="conjugation-example__spinner" aria-hidden="true" data-v-0960ca12></span><span class="sr-only" data-v-0960ca12>${ssrInterpolate(unref(ui)("Préparation de l’aperçu"))}</span></div>`);
        } else {
          _push(`<div class="conjugation-example__body" data-v-0960ca12>`);
          if (unref(exampleRevealStage) >= 1) {
            _push(`<div class="conjugation-example__question" data-v-0960ca12><span class="conjugation-example__block-label" data-v-0960ca12>${ssrInterpolate(unref(ui)("Exemple de question"))}</span>`);
            if (__props.exerciseKind === "tense-identification" && __props.conjugationInstruction && __props.conjugationQuestion) {
              _push(`<!--[--><p class="conjugation-example__instruction" data-v-0960ca12>${ssrInterpolate(__props.conjugationInstruction)}</p>`);
              if (__props.conjugationLiteraryCitation) {
                _push(`<blockquote class="conjugation-example__citation" data-v-0960ca12><p data-v-0960ca12><span data-v-0960ca12>${ssrInterpolate(__props.conjugationLiteraryCitation.before)}</span><mark data-v-0960ca12>${ssrInterpolate(__props.conjugationLiteraryCitation.target)}</mark><span data-v-0960ca12>${ssrInterpolate(__props.conjugationLiteraryCitation.after)}</span></p><footer data-v-0960ca12>${ssrInterpolate(__props.conjugationLiteraryCitation.author)}, <cite data-v-0960ca12>${ssrInterpolate(__props.conjugationLiteraryCitation.work)}</cite></footer></blockquote>`);
              } else {
                _push(`<p class="conjugation-example__question-line" data-v-0960ca12><span class="conjugation-example__prompt" data-v-0960ca12>${ssrInterpolate(unref(identificationQuestion))}</span></p>`);
              }
              _push(`<!--]-->`);
            } else {
              _push(`<!--[-->`);
              ...
              if (__props.conjugationQuestionContext) {
                _push(`<p class="conjugation-example__question-line" data-v-0960ca12><span class="conjugation-example__context" data-v-0960ca12>${ssrInterpolate(__props.conjugationQuestionContext)}</span></p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
          ...
          if (unref(exampleRevealStage) >= 2) {
            _push(`<div class="conjugation-example__correction" data-v-0960ca12><span data-v-0960ca12>${ssrInterpolate(unref(ui)("Réponse attendue"))}</span><p data-v-0960ca12>`);
            if (__props.conjugationExampleEmphasis) {
              _push(`<!--[--><span data-v-0960ca12>${ssrInterpolate(__props.conjugationExamplePrefix)}</span><strong data-v-0960ca12>${ssrInterpolate(__props.conjugationExampleEmphasis)}</strong><span data-v-0960ca12>${ssrInterpolate(__props.conjugationExampleSuffix)}</span><!--]-->`);
            } else {
              _push(`<span data-v-0960ca12>${ssrInterpolate(__props.conjugationExample)}</span>`);
            }
            _push(`</p></div>`);
          } else {
            _push(`<!---->`);
...
const ChallengeOptions = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$6, [["__scopeId", "data-v-0960ca12"]]), { __name: "ChallengeOptions" });
...
//# sourceMappingURL=WizardChallengeWorkspace-DsnbWT_K.mjs.map
