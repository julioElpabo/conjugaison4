...
export const canonicalInfinitives: Record<string, string> = {
  ...
  deposer: 'déposer', deriver: 'dériver', desactiver: 'désactiver', designer: 'désigner',
  detourner: 'détourner', developper: 'développer',
}
...
export const semanticVerbSeeds: Record<string, readonly string[]> = {
  ...
  mouvement: ['aller', 'venir', 'partir', 'arriver', 'entrer', 'sortir', 'rentrer', 'retourner', 'avancer', 'reculer', 'courir', 'marcher', 'nager', 'voyager', 'naviguer', 'fuir', 'tomber', 'monter', 'descendre', 'passer', 'traverser', 'sauter', 'plonger', 'rouler', 'se déplacer', 'se diriger', 'se mouvoir', 'tourner'],
  ...
  transformation: ['changer', 'devenir', 'grandir', 'affaiblir', "s'affaiblir", 'améliorer', 'adapter', 'augmenter', 'baisser', 'allonger', 'mélanger', 'se mélanger', 'brûler', 'geler', 'salir', 'casser', 'se casser', 'démolir', 'vider', 'remplir'],
  manipulation: ['prendre', 'mettre', 'porter', 'apporter', 'couper', 'se couper', 'ouvrir', 'fermer', 'couvrir', 'se couvrir', 'tirer', 'pousser', 'jeter', 'attraper', 'saisir', 'se saisir', 'joindre', 'plier', 'coudre', 'moudre', 'broyer', 'cuire', 'coller', 'brancher', 'remuer', 'nettoyer'],
  ...
  communication: ['dire', 'parler', 'demander', 'se demander', 'répondre', 'raconter', 'expliquer', 'écrire', 'lire', 'communiquer', 'appeler', "s'appeler", 'annoncer', 'avouer', 'citer', 'commenter', 'prononcer', 'suggérer', 'saluer', 'crier', "s'écrier", 'aboyer'],
  ...
  'creation-travail': ['faire', 'créer', 'fabriquer', 'construire', 'produire', 'travailler', 'bricoler', 'cuisiner', 'dessiner', 'peindre', 'colorier', 'tracer', 'écrire', 'filmer', 'photocopier', 'copier', 'cliquer', 'archiver', 'classer', 'organiser', 'réparer', 'cultiver'],
