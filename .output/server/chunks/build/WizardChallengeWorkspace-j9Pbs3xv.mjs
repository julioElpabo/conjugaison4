...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    function loadClassicExercise() {
      classicExercisePromise ??= import('./ClassicExercise-MZS7H77L.mjs').then((module) => module.default).catch((error) => {
    ...
    function loadChatExercise() {
      chatExercisePromise ??= import('./ChatExercise-C4Sv_JsE.mjs').then((module) => module.default).catch((error) => {
...
//# sourceMappingURL=WizardChallengeWorkspace-j9Pbs3xv.mjs.map
