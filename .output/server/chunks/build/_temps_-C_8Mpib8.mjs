...
import { g as useRoute, f as useLanguagePreferences, l as createError, u as useHead } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "tense-page" }, _attrs))} data-v-e8862398>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span aria-hidden="true" data-v-e8862398${_scopeId}>←</span> ${ssrInterpolate(unref(copy).back)}`);
          } else {
            return [
      ...
      _push(`<header class="tense-page__hero" data-v-e8862398><p data-v-e8862398>${ssrInterpolate(unref(mode).modeName)} · ${ssrInterpolate(unref(tense).label)}</p><h1 data-v-e8862398>${ssrInterpolate(unref(copy).title)}</h1></header><div class="tense-page__content" data-v-e8862398><section class="tense-page__panel tense-page__panel--uses" data-v-e8862398><h2 data-v-e8862398>${ssrInterpolate(unref(copy).uses)}</h2><ul data-v-e8862398><!--[-->`);
      ssrRenderList(unref(pedagogy).uses, (use) => {
        _push(`<li data-v-e8862398>${ssrInterpolate(use)}</li>`);
      });
      _push(`<!--]--></ul></section><section class="tense-page__endings" data-v-e8862398><header data-v-e8862398><h2 data-v-e8862398>${ssrInterpolate(unref(copy).endings)}</h2><p data-v-e8862398>${ssrInterpolate(unref(endingsGuide).intro)}</p></header>`);
      if (unref(endingPronouns).length && unref(endingTableGroups).length) {
        _push(`<div class="tense-page__table-wrap" data-v-e8862398><table data-v-e8862398><thead data-v-e8862398><tr data-v-e8862398><th scope="col" data-v-e8862398>Pronom</th><!--[-->`);
        ssrRenderList(unref(endingTableGroups), (group) => {
          _push(`<th scope="col" data-v-e8862398>${ssrInterpolate(group.label)}</th>`);
        });
        _push(`<!--]--></tr></thead><tbody data-v-e8862398><!--[-->`);
        ssrRenderList(unref(endingPronouns), (pronoun, index) => {
          _push(`<tr data-v-e8862398><th scope="row" data-v-e8862398>${ssrInterpolate(pronoun)}</th><!--[-->`);
          ssrRenderList(unref(endingTableGroups), (group) => {
            _push(`<td data-v-e8862398><strong data-v-e8862398>${ssrInterpolate(endingForms(group.endings)[index])}</strong></td>`);
          });
          _push(`<!--]--></tr>`);
        });
      ...
      if (unref(endingReferenceGroups).length) {
        _push(`<div class="tense-page__table-wrap tense-page__table-wrap--reference" data-v-e8862398><table data-v-e8862398><thead data-v-e8862398><tr data-v-e8862398><th scope="col" data-v-e8862398>Groupe ou élément</th><th scope="col" data-v-e8862398>Terminaison ou construction</th><th scope="col" data-v-e8862398>Exemple</th></tr></thead><tbody data-v-e8862398><!--[-->`);
        ssrRenderList(unref(endingReferenceGroups), (group) => {
          _push(`<tr data-v-e8862398><th scope="row" data-v-e8862398>${ssrInterpolate(group.label)}</th><td data-v-e8862398><strong data-v-e8862398>${ssrInterpolate(group.endings)}</strong></td><td data-v-e8862398>${ssrInterpolate(group.example)}</td></tr>`);
        });
        _push(`<!--]--></tbody></table></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="tense-page__ending-notes" data-v-e8862398><!--[-->`);
      ssrRenderList(unref(endingsGuide).groups.filter((item) => item.note), (group) => {
        _push(`<p data-v-e8862398><strong data-v-e8862398>${ssrInterpolate(group.label)} :</strong> ${ssrInterpolate(group.note)}</p>`);
      });
      _push(`<!--]--></div></section><section class="tense-page__examples"${ssrRenderAttr("aria-labelledby", `${unref(modeSlug)}-${unref(tenseSlug)}-examples`)} data-v-e8862398><header data-v-e8862398><p data-v-e8862398>02</p><div data-v-e8862398><h2${ssrRenderAttr("id", `${unref(modeSlug)}-${unref(tenseSlug)}-examples`)} data-v-e8862398>${ssrInterpolate(unref(copy).examples)}</h2><p data-v-e8862398>${ssrInterpolate(unref(copy).examplesIntro)}</p></div></header><div data-v-e8862398><!--[-->`);
      ssrRenderList(unref(pedagogy).examples, (example, index) => {
        _push(`<article data-v-e8862398><p class="tense-page__example-label" data-v-e8862398>${ssrInterpolate(unref(copy).example)} ${ssrInterpolate(String(index + 1).padStart(2, "0"))}</p><blockquote data-v-e8862398>${ssrInterpolate(example.sentence)}</blockquote><dl data-v-e8862398><div data-v-e8862398><dt data-v-e8862398>${ssrInterpolate(unref(copy).context)}</dt><dd data-v-e8862398>${ssrInterpolate(example.context)}</dd></div><div data-v-e8862398><dt data-v-e8862398>${ssrInterpolate(unref(copy).reason)}</dt><dd data-v-e8862398>${ssrInterpolate(example.reason)}</dd></div></dl></article>`);
      });
      _push(`<!--]--></div></section></div><footer class="tense-page__actions" data-v-e8862398>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(copy).practise)} <span aria-hidden="true" data-v-e8862398${_scopeId}>→</span>`);
          } else {
            return [
...
const _temps_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e8862398"]]);

export { _temps_ as default };
//# sourceMappingURL=_temps_-C_8Mpib8.mjs.map
