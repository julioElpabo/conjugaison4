...
<template>
  <div class="learner-error-feedback" :class="{ 'is-compact': compact }">
    <strong class="learner-error-feedback__title">
      {{ ui(details.length > 1 ? 'Types de faute' : 'Type de faute') }}
    </strong>
    <ul>
